...
<div class="card p-3">
    <div class="card-body">
        ...
        @endif
        <form action="{{ route('admin.add_user_data') }}" method="POST" class="row g-3">
        @csrf
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="email" class="form-control" name="email" id="email" placeholder="User Email Address" value="{{old('phone')}}">
                @if ($errors->has('email'))
           ...
           <input type="hidden" name="role" value="2">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="gst_number" id="GST" placeholder="GST Number" value="{{old('gst_number')}}">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="transport" id="Transport" placeholder="Transport Name" value="{{old('transport')}}">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="floor_no" id="FloorNo" placeholder="Floor No." value="{{old('floor_no')}}">
