            ...
            <div class="houmanity-card p-3">
                <div class="card p-3">
                    <div class="card-body m-3">
                        <form action="{{ route('admin.store_banner') }}" method="POST" enctype="multipart/form-data" class="dropzone" id="dropzone">
                            @csrf 
                        </form>
                    ...
                    <tbody>
                        @if(!blank($banners))
                            @foreach ($banners as $item)
                                <tr>
                                    <td data-th="Image"><img src="{{url('/')}}/public/banners/{{$item->image}}" alt="" width="80px"></td>
                        ...
                        @else
                            <tr class="text-center">
                                <th colspan="3">Banners not found.</th>
                            </tr>
                        @endif
                    </tbody>
                </table>
