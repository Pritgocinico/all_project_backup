        ...
        <table class="table w-100 mt-10">
            ...
            @if(isset($statement['role']))
                ...
                @elseif($statement['role'] == 3)
                    <tr>
                        <td>
                           <p class="m-0 text-bold w-100"> Head Quarter</p>
                        </td>
                        <td>
                            <span class="gray-color">{{$statement['headquarter']}}</span>
                        </td>
                    </tr>
                @endif
            @else
                ...
                <tr>
                    ...
                    <td>
                        <?php
                            ...
                            if(!blank($products)){
                                $cgst = (($item->price*$products->cgst)/100)*$item->quantity; 
                                $sgst = (($item->price*$products->sgst)/100)*$item->quantity;
