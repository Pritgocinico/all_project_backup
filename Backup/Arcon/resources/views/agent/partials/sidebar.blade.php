    ...
    <div class="row justify-content-end m-0 p-0">
        ...
        <div class="header">
            <div class="px-md-2 d-flex align-items-center">
                @if(isset($icon) && $icon != '')
                    ...
                    <li>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <li><a class="dropdown-item" href="{{ route('agent.view.profile') }}">My Profile</a></li>
                                <li><a class="dropdown-item" href="{{ route('agent.edit.profile') }}">Edit Profile</a></li>
    ...
    <nav id="sidebarMenu" class="col-md-2 col-lg-2 col-xl-2 col-xxl-2 d-md-block bg-light sidebar collapse gc-sidebar">
        <div class="position-sticky pt-3">
            ...
            <ul class="sidenav admin-sidebar nav flex-column">
                ...
                <li class="">
                    <a class="nav-link @if(\Request::route()->getName() == 'agent.dashboard') active @endif"
                ...
                <li class="">
                    <a class="nav-link  @if(\Request::route()->getName() == 'agent.users') active @endif"
                ...
                {{-- <li class="">
                    <a href="#" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle sub-menu nav-link @if(\Request::route()->getName() == 'agent.products' || \Request::route()->getName() == 'agent.categories' || \Request::route()->getName() == 'agent.edit_category' || \Request::route()->getName() == 'agent.add_product')  active @endif">
                        <span class="nav-link-icon">
                    ...
                    <ul class="dropdown-container collapse list-unstyled">
                        <li><a href="{{ route('agent.products') }}" class="@if(\Request::route()->getName() == 'agent.products' || \Request::route()->getName() == 'agent.add_product' || \Request::route()->getName() == 'agent.edit_product') active @endif">Products</a></li>
                        <li><a href="{{ route('agent.categories') }}" class="@if(\Request::route()->getName() == 'agent.categories' || \Request::route()->getName() == 'agent.add_category' || \Request::route()->getName() == 'agent.edit_category') active @endif">Categories</a></li>
                    </ul>
                </li> --}}
                <li class="">
                    <a class="nav-link  @if(\Request::route()->getName() == 'agent.orders') active @endif"
