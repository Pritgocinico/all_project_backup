...
<div class="row row-cols-1 row-cols-md-3 g-4">
    <div class="col-lg-12 col-md-12">
        <div class="col-md-4 float-end">
            <form action="{{route('agent.dashboard')}}">
                <div class="d-flex">
                    <input type="text" name="start_date" id="startDate" class="form-control me-2" value="@if(request()->get('start_date')){{request()->get('start_date')}}@endif">
                    <input type="text" name="end_date" id="endDate" class="form-control me-2" value="@if(request()->get('end_date')){{request()->get('end_date')}}@endif">
            ...
            <div class="card-body">
                <div class="d-flex">
                    <div>
                        ...
                        <?php
                            $order_count = DB::table('orders')->join('users','users.id','=','orders.user_id')
                ...
                <a href="{{route('agent.orders')}}" class="card_link"></a>
            </div>
        </div>
    </div>
    <div class="col-lg-4 col-md-12">
        <div class="card card-bg1 h-100 p-2">
            <div class="card-body">
                <div class="d-flex">
                    <div>
                        <p class="mb-0 fs-20"><i> Total <b>Dealers</b></i></p>
                        <div class="d-flex mb-2">
                            <?php $user_count = DB::table('users')->where('role',2)->where('agent', Auth::user()->id)->count(); ?>
                            <h1 class="mb-0">{{$user_count}}</h1>
                            <!-- <div class="ms-auto" id="total-orders"></div> -->
                        </div>
                        <p>{{$user_count}}+ total dealers...</p>
                    </div>
                    <div class="dropdown ms-auto">
                        <a href="#" data-bs-toggle="dropdown" class="btn btn-sm" aria-haspopup="true"
                        aria-expanded="false">
                ...
                <a href="{{route('agent.users')}}" class="card_link"></a>
            </div>
        </div>
    </div>
    <div class="col-lg-8">
