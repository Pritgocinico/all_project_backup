    ...
    <div
        ...
        <main class="container-fluid p-0">
            <div class="px-6 px-lg-7 pt-8 border-bottom">
                ...
                @elseif(collect($accesses)->where('menu_id', '12')->first()->status == 1 ||
                        collect($accesses)->where('menu_id', '12')->first()->status == 3)
                    <ul class="nav nav-tabs nav-tabs-flush gap-8 overflow-x border-0 mt-4" id="myTab" role="tablist">
                        <li class="nav-item">
            ...
            <div class="px-6 px-lg-7 pt-6">
                <div class="tab-content clearfix">
                    <div id="generate-certificate"
                        class="tab-pane fade @if (collect($accesses)->where('menu_id', '12')->first()->status == 2) show active @endif"role="tabpanel"
                        aria-labelledby="generate-certificate-tab">
                        <main class="container-fluid px-6 pb-10">
                            <form id="certificateForm" enctype="multipart/form-data"  method="POST">
                                @csrf
                                <div class="row align-items-center g-3 mt-6">
                                    <div class="col-md-2"><label class="form-label mb-0">Title <span class="text-danger">*</span></label></div>
                                    ...
                                    <div class="col-md-2"><label class="form-label mb-0">Employee <span class="text-danger">*</span></label></div>
                                    <div class="col-md-4 col-xl-4">
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    <div class="col-md-2"><label class="form-label mb-0">Director <span class="text-danger">*</span></label></div>
                                    <div class="col-md-4 col-xl-4">
                                    ...
                                    <div class="col-md-2"><label class="form-label mb-0">Manager <span class="text-danger">*</span></label></div>
                                    <div class="col-md-4 col-xl-4">
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    <div class="col-md-2"><label class="form-label mb-0">Director Signature</label>
                                    </div>
                                    <div class="col-md-4 col-xl-4">
                                    ...
                                    <div class="col-md-2"><label class="form-label mb-0">Manager Signature</label>
                                    </div>
                                    <div class="col-md-4 col-xl-4">
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    <div class="col-md-2"><label class="form-label mb-0">Description <span class="text-danger">*</span></label></div>
                                ...
                                <div class="row align-items-center g-3 mt-6" id="">
                                    <div class="col-md-2"><label class="form-label mb-0">Month <span class="text-danger">*</span></label></div>
                                    <div class="col-md-4">
                    ...
                    <div id="certificate-list" class="tab-pane fade @if (collect($accesses)->where('menu_id', '12')->first()->status == 1 ||
                            collect($accesses)->where('menu_id', '12')->first()->status == 3) show active @endif"
                        role="tabpanel" aria-labelledby="certificate-list-tab">
                        <div class="px-6 px-lg-7 pt-6">
                            <div id="certificate_table_ajax" class=" custom-scrollbar"></div>
                        </div>
                    </div>
                </div>
            </div>
