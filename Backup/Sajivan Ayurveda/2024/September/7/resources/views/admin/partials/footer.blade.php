...
<script>
    ...
    // Global Search
    // $(document).ready(function() {
    //     var selectedTextVal = 'name'; // Default value
    ...
    //                     var html = `<div class="header-nav-search-result-inner" id="no-result-found">
    //             <div class="header-nav-search-result-inner-div">

    //                 <div class="header-nav-search-result-inner-div-result">`
    //                     $.each(data,function(i,v){
    //                         html += `<a href="{{url('customer')}}/${v.id}"><p>${i+1} . ${v.name} - ${v.mobile_number}</p></a>`;                            
    //                     });
    //                     // 
    //                 html +=`</div>
    ...
    //         </div>`;
    //                     // $('#no-result-found').html('<div class="header-nav-search-result-inner-div-result">' + data + '</div>');
    //                 }else{
    //                     var html = `
    ...
    $(document).click(function(e) {
        ...
        if (!target.closest('#customerGlobal_search').length && !target.closest('#search_data').length) {
            $('#search_data').empty();
        }
    });
});
