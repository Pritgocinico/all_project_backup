...
<head>
    ...
    <link rel="shortcut icon" href="{{ $settings && isset($settings->fa_icon) ? asset('/storage/' . $settings->fa_icon) : asset('assets/img/login/favicon-sajivan.png') }}" />
    <title>{{isset($page)?$page."-":""}}{{ $settings && $settings->site_name ? $settings->site_name : 'Sajivan Ayurveda' }}</title>
    ...
    <!-- flatpickr CSS -->
    <link href="{{ asset('plugin/flatpickr/flatpickr.min.css') }}" rel="stylesheet">
    <link href="{{ asset('plugin/flatpickr/style.css') }}" rel="stylesheet">
