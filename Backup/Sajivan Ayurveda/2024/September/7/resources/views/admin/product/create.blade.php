                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            <div class="col-md-4 col-xl-4 d-none" id="powder_div">
                                <select name="powder_unit" class="form-control">
                                    <option value="">Select Option</option>
                                    <option value="10_gm" {{ old('powder_unit') == '10_gm' ? 'selected' : '' }}>10 gm</option>
                                    <option value="50_gm" {{ old('powder_unit') == '50_gm' ? 'selected' : '' }}>50 gm</option>
                            ...
                            <div class="col-md-4 col-xl-4 d-none" id="tab_div">
                                <select name="tablet_unit" class="form-control">
                                    <option value="">Select Option</option>
                                    <option value="10_tab" {{ old('tablet_unit') == '10_tab' ? 'selected' : '' }}>10 tab</option>
                                    <option value="50_tab" {{ old('tablet_unit') == '50_tab' ? 'selected' : '' }}>50 tab</option>
                                    <option value="100_tab" {{ old('tablet_unit') == '100_tab' ? 'selected' : '' }}>100 tab</option>
                                </select>
                                @error('tablet_unit')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4 col-xl-4 d-none" id="capsule_div">
                                <select name="capsule_unit" class="form-control">
                                    <option value="">Select Option</option>
                                    <option value="10_tab" {{ old('capsule_unit') == '10_tab' ? 'selected' : '' }}>10 tab</option>
                                    <option value="50_tab" {{ old('capsule_unit') == '50_tab' ? 'selected' : '' }}>50 tab</option>
                                    <option value="100_tab" {{ old('capsule_unit') == '100_tab' ? 'selected' : '' }}>100 tab</option>
                                </select>
                                @error('capsule_unit')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
