            ...
            <div
                ...
                <main class="container-fluid px-6 pb-10">
                    <form action="{{ route('user.update', $user->id) }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            <div class="col-md-2"><label class="form-label mb-0">Password <span class="text-danger">*</span></label></div>
                            <div class="col-md-4 col-xl-4">
                            ...
                            <div class="col-md-2"><label class="form-label mb-0">Joining Date <span class="text-danger">*</span></label></div>
                            <div class="col-md-4 col-xl-4">
                                <input type="date" name="joining_date" class="form-control" value="{{$user->joining_date}}" max="{{date('Y-m-d')}}">
                                @error('joining_date')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            <div class="col-md-2"><label class="form-label mb-0">Role <span class="text-danger">*</span></label></div>
                            <div class="col-md-4 col-xl-4">
                        ...
                        <div class="row align-items-center g-3 mt-6" id="salary-input" style="display: none;">
                            <div class="col-md-2"><label class="form-label mb-0">Salary <span class="text-danger">*</span></label></div>
                            <div class="col-md-4 col-xl-4">
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            @if(isset($user->profile_image))
                                <div class="col-md-1 col-xl-1 adhar_image_div">
                                    <a href="{{ asset('storage/'.$user->profile_image) }}" target="_blank" class="btn btn-sm btn-dark "><span>View</span></a>
                                </div>
                                <div class="col-md-1 col-xl-1">
                                    <a href="#" class="btn btn-sm btn-danger remove_document" data-type="profile_image"><span>Remove</span></a>
                                </div>
                            @endif
