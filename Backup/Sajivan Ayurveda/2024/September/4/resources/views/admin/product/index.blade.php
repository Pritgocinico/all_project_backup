    ...
    <div
        ...
        <main class="container-fluid p-0">
                    ...
                    <div class="hstack gap-2 ms-auto">
                        @if (collect($accesses)->where('menu_id', '19')->first()->status == 2)
                            <a href="#" class="btn btn-sm btn-dark" data-bs-toggle="modal"
                                ...
                                Export</a>
                            <a href="{{ route('product.create') }}" class="btn btn-sm btn-dark"><i class="fa fa-plus me-2"></i>
                                Create Product</a>
                        @endif
                    </div>
                </div>
            ...
            <div class="px-6 px-lg-7 pt-8">
                <div id="product_table_ajax" class="table-responsive custom-scrollbar"></div>
            </div>
                ...
                success: function(res) {
                    ...
                    $("#product_table").DataTable({
                        initComplete: function() {
                            ...
                            $searchInput.attr('placeholder', 'Search Product');
                        },
                        lengthChange: false,
                        "order": [
                            [0, 'asc']
