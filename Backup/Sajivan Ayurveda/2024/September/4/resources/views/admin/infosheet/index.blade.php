...
@section('content')
    <div
        ...
        <main class="container-fluid p-0">
                ...
                <div class="d-flex align-items-center mb-5">
                    ...
                    <div class="hstack gap-2 ms-auto">
                        ...
                        <a href="#" class="btn btn-sm btn-dark" data-bs-toggle="modal" data-bs-target="#kt_modal_export_users"
                                ...
                                Export</a>
                            <a href="{{ route('info_sheet.create') }}" class="btn btn-sm btn-dark"><i class="fa-solid fa-plus"></i>
                                Create Info Sheet</a>
                        @endif
                    </div>
                </div>
            ...
            <div id="infosheet_table_ajax" class="table-responsive custom-scrollbar">
            </div>  
            </div>
            {{-- export modal --}}
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    initComplete: function() {
                        ...
                        $searchInput.attr('placeholder', 'Search Info Sheet');
                    },
                    "pageLength": 20,
                    lengthChange: false,
                            "order": [
        ...
        function deleteInfoSheet(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('info_sheet.destroy', '') }}" + "/" + id,
                        type: 'DELETE',
                        dataType: 'json',
                        data: {
                            _token: "{{ csrf_token() }}",
