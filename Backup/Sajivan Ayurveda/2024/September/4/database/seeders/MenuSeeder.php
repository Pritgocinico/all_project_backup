...
class MenuSeeder extends Seeder
{
    ...
    {
        $menus = ['dashboard', 'department', 'designation', 'role', 'user', 'info sheet', 'leave', 'holiday', 'ticket', 'attendance', 'daily attendance', 'certificate', 'pay salary', 'shift', 'lead','follow_up','Service Preference', 'customer', 'product', 'category', 'log'];
