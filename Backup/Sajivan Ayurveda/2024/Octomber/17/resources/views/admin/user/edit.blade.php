            ...
            <div
                ...
                <main class="container-fluid px-6 pb-10">
                    <form action="{{ route('user.update', $user->id) }}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="col-md-6 row align-items-center g-3 ">
                                ...
                                <div class="col-md-8 col-xl-6">
                                    <input type="text" name="personal_email" class="form-control"
                                        placeholder="Enter Personal Email" value="{{ $user->personal_email }}">
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            <div class="col-md-6 row align-items-center g-3 ">
                                <div class="col-md-4"><label class="form-label mb-0">Login Id <span
                                            class="text-danger">*</span></label></div>
                                <div class="col-md-8 col-xl-6">
                            ...
                            <div class="col-md-6 row align-items-center g-3 ">
                                <div class="col-md-4"><label class="form-label mb-0">Login Password <span
                                            class="text-danger">*</span></label></div>
                                <div class="col-md-8 col-xl-6">
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            ...
                            <div class="col-md-6 row align-items-center g-3 ">
                                <div class="col-md-4"><label class="form-label mb-0">Phone Number <span
                                            class="text-danger">*</span></label></div>
                                <div class="col-md-8 col-xl-6">
                                    <input type="text" name="phone_number" pattern="\d*" minlength="10" maxlength="10"
                            ...
                            <div class="col-md-6 row align-items-center g-3 ">
                                ...
                                <div class="col-md-8 col-xl-6">
                                    <input type="date" name="date_of_birth" class="form-control"
                                        value="{{ $user->date_of_birth ?? date('Y-m-d') }}" id="date_of_birth">
                                    @error('date_of_birth')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        @foreach ($user->officeNumber as $index => $number)
                            <div class="row align-items-center gap-3 mt-3 exist_office_num_{{ $number->id }}">
                                ...
                                <div class="col-md-6 row align-items-center g-3 ">
                                    ...
                                    <div class="col-md-8 col-xl-6">
                                        <input type="hidden" name="office_num_ids[]" value="{{ $number->id }}">
                                        <input type="text" name="office_calling_number[]" class="form-control"
                                            ...
                                            value="{{ old('office_calling_number.' . $index, $number->office_calling_number) }}">
                                        @error('office_calling_number.' . $index)
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div
                            class="row align-items-center gap-3 mt-6 is_manager_div_select {{ $user->role_id == '1' ? 'd-none' : '' }}">
                            <div class="col-md-6 row align-items-center g-3 ">
                                ...
                                <div class="col-md-8 col-xl-6">
                                    <select name="is_manager" class="form-control" id="is_manager">
                                        ...
                                        <option value="yes" @if ($user->is_manager == 'yes') selected @endif>Yes
                                        </option>
                                        <option value="no" @if ($user->is_manager == 'no') selected @endif>No
                                        </option>
                                    </select>
                                    @error('is_manager')
                                        <div class="text-danger">{{ $message }}</div>
                            ...
                            <div
                                class="col-md-6 row align-items-center g-3 team_member_select {{ $user->is_manager == 'no' ? 'd-none' : '' }}">
                                ...
                                <div class="col-md-8 col-xl-6">
                                    <select name="user_id[]" class="form-control" id="user_id" multiple>
                                        @foreach ($employeeList as $userEmployee)
                                            <option value="{{ $userEmployee->id }}"
                                                {{ in_array($userEmployee->id, $managerMember) ? 'selected' : '' }}>
                                                {{ $userEmployee->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('user_id')
                                        <div class="text-danger">{{ $message }}</div>
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            <div class="col-md-6 row align-items-center g-3 ">
                                ...
                                <div class="col-md-3 col-xl-2">
                                    ...
                                    <div id="aadhar_card_preview" class="preview_image_upload"></div>
                                    @error('aadhar_card')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 row align-items-center g-3 ">
                                ...
                                <div class="col-md-3 col-xl-2">
                                    ...
                                    <div id="pan_card_preview" class="preview_image_upload"></div>
                                    @error('pan_card')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                                    ...
                                    <div class="hstack gap-2 ">
                                        <label for="address_proof" class="btn btn-sm btn-neutral"><span>Upload</span>
                                            <input type="file" name="address_proof" id="address_proof"
                                                class="visually-hidden address_proof" value="{{ $user->address_proof }}">
                                        </label>
                                    </div>
                                    <div class="w-100 preview_image_upload" id="address_proof_preview"></div>
                                    @error('address_proof')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                @if (isset($user->address_proof))
                                    <div class="col-md-2 col-xl-1 mt-0 adhar_image_div">
                                    ...
                                    <div class="col-md-2 col-xl-1 mt-0">
                                        <a href="#" class="btn btn-sm btn-danger remove_document"
                                            data-type="address_proof"><span>Remove</span></a>
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="col-md-6 row align-items-center g-3 ">
                                    ...
                                    <div class="hstack gap-2 ">
                                        <label for="passport_photo" class="btn btn-sm btn-neutral"><span>Upload</span>
                                            <input type="file" name="passport_photo" id="passport_photo"
                                                ...
                                                value="{{ $user->passport_photo }}">
                                        </label>
                                    </div>
                                    <div class="w-100 preview_image_upload" id="passport_photo_preview"></div>
                                ...
                                @if (isset($user->passport_photo))
                                    ...
                                    <div class="col-md-2 col-xl-1 mt-0">
                                        <a href="#" class="btn btn-sm btn-danger remove_document"
                                            data-type="passport_photo"><span>Remove</span></a>
                                    </div>
                                @endif
                            </div>
                        </div>
                                    ...
                                    <div class="hstack gap-2 ">
                                        <label for="marksheet" class="btn btn-sm btn-neutral"><span>Upload</span>
                                            <input type="file" name="marksheet" id="marksheet"
                                                class="visually-hidden marksheet" value="{{ $user->marksheet }}">
                                        </label>
                                    </div>
                                    <div class="w-100 preview_image_upload" id="marksheet_preview"></div>
                                    @error('marksheet')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                @if (isset($user->marksheet))
                                    <div class="col-md-2 col-xl-1 mt-0 adhar_image_div">
                                        <a href="{{ asset('storage/' . $user->marksheet) }}" target="_blank"
                                            class="btn btn-sm btn-dark "><span>View</span></a>
                                    </div>
                                    <div class="col-md-2 col-xl-1 mt-0">
                                        <a href="#" class="btn btn-sm btn-danger remove_document"
                                            data-type="marksheet"><span>Remove</span></a>
                                    </div>
                                @else
                                    <div class="col-md-2"></div>
                                @endif
                                    ...
                                    <div class="hstack gap-2">
                                        <label for="bank_details" class="btn btn-sm btn-neutral"><span>Upload</span>
                                            <input type="file" name="bank_details" id="bank_details"
                                                class="visually-hidden bank_details" value="{{ $user->bank_details }}">
                                        </label>
                                    </div>
                                    <div class="w-100 preview_image_upload" id="bank_details_preview"></div>
                                    @error('bank_details')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                @if (isset($user->bank_details))
                                    <div class="col-md-2 col-xl-1 mt-0 bank_details">
                                        <a href="{{ asset('storage/' . $user->bank_details) }}" target="_blank"
                                            class="btn btn-sm btn-dark "><span>View</span></a>
                                    </div>
                                    <div class="col-md-2 col-xl-1 mt-0">
                                        <a href="#" class="btn btn-sm btn-danger remove_document"
                                            data-type="bank_details"><span>Remove</span></a>
                                    </div>
                                @endif
                            </div>
                        </div>
...
@section('script')
    <script>
        ...
        $(document).on('click', '.del-num', function() {
            ...
            var office_num_id = $(this).data("id");
            Swal.fire({
                title: 'Are you sure?',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $(`.exist_office_num_${office_num_id}`).remove();
                        },
