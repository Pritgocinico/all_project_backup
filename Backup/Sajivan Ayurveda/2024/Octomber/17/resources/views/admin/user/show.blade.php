        ...
        <main class="container-fluid px-3 py-5 p-lg-6 p-xxl-8">
            <div class="mb-6 mb-xl-10">
                <div class="row g-3 align-items-center">
                    <div class="col-auto">
                        @php
                            $image = asset('assets/img/login/favicon-sajivan.png');
                            if($user->profile_image != null){
                                $image = asset('storage/'.$user->profile_image);
                            }
                        @endphp
                        <img src="{{ $image }}" class="img-fluid rounded-top-start-4"
            ...
            <div class="tab-content clearfix">
                ...
                <div id="user-detail-tab"
                    ...
                    <div class="row align-items-center g-3 mt-6">
                        <div class="col-md-2"><label class="form-label mb-0">Personal Email Id</label></div>
                        <div class="col-md-4 col-xl-4">
                            {{ $user->personal_email ?? "-" }}
                        </div>
                        <div class="col-md-2"><label class="form-label mb-0">Date Of Birth</label></div>
                        <div class="col-md-4 col-xl-4">
                            {{ isset($user->date_of_birth) ? date('d-m-Y', strtotime($user->date_of_birth)) : '-' }}
                        </div>
                    </div>
                    <div class="row align-items-center g-3 mt-6">
                    ...
                    <div class="row align-items-center g-3 mt-6">
                        <div class="col-md-2"><label class="form-label mb-0">Office Calling Number</label></div>
                        <div class="col-md-4 col-xl-4">
                            @foreach ($user->officeNumber as $key=>$office)
                                {{ $office->office_calling_number }}
                                @if($key != count($user->officeNumber)-1)
                                    ,
                                @endif
                            @endforeach
                        </div>
                        <div class="col-md-2"><label class="form-label mb-0">Is Manager</label></div>
                        <div class="col-md-4 col-xl-4">
                            {{ ucfirst($user->is_manager)}}
                        </div>
                    </div>
                    @if($user->is_manager == 'yes')
                        <div class="row align-items-center g-3 mt-6">
                            <div class="col-md-2"><label class="form-label mb-0">Team Member Name</label></div>
                            <div class="col-md-4 col-xl-4">
                                @foreach ($user->teamMemberList as $key=>$member)
                                    @if(isset($member->memberData))
                                        {{ $member->memberData->name }}
                                    @endif
                                    @if($key != count($user->teamMemberList)-1)
                                        ,
                                    @endif
                                @endforeach
                            </div>
                    ...
                    <div class="row align-items-center g-3 mt-6">
                        <div class="col-md-2"><label class="form-label mb-0">Address Proof</label></div>
                        <div class="col-md-4 col-xl-4">
                        ...
                        <div class="col-md-2"><label class="form-label mb-0">Passport Size Photo</label></div>
                        <div class="col-md-4 col-xl-4">
                            @if ($user->passport_photo)
                                <a href="{{ asset('storage/' . $user->passport_photo) }}" target="_blank"
                                    class="btn btn-primary">View</a>
                            @else
                                -
                            @endif
                    ...
                    <div class="row align-items-center g-3 mt-6">
                        <div class="col-md-2"><label class="form-label mb-0">Last Marksheet</label></div>
                        <div class="col-md-4 col-xl-4">
                            @if ($user->marksheet)
                        ...
                        <div class="col-md-2"><label class="form-label mb-0">Bank Details</label></div>
                        <div class="col-md-4 col-xl-4">
