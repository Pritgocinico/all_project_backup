            ...
            <div class="row d-flex align-items-center mb-5">
                ...
                <div class="col-md-8">
                    <div class="row attendance-list-btn">
                        ...
                        <div class="col-md-3">
                            <select name="leave_status" id="leave_status" class="form-control" onchange="leaveAjax(1)">
                        ...
                        <div class="col-md-1">
                            <a class="btn btn-sm btn-dark" id="search_date" onclick="clearFilter()" value="Clear">Clear</a>
                        </div>
                        ...
                        @endif
                        @if (Auth()->user()->role_id != 1 && collect($accesses)->where('menu_id', '7')->first()->status == 2)
                        <div class="col-md-1">
...
<script>
    ...
    function exportCSV() {
        ...
        window.open(exportFile + '?format=' + format + '&search=' + search + "&date=" + date + "&status=" + status + "", '_blank');
    }
