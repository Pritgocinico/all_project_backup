        ...
        @foreach ($leads as $key=>$lead)
            <tr>
                ...
                <div class="icon-td">
                    ...
                    <a href="javascript:void(0)" onclick="saleApproval({{$lead->id}})" data-bs-toggle="tooltip" data-bs-placement="top" title="Move to Sale Approval"><i class="fa-solid fa-caravan"></i></a>
                    <a href="javascript:void(0)" onclick="rejectLead({{$lead->id}})" data-bs-toggle="tooltip" data-bs-placement="top" title="Reject Approval"><i class="fa fa-close"></i></a>
