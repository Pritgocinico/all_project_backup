                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            ...
                            <div class="col-md-6 row align-items-center g-3 ">
                                <div class="col-md-4"><label class="form-label mb-0">Customer Name <span
                                            class="text-danger">*</span></label></div>
                                <div class="col-md-8 col-xl-6">
                                    <input type="text" name="name" class="form-control capitalize_letter" id="customer_name"
                            ...
                            <div class="row align-items-center gap-3 mt-6 d-none other_option_div">
                                ...
                                <div class="col-md-6 row align-items-center g-3 {{ old('cust_disease') == 'Other' ? '' : 'd-none' }}"
                                    ...
                                    <div class="col-md-4"><label class="form-label mb-0">Other Disease <span
                                                class="text-danger">*</span></label></div>
                                    <div class="col-md-8 col-xl-6">
                                        <input type="text" name="other_cust_disease" class="form-control"
                                            placeholder="Enter Other Disease" value="{{ old('other_cust_disease') }}">
...
@section('script')
    <script>
        ...
        $('#lead_source').on('change', function() {
            ...
            $('.other_option_div').addClass('d-none');   
            if($(this).val() == "Other" || $('#cust_disease').val() == "other"){
                $('.other_option_div').removeClass('d-none');   
            }
        });
        ...
        $('#cust_disease').on('change', function() {
            ...
            $('.other_option_div').addClass('d-none');   
            if($(this).val() == "other" || $('#lead_source').val() == "Other"){
                $('.other_option_div').removeClass('d-none');   
            }
        })
        ...
        function customerExist(){
            var number = $('#customer_number').val();
            $.ajax({
                url: "{{ route('check.number.customer') }}",
                type: 'GET',
                data: {
                    alt_num: number
                },
                success: function(data) {
                    ...
                    $('#customer_name').addClass('read-only');
                },
                error: function(error) {
                    $('#customer_name').val('');
                    $('#customer_name').removeClass('read-only');
                }
            });
        }
        // New Customer
