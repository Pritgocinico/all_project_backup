    ...
    <div
        ...
        <main class="container-fluid p-0">
            <div class="px-6 px-lg-7 pt-8 border-bottom">
                ...
                @if (collect($accesses)->where('menu_id', '12')->first()->status == 2 && Auth()->user()->role_id == 1)
                    ...
                    <div id="generate-certificate"
                        ...
                        <main class="container-fluid px-6 pb-10">
                            <form id="certificateForm" enctype="multipart/form-data"  method="POST">
                                ...
                                <div class="row align-items-center gap-3 mt-6">
                                <div class="col-md-6 row align-items-center g-3 ">
                                    <div class="col-md-4"><label class="form-label mb-0">Director <span class="text-danger">*</span></label></div>
                                    <div class="col-md-8 col-xl-6">
                                    ...
                                    <div class="col-md-6 row align-items-center g-3 ">
                                    <div class="col-md-4"><label class="form-label mb-0">Manager <span class="text-danger">*</span></label></div>
                                    <div class="col-md-8 col-xl-6">
                                ...
                                <div class="row align-items-center gap-3 mt-6">
                                <div class="col-md-6 row align-items-center g-3 ">
                                    <div class="col-md-4"><label class="form-label mb-0">Director Signature</label>
                                    </div>
                                    <div class="col-md-8 col-xl-6">
                                    ...
                                    <div class="col-md-6 row align-items-center g-3 ">
                                    <div class="col-md-4"><label class="form-label mb-0">Manager Signature</label>
                                    </div>
                                    <div class="col-md-8 col-xl-6">
                                ...
                                <div class="row align-items-center gap-3 mt-6">
                                <div class="col-md-6 row align-items-center g-3 ">
                                    <div class="col-md-4"><label class="form-label mb-0">Description <span class="text-danger">*</span></label></div>
                                    <div class="col-md-8 col-xl-6">
                                    ...
                                    <div class="col-md-6 row align-items-center g-3 ">
                                    <div class="col-md-4"><label class="form-label mb-0">Month <span class="text-danger">*</span></label></div>
                                    <div class="col-md-8 col-xl-6">
