                    ...
                    <div class="row align-items-center gap-3 mt-6">
                        ...
                        <div class="col-md-6 row align-items-center g-3 ">
                            ...
                            <div class="col-md-8 col-xl-6">
                                ...
                                <input type="hidden" name="mobile_number" class="form-control" id="customer_number"
                            ...
                            <div class="col-md-6 row align-items-center g-3 ">
                                ...
                                <div class="col-md-8 col-xl-6">
                                    <input type="date" name="lead_date" class="form-control"
                                        ...
                                        value="{{ $lead->lead_date }}" @if(auth()->user()->role_id == 1) @else readonly @endif>
                                    @error('lead_date')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
        ...
        if (number.length === 10) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    let addressHtml = '<div class="row align-items-center g-3 mt-6">';
                    $.each(data.data.customer_address, function(i, address) {
                        ...
                        else if(address.add_type === 'home_add'){
                            addType = 'Home Address';
                            icon = '<i class="fa fa-home" aria-hidden="true"></i>';
                        }
                        addressHtml += ` <div class="col-md-4 col-xl-4">
                            <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                                <strong>${icon} ${addType}</strong>
                                        </h5>
                                        <p class="card-test">
                                            ${address.address}, <br />
                                            ${address.village}, <br />
                                            ${address.office_name}, <br />
                                            ${address.dist_city}, ${address.dist_state},<br /> 
                                            ${address.pin_code}
                                        </p>
                                            </div>
                                            </div>
