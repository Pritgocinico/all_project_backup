...
<head>
    ...
    <link rel="shortcut icon"
        href="{{ $settings && isset($settings->fa_icon) ? asset('/storage/' . $settings->fa_icon) : asset('assets/img/login/favicon-sajivan.png') }}" />
    <title>{{ isset($page) ? $page . '-' : '' }}{{ $settings && isset($settings->site_name) ? $settings->site_name : 'Sajivan Ayurveda' }}</title>
