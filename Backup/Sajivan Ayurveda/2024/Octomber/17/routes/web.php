...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('change-user-status', [UserController::class, 'userStatus'])->name('change-user-status');
    Route::get('user-lead-data', [UserController::class, 'userLeadData'])->name('user.lead.data');
    Route::post('de-active-user-data', [UserController::class, 'deActiveUserData'])->name('de-active-user-data');
    ...
    Route::get('change-attendance-status', [AttendanceController::class, 'changeStatus'])->name('change.attendance.status');
    ...
    Route::get('check.number.customer',[CustomerController::class,'checkNumberCustomer'])->name('check.number.customer');
    Route::get('lead-view-edit/{id}',[LeadController::class,'viewEdit'])->name('lead-view-edit');

    Route::get('remove-cust-product',[CustomerController::class,'removeCustProduct'])->name('remove-cust-product');
    Route::get('remove-product-invoice',[ProductController::class,'removeProductInvoice'])->name('remove.product.invoice');
    
    Route::POST('bulk-assign-lead',[LeadController::class,'bulkAssign'])->name('bulk-assign-lead');
    Route::POST('bulk-lead-import',[LeadController::class,'bulkImport'])->name('bulk-lead-import');
    Route::GET('sale-approval-dashboard',[DashboardController::class,'saleApprovalDashboard'])->name('sale-approval-dashboard');
    Route::GET('leads-sale-approval',[LeadController::class,'saleApproval'])->name('leads.sale.approval');
});