        ...
        <main class="container-fluid px-3 py-5 p-lg-6 p-xxl-8">
            <div class="mb-6 mb-xl-10">
                ...
                <div class="vstack gap-3 gap-xl-6">
                    ...
                    <div class="row row-cols-xl-12 dashboard-cards emplyee-dashboard m-0">
                        <div class="d-flex justify-content-start gap-2 ">
                            <select name="follow_up_user_id" id="follow_up_user_id" class="form-control"
                    ...
                    <div class="row row-cols-xl-12 g-3 g-xl-6 dashboard-cards emplyee-dashboard mt-0">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    Up Coming Follow Up
                                ...
                                <div class="row">
                                    <div id="up_coming_follow_up_event" class="table-responsive custom-scrollbar"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div id="today_follow_up_event" class="table-responsive custom-scrollbar"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row row-cols-xl-12 g-3 g-xl-6 dashboard-cards emplyee-dashboard">
                                ...
                                <div class="col">
                                    <a href="{{ route('salary-slip.index') }}">
                                        <div class="card bg-style3">
                                            <div class="p-7 dashboard-inner-card">
                                                <div>
                                                    <span class="d-block h3 d-inner-title"
                                                        style="font-size: 28px!important">{{ $salarySlipMonth }}</span>
...
@section('script')
    ...
    <script>
        ...
        $('#follow_up_user_id').on('change', function() {
            upComingFollow();
            todayFollow();
        })

        function upComingFollow() {
            var userId = $('#follow_up_user_id').val();
            $.ajax({
                type: "GET",
                url: "{{ route('dashboard-follow-up-data') }}",
                data: {
                    _token: "{{ csrf_token() }}",
                    user_id: userId,
                    'type': 'upcoming',
                ...
                success: function(response) {
                    $('#up_coming_follow_up_event').html("")
                    $('#up_coming_follow_up_event').html(response)
                },
            })
        }

        function todayFollow() {
            var userId = $('#follow_up_user_id').val();
            $.ajax({
                type: "GET",
                url: "{{ route('dashboard-follow-up-data') }}",
                ...
                success: function(response) {
                    $('#today_follow_up_event').html(response)
                },
            })
        }
    </script>
