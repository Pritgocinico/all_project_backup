    ...
    <div class="row align-items-center g-3 mt-6">
        ...
        <div class="col-md-2 insurance_label"
            style="display: @if ($type !== 0 || old('invest_type') == 'travel' || old('invest_type') == '') none @endif;"><label
                class="form-label mb-0"><span class="invest_insurance_type_span">Investment </span> Type</label></div>
        ...
        <div class="col-md-2 investement_field_label investement_type_field">
            <label class="form-label mb-0"><span class="invest_insurance_type_span">Investment </span> Field</label>
        </div>
