                ...
                <main class="container-fluid px-6 pb-10">
                    <form action="{{ route('customer.update-profile') }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            ...
                            <div class="col-md-8 col-xl-6"">{{ $customerDetail->customer_id }}</div>
                        </div>
                            <div class="col-md-6 row align-items-center g-3">
                            <div class="col-md-4"><label class="form-label mb-0">Customer Name:</label></div>
                            <div class="col-md-8 col-xl-6"">{{ $customerDetail->name }}</div>
                        </div>
                        </div>
                        <div class="row align-items-center gap-3 mt-6">
                            <div class="col-md-6 row align-items-center g-3">
                            <div class="col-md-4"><label class="form-label mb-0">Customer Email:</label></div>
                            <div class="col-md-8 col-xl-6">{{ $customerDetail->email }}</div></div>
                            <div class="col-md-6 row align-items-center g-3">
                            <div class="col-md-4"><label class="form-label mb-0">Phone Number:</label></div>
                            <div class="col-md-8 col-xl-6">{{ $customerDetail->mobile_number }}</div></div>
                        </div>
                        <hr class="my-6">
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            <div class="col-md-6 row align-items-center g-3">
                            <div class="col-md-4"><label class="form-label mb-0">Customer Type:</label></div>
                            ...
                            <div class="col-md-8 col-xl-6 budget_div {{$customerDetail->customer_type !== "budget" ? "d-none" : ""}}">
                            ...
                            <div class="col-md-8 col-xl-6 premium_div {{$customerDetail->customer_type !== "premium" ? "d-none" : ""}}">
            ...
            $('#add_more_button').on('click', function(e) {
                ...
                var html = `<div class="row align-items-center g-3 mt-6 add-more-items-${number}">
                    <input type="hidden" name="service_preference_tag_id[]" value="">
                            ...
                            <div class="col-md-4">
                                <select class="form-select preference_id-${i}" name="preference_id[]" data-id=${i} onchange=checkedBox(${i})>
                                    <option value="">Select Service Preference</option>
                                    @foreach ($servicePreferenceList as $preference)
                                        <option value="{{ $preference->id }}">{{ $preference->name }}</option>
                                    @endforeach
