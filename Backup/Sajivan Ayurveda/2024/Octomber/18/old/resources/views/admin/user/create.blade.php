...
@section('content')
    ...
    <div
        ...
        <main class="container-fluid px-3 py-5 p-lg-6 p-xxl-8">
            ...
            <div class="flex-fill  scrollbar bg-body rounded-top-4 rounded-top-start-lg-4 rounded-top-end-lg-0 border-top border-lg shadow-2">
                    ...
                    <form action="{{ route('user.store') }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            ...
                            <div class="col-md-6 row align-items-center g-3">
                                ...
                                <div class="col-md-4"><label class="form-label mb-0">Role</label></div>
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            <div class="col-md-6 row align-items-center g-3">
                                ...
                                <div class="col-md-8 col-xl-6">
                                    ...
                                    <select name="is_manager" class="form-control" id="is_manager" onchange="managerUser()">
                                        ...
                                        <option value="yes" {{old('is_manager') == "yes" ? "selected" : ""}}>Yes</option>
                                    </select>
                            ...
                            <div class="col-md-6 row align-items-center g-3">
                                <div class="col-md-4 manger_list_div {{old('is_manager') !== "yes" ? "d-none" : ""}}"><label class="form-label mb-0">User List</label></div>

                                <div class="col-md-8 col-xl-6 manger_list_div {{old('is_manager') !== "yes" ? "d-none" : ""}}">

                                    <select name="user_id[]" class="form-control js-example-basic-single" id="user_id" multiple>
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            ...
                            <div class="col-md-6 row align-items-center g-3">
                                ...
                                <div class="col-md-8 col-xl-6">
                                    ...
                                    <div id="user_agreement_preview upload-image-title"></div>
    ...
    <script>
        ...
        $('#phone_number').on('keyup', function(e) {
            ...
            if (phone_number.length > 10) {
                $('#phone_number').val($('#phone_number').val().substring(0, 10));
            }
        })
    </script>
