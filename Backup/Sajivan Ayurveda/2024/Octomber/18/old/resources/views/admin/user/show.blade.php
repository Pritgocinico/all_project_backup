        ...
        <main class="container-fluid px-3 py-5 p-lg-6 p-xxl-8">
            ...
            <ul class="nav nav-tabs nav-tabs-flush gap-8 overflow-x border-0 mt-4" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link active" id="user-detail" data-bs-toggle="tab" href="#user-detail-tab" role="tab"
                        aria-controls="user-detail" aria-selected="true">User Detail</a>

                </li>

                <li class="nav-item">

                    <a class="nav-link" id="attendance-list" data-bs-toggle="tab" href="#attendance-list-tab" role="tab"
                        aria-controls="attendance-list" aria-selected="false">Attendance Detail</a>

                </li>
                <li class="nav-item">

                    <a class="nav-link" id="lead-list" data-bs-toggle="tab" href="#lead-list-tab" role="tab"
                        aria-controls="lead-list" aria-selected="false">Lead Detail</a>
            ...
            <div class="tab-content clearfix">
                ...
                <div id="attendance-list-tab" class="tab-pane fade" role="tabpanel" aria-labelledby="attendance-list-tab">
                ...
                <div id="lead-list-tab" class="tab-pane fade" role="tabpanel" aria-labelledby="lead-list-tab">
                    <div class="row mb-3">
                        <di class="col-md-9"></di>
                        <div class="col-md-3">
                            <input type="text" name="lead_date_picker" id="lead_date_picker" class="form-control">
                        </div>
                    </div>
                    <div id="lead_calendar"></div>


                </div>

                <div id="user-detail-tab" class="tab-pane fade  show active" role="tabpanel"
                    ...
                    <div class="row align-items-center g-3 mt-6">
                        ...
                        @foreach ($user->deductionDetail as $deduct)
                            <div class="col-md-2"><label class="form-label mb-0">{{ $deduct->deduction_type }}</label>
                            </div>
...
@section('script')
    <script>
        $(document).ready(function() {
            $(function() {
                $('#lead_date_picker').daterangepicker({
                    autoUpdateInput: true,
                    maxDate: moment(),
                    startDate: moment(),
                    endDate: moment(),
                }, function(start, end, label) {
                    $('#lead_date_picker').val(start.format('Y-MM-DD') + '/' + end.format(
                        'Y-MM-DD'));
                    leadDataAjax();
                });
        ...
        function leadDataAjax() {
            var date = $('#lead_date_picker').val();
            var url = "{{ route('emp.lead.ajax') }}";
            $.ajax({
                type: "GET",
                url: url,
                data: {
