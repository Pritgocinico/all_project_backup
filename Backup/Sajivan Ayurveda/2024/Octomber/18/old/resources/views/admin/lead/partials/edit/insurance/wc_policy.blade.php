...
<div class="row align-items-center g-3 mt-6">
    <div class="col-md-2"><label class="form-label mb-0">Sub-Contractor Employee Coverage</label></div>
    <div class="col-md-4 col-xl-4">
        <select name="sub_contract_coverage" id="sub_contract_coverage" class="form-select">
            <option value="">Select Sub-Contractor Employee Coverage</option>
            <option value="yes" {{ $insuranceData->sub_contract_coverage == "yes" ? 'selected'  : ""}}>Yes</option>
            <option value="no" {{ $insuranceData->sub_contract_coverage == "no" ? 'selected'  : ""}}>No</option>
        </select>
    </div>
    <div class="col-md-2"><label class="form-label mb-0">Occupational Diseases Coverage</label></div>
    <div class="col-md-4 col-xl-4">
        <select name="occupatioanal_diseases_covarage" id="occupatioanal_diseases_covarage" class="form-select">
            <option value="">Select Occupational Diseases Coverage</option>
            <option value="yes" {{ $insuranceData->occupatioanal_diseases_covarage == "yes" ? 'selected'  : ""}}>Yes</option>
            <option value="no" {{ $insuranceData->occupatioanal_diseases_covarage == "no" ? 'selected'  : ""}}>No</option>
        </select>
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-2"><label class="form-label mb-0">Fire Extinguishers, Fire hydrant</label></div>
    <div class="col-md-4 col-xl-4">
        <select name="fire_extinguishers" class="form-control" id="fire_extinguishers">
            <option value="">Select Fire Extinguishers, Fire hydrant</option>
