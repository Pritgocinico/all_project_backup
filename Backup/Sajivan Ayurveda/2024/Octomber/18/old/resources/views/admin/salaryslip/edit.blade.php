            ...
            <div
                ...
                <main class="container-fluid px-6 pb-10">
                    <form action="{{ route('salary-slip.update', $salaryDetail->id) }}" enctype="multipart/form-data"
                        ...
                        @csrf
                        <div class="mt-6">
                            <input type="hidden" name="default_overtime" value="{{$salaryDetail->over_time_amount ??0}}">
                            <div id="deduction-container">
                                <div class="row align-items-center gap-3 mt-6">
                                    <div class="col-md-6 row align-items-center g-3">
                                        <div class="col-md-4"><label class="form-label mb-0">Employee</label></div>
                                    ...
                                    <div class="col-md-6 row align-items-center g-3">
                                    <div class="col-md-4"><label class="form-label mb-0">Present Days</label></div>
                                    <div class="col-md-8 col-xl-6">
                                        <input type="text" name="present_day" class="form-control"
                                            value="{{ $salaryDetail->present_days}}">
                                        @error('present_day')
                                            <div class="text-danger required-msg">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row align-items-center gap-3 mt-6">
                                    ...
                                    <div class="col-md-6 row align-items-center g-3">
                                        <div class="col-md-4"><label class="form-label mb-0">Absent Day</label></div>
                                        <div class="col-md-8 col-xl-6">
                                            <input type="text" name="absent_day" class="form-control"
                                                value="{{ $salaryDetail->absent_day}}">
                                            @error('absent_day')
                                                <div class="text-danger required-msg">{{ $message }}</div>
                                            @enderror
                                        </div>
                                   ...
                                   <div class="col-md-6 row align-items-center g-3">
                                        <div class="col-md-4"><label class="form-label mb-0">Total Overtime Hour</label></div>
                                        <div class="col-md-8 col-xl-6">
                                            <input type="text" name="total_over_time" class="form-control"
                                                value="{{ $salaryDetail->total_over_time}}">
                                ...
                                <div class="row align-items-center gap-3 mt-6">
                                    <div class="col-md-6 row align-items-center g-3">
                                        <div class="col-md-4"><label class="form-label mb-0">Total Overtime Amount</label></div>
                                        <div class="col-md-8 col-xl-6">
                                            <input type="text" name="over_time_amount" class="form-control"
                                                value="{{ $salaryDetail->over_time_amount}}">
    ...
    <script>
        $(document).ready(function() {
            $('#add-deduction').click(function() {
                var newDeduction = `
                    <div class="row align-items-center gap-3 mt-6 deduction-row">
                        <div class="col-md-6 row align-items-center g-3">
                    <input type="hidden" name="deduction_id[]" value="" data-type="button">
                        ...
                        <div class="col-md-2 col-xl-2 text-end">
                            <button type="button" class="btn btn-danger remove-deduction" data-type="button"><i class="fa fa-trash-can"></i></button>
                        </div>
                        </div>
                    </div>
                `;
