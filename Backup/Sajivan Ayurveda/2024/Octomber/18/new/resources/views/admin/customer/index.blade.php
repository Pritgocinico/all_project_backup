    ...
    <div
        ...
        <main class="container-fluid p-0">
            <div class="px-6 px-lg-7 pt-8 border-bottom">
                <div class="d-flex align-items-center mb-5">
                    ...
                    <div class="hstack gap-2 ms-auto">
                        @if (collect($accesses)->where('menu_id', '18')->where('export', 1)->first())
                            <a href="#" class="btn btn-sm btn-dark" data-bs-toggle="modal"
                                data-bs-target="#kt_modal_export_users" data-bs-toggle="modal">
                                Export</a>
                        @endif
                        @if (collect($accesses)->where('menu_id', '18')->where('add', 1)->first())
                            <a href="{{ route('customer.create') }}" class="btn btn-sm btn-dark"><i
            ...
            <div class="px-6 px-lg-7 pt-8">
                <div id="customer_table_ajax" class=" custom-scrollbar">
                ...
                success: function(res) {
                    ...
                    $("#customer_table").DataTable({
                        initComplete: function() {
                            ...
                            $searchInput.attr('placeholder', 'Search Customers');
                        },
                        lengthChange: false,
                        "order": [
                            [0, 'asc']
