                                                                    ...
                                                                    <div class="col-md-6 row align-items-center g-3">
                                                                        ...
                                                                        <div class="col-md-8 col-xl-6">
                                                                            ...
                                                                            <input type="text" name="quantity[]"
                                                                                ...
                                                                                data-index="{{ $ind }}">
                                                                            <div id="total_stock_div_{{$ind}}">Stock:- <span id="total_stock_{{$ind}}">{{ isset($product->leadProduct) ? $product->leadProduct->stock : 0 }}</span></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-md-6 row align-items-center g-3">
                                                                        ...
                                                                        <div class="col-md-8 col-xl-6">
                                                                            ...
                                                                            <input type="text" name="quantity[]"
                                                                                ...
                                                                                value="" data-index="0">
                                                                            <div id="total_stock_div_0">Stock:- <span id="total_stock_0">0</span></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="col-md-6 row align-items-center g-3">
                                                    ...
                                                    <div class="col-md-8 col-xl-6">
                                                        ...
                                                        <input type="text" name="quantity[]"
                                                            ...
                                                            data-index="${product}">
                                                        <div id="total_stock_div_${product}">Stock:- <span id="total_stock_${product}">0</span></div>
                                                    </div>
                                                </div>
                                            </div>
