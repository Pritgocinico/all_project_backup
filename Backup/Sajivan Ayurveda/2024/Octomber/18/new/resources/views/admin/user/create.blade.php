                ...
                <main class="container-fluid px-6 pb-10">
                    <form action="{{ route('user.store') }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div
                            ...
                            <div
                                class="col-md-6 row align-items-center g-3 team_member_select {{ old('is_manager') == 'yes' ? '' : 'd-none' }}">
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            ...
                            <div class="col-md-6 row align-items-center g-3">
                                ...
                                <div class="col-md-3 col-xl-2">
                                    ...
                                    <div id="passport_photo_preview" class="preview_image_upload"></div>
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            <div class="col-md-6 row align-items-center g-3">
                                ...
                                <div class="col-md-4 col-xl-4">
                                    ...
                                    <div id="marksheet_preview" class="preview_image_upload"></div>
                                    @error('marksheet')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 row align-items-center g-3 mt-0 ">
                                ...
                                <div class="col-md-3 col-xl-2">
                                    ...
                                    <div id="bank_details_preview" class="preview_image_upload"></div>
                                    @error('bank_details')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
