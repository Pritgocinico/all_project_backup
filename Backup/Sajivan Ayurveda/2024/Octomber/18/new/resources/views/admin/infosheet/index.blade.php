            ...
            <div class="px-6 px-lg-7 pt-8 border-bottom">
                <div class="d-flex align-items-center mb-5">
                    ...
                    <div class="hstack gap-2 ms-auto">
                        @if (collect($accesses)->where('menu_id', '6')->where('export', 1)->first())
                            <a href="#" class="btn btn-sm btn-dark" data-bs-toggle="modal"
                                data-bs-target="#kt_modal_export_users" data-bs-toggle="modal">
                                Export</a>
                        @endif
                        @if (collect($accesses)->where('menu_id', '6')->where('create', 1)->first())
                            <a href="{{ route('incentive.create') }}" class="btn btn-sm btn-dark"><i
