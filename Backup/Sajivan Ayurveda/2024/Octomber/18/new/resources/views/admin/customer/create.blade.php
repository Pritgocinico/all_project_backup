...
<script>
    ...
    function getAddressDetailAdd(index) {
                ...
                <div class="address-block" data-index="${addressIndex}">
                    ...
                    <div class="row align-items-center gap-3 mt-6">
                        ...
                        <div class="col-md-6 row align-items-center g-3">
                            <div class="col-md-4"><label class="form-label mb-0">Pin Code </label></div>
                            <div class="col-md-8 col-xl-6">
                                <input type="number" name="pin_code[]" min="0" class="form-control pin_add_code" placeholder="Enter Pin Code" data-index="${addressIndex}" id="pin_code_${addressIndex}" onkeyup="getAddressDetailAdd(${addressIndex})">
                            </div>
                        </div>
                    </div>
