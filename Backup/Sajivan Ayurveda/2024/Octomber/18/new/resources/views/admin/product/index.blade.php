    ...
    <div
        ...
        <main class="container-fluid p-0">
            <div class="px-6 px-lg-7 pt-8 border-bottom">
                <div class="d-flex align-items-center mb-5">
                    ...
                    <div class="hstack gap-2 ms-auto">
                        @if (collect($accesses)->where('menu_id', '19')->where('export', 1)->first())
                            <a href="#" class="btn btn-sm btn-dark" data-bs-toggle="modal"
                                data-bs-target="#kt_modal_export_product" data-bs-toggle="modal">
                                Export</a>
                        @endif
                        @if (collect($accesses)->where('menu_id', '19')->where('add', 1)->first())
                            <a href="{{ route('product.create') }}" class="btn btn-sm btn-dark"><i
            ...
            <div class="px-6 px-lg-7 pt-8">
                <div id="product_table_ajax" class=" custom-scrollbar"></div>
            </div>
            <div class="modal fade" id="kt_modal_export_product" tabindex="-1" aria-labelledby="depositLiquidityModalLabel"
                style="display: none;" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content overflow-hidden">
                        <div class="modal-header pb-0 border-0">
                            <h1 class="modal-title h4" id="depositLiquidityModalLabel">Export Product</h1>
...
@section('script')
    <script>
                ...
                success: function(res) {
                    ...
                    $("#product_table").DataTable({
                        initComplete: function() {
                            var $searchInput = $('#product_table_filter input');
                            $searchInput.attr('id', 'product_search'); // Assign the ID
        ...
        function deleteProduct(id) {
            Swal.fire({
                title: 'Are you sure?',
                text: "Are you sure the delete this Product?",
                icon: 'warning',
