            ...
            <div class="px-6 px-lg-7 pt-8 border-bottom">
                <div class="d-flex align-items-center mb-5">
                    ...
                    <div class="hstack gap-2 ms-auto">
                        @if (collect($accesses)->where('menu_id', '16')->where('export', 1)->first())
                            <a href="#" class="btn btn-sm btn-dark" data-bs-toggle="modal"
                                data-bs-target="#kt_modal_export_users" data-bs-toggle="modal">
                                Export</a>
                        @endif
                        @if (collect($accesses)->where('menu_id', '16')->where('add', 1)->first())
            ...
            <div class="px-6 px-lg-7 pt-6">
                <div class="row g-4 mt-6">
                    <div class="col-md-6 table-responsive">
                        <div id="followup_table_ajax" class=" custom-scrollbar"></div>
                    </div>
                    <div class="col-md-6">
