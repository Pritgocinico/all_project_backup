            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content overflow-hidden">
                    <div class="modal-header pb-0 border-0">
                        ...
                        <button type="button" class="btn-close close-designation" data-bs-dismiss="modal"
                    ...
                    <form class="vstack" method="POST" id="addForm">
                        ...
                        <div class="modal-body undefined">
                            <div class="vstack gap-1">
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    <div class="col-md-3"><label class="form-label mb-0">Designation <span
                                                class="text_danger_require">*</span></label></div>
                                    <div class="col-md-9 col-xl-9">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-neutral close-designation"
