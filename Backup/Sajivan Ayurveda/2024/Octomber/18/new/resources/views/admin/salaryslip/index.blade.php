            ...
            <div class="px-6 px-lg-7 pt-8 border-bottom">
                <div class="d-flex align-items-center mb-5">
                    ...
                    <div class="hstack gap-2 ms-auto">
                        @if (collect($accesses)->where('menu_id', '13')->where('export', 1)->first())
                            <a href="#" class="btn btn-sm btn-dark" data-bs-toggle="modal"
                                data-bs-target="#kt_modal_export_users" data-bs-toggle="modal">
                                Export</a>
                        @endif
                        @if (collect($accesses)->where('menu_id', '13')->where('add', 1)->first())
                    ...
                    <div class="modal-body undefined">
                        <div class="vstack gap-1">
                            <div class="row align-items-center g-3 mt-6">
                                <div class="col-md-2">
                                    <label class="form-label">Month <span class="text_danger_require">*</span></label>
                                </div>
                                <div class="col-md-10 col-xl-10">
                                    ...
                                    <span style="color: red;" id="month_error"></span>
                                </div>
                            </div>
                        </div>
                    </div>
