        ...
        <tbody>
            @forelse ($productList as $key=>$product)
                <tr>
                    ...
                    <td class="table">{{ $product->sku }}</td>
                    <td class="table">{{ isset($product->category) ? ucfirst($product->category->name) : '' }}</td>
                    <td class="table">{{ $product->quantity }}</td>
                    <td class="table">{{ isset($product->userDetail) ? $product->userDetail->name : '-' }}</td>
                </tr>
            @empty
                <tr>
