                    ...
                    <form action="{{ $route }}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="col-md-4 col-xl-4">
                                <select name="lead_id" id="lead_id" class="form-control type_id">
                                    ...
                                    @foreach ($leads as $lead)
                                        <option value="{{ $lead->id }}" {{ old('lead_id') == $lead->id ? "selected" :"" }}>{{ $lead->lead_id }}</option>
                                    @endforeach
                                </select>
                                @error('type_id')
                                    <div class="text-danger">{{ $message }}</div>
                            ...
                            <div class="row align-items-center g-3 mt-6">
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <input type="date" class="form-control start_date" name="start_date" id="start_date"
                                        placeholder="" value="{{ old('start_date') }}" min="{{date('Y-m-d')}}">
                                    @error('start_date')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row align-items-center g-3 mt-6">
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <input type="date" class="form-control end_date" name="end_date" id="end_date"
                                        placeholder="" value="{{ old('end_date') }}" min="{{date('Y-m-d')}}">
                                    @error('end_date')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="existing d-none">
                            ...
                            <div class="row align-items-center g-3 mt-6">
                                <div class="col-md-2"><label class="form-label mb-0">Start Date</label></div>
                                <div class="col-md-4 col-xl-4">
                                    <input type="date" name="exist_start_date" id="exist_start_date" class="form-control" min="{{date('Y-m-d')}}">
                                </div>
                                <div class="col-md-2"><label class="form-label mb-0">End Date</label></div>
                                <div class="col-md-4 col-xl-4">
                                    <input type="date" name="exist_end_date" id="exist_end_date" class="form-control" min="{{date('Y-m-d')}}">
                                </div>
                            </div>
                            <div class="row align-items-center g-3 mt-6">
                                <div class="col-md-2"><label class="form-label mb-0">Remarks</label></div>
