...
@section('content')
    <div
            ...
            <div class="px-6 px-lg-7 pt-8 border-bottom">
                <div class="d-flex align-items-center mb-5">
                    ...
                    <div class="hstack gap-2 ms-auto">
                        @if (collect($accesses)->where('menu_id', '22')->where('export', 1)->first())
                            <a href="#" class="btn btn-sm btn-dark" data-bs-toggle="modal"
                                data-bs-target="#kt_modal_export_users" data-bs-toggle="modal">
                                Export</a>
                        @endif
                        @if (collect($accesses)->where('menu_id', '22')->where('add', 1)->first())
        ...
        <div class="modal fade" id="addDiseaseModal" tabindex="-1" aria-labelledby="depositLiquidityModalLabel"
            data-bs-backdrop="static" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content overflow-hidden">
                    <div class="modal-header pb-0 border-0">
                        <h1 class="modal-title h4">Add Disease</h1>
                        <button type="button" class="btn-close close-disease" data-bs-dismiss="modal"
                    ...
                    <form class="vstack" method="POST" id="addForm">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-neutral close-disease"
        ...
        <div class="modal fade" id="editDiseaseModal" tabindex="-1" aria-labelledby="depositLiquidityModalLabel"
            data-bs-backdrop="static" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content overflow-hidden">
                    <div class="modal-header pb-0 border-0">
