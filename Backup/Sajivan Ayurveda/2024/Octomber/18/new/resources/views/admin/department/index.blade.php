    ...
    <div
        ...
        <main class="container-fluid p-0">
            ...
            <div class="px-6 px-lg-7 pt-8">
                <div id="department_table_ajax" class=" custom-scrollbar"></div>
            </div>
        </main>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content overflow-hidden">
                    <div class="modal-header pb-0 border-0">
                        ...
                        <button type="button" class="btn-close close-department" data-bs-dismiss="modal"
                    ...
                    <form class="vstack" method="POST" id="addForm">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-neutral close-department"
