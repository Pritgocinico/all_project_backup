...
use App\Http\Requests\CreateServicePrefrenceTag;
use App\Models\Log;
...
class ServicePreferenceController extends Controller
{
     ...
     */
    public function store(CreateServicePrefrenceTag $request)
    {
     ...
     */
    public function update(CreateServicePrefrenceTag $request, ServicePreference $servicePreference)
    {
