...
class LeadController extends Controller
{
    ...
    public function store(CreateLeadRequest $request)
    {
        ...
        if($request->lead_type == "New Lead" || $request->lead_type == "Referance Lead"){
    ...
    public function show(string $id)
    {
        ...
        return view('admin.lead.show', compact('lead', 'customer', 'custAltnumbers', 'custAddresses', 'leadRemarks'));
    }
    ...
    public function leadRemarks(Request $request){
        ...
        if ($store) {
            ...
            return response()->json(['status' => 1, 'data' => $lead, 'message' => 'Remark added successfully.'], 200);
        }
        return response()->json(['status' => 1, 'message' => 'Something went to wrong.'], 500);
