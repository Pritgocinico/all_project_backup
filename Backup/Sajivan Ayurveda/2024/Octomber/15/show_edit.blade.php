                            ...
                            <div class="row align-items-center g-3 mt-6">
                                ...
                                <div id="product-containers">
                                    ...
                                    @if (count($leadProduct) == 0)
                                        ...
                                        <input type="hidden" name="per_product_price[]" value=""
                                            id="per_product_price_0">
                                                ...
                                                <div class="col-md-6 row align-items-center g-3">
                                                    ...
                                                    <div class="col-md-8 col-xl-6">
                                                        <input type="text" name="quantity[]"
                                                            ...
                                                            onchange="getQuantityPrice(0)" value="" data-index="0">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6 row align-items-center g-3">
                                                    ...
                                                    <div class="col-md-12 text-end mt-3">
                                                        <button type="button" class="btn btn-danger"
                                                            onclick="removeProduct(0)" data-id="0">Remove</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6 row align-items-center g-3">
                                        ...
                                        <div class="col-md-8 col-xl-8">
                                            <input type="text" name="collect_amount" class="form-control"
                                                placeholder="Enter Collactable Amount"
                                            ...
                                            <div class="timeline-header-outer">
                                                ...
                                                <div class="time d-flex">
                                                    <div class="time-tooltip">
                                                        ...
                                                        @endif
                                                        @if ($name != '')
                                                            <p data-bs-placement="top" data-animation="false"
...
@section('script')
    <script>
        $(document).ready(function(e) {
            $(function() {
                // Initialize tooltips with no animation
