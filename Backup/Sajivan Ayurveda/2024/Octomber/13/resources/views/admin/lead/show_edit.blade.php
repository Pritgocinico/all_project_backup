                    ...
                    @if (isset($lead->customerDetail))
                        ...
                        <form action="{{ route('customer_lead_update') }}" id="customer_form" method="POST">
                            ...
                            <div class="row align-items-center g-3 mt-6">
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    <div class="col-md-6 row align-items-center g-3 ">
                                        <div class="col-md-4"><label class="form-label mb-0">Lead Generation  Date</label></div>
                                        <div class="col-md-8 col-xl-6">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row align-items-center mt-6 call_back_div d-none">
                            <div class="col-md-12">
                                ...
                                <input type="datetime-local" name="next_call_date_time" id="next_call_date_time" class="form-control"
                                    placeholder="Enter Title" value="{{date('Y-m-d\TH:i')}}" min="{{date('Y-m-d\TH:i')}}">
                                        ...
                                        <div class="timeline-item">
                                            <div class="timeline-header-outer">
                                                <h3 class="timeline-header">
                                                    ...
                                                    @if($remark->remark != '')
                                                        -
                                                        <span class="remark-description-title" data-id="{{ $remark->id }}">{{$remark->remark}}</span>
                                                    @endif
                                                </h3>
                ...
                <div class="address-block" data-index="${addressIndex}">
                    ...
                    <div class="row align-items-center gap-3 mt-6">
                        ...
                        <div class="col-md-6 row align-items-center g-3">
                            ...
                            <div class="col-md-8 col-xl-6">
                                <input type="text" name="pin_code[]" min="0" class="form-control pin-code" placeholder="Enter Pin Code" data-index="${addressIndex}">
                            </div>
                        </div>
                    </div>
