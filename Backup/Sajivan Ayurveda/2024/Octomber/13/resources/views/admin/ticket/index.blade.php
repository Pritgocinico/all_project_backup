...
@section('content')
    <div
                ...
                <div class="d-flex align-items-center mb-5">
                    ...
                    <div class="hstack gap-2 ms-auto">
                        ...
                        <a href="#" class="btn btn-sm btn-dark" data-bs-toggle="modal"
                            ...
                            Export</a>
                            @endif
                        @if (collect($accesses)->where('menu_id', '9')->first() !== null &&
                                collect($accesses)->where('menu_id', '9')->first()->status == 2 &&
                                Auth()->user()->role_id !== 1)
        ...
        <div class="modal fade" id="AddticketLiquidityModal" tabindex="-1" aria-labelledby="depositLiquidityModalLabel" data-bs-backdrop="static"
            style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content overflow-hidden">
                    <div class="modal-header pb-0 border-0">
                        <h1 class="modal-title h4" id="depositLiquidityModalLabel">Add Help</h1>
                        <button type="button" class="btn-close close-ticket" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form class="vstack" method="POST" id="addForm">
                        ...
                        <div class="modal-body undefined">
                            <div class="vstack gap-1">
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    <div class="col-md-3"><label class="form-label mb-0">Ticket Type <span class="text_danger_require">*</span></label></div>
                                    <div class="col-md-9 col-xl-9">
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    <div class="col-md-3"><label class="form-label mb-0">Subject <span class="text_danger_require">*</span></label></div>
                                    <div class="col-md-9 col-xl-9">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-neutral close-ticket" data-bs-dismiss="modal">Close</button>
        ...
        <div class="modal fade" id="editticketLiquidityModal" tabindex="-1" aria-labelledby="depositLiquidityModalLabel" data-bs-backdrop="static"
            style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content overflow-hidden">
                    <div class="modal-header pb-0 border-0">
                        ...
                        <div class="modal-body undefined">
                            <div class="vstack gap-1">
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    <div class="col-md-3"><label class="form-label mb-0">Description <span class="text_danger_require">*</span></label></div>
                                    <div class="col-md-9 col-xl-9">
                                        <textarea name="description" placeholder="Enter Description" class="form-control" id="edit_description" cols="10"
                                            rows="5">{{ old('description') }}</textarea>
