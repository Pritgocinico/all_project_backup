                    ...
                    @if (isset($lead->customerDetail))
                        ...
                        <form action="{{ route('customer_lead_update') }}" id="customer_form" method="POST"
                            ...
                            <div id="customer_detail_div">
                                ...
                                @endif
                                <li class="list row1 ui-state-default list-unstyled ui-sortable-handle mt-6"
                                    data-id="{{ $lead->id }}">
                                    <div class="houmanity-card card">
                                        <div class="accordion lead_address_accordion" id="accordionFlushExample">
                                                    ...
                                                    <div class="accordion-body">
                                                            ...
                                                            @foreach ($custAddresses as $index => $address)
                                                                <div class="address-block"
                                                                    ...
                                                                    <div class="row align-items-center gap-3 mt-6">
                                                                        ...
                                                                        <div class="col-md-6 row align-items-center g-3">
                                                                            <div class="col-md-4"><label
                                                                                    class="form-label mb-0">City </label>
                                                                            </div>
                                                                            <div class="col-md-8 col-xl-6">
                                                        ...
                                                        <div class="row mt-3">
                                                            ...
                                                            <div class="col-md-4 text-end">
                                                                <button type="button"
                                                                    class="btn btn-primary add-address">Add More
                                                                    Address</button>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-6 row align-items-center g-3 ">
                                        ...
                                        <div class="col-md-8 col-xl-6">
                                            <select name="customer_language" class="form-control" id="customer_language">
                                                ...
                                                <option value="Hindi"
                                                    {{ $lead->customer_language == 'Hindi' ? 'selected' : '' }}>
                                                    Hindi
                                                </option>
                                ...
                                <div id="product-containers">
                                    ...
                                    @foreach ($leadProduct as $index => $product)
                                        ...
                                        <input type="hidden" name="cust_product_id[]" value="{{ $product->id }}">
                                        <input type="hidden" name="per_product_price[]" value="{{$product->leadProduct->price}}" id="per_product_price_{{ $product->id }}">
                                        <div class="product-block" data-index="{{ $ind }}">
                                            <div class="row align-items-center g-3 mt-6">
                                                ...
                                                <div class="col-md-6 row align-items-center g-3">
                                                    <div class="col-md-4"><label class="form-label mb-0">Quantiy
                                                        </label>
                                                    </div>
                                                    <div class="col-md-8 col-xl-6">
                                                        <input type="text" name="quantity[]"
                                                            class="form-control pin-code" min="0"
                                                            id="quantity_{{ $product->id }}" maxlength="6"
                                                            data-id="{{ $product->id }}"
                                                            onchange="getQuantityPrice({{ $product->id }})"
                                                            placeholder="Enter Quantiy" value="{{ $product->quantity }}"
                                                            data-index="{{ $ind }}">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6 row align-items-center g-3">
                                                    ...
                                                    <div class="col-md-8 col-xl-6">
                                                        <input type="number" name="tax[]" class="form-control"
                                                            placeholder="Enter Tax" placeholder="Enter Tax"
                                                            value="{{ $product->tax }}" id="tax_{{ $product->id }}"
                                                            data-id="{{ $product->id }}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row align-items-center g-3 mt-6">
                                                <div class="col-md-2"><label class="form-label mb-0">Invoice
                                                    </label></div>
                                                <div class="col-md-3">
                                                    <input type="file" name="invoice[]" id="dat_invoice"
                                                        class="form-control invoice"
                                                        value="{{ $product->invoice_file }}">
                                                </div>
                                                <div class="col-md-3 col-xl-1 mt-0 adhar_image_div">
                                                    @if (isset($product->invoice_file))
                                                        <a href="{{ asset('storage/' . $product->invoice_file) }}"
                                                            target="_blank"
                                                ...
                                                <div class="col-md-2 col-xl-1 mt-0">
                                                    @if (isset($product->invoice_file))
                                                        <a href="#" class="btn btn-sm btn-danger remove_document"
                                                            data-type="{{ $product->id }}"><span>Remove</span></a>
                                                    @endif
                                                </div>


                                                <div class="col-md-1 text-end mt-3">
                                                    <button type="button" class="btn btn-danger product_address"
                                    ...
                                    @if (count($leadProduct) == 0)
                                        ...
                                        <input type="hidden" name="per_product_price[]" value="" id="per_product_price_0">
                                        <div class="product-block" id="add_more_product_option_0">
                                            <div class="row align-items-center g-3 mt-6">
                                                <div class="col-md-6 row align-items-center g-3">
                                                    ...
                                                    <div class="col-md-8 col-xl-6">
                                                        <select name="product_id[]" class="form-control product_id"
                                                            onchange="getProductPrice(0)" id="product_id_0"
                                                            data-id="0">
                                                ...
                                                <div class="col-md-6 row align-items-center g-3">
                                                    ...
                                                    <div class="col-md-8 col-xl-6">
                                                        <input type="text" name="quantity[]"
                                                            class="form-control quantity" min="0" data-id="0"
                                                            id="quantity_0" placeholder="Enter Quantiy"
                                            ...
                                            <div class="row align-items-center gap-3 mt-6">
                                                ...
                                                <div class="col-md-6 row align-items-center g-3">
                                                    ...
                                                    <div class="col-md-8 col-xl-6">
                                                        <input type="number" name="tax[]" class="form-control"
                                                            data-id="0" placeholder="Enter Tax" id="tax_0">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row align-items-center gap-3 mt-6">
                                                <div class="col-md-6 row align-items-center g-3">
                                                    <div class="col-md-4"><label class="form-label mb-0">Invoice
                                                        </label></div>
                                                    <div class="col-md-8 col-xl-6">
                                                ...
                                                <div class="col-md-6 row align-items-center g-3">
                                                    ...
                                                    <div class="col-md-12 text-end mt-3">
                                                        <button type="button" class="btn btn-danger" onclick="removeProduct(0)"
                                                            data-id="0">Remove</button>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6 row align-items-center g-3">
                                        ...
                                        <input type="hidden" name="total_amount" class="form-control" value="{{$lead->total_amount}}"
                                            id="total_amount" >
                                    </div>

                                    <div class="col-md-6 row align-items-center g-3">
                                        <div class="col-md-4"><label class="form-label mb-0">Collactable Amount
                                            </label></div>
                                        <div class="col-md-8 col-xl-8">
                                            <input type="text" name="collect_amount" class="form-control"
                                                placeholder="Enter Collactable Amount" value="{{$lead->collectable_amount}}"
                                                id="collect_amount" >
                                        </div>
                                    </div>
                                </div>
...
@section('script')
    <script>
                ...
                <input type="hidden" name="per_product_price[]" value="" id="per_product_price_${product}">
                                                ...
                                                <div class="col-md-6 row align-items-center g-3">
                                                    ...
                                                    <div class="col-md-8 col-xl-6">
                                                        <input type="text" name="quantity[]"
                                                            ...
                                                            placeholder="Enter Quantiy" value=""
                                                            data-index="${product}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row align-items-center gap-3 mt-6">
                                                <div class="col-md-6 row align-items-center g-3">
                                                    ...
                                                    <div class="col-md-8 col-xl-6">
                                                        <input type="text" name="amount[]" class="form-control" data-id="${product}"
        ...
        function getQuantityPrice(id) {
            ...
            var totalAmount = $('#total_amount').val();
            $(`#amount_${id}`).val(parseInt(quantity) * parseInt(amount));

            $('#total_amount').val(parseInt(totalAmount) + (parseInt(quantity) * parseInt(amount)));
            $('#total_amount_div').html(parseInt(totalAmount) + (parseInt(quantity) * parseInt(amount)))
        }
