...
@section('content')
    <div class="flex-fill scrollbar bg-body rounded-top-4 rounded-top-start-lg-4 rounded-top-end-lg-0 border-top border-lg ">
                ...
                <main class="container-fluid px-6 pb-10">
                    <form action="{{ route('customer.store') }}" enctype="multipart/form-data" method="POST">
                        ...
                        @if (old('pin_code'))
                            ...
                            @for ($i = 0; $i < $cnt; $i++)
                                <input type="hidden" name="other_village[]" id="other_village_{{ $i }}">
                                <input type="hidden" name="other_office[]" id="other_office_{{ $i }}">
                                <div class="row align-items-center gap-3 mt-6">
                                    <div class="col-md-6 row align-items-center g-3">
                                    ...
                                    <div class="col-md-6 row align-items-center g-3">
                                        ...
                                        <div class="col-md-8 col-xl-6">
                                            <input type="number" name="pin_code[]" min="0"
                                                class="form-control pin-code"
                                                onkeyup="getAddressDetailDefault({{ $i }})"
                                                placeholder="Enter Pin Code" value="{{ old('pin_code.' . $i) }}"
                                                data-index="{{ $i }}" id="pin_code_{{ $i }}">
                                            @error('pin_code.' . $i)
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6 row align-items-center g-3">
                                        ...
                                        <div class="col-md-7 col-xl-7">
                                            <select name="village[]" class="form-control"
                                                onchange="addOtherOptions({{ $i }},'village')"
                                                id="village_id_{{ $i }}">
                                        ...
                                        <div class="col-md-1">
                                            <a href="javascript:void(0)" class="btn btn-primary copy-detail"
                                                onclick="copyVillage({{ $i }},'village')"
                                                data-index="{{ $i }}"><i class="fa-solid fa-copy"></i></a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center gap-3 mt-6">
                                    <div class="col-md-6 row align-items-center g-3">
                                        ...
                                        <div class="col-md-7 col-xl-7">
                                            <select name="office_name[]" class="form-control" id="office_id"
                                                onchange="addOtherOptions({{ $i }},'office')">
                                    ...
                                    <div class="col-md-6 row align-items-center g-3">
                                        ...
                                        <div class="col-md-7 col-xl-7">
                                            <input type="text" name="taluka_tehsil[]" id="taluka_tehsil"
                                                value="{{ old('taluka_tehsil.' . $i) }}" class="form-control">
                                        ...
                                        <div class="col-md-1">
                                            <a href="javascript:void(0)" class="btn btn-primary copy-detail"
                                                onclick="copyVillage({{ $i }},'taluka')" data-index=""><i
                        ...
                        @else
                            <div class="row align-items-center gap-3 mt-6">
                                <div class="col-md-6 row align-items-center g-3">
                                    <div class="col-md-4"><label class="form-label mb-0">Address Type </label></div>
                                    <div class="col-md-8 col-xl-6">
                                        <input type="hidden" name="other_village[]" id="other_village">
                                        <input type="hidden" name="other_office[]" id="other_office">
                                        <select name="add_type[]" class="form-control">
                                            <option value="">Select Type</option>
                                            <option value="office_add"
                                ...
                                <div class="col-md-6 row align-items-center g-3">
                                    ...
                                    <div class="col-md-7 col-xl-7">
                                        <select name="village[]" class="form-control" id="village_id"
                                            onchange="addOtherOptions('','village')">
                                            <option value="">Select Village</option>
                                        </select>
                                        @error('village.0')
                                            <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <div class="col-md-1">
                                        <a href="javascript:void(0)" class="btn btn-primary copy-detail"
                                            onclick="copyVillage('','village')" data-index=""><i
                                                class="fa-solid fa-copy"></i></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center gap-3 mt-6">
                                <div class="col-md-6 row align-items-center g-3">
                                    ...
                                    <div class="col-md-7 col-xl-7">
                                        <select name="office_name[]" class="form-control" id="office_id"
                                            onchange="addOtherOptions('','office')">
                                            <option value="">Select Post Office</option>
                                        </select>
                                        @error('office_name.0')
                                            <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <div class="col-md-1">
                                        <a href="javascript:void(0)" class="btn btn-primary copy-detail"
                                            onclick="copyVillage('','office')" data-index=""><i
                                                class="fa-solid fa-copy"></i></a>
                                    </div>
                                </div>
                                <div class="col-md-6 row align-items-center g-3">
                                    ...
                                    <div class="col-md-7 col-xl-7">
                                        <input type="text" name="taluka_tehsil[]" class="form-control"
                                            id="taluka_tehsil" value="{{ old('taluka_tehsil.0') }}">
                                        @error('taluka_tehsil.0')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-1">
                                        <a href="javascript:void(0)" class="btn btn-primary copy-detail"
                                            onclick="copyVillage('','taluka')" data-index=""><i
                                                class="fa-solid fa-copy"></i></a>
                                    </div>
                                </div>
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        if (data.length > 0) {
                            ...
                            html2 += `<option value="other">Other</option>`
                        ...
                        $('#taluka_tehsil').val(data[0].sub_distname);
        ...
        $(document).ready(function() {
            ...
            $('.add-address').on('click', function() {
                ...
                <div class="address-block" data-index="${addressIndex}">
                    <input type="hidden" name="other_village[]" id="other_village_${addressIndex}">
                                        <input type="hidden" name="other_office[]" id="other_office_${addressIndex}">
                    <hr class="my-6">
                    <div class="row align-items-center gap-3 mt-6">
                        <div class="col-md-6 row align-items-center g-3">
                            <div class="col-md-4"><label class="form-label mb-0">Address Type </label></div>
                        ...
                        <div class="col-md-6 row align-items-center g-3">
                            <div class="col-md-4"><label class="form-label mb-0">Pin Code </label></div>
                            <div class="col-md-8 col-xl-6">
                                <input type="number" name="pin_code[]" min="0" class="form-control pin-code" placeholder="Enter Pin Code" data-index="${addressIndex}" id="pin_code_${addressIndex}" onkeyup="getAddressDetail(${addressIndex})">
                            </div>
                        </div>
                    </div>
            ...
            function getAddressDetailDefault(index) {
                // Get the unique index for this block
                var pincode = $(`pin_code_${index}`).val();
                if (pincode.length === 6) {
                    $.ajax({
                        method: 'get',
                        url: "{{ route('pin-code-ajax') }}",
