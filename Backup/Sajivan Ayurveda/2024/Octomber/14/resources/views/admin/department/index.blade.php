    ...
    <div
        ...
        <main class="container-fluid p-0">
            ...
            <div class="px-6 px-lg-7 pt-8">
                <div id="department_table_ajax" class=" custom-scrollbar">

                </div>
            </div>
        </main>
        <div class="modal fade" id="addDepartmentModal" tabindex="-1" aria-labelledby="depositLiquidityModalLabel" data-bs-backdrop="static"
            style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content overflow-hidden">
                    <div class="modal-header pb-0 border-0">
                        <h1 class="modal-title h4">Add Department</h1>
                        <button type="button" class="btn-close close-department" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form class="vstack" method="POST" id="addForm">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-neutral close-department" data-bs-dismiss="modal">Close</button>
        ...
        <div class="modal fade" id="editDepartmentModal" tabindex="-1" aria-labelledby="depositLiquidityModalLabel" data-bs-backdrop="static"
            style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content overflow-hidden">
                    <div class="modal-header pb-0 border-0">
...
@section('script')
    <script>
        ...
        $('.close-department').on('click', function(){
            $('#addForm').trigger("reset");
        });

        function updateDepartment() {
            var departmentName = $('#edit_name').val();
            var id = $('#department_id').val();
            
            if (departmentName == '') {
                $('#edit_department_error').html('Please Enter Department.')
                editDepartment(id);
                    return false;
            }else{
