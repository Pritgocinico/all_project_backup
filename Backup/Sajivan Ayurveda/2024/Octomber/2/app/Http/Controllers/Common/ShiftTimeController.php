...
class ShiftTimeController extends Controller
{
    ...
    {
        return view('admin.shift_time.index');
    }
    ...
    public function store(CreateShiftTimeRequest $request)
    {
        ...
        $shiftCode = 'CA-' . strtoupper(substr($request->shift_name, 0, 3)) . '-' . substr("00000{$lastId}", -6);
    ...
    public function exportFile(Request $request)
    {
        ...
        if ($request->format == "pdf") {
            ...
            $pdf = PDF::loadView('admin.pdf.shift', ['shiftTimeList' => $shiftTimeList,'setting' =>$setting]);
