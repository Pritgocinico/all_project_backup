...
class Customer extends Model
{
    ...
    public function getAlternativeNumber(){
        return $this->hasMany(CustAlternateNumber::class,'customer_id','id');
    }

    public function customerAddress(){
        return $this->hasMany(CustAddress::class,'customer_id','id');
    }

    public function custDisease(){
        return $this->hasOne(Disease::class,'id','cust_disease');
    }
}
