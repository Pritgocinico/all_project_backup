...
@section('content')
    <div
        class="flex-fill overflow-y-lg-auto scrollbar main-table main-table bg-body rounded-top-4 rounded-top-start-lg-4 rounded-top-end-lg-0 border-top border-lg shadow-2">
        <main class="container-fluid p-0">
            ...
            <div class="px-6 px-lg-7 pt-6">
                <div id="shift_time_ajax" class=" custom-scrollbar"></div>
            </div>
        </main>
                        ...
                        <div class="modal-body undefined">
                            <div class="vstack gap-1">
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    <div class="col-md-3"><label class="form-label mb-0">Shift End Time</label></div>
                                    <div class="col-md-9 col-xl-9">
                                        <input type="time" name="shift_end_time" class="form-control" id="edit_hift_end_time"
                                            placeholder="Enter Shift End Time">
                                    </div>
                                </div>
        ...
        function editShift(id) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#edit_hift_end_time').val(moment(data.data.shift_end_time, "HH:mm:ss").format("HH:mm"));
