...
<style>
    ...
    .certificate-container:before {
        ...
        top: 37px;
        left: 37px;
        border-top: 30px solid #207C1C;
        border-left: 31px solid #207C1C;
        z-index: 1;
    }
    ...
    .certificate-container:after {
        ...
        bottom: 37px;
        right: 37px;
        border-bottom: 30px solid #207C1C;
        border-right: 31px solid #207C1C;
        z-index: 1;
    }
        ...
        <div class="certificate">
            ...
            if(isset($setting) && $setting->logo !== null){
                $imagePath = public_path('storage/'.$setting->logo);
                    ...
                    $imagePath1 = public_path('assets/img/login/sajivan-logo.png');
            ...
            <div style="position: relative; width: 100%;">
                {{-- <div style="width: 150px; float: right; position: absolute;  height: 120px;margin-bottom: 12px;text-align: center;margin: 19px auto;/* margin-bottom: 21px; */  margin-right :100px;">
                    <img src="{{ $src }}" class="logo" alt="" style="max-width: 70px;" style="width: 100%; height: 100%; object-fit: cover;">
                </div> --}}
                
                <div style="width: 200px; float: right; position: absolute;  height: 170px;margin-bottom: 12px;text-align: center;margin: 19px auto;/* margin-bottom: 21px; */  margin-right :180px;">
                    <img src="{{ $src }}" class="logo" alt="" style="max-width: 70px;" style="width: 100%; height: 100%; object-fit: cover;">
                </div>
            </div>
