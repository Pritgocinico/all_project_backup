                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            <div class="col-md-6 row align-items-center g-3 ">
                                <div class="col-md-4"><label class="form-label mb-0">Phone Number <span
                                            class="text-danger">*</span></label></div>
                                <div class="col-md-8 col-xl-6">
                                    <input type="text" name="mobile_number" id="mobile_number" class="form-control" min="0"
                                        placeholder="Enter Phone Number" value="{{ old('mobile_number') }}" pattern="\d*" minlength="10" maxlength="10"
                ...
                var newField = `
                    <div class="row align-items-center g-3 mt-3">
                        ...
                        <div class="col-md-4 col-xl-4">
                            <input type="text" name="cust_alt_num[]" pattern="\d*" minlength="10" maxlength="10" onkeypress="return isNumberKey(event)" class="form-control" placeholder="Enter Alternate Number" >
                            @error('cust_alt_num')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
