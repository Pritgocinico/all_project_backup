                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            <div class="col-md-4 col-xl-4">
                                <select name="leave_reason" class="form-control" id="leave_reason_dropdown">
                                    ...
                                    <option value="family_function" @if (old('leave_reason') == 'family_function') selected @endif>Family Function
                                    </option>
                                    <option value="sick_leave" @if (old('leave_reason') == 'sick_leave') selected @endif>Sick Leave
                                    </option>
                                    <option value="emergency_leave" @if (old('leave_reason') == 'emergency_leave') selected @endif>Emergency Leave
                                    </option>
