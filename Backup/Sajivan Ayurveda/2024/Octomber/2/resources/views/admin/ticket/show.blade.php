        ...
        <main class="container-fluid px-3 py-5 p-lg-6 p-xxl-8">
            <div class="mb-6 mb-xl-10">
                <div class="row g-3 align-items-center">
                    <div class="col">
                        <h1 class="ls-tight">Help Details</h1>
                    </div>
                </div>
            </div>
            <hr class="my-6" />
            <div class="row align-items-center g-3">
                <div class="col-md-2">Help Id</div>
                <div class="col-md-4">{{ $help->ticket_id }}</div>
                <div class="col-md-2">Subject</div>
                <div class="col-md-4">{{ $help->subject }}</div>
            </div>
            <div class="row align-items-center mt-6">
                <div class="col-md-2">Description</div>
                <div class="col-md-4">{{ $help->description }}</div>
                <div class="col-md-2">Help Raised For Department</div>
                <div class="col-md-4">{{ isset($help->departmentDetail) ? $help->departmentDetail->name : '-' }}</div>
            </div>
            <div class="row align-items-center mt-6">
                <div class="col-md-2">Created By / Department Name</div>
                <div class="col-md-4">{{ isset($help->userDetail) ? $help->userDetail->name : '-' }} -
                    {{ isset($help->userDetail) && isset($help->userDetail->departmentDetail) ? $help->userDetail->departmentDetail->name : '-' }}
                </div>
                <div class="col-md-2">Created At</div>
                <div class="col-md-4">{{ Utility::convertDmyAMPMFormat($help->created_at) }}</div>
            </div>
            <div class="row align-items-center mt-6">
                <div class="col-md-2">Help Type</div>
                <div class="col-md-4">{{ $help->ticket_type }}</div>
                ...
                <main class="container-fluid px-6 pb-10">
                    <div class="card-header" id="kt_chat_messenger_header">
                        <div class="card-title">
                            <div class="d-flex justify-content-center flex-column p-3">
                                <span
                                    class="fs-4 fw-bold text-gray-900 text-hover-primary me-1 mb-2 lh-1">{{ $help->subject }}
                                    ( {{ $help->ticket_id }})</span>
                                <div class="mb-0 lh-1">
                    ...
                    <div class="card-body raise-ticket" id="kt_chat_messenger_body">
                        <div class="scroll-y me-n5 pe-5 h-300px h-lg-auto" id="scroll_message_div">
                            @foreach ($help->ticketCommentDetail as $ticketComment)
                                @php
                                ...
                                @endphp
                                @if ((int) $ticketComment->user_id !== Auth()->user()->id)
                    ...
                    <div class="card-footer pt-4  raise-form" id="kt_chat_messenger_footer">
                        ...
                        <form id="send_message_form" action="{{ route('help-comment-store') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="ticket_id" value="{{ $help->id }}" />
