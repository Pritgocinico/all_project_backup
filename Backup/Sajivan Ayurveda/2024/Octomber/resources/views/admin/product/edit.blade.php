                    ...
                    <form action="{{ route('product.update', $product->id) }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            ...
                            <div class="col-md-6 row align-items-center g-3 ">
                                ...
                                <div class="col-md-4"><label class="form-label mb-0">Medicine Type <span
                                            class="text-danger">*</span></label></div>
                                <div class="col-md-8 col-xl-6">
                                    <select name="medicine_type" class="form-control" id="medicine_type">
                                        <option value="">Select Option</option>
                                        <option value="powder" {{ $product->medicine_type == 'powder' ? 'selected' : '' }}>
                                            Powder</option>
                                        <option value="tablet" {{ $product->medicine_type == 'tablet' ? 'selected' : '' }}>
                                            Tablet</option>
                                        <option value="capsule"
                                            {{ $product->medicine_type == 'capsule' ? 'selected' : '' }}>Capsule</option>
                                    </select>
                                    @error('medicine_type')
                            ...
                            <div class="col-md-6 row align-items-center g-3 ">
                                <!-- Powder Unit -->
                                <div class="col-md-4 d-none" id="powder_div_label"><label class="form-label mb-0">Unit of
                                        Powder <span class="text-danger">*</span></label></div>
                                <div class="col-md-8 col-xl-6 d-none" id="powder_div">
                                    <select name="powder_unit" class="form-control">
                                        <option value="">Select Option</option>
                                        <option value="10_gm" {{ $product->powder_unit == '10_gm' ? 'selected' : '' }}>10
                                            gm</option>
                                        <option value="50_gm" {{ $product->powder_unit == '50_gm' ? 'selected' : '' }}>50
                                            gm</option>
                                        <option value="100_gm" {{ $product->powder_unit == '100_gm' ? 'selected' : '' }}>100
                                            gm</option>
                                    </select>
                                    @error('powder_unit')
                                        <div class="text-danger">{{ $message }}</div>
                                ...
                                <!-- Tablet Unit -->
                                <div class="col-md-4 d-none" id="tab_div_label"><label class="form-label mb-0">Unit of Tab
                                ...
                                <div class="col-md-8 col-xl-6 d-none" id="tab_div">
                                    <select name="tablet_unit" class="form-control">
                                        <option value="">Select Option</option>
                                        <option value="10_tab" {{ $product->tablet_unit == '10_tab' ? 'selected' : '' }}>10
                                            tab</option>
                                        <option value="50_tab" {{ $product->tablet_unit == '50_tab' ? 'selected' : '' }}>50
                                            tab</option>
                                        <option value="100_tab" {{ $product->tablet_unit == '100_tab' ? 'selected' : '' }}>
                                            100 tab</option>
                                    </select>
                                    @error('tablet_unit')
                                        <div class="text-danger">{{ $message }}</div>
                                ...
                                <!-- Capsule Unit -->
                                <div class="col-md-4 d-none" id="capsule_div_label"><label class="form-label mb-0">Unit of
                                        Capsule <span class="text-danger">*</span></label></div>
                                <div class="col-md-8 col-xl-6 d-none" id="capsule_div">
                                    <select name="capsule_unit" class="form-control">
                                        <option value="">Select Option</option>
                                        <option value="10_tab" {{ $product->capsule_unit == '10_tab' ? 'selected' : '' }}>
                                            10 tab</option>
                                        <option value="50_tab" {{ $product->capsule_unit == '50_tab' ? 'selected' : '' }}>
                                            50 tab</option>
                                        <option value="100_tab"
                                            {{ $product->capsule_unit == '100_tab' ? 'selected' : '' }}>100 tab</option>
                                    </select>
                                    @error('capsule_unit')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            ...
                            <div class="col-md-6 row align-items-center g-3 ">
                                <div class="col-md-4"><label class="form-label mb-0">HSM/SAC <span
                                            class="text-danger">*</span></label></div>
                                <div class="col-md-8 col-xl-6">
                                    <input type="text" name="hsm_sac" class="form-control"
                                        placeholder="Enter Product HSM/SAC" value="{{ $product->hsm_sac }}">
                                    @error('hsm_sac')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            <div class="col-md-6 row align-items-center g-3 ">
                                <div class="col-md-4"><label class="form-label mb-0">Batch Number <span
                                            class="text-danger">*</span></label></div>
                                <div class="col-md-8 col-xl-6">
                                    <input type="text" name="batch_number" class="form-control"
                                        placeholder="Enter Batch Number" value="{{ $product->batch_number }}">
                                    @error('batch_number')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 row align-items-center g-3 ">
                                <div class="col-md-4"><label class="form-label mb-0">Price <span
                                            class="text-danger">*</span></label></div>
                                <div class="col-md-8 col-xl-6">
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            <div class="col-md-6 row align-items-center g-3 ">
                                ...
                                <div class="col-md-8 col-xl-6">
                                    <input type="number" name="without_tax_price" class="form-control" min="0"
                                        placeholder="Enter Price" value="{{ $product->without_tax_price }}">
                            ...
                            <div class="col-md-6 row align-items-center g-3 ">
                                <div class="col-md-4"><label class="form-label mb-0">Mfg. Lic. Number <span
                                            class="text-danger">*</span></label></div>
                                <div class="col-md-8 col-xl-6">
                                    <input type="text" name="mfg_lic_number" class="form-control"
                                        placeholder="Enter Mfg. Lic. Number" value="{{ $product->mfg_lic_number }}">
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            <div class="col-md-6 row align-items-center g-3 ">
                                <div class="col-md-4"><label class="form-label mb-0">Mfg. Date <span
                                            class="text-danger">*</span></label></div>
                                <div class="col-md-8 col-xl-6">
                                    <input type="text" name="mfg_date" id="MFGdate" class="form-control"
                                        placeholder="Enter Mfg. Date" value="{{ old('mfg_date', $product->mfg_date) }}">
                                    @error('mfg_date')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 row align-items-center g-3 ">
                                <div class="col-md-4"><label class="form-label mb-0">Stock <span
                                            class="text-danger">*</span></label></div>
                                <div class="col-md-8 col-xl-6">
