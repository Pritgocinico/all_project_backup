        ...
        @foreach ($roleList as $key=>$role)
            <tr>
                ...
                <td>
                    ...
                    @endphp
                    <span class="badge bg-{{ $color }} w-120 status-btn" data-id="{{ $role->id }}" onclick="changeStatus(this)" data-bs-toggle="tooltip" data-bs-placement="top" title="Change Status">{{ $text }}</span>
                </td>
                <td class="text-end">
                    <div class="icon-td">
