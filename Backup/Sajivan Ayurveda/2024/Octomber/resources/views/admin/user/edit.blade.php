            ...
            <div
                ...
                <main class="container-fluid px-6 pb-10">
                    <form action="{{ route('user.update', $user->id) }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            <div class="col-md-6 row align-items-center g-3 ">
                                <div class="col-md-4"><label class="form-label mb-0">Profile Image</label></div>
                                <div class="col-md-3 col-xl-2">
                                    ...
                                    <div class="w-100" id="profile_image_preview"></div>
                                    @error('profile_image')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            ...
                            <div class="col-md-6 row align-items-center g-3 ">
                                <div class="col-md-4"><label class="form-label mb-0">Agreement</label></div>
                                <div class="col-md-3 col-xl-2">
                                    <div class="hstack gap-2">
...
@section('script')
    <script>
        function isNumberKey(evt) {
            ...
            // Allow only numbers (keyCode between 48-57)
