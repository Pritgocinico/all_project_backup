                ...
                <div class="icon-td">
                    ...
                    @if (Auth()->user()->role_id == 1)
                        @if ($ticket->status == 0)
                            <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="Reopen Help" onclick="changeTicketStatus({{ $ticket->id }},1)"><i class="fa-solid fa-rotate"></i>
                        @else
                            <a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="top"
                    ...
                    @elseif (collect($accesses)->where('menu_id', 9)->first()->status == 2)
                        <a href="javascript:void(0)" onclick="editTicket({{ $ticket->id }})" data-bs-toggle="tooltip"
                            data-bs-placement="top" title="Edit Help"><i class="fa-solid fa-pen-to-square me-3"></i></a>
