                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            ...
                            <div class="col-md-6 row align-items-center g-3 ">
                                <div class="col-md-4"><label class="form-label mb-0">Phone Number <span
                                            class="text-danger">*</span></label></div>
                                <div class="col-md-8 col-xl-6">
                                    <input type="text" name="phone_number" minlength="10" maxlength="10" onkeypress="return isNumberKey(event)" class="form-control"
                            ...
                            @for ($i = 0; $i < $cnt; $i++)
                                <div class="row align-items-center gap-3 mt-6">
                                    <div class="col-md-6 row align-items-center g-3 ">
                                        ...
                                        <div class="col-md-8 col-xl-6">
                                                <input type="text" name="office_calling_number[]" class="form-control" onkeypress="return isNumberKey(event)" minlength="10" maxlength="10" value="{{ old('office_calling_number.' . $i) }}" placeholder="Enter Office Calling Number">
                                    ...
                                    <div class="hstack gap-2 ">
                                        <label for="passport_photo" class="btn btn-sm btn-neutral"><span>Upload</span>
                                            <input type="file" name="passport_photo" id="passport_photo"
                                                class="visually-hidden passport_photo" value="{{ old('passport_photo') }}">
                                        </label>
                                    </div>
