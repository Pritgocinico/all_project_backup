...
class LeadController extends Controller
{
    ...
    public function show(string $id)
    {
        ...
        $leadRemarks = Remark::where('lead_id', $id)->get();
        $diseases = Disease::get();
        ...
        return view('employee.lead.show', compact('leadProduct','products', 'diseases', 'lead', 'customer', 'custAltnumbers', 'custAddresses', 'leadRemarks'));
    }
    ...
    public function leadRemarks(Request $request)
    {
        ...
        if ($store) {
            ...
            return response()->json(['status' => 1, 'data' => $lead_remark, 'message' => 'Remark added successfully.'], 200);
        }
        return response()->json(['status' => 1, 'message' => 'Something went to wrong.'], 500);
    }
    public function updateLeadCustomerData(Request $request)
    {
        ...
        if ($lead) {
            ...
            return redirect()->back()->with('success', 'Lead Customer Details updated successfully.');
        }
