                  ...
                  {{--  @if ($errors->any())
                    ...
                    <div class="col-md-6 form-floating mt-4 health" style="display:none;">
                        <select class="form-control" name="health_category" id="HealthCategory" placeholder="">
                            <option value="1" {{ old('health_category') == 1 ? 'selected' : '' }}>Base</option>
                            <option value="2" {{ old('health_category') == 2 ? 'selected' : '' }}>Personal Accident</option>
                            <option value="3" {{ old('health_category') == 3 ? 'selected' : '' }}>Super Topup</option>
                        </select>
                               ...
                               <div class="col-md-12 form-floating mt-4">
                                ...
                                <div class="col-md-12 form-floating mt-4">
                                    <select name="managed_by" class="form-control" id="managedBy">
                                        ...
                                        <option value="{{$manage->id}}" {{ old('managed_by') == $manage->id ? 'selected' : '' }}>{{$manage->name}}</option>
                                        @endforeach
                                    </select>
