...
class CustomerPayoutPDFExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents
{
    ...
    */
    ...
    {
        $payouts = PayoutList::with('agents')->whereBetween('created_at', [$this->start_date, $this->end_date])->get();
        $records = [];
