                    ...
                    <div class="row">
                      <div class="col-xl-4 xl-3 col-md-5 col-sm-12 col box-col-12">
                        ...
                        <div class="form-floating">
                          <input type="date" name="from_date" class="form-control" id="" value="{{date('Y-m-d',strtotime($from_date))}}">
                      ...
                      <div class="col-xl-4 xl-3 col-md-5 col-sm-12 col box-col-12">
                        ...
                        ?>
                        <div class="form-floating">
                          <input type="date" name="to_date" class="form-control" id="" value="{{date('Y-m-d',strtotime($to_date))}}">
                      ...
                      <div class="col-xl-2 xl-2 col-md-1 col-sm-12 col box-col-12">
                           <a class="btn btn-primary" href="{{route('admin.dashboard')}}"><i class="fa fa-refresh"></i> Refresh</a>
                      </div>
                    </div>
                  </div>
                </div>
            </div>
        <div class="col-xxl-8 col-xl-8 col-lg-8 box-col-8">
            <div class="row"> 
                  ...
                  <table class="display border" id="basic-1">
                      ...
                      @if (!blank($claims))
                              @foreach ($claims as $claim)
                                  <tr>
                                      <td>{{$loop->index+1}}</td>
                                      <td><a class="table-url" href="{{route('admin.view_claim',$claim->id)}}">{{$claim->claim_no}}</a></td>
      ...
      <div class="row">
                        ...
                        <div class="justify-content-between d-flex">
                          <div style="width:15%">
                              <div class="form-floating">
                                <?php
                                    ...
                                    ?>
                                <select class="form-control m-input col-lg-3" name="lob_month" id="year">
                                  @for ($i = 1; $i <= 12; $i++)
                                  <option value="{{ $i }}" <?php if($i == $lob_month) echo "selected"; ?>>{{ $i }}</option>
                                  @endfor
                                </select>
                          ...
                          <div  style="width:15%">
                              <div class="form-floating">
                                ...
                                ?>
                                <select class="form-control m-input col-lg-3" name="lob_year" id="year">
                                  @for ($i = 2018; $i <= 2100; $i++)
                                  <option value="{{ $i }}" <?php if($i == $lob_year) echo "selected"; ?>>{{ $i }}</option>
                                  @endfor
                                </select>
                          ...
                          <div  style="width:15%">
                              <div class="form-floating">
                                <?php
                                    ...
                                    ?>
                                <select class="form-control m-input col-lg-3" name="p_lob_month" id="year">
                                  @for ($i = 1; $i <= 12; $i++)
                                  <option value="{{ $i }}" <?php if($i == $p_lob_month) echo "selected"; ?>>{{ $i }}</option>
                                  @endfor
                                </select>
                          ...
                          <div  style="width:15%">
                              <div class="form-floating">
                                ...
                                ?>
                                <select class="form-control m-input col-lg-3" name="p_lob_year" id="year">
                                    @for ($i = 2018; $i <= 2100; $i++)
                                        <option value="{{ $i }}" <?php if($i == $p_lob_year) echo "selected"; ?>>{{ $i }}</option>
                                    @endfor
                                  </select>
                          ...
                          <div  style="width:8%">
                              <a class="btn btn-primary" href="{{route('admin.dashboard')}}"> Refresh</a>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-6 mb-md-0 mb-3">
                <div class="card p-2">
                    <h4 class="text-center">{{date("F", mktime(0, 0, 0, $lob_month, 1))}}, {{$lob_year}} LOB</h4>
            ...
            <div class="col-md-6">
                <div class="card p-2">
                    <h4 class="text-center">{{date("F", mktime(0, 0, 0, $p_lob_month, 1))}}, {{$p_lob_year}} LOB</h4>
                    <div class="chart-wrapper">
                            ...
                            <div class="col-md-8 row">
                                <div class="col-md-5  mb-md-0 mb-sm-3 mb-2">
                                     <div class="form-floating">
                                        ...
                                        ?>
                                        <select class="form-control m-input col-lg-3" name="previous_year" id="year">
                                            @for ($i = 2018; $i <= 2100; $i++)
                                                <option value="{{ $i }}" <?php if($i == $previous_year) echo "selected"; ?>>{{ $i }}</option>
                                            @endfor
                                        </select>
                                ...
                                <div class="col-md-5  mb-md-0 mb-sm-3 mb-2">
                                    <div class="form-floating">
                                        ...
                                        ?>
                                        <select class="form-control m-input col-lg-3" name="current_year" id="year">
                                            @for ($i = 2018; $i <= 2100; $i++)
                                                <option value="{{ $i }}" <?php if($i == $current_year) echo "selected"; ?>>{{ $i }}</option>
                                            @endfor
                                        </select>
