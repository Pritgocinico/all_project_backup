     ...
     <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    {{date('d-m-Y',strtotime($payouts->start_date))}} - {{date('d-m-Y',strtotime($payouts->end_date))}}
                </div>
            </div>
            <hr>
                                ...
                                <?php
                                    ...
                                    foreach($payout_records as $record){
                                        ...
                                        <tr>
                                            ...
                                            <td>₹{{$policy->od}}<input type="hidden" name="payout[{{$record->id}}][od]" value="{{$od}}"></td>
                                            <td>₹{{$policy->tp}}<input type="hidden" name="payout[{{$record->id}}][tp]" value="{{$tp}}"></td>
