...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            <form action="{{route('admin.add.claim.data')}}" method="post" class="row g-3" id="formDropzone" enctype="multipart/form-data">
                @csrf
                <div class="col-md-6 form-floating mt-4">
                    <input type="date" class="form-control" name="claim_date" id="Date" value="{{old('date')?old('date'):date('Y-m-d')}}" placeholder="" autofocus />
                ...
                <div class="col-md-6 form-floating mt-4">
                    <input type="text" class="form-control" name="claim_no" id="ClaimNo" value="{{old('claim_no')}}" placeholder="" autofocus />
                ...
                <div class="col-md-6 form-floating mt-4">
                    <input type="text" class="form-control" name="contact_person" id="ContactPerson" value="{{old('contact_person')}}" placeholder="" autofocus />
                ...
                <div class="col-md-6 form-floating mt-4">
                    <input type="text" class="form-control" name="contact_person_no" id="ContactPersonNo" value="{{old('contact_person_no')}}" placeholder="" autofocus />
                ...
                <div class="col-md-6 form-floating mt-4">
                    <input type="text" class="form-control" name="surveyar_name" id="SurveyarName" value="{{old('surveyar_name')}}" placeholder="" autofocus />
                ...
                <div class="col-md-6 form-floating mt-4">
                    <input type="text" class="form-control" name="surveyar_no" id="SurveyarNo" value="{{old('surveyar_no')}}" placeholder="" autofocus />
                ...
                <div class="col-md-6 form-floating mt-4">
                    <input type="email" class="form-control" name="surveyar_email" id="SurveyarEmail" value="{{old('surveyar_email')}}" placeholder="" autofocus />
                ...
                <div class="col-md-6 form-floating mt-4">
                    <input type="text" class="form-control" name="repairing_location" id="RepairingLocation" value="{{old('repairing_location')}}" placeholder="" />
                ...
                <div class="col-md-6 form-floating mt-4">
                    <input type="text" class="form-control" name="status_text" id="StatusText" value="{{old('status_text')}}" placeholder="" />
                ...
                <div class="col-md-6 form-floating mt-4 status">
                    <input type="date" class="form-control" name="status_date" id="StatusDate"  value="{{old('status_date')?old('status_date'):date('Y-m-d')}}" placeholder="" />
                ...
                <div class="col-md-6 form-floating mt-4 cheque" style="display:none;">
                ...
                <div class="col-md-6 form-floating mt-4 cheque" style="display:none;">
                    <input type="date" class="form-control" name="cheque_date" id="chequeDate" value="{{old('cheque_date')}}" placeholder="" />
                ...
                <div class="col-md-6 form-floating mt-4 online" style="display: none;">
...
@section('script')
    ...
    <script>
        ...
        var myDropzone = new Dropzone('#formDropzone',{
            ...
            url: "{{route('admin.add.claim.data')}}",
            addRemoveLinks: true,
            autoProcessQueue: false,
            uploadMultiple: true,
            parallelUploads: 50,
            maxFiles: 50,
            acceptedFiles: '.jpeg, .jpg, .png, .gif, .pdf, .docx,.csv, .xls, .xlsx',
            thumbnailWidth: 200,
            thumbnailHeight: 200,
            ...
            success: function(file, response)
            {
                ...
                // if(response == ''){
                    top.location.href="{{ route('admin.claims',$id) }}";
                // }
                // setTimeout(function() {
