        ...
        <div class="card-body">
            <form action="{{route('admin.edit.policy.data')}}" method="post" class="g-3 " id="formDropzone" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 form-floating mt-4 payout_restricted_remark_div @if($policy->payout_restricted == 'yes') d-block @else d-none @endif">
                        <input type="text" class="form-control" name="payout_restricted_remark" id="payout_restricted_remark" value="{{$policy->payout_restricted_remark}}" placeholder="">
