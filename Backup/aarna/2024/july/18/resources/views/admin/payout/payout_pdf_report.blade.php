            ...
            <td width="50%" style="text-align:center;">
                <table width="100%" style="font-family: sans-serif; text-align:center; justify-content:center; align-item:center;" cellpadding="10">
                    <tr>
                        ...
                        <td width="30%" style="font-weight:bold; border: 0.3mm solid rgb(21, 21, 21);">{{date('d-m-Y',strtotime($start_date))}}</td>
                        <td width="20%" style="font-weight:bold; border: 0.3mm solid rgb(21, 21, 21);">To</td>
                        <td width="30%" style="font-weight:bold; border: 0.3mm solid rgb(21, 21, 21);">{{date('d-m-Y',strtotime($end_date))}}</td>
                    </tr>
                </table>
            </td>
            <td width="25%"></td>
    ...
    <table class="items" width="100%" style="border: 0.3mm solid rgb(21, 21, 21);font-size: 14px; border-collapse: collapse;" cellpadding="8">
        <thead>
            <tr style="background-color:rgb(209, 204, 204); border: 0.3mm solid rgb(21, 21, 21); font-weight:bold; font-size:14px;">
                ...
                <td width="10%" style="text-align: left;border: 0.3mm solid rgb(21, 21, 21);"><strong>Payout Date</strong></td>
                <td width="40%" style="text-align: left;border: 0.3mm solid rgb(21, 21, 21);"><strong>DSA</strong></td>
                <td width="15%" style="text-align: left;border: 0.3mm solid rgb(21, 21, 21);"><strong>No. of Policy(s)</strong></td>
                <td width="15%" style="text-align: left;border: 0.3mm solid rgb(21, 21, 21);"><strong>Payout Amount</strong></td>
                <td width="15%" style="text-align: left;border: 0.3mm solid rgb(21, 21, 21);"><strong>Payout Status</strong></td>
            </tr>
        </thead>
        <tbody>
            ...
            @if(!blank($records))
                @foreach ($records as $record)
                    ...
                    <tr style="border: 0.3mm solid rgb(21, 21, 21);">
                        ...
                        <td style="border: 0.3mm solid rgb(21, 21, 21);">{{$record['agent']}}</td>
                        <td style="border: 0.3mm solid rgb(21, 21, 21);">{{$record['policy']}}</td>
                        <td style="border: 0.3mm solid rgb(21, 21, 21);">{{$record['amount']}}</td>
                        <td style="border: 0.3mm solid rgb(21, 21, 21);">{{$record['status']}}</td>
                    </tr>
                @endforeach
            @else
        ...
        <tfoot>
            <tr style="border-top: 0.3mm solid rgb(21, 21, 21);">
                ...
                <td style="border: 0.3mm solid rgb(21, 21, 21);"><strong>{{$policy}}</strong></td>
