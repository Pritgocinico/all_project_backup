...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            <form action="{{route('admin.update.source')}}" method="post" class="row g-3">
                @csrf
                <div class="col-md-12 form-floating mt-4">
                    <select class="form-control" name="insurance_type" id="InsuranceType" placeholder="">
                        <option value="1" @if($sources->insurance_type == 1) selected @endif>Motor Insurance</option>
                        <option value="2" @if($sources->insurance_type == 2) selected @endif>Health Insurance</option>
                    </select>
                ...
                <div class="row motor-insurance @if($sources->insurance_type == 2) d-none @endif">
                    <div class="col-md-6 form-floating mt-4">
                        <select class="form-control" name="motor_category" id="MotorCategory" value="{{old('motor_category')}}" placeholder="">
                            @foreach ($categories as $category)
                                <option value="{{$category->id}}" @if($sources->category == $category->id) selected @endif>{{$category->name}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 form-floating mt-4">
                        <select class="form-control" name="motor_subcategory" id="MotorSubCategory" value="{{old('motor_subcategory')}}" placeholder="">
                            @foreach ($sub_categories as $sub_category)
                                <option value="{{$sub_category->id}}" @if($sources->sub_category == $sub_category->id) selected @endif>{{$sub_category->name}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-12 form-floating mt-4">
                        <select class="form-control" name="insurance_company" id="InsuranceCompany" value="{{old('insurance_company')}}" placeholder="">
                            @foreach ($companies as $company)
                                <option value="{{$company->id}}" @if($sources->company == $company->id) selected @endif>{{$company->name}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 form-floating mt-4">
                        <select class="form-control select2" name="customer" id="Customer" value="{{old('customer')}}" placeholder="">
                            ...
                            @foreach ($customers as $customer)
                                <option value="{{$customer->id}}" @if($sources->customer == $customer->id) selected @endif>{{$customer->name}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 form-floating mt-4">
                        <select class="form-control" name="business_type" id="BusinessType" placeholder="">
                            <option value="1" @if($sources->business_type == 1) selected @endif>New</option>
                            <option value="2" @if($sources->business_type == 2) selected @endif >Renewal</option>
                            <option value="3" @if($sources->business_type == 3) selected @endif>Rollover</option>
                            <option value="4" @if($sources->business_type == 4) selected @endif>Used</option>
                        </select>
                    ...
                    <div class="col-md-6 form-floating mt-4 business_type @if(old('business_type')) @if(old('business_type') == 1 || old('business_type') == 4) d-none @endif @elseif($sources->business_type == 1 || $sources->business_type == 4) d-none @endif">
                        <input type="text" class="form-control" name="motor_pyp_no" id="PypNo" value="{{$sources->pyp_no}}" placeholder="" />
                    ...
                    <div class="col-md-6 form-floating mt-4 business_type @if(old('business_type')) @if(old('business_type') == 1 || old('business_type') == 4) d-none @endif @elseif($sources->business_type == 1 || $sources->business_type == 4) d-none @endif">
                        <input type="text" class="form-control" name="motor_pyp_insurance_company" id="PypInsuranceCompany" value="{{$sources->pyp_insurance_company}}" placeholder="" />
                    ...
                    <div class="col-md-6 form-floating mt-4 business_type @if(old('business_type')) @if(old('business_type') == 1 || old('business_type') == 4) d-none @endif @elseif($sources->business_type == 1 || $sources->business_type == 4) d-none @endif">
                        <input type="date" class="form-control" name="motor_pyp_expiry_date" id="PypExpiryDate" value="{{date('Y-m-d',strtotime($sources->pyp_expiry_date))}}" placeholder="" />
                    ...
                    <div class="col-md-6 form-floating mt-4">
                        <input type="text" class="form-control" name="vehicle_chassis_no" id="vehicleChassisNo" value="{{$sources->vehicle_chassic_no}}" placeholder="">
                    ...
                    <div class="col-md-6 form-floating mt-4">
                        <input type="date" class="form-control" name="risk_start_date" id="RiskStartDate" value="{{date('Y-m-d',strtotime($sources->risk_start_date))}}" placeholder="" />
                    ...
                    <div class="col-md-6 form-floating mt-4">
                        <input type="number" class="form-control" min="0" name="gross_premium_amount" id="GrossPremiumAmount" value="{{$sources->gross_premium_amount}}" placeholder="" />
                    ...
                    <div class="col-md-6 form-floating mt-4">
                        <input type="number" class="form-control" min="0" name="net_premium_amount" id="NetPremiumAmount" value="{{$sources->net_premium_amount}}" placeholder="" />
                ...
                <div class="row health-insurance @if($sources->insurance_type == 1) d-none @endif">
                    <div class="col-md-6 form-floating mt-4">
                        <select class="form-control" name="health_category" id="HealthCategory" placeholder="">
                            <option value="1" @if($sources->category == 1) selected @endif>Base</option>
                            <option value="2" @if($sources->category == 2) selected @endif>Personal Accident</option>
                            <option value="3" @if($sources->category == 3) selected @endif>Super Yopup</option>
                        </select>
                    ...
                    <div class="col-md-6 form-floating mt-4">
                        <select class="form-control" name="health_plan" id="HealthPlan" value="{{old('health_plan')}}" placeholder="">
                            ...
                            @foreach ($plans as $item)
                                <option value="{{$item->id}}" @if($sources->health_plan == $item->id) selected @endif>{{$item->name}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 form-floating mt-4 business_type @if(old('business_type')) @if(old('business_type') == 1 || old('business_type') == 4) d-none @endif @elseif($sources->business_type == 1 || $sources->business_type == 4) d-none @endif">
                        <input type="text" class="form-control" name="pyp_no" id="PypNo" value="{{$sources->pyp_no}}" placeholder="" />
                        <label for="PypNo" class="form-label">Pyp No *</label>
                    ...
                    <div class="col-md-6 form-floating mt-4 business_type @if(old('business_type')) @if(old('business_type') == 1 || old('business_type') == 4) d-none @endif @elseif($sources->business_type == 1 || $sources->business_type == 4) d-none @endif">
                        <input type="text" class="form-control" name="pyp_insurance_company" id="PypInsuranceCompany" value="{{$sources->pyp_insurance_company}}" placeholder="" />
                        <label for="PypInsuranceCompany" class="form-label">Pyp Insurance Company *</label>
                    ...
                    <div class="col-md-6 form-floating mt-4 business_type @if(old('business_type')) @if(old('business_type') == 1 || old('business_type') == 4) d-none @endif @elseif($sources->business_type == 1 || $sources->business_type == 4) d-none @endif">
                        <input type="date" class="form-control" name="pyp_expiry_date" id="PypExpiryDate" value="{{date('Y-m-d',strtotime($sources->pyp_expiry_date))}}" placeholder="" />
                        <label for="PypExpiryDate" class="form-label">Pyp Expiry Date *</label>
                    ...
                    <div class="col-md-6 form-floating mt-4">
                        <input type="date" class="form-control" name="health_risk_start_date" id="HealthRiskStartDate" value="{{date('Y-m-d',strtotime($sources->risk_start_date))}}" placeholder="" />
                    ...
                    <div class="col-md-6 form-floating mt-4">
                        <input type="number" class="form-control" min="0" name="health_gross_premium_amount" id="HealthGrossPremiumAmount" value="{{$sources->gross_premium_amount}}" placeholder="" />
                    ...
                    <div class="col-md-6 form-floating mt-4">
                        <input type="number" class="form-control" min="0" name="health_net_premium_amount" id="HealthNetPremiumAmount" value="{{$sources->net_premium_amount}}" placeholder="" />
