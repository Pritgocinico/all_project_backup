    ...
    <table class="items" width="100%" style="border: 0.3mm solid rgb(21, 21, 21);font-size: 14px; border-collapse: collapse;" cellpadding="8">
        <thead>
            <tr style="background-color:rgb(209, 204, 204); border: 0.3mm solid rgb(21, 21, 21); font-weight:bold; font-size:14px;">
                ...
                <td width="10%" style="text-align: left;border: 0.3mm solid rgb(21, 21, 21);"><strong>Sub Category</strong></td>
                <td width="10%" style="text-align: left;border: 0.3mm solid rgb(21, 21, 21);"><strong>Vehicle Registration No</strong></td>
            ...
            @if(!blank($records))
                @foreach ($records as $record)
                    ...
                    <tr style="border: 0.3mm solid rgb(21, 21, 21);">
                        ...
                        <td style="border: 0.3mm solid rgb(21, 21, 21);">{{$record['sub_category']}}</td>
                        <td style="border: 0.3mm solid rgb(21, 21, 21);">{{$record['vehicle_registration_no']}}</td>
                        ...
                        <td style="border: 0.3mm solid rgb(21, 21, 21);">{{$record['payout_percentage']}}</td>
