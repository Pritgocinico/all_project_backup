...
@elseif($policy->payment_type == 2)
    ...
    @endif-->
                                                ...
                                                <tr>
                                                    <td>Created By</td>
                                                    <td>{{ isset($policy->createdUserDetail) ? $policy->createdUserDetail->name : "-"}}</td>
                                                </tr>
                                                <tr>
                                                    <td>Created At</td>
                                                    <td>{{date('d/m/Y h:i:s A',strtotime($policy->created_at))}}</td>
                                                </tr>
                                                <tr>
                                                    <td>Modified By</td>
                                                    <td>{{ isset($policy->modifiedUserDetail) ? $policy->modifiedUserDetail->name : "-"}}</td>
                                                </tr>
                                                <tr>
                                                    <td>Modified At</td>
                                                    <td>{{$policy->last_modified_by !== 0 ? date('d/m/Y h:i:s A',strtotime($policy->updated_at)) : "-"}}</td>
                                                </tr>
