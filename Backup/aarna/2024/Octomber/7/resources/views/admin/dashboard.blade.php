                                            ...
                                            <table class="table display" style="width:100%">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5>{{ $sales_overview['non_motor'] }}</h5>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                            ...
                                            <table class="table display" style="width:100%">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5>{{ $month_overview['non_motor'] }}</h5>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                            ...
                                            <table class="table display" style="width:100%">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5>{{ $finance_overview['non_motor'] }}</h5>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
