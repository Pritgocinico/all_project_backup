                    ...
                    <div id="sidebar-menu">
                        <ul class="sidebar-links" id="simple-bar">
                            ...
                            <li class="sidebar-list mt-3"><i class="fa fa-thumb-tack"></i><a
                                    class="sidebar-link sidebar-title link-nav" href="{{ route('admin.dashboard') }}">
                            ...
                            @if (Auth::user()->role == 3)
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use href="{{ url('/') }}/assets/svg/icon-sprite.svg#stroke-editors">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="{{ url('/') }}/assets/svg/icon-sprite.svg#fill-editors">
                                            </use>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use href="{{ url('/') }}/assets/svg/icon-sprite.svg#stroke-layout">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            <use href="{{ url('/') }}/assets/svg/icon-sprite.svg#fill-layout">
                                            </use>
                            ...
                            @else
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="fill-icon">
                                            <use href="{{ url('/') }}/assets/svg/icon-sprite.svg#fill-learning">
                                            </use>
                                    ...
                                    <ul class="sidebar-submenu">
                                        ...
                                        @if (Auth()->user()->role !== 1)
                                            ...
                                            @foreach ($permissions as $permission)
                                                @if ($permission->capability == 'category-global-view' && $permission->value == 1)
                                                    <li>
                                                ...
                                                @endif
                                                @if ($permission->capability == 'sub-category-global-view' && $permission->value == 1)
                                                    <li>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        class="sidebar-link sidebar-title @if (
                                            \Request::route()->getName() == 'admin.business.source' ||
                                                ...
                                                \Request::route()->getName() == 'admin.cancelled.policies') active @endif"
                                        href="#">
                                        <svg class="stroke-icon">
                                            <use href="{{ url('/') }}/assets/svg/icon-sprite.svg#stroke-editors">
                                            </use>
                                        ...
                                        @if (Auth::user()->role == 1)
                                            ...
                                            <li>
                                                <a href="{{ route('admin.claims-data') }}"
                                                    class="@if (\Request::route()->getName() == 'admin.claims') active @endif">
                                                    Manage Claims
                                                </a>
                                            </li>
                                            <li>
                        ...
                        <div class="col-sm-6 p-0">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">
                                        <svg class="stroke-icon">
                                            <use href="{{ url('/') }}/assets/svg/icon-sprite.svg#stroke-home">
                                            </use>
                                        </svg></a></li>
                                ...
                                <li>
                                    @if (\Request::route()->getName() != 'admin.dashboard')
                                        <a onclick="history.back()" href="javascript:void(0)"
                                            class="btn btn-info ms-3"><i class="fa fa-arrow-left"
