                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                            ...
                            <tr>
                                <td>Category</td>
                                <td>
                                    <input type="hidden" name="permission[category][category-global-view]" value="0" id="">
                                    <input type="checkbox" name="permission[category][category-global-view]" 
                                    <?php if(!empty($arr)){
                                            if(isset($arr['category-global-view']) && $arr['category-global-view'] == 1){ ?>
                                                checked 
                                        <?php }
                                    } ?>> View (Global)<br>
                                    <input type="hidden" name="permission[category][category-create]" value="0" id="">
                                    <input type="checkbox" name="permission[category][category-create]" 
                                    <?php if(!empty($arr)){
                                            if(isset($arr['category-create']) && $arr['category-create'] == 1){ ?>
                                                checked 
                                        <?php }
                                    } ?>> Create<br>
                                    <input type="hidden" name="permission[category][category-edit]" value="0" id="">
                                    <input type="checkbox" name="permission[category][category-edit]" 
                                    <?php if(!empty($arr)){
                                            if(isset($arr['category-edit']) && $arr['category-edit'] == 1){ ?>
                                                checked 
                                        <?php }
                                    } ?>> Edit<br>
                                    <input type="hidden" name="permission[category][category-delete]" value="0" id="">
                                    <input type="checkbox" name="permission[category][category-delete]" 
                                    <?php if(!empty($arr)){
                                            if(isset($arr['category-delete']) && $arr['category-delete'] == 1){ ?>
                                                checked 
                                        <?php }
                                    } ?>> Delete
                                </td>
                            ...
                            <tr>
                                <td>Sub Category</td>
                                <td>
                                    <input type="hidden" name="permission[sub-category][sub-category-global-view]" value="0" id="">
                                    <input type="checkbox" name="permission[sub-category][sub-category-global-view]" 
                                    <?php if(!empty($arr)){
                                            if(isset($arr['sub-category-global-view']) && $arr['sub-category-global-view'] == 1){ ?>
                                                checked 
                                        <?php }
                                    } ?>> View (Global)<br>
                                    <input type="hidden" name="permission[sub-category][sub-category-create]" value="0" id="">
                                    <input type="checkbox" name="permission[sub-category][sub-category-create]" 
                                    <?php if(!empty($arr)){
                                            if(isset($arr['sub-category-create']) && $arr['sub-category-create'] == 1){ ?>
                                                checked 
                                        <?php }
                                    } ?>> Create<br>
                                    <input type="hidden" name="permission[sub-category][sub-category-edit]" value="0" id="">
                                    <input type="checkbox" name="permission[sub-category][sub-category-edit]" 
                                    <?php if(!empty($arr)){
                                            if(isset($arr['sub-category-edit']) && $arr['sub-category-edit'] == 1){ ?>
                                                checked 
                                        <?php }
                                    } ?>> Edit<br>
                                    <input type="hidden" name="permission[sub-category][sub-category-delete]" value="0" id="">
                                    <input type="checkbox" name="permission[sub-category][sub-category-delete]" 
                                    <?php if(!empty($arr)){
                                            if(isset($arr['sub-category-delete']) && $arr['sub-category-delete'] == 1){ ?>
                                                checked 
                                        <?php }
                                    } ?>> Delete
                                </td>
