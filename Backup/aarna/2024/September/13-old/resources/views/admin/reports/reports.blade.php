...
@section('content')
        ...
        <div class="card">
            <div class="card-body">
                <ul class="nav nav-pills mb-4" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a href="#pills-policy" class="nav-link me-2 active" id="pills-policy-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-policy" type="button" role="tab" aria-controls="pills-policy"
                            aria-selected="true">Policy</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a href="#pills-endorsement" class="nav-link me-2" id="pills-endorsement-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-endorsement" type="button" role="tab"
                            aria-controls="pills-endorsement" aria-selected="false">Endorsement</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a href="#pills-claim" class="nav-link me-2" id="pills-claim-tab" data-bs-toggle="pill"
                            data-bs-target="#pills-claim" type="button" role="tab" aria-controls="pill-claim"
                            aria-selected="false">Claim</a>
                    </li>
                </ul>
                <hr>
                <div class="tab-content " id="pills-tabContent">
                    <div class="tab-pane fade" id="pills-business-source" role="tabpanel"
                        aria-labelledby="pills-business-source-tab">
                        <div class="row px-3">
                            <form action="{{ route('admin.business_source_report') }}" method="post" class="row"
                                id="businessSourceForm">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12 form-floating mt-4">
                                        <select class="form-control" name="insurance_type" id="InsuranceType"
                                            value="{{ old('insurance_type') }}" placeholder="">
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-floating mt-4 motor-insurance">
                                        <select class="form-control" name="motor_category" id="MotorCategory"
                                            value="{{ old('motor_category') }}" placeholder="">
                                    ...
                                    <div class="col-md-6 form-floating mt-4 motor-insurance">
                                        <select class="form-control" name="motor_subcategory" id="MotorSubCategory"
                                            value="{{ old('motor_subcategory') }}" placeholder="">
                                    ...
                                    <div class="col-md-6 form-floating mt-4  motor-insurance">
                                        <input type="text" class="form-control" name="vehicle_chassis_no"
                                            id="vehicleChassisNo" value="{{ old('vehicle_chassis_no') }}"
                                            placeholder="">
                                    ...
                                    <div class="col-md-6 form-floating mt-4 health-insurance d-none">
                                        <select class="form-control" name="health_category" id="HealthCategory"
                                            value="{{ old('motor_category') }}" placeholder="">
                                            <option value="0">Select Category...</option>
                                            <option value="0">Select Category...</option>
                                    ...
                                    <div class="col-md-6 form-floating mt-4">
                                        ...
                                        @if ($errors->has('insurance_company'))
                                            <span
                                                class="text-danger">{{ $errors->first('health_insurance_company') }}</span>
                                        @endif
                                    </div>
                                    <div class="col-md-6 form-floating mt-4">
                                        <select class="form-control" name="health_plan" id="HealthPlan"
                                            value="{{ old('health_plan') }}" placeholder="">
                                    ...
                                    <div class="col-md-6 form-floating mt-4 health-insurance d-none">
                                        <select class="form-control" name="health_business_type" id="HealthBusinessType"
                                            value="{{ old('health_business_type') }}" placeholder="">
                                            <option value="0">Select Business Type...</option>
                                            <option value="1">New</option>
                                            <option value="2">Renewal</option>
                                            <option value="3">Rollover</option>
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-floating mt-4">
                                        <input type="date" class="form-control" name="business_source_from"
                                            id="BusinessSourceFrom" value="{{ old('business_source_from') }}"
                                            placeholder="" />
                                    ...
                                    <div class="col-md-6 form-floating mt-4">
                                        <input type="date" class="form-control" name="business_source_to"
                                            id="BusinessSourceTo" value="{{ old('business_source_to') }}"
                                            placeholder="" />
                                ...
                                <div class="col-12 text-center mt-2">
                                    <input type="hidden" name="business_report_type" class="business_report_type"
                                        value="">
                                    <a href="javascript:void(0);" class="btn btn-info mt-3 businessSourceReportCSV"
                                        data-type="csv">
                                        Export To CSV
                                    </a>
                                    <a href="javascript:void(0);" class="btn btn-secondary mt-3 businessSourceReportCSV"
                                        data-type="pdf">
                                        Export To PDF
                                    </a>
                                </div>
                    ...
                    <div class="tab-pane fade show active" id="pills-policy" role="tabpanel"
                        aria-labelledby="pills-policy-tab">
                        <div class="row px-3">
                            <form action="{{ route('admin.policy_report') }}" method="post" class="row"
                                id="policyForm">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12 form-floating mt-4">
                                    ...
                                    <div class="col-md-6 form-floating mt-4">
                                        <select class="form-control" name="agent_name" id="agent_name"
                                            value="{{ old('agent_name') }}" placeholder="">
                                    ...
                                    <div class="col-md-6 form-floating mt-4">
                                        <input type="date" class="form-control" name="created_date" id="created_date"
                                            value="{{ old('created_date') }}" placeholder="" />
    ...
    @endforeach -->
                                    ...
                                    <div class="col-md-6 form-floating mt-4">
                                        <select class="form-control" name="insurance_company" id="PolicyInsuranceCompany"
                                            value="{{ old('insurance_company') }}" placeholder="">
                                            <option value="0">Select Company...</option>
                                            @foreach ($companies as $company)
                                                <option value="{{ $company->id }}">{{ $company->name }}</option>
                                    ...
                                    <div class="col-md-6 form-floating mt-4">
                                        <input type="text" name="customer" class="form-control" id=""
                                            value="{{ old('customer') }}">
                                        <label for="Customer" class="form-label">Customer</label>
                                        @if ($errors->has('customer'))
                                            <span class="text-danger">{{ $errors->first('customer') }}</span>
                                    ...
                                    <div class="col-md-6 form-floating mt-4  health-insurance d-none">
                                        <select class="form-control" name="health_plan" id="PolicyHealthPlan"
                                            value="{{ old('health_plan') }}" placeholder="">
                                            <option value="0">Select Health Plan...</option>
                                            @foreach ($plans as $item)
                                                <option value="{{ $item->id }}">{{ $item->name }}</option>
                                    ...
                                    <div class="col-md-6 form-floating mt-4">
                                        <input type="date" class="form-control" name="policy_created_from"
                                            id="policyCreatedFrom" value="{{ old('policy_created_from') }}"
                                            placeholder="" />
                                        <label for="policyCreatedFrom" class="form-label">Policy From Risk Start
                                            Date</label>
                                    ...
                                    <div class="col-md-6 form-floating mt-4">
                                        <input type="date" class="form-control" name="policy_created_to"
                                            id="policyCreatedTo" value="{{ old('policy_created_to') }}"
                                            placeholder="" />
                                        <label for="policyCreatedTo" class="form-label">Policy To Risk Start Date</label>
                                        @if ($errors->has('policy_created_to'))
                                            <span class="text-danger">{{ $errors->first('policy_created_to') }}</span>
                                        @endif
                                    </div>
                                    <div class="col-md-6 form-floating mt-4">
                                        <input type="date" class="form-control" name="policy_expiry_from"
                                            id="policyExpiryFrom" value="{{ old('policy_expiry_from') }}"
                                            placeholder="" />
                                        <label for="policyExpiryFrom" class="form-label">Policy From Risk End Date</label>
                                        @if ($errors->has('policy_expiry_from'))
                                            <span class="text-danger">{{ $errors->first('policy_expiry_from') }}</span>
                                        @endif
                                    </div>
                                    <div class="col-md-6 form-floating mt-4">
                                        <input type="date" class="form-control" name="policy_expiry_to"
                                            id="policyExpiryFrom" value="{{ old('policy_expiry_to') }}"
                                            placeholder="" />
                                        <label for="policyExpiryTo" class="form-label">Policy To Risk End Date</label>
                                ...
                                <div class="col-12 text-center mt-2">
                                    <input type="hidden" name="policy_report_type" class="policy_report_type"
                                        value="">
                                    <a href="javascript:void(0);" class="btn btn-info mt-3 policyReportCSV" id="policyReportCSV"
                                        data-type="csv">
                                        Export To CSV
                                    </a>
                                    <a href="javascript:void(0);" class="btn btn-secondary mt-3 policyReportCSV" id="policyReportPDF"
                                        data-type="pdf">
                                        Export To PDF
                                    </a>
                                </div>
                    ...
                    <div class="tab-pane fade" id="pills-endorsement" role="tabpanel"
                        aria-labelledby="pills-endorsement-tab">
                        <div class="row p-3">
                            <form action="{{ route('admin.endorsement_report') }}" method="post" class="row"
                                id="endorsementForm">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6 form-floating mt-4">
                                        <input type="date" class="form-control" name="endorsement_start_date"
                                            id="EndorsementStartDate" value="{{ old('endorsement_start_date') }}"
                                            placeholder="">
                                        <label for="EndorsementStartDate" class="form-label">Endorsement Start
                                            Date</label>
                                        @if ($errors->has('endorsement_start_date'))
                                            <span
                                                class="text-danger">{{ $errors->first('endorsement_start_date') }}</span>
                                        @endif
                                    </div>
                                    <div class="col-md-6 form-floating mt-4">
                                        <input type="date" class="form-control" name="endorsement_end_date"
                                            id="EndorsementEndDate" value="{{ old('endorsement_end_date') }}"
                                            placeholder="">
                                    ...
                                    <div class="col-md-6 form-floating mt-4">
                                        <input type="text" class="form-control" name="customer_name"
                                            id="CustomerName" value="{{ old('customer_name') }}" placeholder="">
                                    ...
                                    <div class="col-md-6 form-floating mt-4">
                                        <input type="text" class="form-control" name="endorsement_details"
                                            id="EndorsementDetails" value="{{ old('endorsement_details') }}"
                                            placeholder="">
                                ...
                                <div class="col-12 text-center mt-2">
                                    <input type="hidden" name="endorsement_report_type" class="endorsement_report_type"
                                        value="">
                                    <a href="javascript:void(0);" class="btn btn-info mt-3 endorsementReportCSV" id="endorsementFormCSV"
                                        data-type="csv">
                                        Export To CSV
                                    </a>
                                    <a href="javascript:void(0);" class="btn btn-secondary mt-3 endorsementReportCSV" id="endorsementFormPDF"
                                        data-type="pdf">
                                        Export To PDF
                                    </a>
                                </div>
                    ...
                    <div class="tab-pane fade" id="pills-claim" role="tabpanel" aria-labelledby="pills-claim-tab">
                        <div class="row p-3">
                            <form action="{{ route('admin.claim_report') }}" method="post" class="row"
                                id="claimForm">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6 form-floating mt-4">
                                        <input type="date" class="form-control" name="claim_start_date"
                                            id="ClaimStartDate" value="{{ old('claim_start_date') }}" placeholder="">
                                        <label for="ClaimStartDate" class="form-label">From Claim Register Date</label>
                                    ...
                                    <div class="col-md-6 form-floating mt-4">
                                        <input type="date" class="form-control" name="claim_end_date"
                                            id="ClaimEndDate" value="{{ old('claim_end_date') }}" placeholder="">
                                        <label for="ClaimEndDate" class="form-label">To Claim Register Date</label>
                                    ...
                                    <div class="col-md-6 form-floating mt-4">
                                        <select class="form-control" name="claim_type" id="claimType"
                                            value="{{ old('claim_type') }}" placeholder="">
                                    ...
                                    <div class="col-md-6 form-floating mt-4">
                                        <select class="form-control" name="claim_status" id="claimStatus"
                                            value="{{ old('claim_status') }}" placeholder="">
                                ...
                                <div class="col-12 text-center mt-2">
                                    <input type="hidden" name="claim_report_type" class="claim_report_type"
                                        value="">
                                    <a href="javascript:void(0);" class="btn btn-info mt-3 claimReportCSV" id="claimFormCSV"
                                        data-type="csv">
                                        Export To CSV
                                    </a>
                                    <a href="javascript:void(0);" class="btn btn-secondary mt-3 claimReportCSV" id="claimFormPDF"
                                        data-type="pdf">
                                        Export To PDF
                                    </a>
                                </div>
...
@section('script')
    <script>
        ...
        $(document).on('click', '.endorsementReportCSV', function() {
            ...
            var formData = $('#endorsementForm').serialize();
            $.ajax({
                type: 'POST',
                url: $('#endorsementForm').attr('action'),
                data: formData,
                xhrFields: {
                    responseType: 'blob',
                },
                success: function(response, status, xhr) {
                    $('#endorsementFormPDF').html("Export To PDF");
                    $('#endorsementFormCSV').html("Export To CSV");
                    var link = document.createElement('a');
                    var url = window.URL.createObjectURL(response);
                    link.href = url;
                    link.download = 'endorsement-report.'+type;
        ...
        $(document).on('click', '.claimReportCSV', function() {
            ...
            $.ajax({
                ...
                success: function(response, status, xhr) {
                    $('#claimFormPDF').html("Export To PDF");
                    $('#claimFormCSV').html("Export To CSV");
                    var link = document.createElement('a');
                    var url = window.URL.createObjectURL(response);
                    link.href = url;
                    link.download = 'claim-report.'+type;
                    document.body.append(link);
                    link.click();
                    link.remove();
                    window.URL.revokeObjectURL(url);
        ...
        $(document).on('click', '.policyReportCSV', function() {
            ...
            $.ajax({
                ...
                success: function(response, status, xhr) {
                    $('#policyReportPDF').html("Export To PDF");
                    $('#policyReportCSV').html("Export To CSV");
                    var link = document.createElement('a');
                    var url = window.URL.createObjectURL(response);
                    link.href = url;
                    link.download = 'policy_report.'+type;
                    document.body.append(link);
                    link.click();
                    link.remove();
                    window.URL.revokeObjectURL(url);
