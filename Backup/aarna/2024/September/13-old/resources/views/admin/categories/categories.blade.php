                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.add_category_data') }}" method="POST" class="row g-3"
                            ...
                            @csrf
                            <div class="col-md-12">
                                <label for="Status" class="form-label">Insurance Type <span
                                ...
                                <select name="insurance_type" id="insurance_type" class="form-control">
                                    ...
                                    <option value="2" @if (old('insurance_type') == 2) {{ 'selected' }} @endif>
                            ...
                            @else
                                @foreach ($permissions as $permission)
                                    @if ($permission->capability == 'category-create' && $permission->value == 1)
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-primary">Submit</button>
                                        </div>
                                    @endif
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <ul class="action">
                                                        ...
                                                        @else
                                                            @foreach ($permissions as $permission)
                                                                @if ($permission->capability == 'category-edit' && $permission->value == 1)
                                                                    <li class="edit"><a
                                                                            href="{{ route('admin.edit_category', $category->id) }}"
                                                                            class=""><i
                                                                                class="icon-pencil-alt"></i></a></li>
                                                                @endif
                                                                @if ($permission->capability == 'category-delete' && $permission->value == 1)
                                                                    <li class="delete"><a href="javascript:void(0);"
                                                                            data-id="{{ $category->id }}"
                                                                            class="ms-2 delete-btn"><i
                                                                                class="icon-trash"></i></i></a> </li>
