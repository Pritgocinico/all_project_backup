...
class Policy extends Model
{
    ...
    public function healthCategorDetail(){
        return $this->belongsTo('App\Models\Category','health_category','id')->withDefault();
    }
    public function categoryDetail(){
        return $this->belongsTo('App\Models\Category','category','id')->withDefault();
    }
    ...
    public function healthCategoryDetail(){
        return $this->hasOne(Category::class,'id','health_category');   
    }
    public function healthSubCategoryDetail(){
        return $this->hasOne(Category::class,'id','health_sub_category');   
    }
    public function createdUserDetail(){
        return $this->hasOne(User::class,'id','created_by');
    }
    public function modifiedUserDetail(){
