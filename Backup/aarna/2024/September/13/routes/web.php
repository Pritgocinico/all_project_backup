...
Route::middleware('auth','role:admin,staff,agent')->prefix($locale)->group(function () {
   ...
   Route::get('delete/admin-payout-record/{id}',[AdminPayoutController::class,'deleteAdminPayoutRecord'])->name('delete.admin.payout.record');
    ...
    Route::get('remove-policy-attachment/{id}',[PolicyController::class,'removePolicyAttachment'])->name('admin.remove_policy_attachment');
    Route::get('search-policy-by-number',[PolicyController::class,'searchPolicyNumber'])->name('search.policy.number');
    Route::get('policy-data',[PolicyController::class,'get_policies_details'])->name('get_policies_details');
    ...
    Route::get('claims-data', [ClaimController::class, 'claimList'])->name('admin.claims-data');
