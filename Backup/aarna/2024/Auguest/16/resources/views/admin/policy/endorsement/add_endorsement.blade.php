...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            <form action="{{route('admin.add.endorsement.data')}}" method="post" class="row g-3 " id="formDropzone" enctype="multipart/form-data">
                @csrf
                <div class="col-md-12 form-floating mt-4">
                    <textarea class="form-control" name="details" id="Details" placeholder="" autofocus >{{old('details')}}</textarea>
                ...
                <div class="col-md-12 form-floating mt-4">
                    <input type="date" class="form-control" name="endorsement_date" id="Date" value="{{old('endorsement_date')?old('endorsement_date'):date('Y-m-d')}}" placeholder="" />
                    <label for="Date" class="form-label">Endorsement Date <span class="text-danger">*</span></label>
                ...
                <div class="col-md-12 form-floating mt-4">
                    <textarea class="form-control" name="documents" id="Documents" placeholder="" autofocus >{{old('details')}}</textarea>
                ...
                <div class="col-md-12 form-floating mt-4 cheque" style="display:none;">
                ...
                <div class="col-md-12 form-floating mt-4 online" style="display: none;">
                ...
                <div class="form-group mb-4 mt-4">
                    <label class="form-label opacity-75 fw-medium" for="formImage">Endorsement Attachments</label>
...
@section('script')
    ...
    <script>
        ...
        var myDropzone = new Dropzone('#formDropzone',{
            ...
            url: "{{route('admin.add.endorsement.data')}}",
            addRemoveLinks: true,
            autoProcessQueue: false,
            uploadMultiple: true,
            parallelUploads: 50,
            maxFiles: 50,
            acceptedFiles: '.jpeg, .jpg, .png, .gif, .pdf, .docx,.xls, .xlsx',
            thumbnailWidth: 200,
            thumbnailHeight: 200,
            ...
            success: function(file, response)
            {
                ...
                // if(response == ''){
                    top.location.href="{{ route('admin.endorsement',$id) }}";
                // }
                // setTimeout(function() {
