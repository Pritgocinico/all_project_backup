...
<body>
    ...
    <table width="100%" style="font-family: sans-serif; text-align:center;" cellpadding="10">
        <tr>
            <td width="100%" style="background-color:rgb(209, 204, 204); font-weight:bold; font-size:16px; border: 0.3mm solid rgb(21, 21, 21);">Endorsement Report</td>
        </tr>
        <tr>
    ...
    <table width="100%" style="font-family: sans-serif; text-align:center;">
        <tr>
            <td width="100%" style="text-align:center;">
                <table width="100%" style="font-family: sans-serif; text-align:center; justify-content:center; align-item:center;" cellpadding="10">
                    <tr>
                        <td width="30%" style="font-weight:bold; border: 0.3mm solid rgb(21, 21, 21);">Endorsement Details</td>
                        <td width="70%" style="font-weight:bold; border: 0.3mm solid rgb(21, 21, 21);">{{$requests['endorsement_details']}}</td>
    ...
    <table class="items" width="100%" style="border: 0.3mm solid rgb(21, 21, 21);font-size: 14px; border-collapse: collapse;" cellpadding="8">
        <thead>
            <tr style="background-color:rgb(209, 204, 204); border: 0.3mm solid rgb(21, 21, 21); font-weight:bold; font-size:14px;">
                ...
                <td width="5%" style="text-align: left;border: 0.3mm solid rgb(21, 21, 21);"><strong>Endorsement</strong></td>
                <td width="25%" style="text-align: left;border: 0.3mm solid rgb(21, 21, 21);"><strong>Company Name</strong></td>
                <td width="25%" style="text-align: left;border: 0.3mm solid rgb(21, 21, 21);"><strong>Endorsement Details</strong></td>
            ...
            @if(!blank($records))
                @foreach ($records as $record)
                    <tr style="border: 0.3mm solid rgb(21, 21, 21);">
                        ...
                        <td width="5%" style="border: 0.3mm solid rgb(21, 21, 21);">{{$record['endorsement']}}</td>
                        <td width="25%" style="border: 0.3mm solid rgb(21, 21, 21);">{{$record['company_name']}}</td>
                        <td width="25%" style="border: 0.3mm solid rgb(21, 21, 21);">{{$record['details']}}</td>
