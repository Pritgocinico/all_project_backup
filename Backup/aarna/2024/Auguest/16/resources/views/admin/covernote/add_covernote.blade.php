...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            <form action="{{route('admin.add.covernote.data')}}" method="post" class="g-3 " id="formDropzone" enctype="multipart/form-data">
                @csrf
                <div class="row">
                        ...
                        <select class="form-control" name="category" id="Category" placeholder="">
                            @foreach ($categories as $category)
                                ...
                                @if(isset($policy->category))
                                     @if($policy->category == $category->id) selected @endif
                                @endif
                    ...
                    <div class="col-md-6 form-floating mt-4 motor">
                        <select class="form-control" name="subcategory" id="SubCategory" value="{{old('subcategory')}}" placeholder="">
                            ...
                            @foreach ($sub_categories as $sub_category)
                                <option value="{{$sub_category->id}}" @if(old('subcategory') == $sub_category->id) selected @endif>{{$sub_category->name}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 mt-4 PolicyType Policy motor" style="display:none;">
                        ...
                        <input type="radio" name="policy_type" value="1" id="individual" class="policy_type policy" @if(old('policy_type')) @if(old('policy_type') == 1) checked @endif @else checked @endif><label class="mx-2" for="individual"> Individual </label>
                        <input type="radio" name="policy_type" value="2" id="corporate" class="policy_type policy" @if(old('policy_type')) @if(old('policy_type') == 1) checked @endif @endif><label class="mx-2" for="corporate" > Corporate </label>
                    ...
                    <div class="col-md-6 form-floating mt-4 health" style="display:none;">
                        <select class="form-control" name="health_category" id="HealthCategory" placeholder="">
                            ...
                            <option value="2" @if(old('health_category') == 2) selected @endif>Personal Accident</option>
                            <option value="3" @if(old('health_category') == 3) selected @endif>Super Topup</option>
                        </select>
                        ...
                        <select class="form-control" name="health_plan" id="HealthPlan" placeholder="">
                            @if(!blank($plans))
                                @foreach ($plans as $plan)
                                    <option value="{{$plan->id}}" @if(old('health_plan') == $plan->id) selected @endif>{{$plan->name}}</option>
                                @endforeach
                            @endif
                        </select>
                                            ...
                                            @foreach ($customers as $customer)
                                                <option value="{{$customer->id}}" 
                                                    @if(isset($policy->customer))
                                                        @if($policy->customer == $customer->id)
                                                             selected 
                                                        @endif
                                                    @endif
                    ...
                    <div class="col-md-6 form-floating mt-4 motor">
                        <input type="text" class="form-control" name="vehicle_model" id="vehicleModel" value="{{$policy->vehicle_model ?? old('vehicle_model')}}" placeholder="">
                    ...
                    <div class="col-md-6 form-floating mt-4 motor">
                        <input type="text" class="form-control" name="vehicle_chassis_no" id="vehicleChassisNo" value="{{$policy->vehicle_chassis_no ?? old('vehicle_chassis_no')}}" placeholder="">
                    ...
                    <div class="col-md-6 form-floating mt-4 motor">
                        <input type="text" class="form-control" name="vehicle_make" id="vehicleMake" value="{{$policy->vehicle_make ?? old('vehicle_make')}}" placeholder="">
                    ...
                    <div class="col-md-6 form-floating mt-4 motor">
                        <input type="text" class="form-control" name="vehicle_registration_no" id="vehicleRegistrationNo" value="{{$policy->vehicle_registration_no ?? old('vehicle_registration_no')}}" placeholder="">
                    ...
                    <div class="col-md-6 form-floating mt-4 motor">
                        <input type="number" class="form-control" name="year_of_manufacture" id="yearOfManufacture" value="{{$policy->year_of_manufacture ?? old('year_of_manufacture')}}" placeholder="">
                    ...
                    <div class="col-md-6 form-floating mt-4 health" style="display:none;">
                        <input type="number" class="form-control" min="0" name="sum_insured_amount" id="SumInsuredAmount" value="{{old('net_premium_amount')}}" placeholder="" />
                    ...
                    <div class="col-md-6 form-floating mt-4 motor business_type @if(old('business_type')) @if(old('business_type') == 1 || old('business_type') == 4) d-none @endif @else d-none @endif">
                        <input type="text" class="form-control" name="pyp_no" id="PypNo" value="{{$policy->policy_no ?? old('pyp_no')}}" placeholder="" />
                    ...
                    <div class="col-md-6 form-floating mt-4 motor business_type @if(old('business_type')) @if(old('business_type') == 1 || old('business_type') == 4) d-none @endif @else d-none @endif">
                        <input type="text" class="form-control" name="pyp_insurance_company" id="PypInsuranceCompany" value="{{$policy->pyp_insurance_company ?? old('pyp_insurance_company')}}" placeholder="" />
                        ...
                        <select class="form-control" name="sourcing_agent" id="SourcingAgent" placeholder="">
                            ...
                            @foreach($sourcing_agents as $agent)
                                ...
                                @if(isset($policy->agent))
                                 @if($policy->agent == $agent->id) selected @endif 
                                ...
                                <div class="col-md-12 form-floating">
                                    <div class="custom-date-div-outer-main">
                                        <div class="custom-date-div-outer justify-content-between d-flex">
                                            ...
                                            <span class="custom-date-span w-100">
                                                <input type="date" class="form-control custom-end-date-div custom-date-div" name="risk_end_date" id="RiskEndDate" value="{{(old('risk_end_date'))?old('risk_end_date'):date('Y-m-d', strtotime('+1 year -1 day'))}}" placeholder="" readonly/>
                                            </span>
                                        </div>
                                    </div>
                    ...
                    <div class="row cheque" @if(old('payment_type') == 2) @else style="display:none;" @endif>
                        <div class="col-md-6 form-floating mt-4">
                            <input type="text" class="form-control" name="cheque_no" id="chequeNo" value="{{old('cheque_no')}}" placeholder="" />
                        ...
                        <div class="col-md-6 form-floating mt-4">
                            <input type="date" class="form-control" name="cheque_date" id="cheque_date" value="{{old('cheque_date')}}" placeholder="" />
                        ...
                        <div class="col-md-6 form-floating mt-4">
                            <input type="text" class="form-control" min="0" name="bank_name" id="BankName" value="{{old('bank_name')}}" placeholder="" />
                    ...
                    <div class="row online" @if(old('payment_type') == 3) @else style="display:none;" @endif>
                        <div class="col-md-6 form-floating mt-4">
                            <input type="text" class="form-control" name="transaction_no" id="TransactionNo" value="{{old('transaction_no')}}" placeholder="" />
