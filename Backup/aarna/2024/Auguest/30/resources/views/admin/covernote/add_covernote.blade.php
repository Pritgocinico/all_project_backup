                ...
                <div class="row">
                            ...
                            <tbody>
                                ...
                                @if ($policy->insurance_type == 2)
                                    <tr>
                                        <td>Category</td>
                                        <td>
                                            {{  isset($policy->healthCategoryDetail) ? $policy->healthCategoryDetail->name : "-" }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Health Plan</td>
                    ...
                    <div class="col-md-6 form-floating mt-4 motor">
                        <select class="form-control" name="category" id="Category" placeholder="">
                            @foreach ($categories as $category)
                                <option value="{{$category->id}}" @if(isset($policy->category))
                                @if($policy->category == $category->id) selected @endif @endif>{{$category->name}}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 form-floating mt-4 motor">
                        <select class="form-control" name="subcategory" id="SubCategory" value="{{old('subcategory')}}"
                            placeholder="">
                            <option value="0">Select Sub Category...</option>
                            @foreach ($sub_categories as $sub_category)
                                <option value="{{$sub_category->id}}" @if($policy->sub_category == $sub_category->id) selected
                    ...
                    <div class="col-md-6 mt-4 PolicyType Policy motor" style="display:none;">
                        ...
                        <input type="radio" name="policy_type" value="1" id="individual" class="policy_type policy"
                            @if($policy->policy_type == 1) checked @endif><label class="mx-2" for="individual"> Individual
                        </label>
                        <input type="radio" name="policy_type" value="2" id="corporate" class="policy_type policy"
                            @if($policy->policy_type == 2) checked @endif><label class="mx-2" for="corporate"> Corporate
                        </label>
                    ...
                    <div class="col-md-6 form-floating mt-4 PolicyIndividualRate Policy motor" style="display:none;">
                        <input type="text" class="form-control" name="policy_individual_rate" id="PolicyIndividualRate"
                            value="{{$policy->policy_individual_rate}}" placeholder="">
                    ...
                    <div class="col-md-6 form-floating mt-4">
                        <select class="form-control" name="insurance_company" id="InsuranceCompany"
                            ...
                            @foreach ($companies as $company)
                                <option value="{{$company->id}}" @if($policy->company == $company->id) selected @endif>
                        ...
                        <select class="form-control" name="health_plan" id="HealthPlan" placeholder="">
                            @if(!blank($plans))
                                @foreach ($plans as $plan)
                                    <option value="{{$plan->id}}" @if(old('health_plan') == $plan->id) selected @endif>
                                        {{$plan->name}}
                                    </option>
                                @endforeach
                            @endif
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <div class="w-100 form-floating">
                                        <select class="form-control select2" name="customer" id="Customer"
                                            ...
                                            @foreach ($customers as $customer)
                                                <option value="{{$customer->id}}" @if(isset($policy->customer))
                                                @if($policy->customer == $customer->id) selected @endif @endif>
                                                    {{$customer->name}}
                                                </option>
                                            @endforeach
                                        </select>
                    ...
                    <div class="col-md-6 form-floating mt-4 motor">
                        <input type="text" class="form-control" name="vehicle_registration_no"
                            id="vehicleRegistrationNo" value="{{$policy->vehicle_registration_no}}" placeholder="">
                    ...
                    <div class="col-md-6 form-floating mt-4 health" style="display:none;">
                        <input type="number" class="form-control" min="0" name="sum_insured_amount"
                            id="SumInsuredAmount" value="{{old('net_premium_amount')}}" placeholder="" />
                    ...
                    <div
                        class="col-md-6 form-floating mt-4 motor business_type @if(old('business_type')) @if(old('business_type') == 1 || old('business_type') == 4) d-none @endif @else d-none @endif">
                    ...
                    <div
                        class="col-md-6 form-floating mt-4 motor business_type @if(old('business_type')) @if(old('business_type') == 1 || old('business_type') == 4) d-none @endif @else d-none @endif">
                        <input type="text" class="form-control" name="pyp_insurance_company" id="PypInsuranceCompany"
                            value="{{$policy->pyp_insurance_company ?? old('pyp_insurance_company')}}" placeholder="" />
                    ...
                    <div class="col-md-6 form-floating mt-4">
                        <select class="form-control" name="sourcing_agent" id="SourcingAgent" placeholder="">
                            ...
                            @foreach($sourcing_agents as $agent)
                                <option value="{{$agent->id}}" @if(isset($policy->agent)) @if($policy->agent == $agent->id)
                                selected @endif @endif>{{$agent->name}}</option>
                            @endforeach
                        </select>
                            ...
                            <div class="custom-date-div-outer-main">
                                <div class="custom-date-div-outer justify-content-between d-flex">
                                    <span class="custom-date-span w-100">
                                        <input type="date" class="form-control custom-start-date-div custom-date-div"
                    ...
                    <div class="row cheque" @if(old('payment_type') == 2) @else style="display:none;" @endif>
                        ...
                        <div class="col-md-6 form-floating mt-4">
                            <input type="text" class="form-control" min="0" name="bank_name" id="BankName"
