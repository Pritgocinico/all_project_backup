    ...
    @endforeach
                        ...
                        <div class="col-md-6 form-floating mt-4 health" style="display:none;">
                            <select class="form-control" name="health_category" id="HealthCategory" placeholder="">
                                ...
                                <option value="2" @if ($policy->health_category == 2) selected @endif>Personal
                                    Accident</option>
                                <option value="3" @if ($policy->health_category == 3) selected @endif>Super Topup
                                </option>
                            </select>
        ...
        var myDropzone = new Dropzone('#formDropzone', {
            ...
            init: function() {
                ...
                this.on('removedfile', function(data) {
                    ...
                    $.ajax({
                        type: 'get',
                        url: "{{ route('admin.remove_policy_attachment', 'empid') }}".replace('empid',id),
