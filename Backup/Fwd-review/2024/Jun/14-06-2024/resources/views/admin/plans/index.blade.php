                        ...
                        @if (!blank($plans))
                            @foreach ($plans as $plan)
                                <tr>
                                    ...
                                    @php
                                        $string = $plan->plan_period_type;
                                        $position = strrpos($string, 's');
                                        if ($position !== false) {
                                    ...
                                    <td class="text-end">
                                        <a href="javascript:void(0)" onclick="editPlan('{{ $plan->id }}')"><img
                                                src="{{ url('/') }}/assets/Images/edit.png" alt=""
                                                class="ed_btn me-2"></a>
                                        <a href="javascript:void(0);" data-id="{{ $plan->id }}" class="delete-btn"><img
