                    ...
                    <tbody>
                        ...
                        @dd($business->planDetail)
                                <tr>
                                    ...
                                    <td>{{isset($business->planDetail) ? $business->planDetail->plan_amount : "-"}}</td>
                                    ...
                                    <td data-header="Action" class="gc_flex">
                                        <div class="d-flex align-items-center justify-content-end">
                                            ...
                                            @endif
                                            <a href="{{route('client.edit.business',$business->id)}}"><img src="{{url('/')}}/assets/Images/edit.png" alt="" class="ed_btn me-2"></a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
