                                ...
                                @foreach ($reports as $report)
                                    <tr>
                                        ...
                                        <td class="generated_report_td">
                                            ...
                                            <a href="{{route('client.report-export',$report->id)}}?type=csv" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="Export CSV" ><img src="{{url('/')}}/assets/Images/csv.png" alt=""></a>
                                                @endif
                                            @if($report->export_pdf == 1)
                                            <a href="{{route('client.report-export',$report->id)}}?type=pdf" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="Export PDF"><img src="{{url('/')}}/assets/Images/pdf.png" alt=""></a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
