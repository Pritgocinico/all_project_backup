...
@section('content')
    <div class="gc_row px-md-4 px-2">
        ...
        <div class="gc_bottom_btn fixed-bottom customer"> <a href=""
                class="btn gc_btn d-flex align-items-center d-block d-md-none"><span class="fs-4 me-2">+</span>Add
                Customer</a></div>
        <div class="card">
            <div class="table-responsive p-3">
                <div class="row">
                    <div class="col-md-1">
                        <label class="mt-3">Expiry AT:-</label>
                    </div>
                    <div class="col-md-8 form-floating mb-3">
                        <input type="text" class="form-control w-50 date_filter" name="expire_at" id="expire_at"
                            value="" placeholder="" />
