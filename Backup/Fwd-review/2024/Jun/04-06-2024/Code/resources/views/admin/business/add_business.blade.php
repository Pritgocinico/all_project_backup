                        ...
                        <form action="{{ route('admin.add.business.data') }}" method="post" class="row g-3">
                            ...
                            <div class="col-md-12 form-floating mt-4">
                                <select name="plan" class="form-control" id="plan">
                                    ...
                                    @foreach ($planList as $plan)
                                        <option value="{{$plan->id}}" @if(old('plan') == $plan->id) "checked" @endif>{{$plan->plan_title}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-12 form-floating mt-4">
                                <select name="payment_option" class="form-control" id="payment_option">
                                    ...
                                    <option value="cash" @if(old('payment_option') == "cash") "checked" @endif>Cash</option>
                                    <option value="online" @if(old('payment_option') == "online") "checked" @endif>Online</option>
                                </select>
