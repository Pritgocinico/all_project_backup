...
<div class="d-flex">
    <div class="pb-3 ms-auto">
        <a href="{{url('/')}}/{{$business->shortname}}" target="_blank"><i class="fa fa-arrow-right me-3"></i>{{url('/')}}/{{$business->shortname}}</a>
    </div>
</div>
<div class="row">
    <div class="col-md-3">
                ...
                <form action="{{route('submit.funnel')}}" method="POST" id="formSubmit" enctype="multipart/form-data">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <div>
                                        ...
                                        <div class="social-media">
                                            <div class="facebook">
                                                ...
                                                <input type="text" name="facebook_url" class="form-control" placeholder="Facebook Page ID" value="{{$business->facebook_url}}">
                                            </div>
                                            <div class="twitter">
                                                <img src="{{url('/')}}/assets/Images/twitter.png" class="icon-set" alt="twitter">
                                                <input type="text" name="twitter_url" class="form-control" placeholder="@ Twitter name" value="{{$business->twitter_url}}">
                                            </div>
                                            <div class="instagram">
                                                <img src="{{url('/')}}/assets/Images/instagram.png" class="icon-set" alt="instagram">
                                                <input type="text" name="instagram_url" class="form-control" placeholder="Instagram" value="{{$business->instagram_url}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="pills-content" role="tabpanel" aria-labelledby="pills-content-tab">
                            ...
                            <div class="card card-border mt-3">
                                <div class="card-body">
                                    <h5>Public Review Workflow</h5>
                                    <p>These visitors are presented with your review site links and instructions.</p>
                                    <hr>
                                    <div>
                                        <label for="publicReviewMessage" class="mb-2">Public review request message</label>
                                        <textarea name="public_review_message" class="form-control">{{$business->public_review_message}}</textarea>
                                    </div>
                                    <div class="mt-3">
                                        <label for="publicReviewMessage" class="mb-2">Public review "thank you" message</label>
                                        <textarea name="public_review_thankyou_message" class="form-control">{{$business->public_review_thankyou_message}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="card card-border mt-3">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        <label for="privateFeedback" class="mb-2">Private feedback request message</label>
                                        <textarea name="private_feedback" id="privateFeedback" class="form-control">{{$business->private_feedback}}</textarea>
                                    </div>
                                    <!-- <div class="mt-3">
                                        <label for="formType">Form Type</label>
                                        <select name="form_type" class="form-control mt-2" id="formType">
                                            <option value="1">Contact Form</option>
                                            <option value="2">Custom</option>
                                        </select>
                                    </div> -->
                                    <div class="mt-3">
                                        <label for="privateFeedbackThankyou" class="mb-2">Private feedbackform "thank you" message</label>
                                        <textarea name="private_feedback_thankyou" id="privateFeedbackThankyou" class="form-control">{{$business->private_feedback_thankyou}}</textarea>
                                    </div>
                                    <div class="mt-3">
                                        <label for="thumbsupText">Thumbs UP link text</label>
                                        <input type="text" name="thumbsup_text" id="thumbsupText" class="form-control" placeholder="Enter message" value="{{$business->thumbsup_text}}">
                                    </div>
                                    <div class="mt-3">
                                        <label for="thumbsdownText">Thumbs DOWN link text</label>
                                        <input type="text" name="thumbsdown_text" id="thumbsdownText" class="form-control" placeholder="Enter message" value="{{$business->thumbsdown_text}}">
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="card card-border mt-3">
                            ...
                            <div class="card card-border">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <input type="text" name="business_name" id="businessName" class="form-control" placeholder="Enter Business Name " value="@if(isset($data['name']) && $data['name'] != ''){{$data['name']}}@else {{$business->business_name}} @endif">
                                    </div>
                                    <div class="mt-3">
                                        ...
                                        <div class="mt-3">
                                            <span class="color-picker">
                                                <label for="colorPicker">
                                                    <input type="color" name="brand_color" value="@if(!blank($business->brand_color)){{$business->brand_color}}@else #111111 @endif" id="colorPicker">
                                                </label>
                                            </span>
                                        </div>
                                    </div>
