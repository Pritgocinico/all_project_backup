                            ...
                            <div class="card card-border">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <button type="button" class="btn gc_btn mt-2 @if(blank($business->logo)) d-none @endif" id="removeLogo">Remove Logo</button>
                                    ...
                                    <div class="mt-3">
                                        <input type="checkbox" name="show_business_name" class="from-control" @if ($business->show_business_name == 'on') checked @endif>
