            ...
            <div class="card-body">
                <ul class="nav nav-pills gap-2 justify-content-center" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a href="#pills-profile-overview-tab" class="nav-link active" id="pills-profile-overview-tab"
                    ...
                    <li class="nav-item" role="presentation">
                        <a href="#pills-campaings-tab" class="nav-link" id="pills-campaings-tab" data-bs-toggle="pill"
