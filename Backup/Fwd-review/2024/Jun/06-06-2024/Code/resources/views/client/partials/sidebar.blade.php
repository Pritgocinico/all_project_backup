            ...
            <div class="menu">
                ...
                @else
                    ...
                    <div class="item" @if(\Request::route()->getName() == 'client.report.analytic') style="display:block" @endif>
                        ...
                        <div class="sub-menu " @if(\Request::route()->getName() == 'client.report.analytic' || \Request::route()->getName() == 'client.report.generated' || \Request::route()->getName() == 'client.report.schedule') style="display:block" @endif>
                            ...
                            <a href="{{route('client.report.generated')}}" class="sub-item d-flex align-items-center @if(\Request::route()->getName() == 'client.report.generated' ) active @endif">
                                <img src="{{url('/')}}/assets/Images/Sidebar_Icons/mail.png" alt="">
                                <span>Generated Reports</span>
                            </a>
                            <a href="{{route('client.report.schedule')}}" class="sub-item d-flex align-items-center @if(\Request::route()->getName() == 'client.report.schedule' ) active @endif">
                                <img src="{{url('/')}}/assets/Images/Sidebar_Icons/pos.png" alt="">
                    ...
                    <div class="item @if(\Request::route()->getName() == 'client.business') active @endif">
                        <a href="{{route('client.business')}}" class="d-flex align-items-center">
                            <img src="{{url('/')}}/assets/Images/add-user.png" alt="">
                            <span>Business</span>
                        </a>
                    </div>
                    <div class="item @if(\Request::route()->getName() == 'client.transaction.page') active @endif">
                        <a href="{{route('client.transaction.page')}}" class="d-flex align-items-center">
                            <img src="{{url('/')}}/assets/Images/add-user.png" alt="">
