        ...
        <div class="row header_row mx-0 py-2 sticky-top">
            <div class="col-2 p-0 d-none d-md-block">
                <div class="header_logo ps-5 mt-2">
                    <a href="{{route('client.dashboard')}}"><img src="{{url('/')}}\assets\Images\footer-logo.png" alt="" class="header_logo "></a>
                </div>
            </div>
            <div class="col-md-10 col-12 p-0">
                <div class="header py-1 px-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-block d-md-none"><a href="{{url('/')}}/"><img src="{{url('/')}}\assets\Images\footer-logo.png" alt="" class="header_logo "></a></div>
                        <div class="d-flex ms-auto align-items-center">
                            @if (!blank($client_business))
                                <div class="me-2">
                                    <select name="client_business" id="" class="form-control p-2 client_business">
                                        @foreach ($client_business as $businesses)
                                            <option value="{{$businesses->id}}" @if(!blank($business)) @if($business->id == $businesses->id) selected @endif @endif>{{$businesses->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            @endif
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" >
                                    <li class=''><a class="dropdown-item fs-6 py-2" href="{{ route('client.my.profile') }}">My Profile</a> </li>
                                    <!-- <li class=''><a class="dropdown-item fs-6 py-2" href="{{url('/')}}">Edit Profile</a> </li> -->
                                    <!-- <li class=''><a class="dropdown-item fs-6 py-2" href="{{url('/')}}">Settings</a> </li> -->
