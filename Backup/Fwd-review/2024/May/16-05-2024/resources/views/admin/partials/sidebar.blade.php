    ...
    <div id="side" class=" ">
        <div class="p-3 sidebar_menu side-bar ">
            ...
            <div class="menu">
                ...
                <div class="item @if(\Request::route()->getName() == 'admin.clients' || \Request::route()->getName() == 'admin.add.client' || \Request::route()->getName() == 'admin.edit.client') active @endif">
                    <a href="{{route('admin.clients')}}" class="d-flex align-items-center">
                        <img src="{{url('/')}}/assets/Images/Sidebar_Icons/customer.png" alt="">
                        <span>Clients</span>
                    </a>
                </div>
                <div class="item @if(\Request::route()->getName() == 'admin.business' || \Request::route()->getName() == 'admin.add.business' || \Request::route()->getName() == 'admin.edit.business') active @endif">
