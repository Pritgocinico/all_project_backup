        ...
        <div class="card-body">
            <div class="row">
                    ...
                    <form action="{{route('admin.add.business.data')}}" method="post" class="row g-3">
                        ...
                        <div class="col-md-11 form-floating mt-4">
                            <select name="client" class="form-control" id="Client">
                                <option value="0" {{ old('client') == 0 ? 'selected' : '' }}>Select Client...</option>
                        ...
                        <div class="col-md-1 form-floating mt-4">
                            <button type="button" class="btn gc_btn" data-bs-toggle="modal" data-bs-target="#RequestReportModal" style="position: absolute; bottom: 10px;">+</button>
                        </div>
                        ...
                        <div class="col-md-12 form-floating mt-4">
                            <input type="text" class="form-control" name="shortname" id="ShortName" value="{{old('shortname')}}" placeholder="" />
                        ...
                        <div class="col-md-12 form-floating mt-4">
                            <input type="text" class="form-control" name="place_id" id="PlaceID" value="{{old('place_id')}}" placeholder="" />
                        ...
                        <div class="col-md-12 form-floating mt-4">
                            <input type="text" class="form-control" name="api_key" id="ApiKey" value="{{old('api_key')}}" placeholder="" />
                ...
                <div class="col-md-6">
                    ...
                    <iframe src="{{url('/')}}/assets/Images/blank.pdf" class="col-d-12" width="600" height="400" frameborder="0"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('admin.add.client.data')}}" method="post" class="row g-3">
                    @csrf
                    ...
                    <div class="modal-footer">
                            ...
                            <button type="submit" class="btn gc_btn">
                                Submit
                            </button>
                    </div>
                </form>
