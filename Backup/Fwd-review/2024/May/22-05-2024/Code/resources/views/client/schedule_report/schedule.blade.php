                        ...
                        <div class="schedule_report_div_box">
                            ...
                            <div class="email-settings">
                                <div class="mail-template-preview">
                                    <div class="mail-headers">
                                        <div class="mail-header send_on_weekends d-flex">
                                            ...
                                            <select name="send_weekend" class="form-control" id="send_weekend">
                                                ...
                                                <option class="no"
                                                    @if (isset($emailTemplate) && $emailTemplate->send_weekend == 'no') {{ 'selected' }} @endif>No</option>
                                            </select>
                                            @if ($errors->has('schedule'))
                                                <span class="text-danger">{{ $errors->first('schedule') }}</span>
                                            @endif
                                    ...
                                    <div class="mail-footer" id="mail-footer">
    ...
    <div class="modal fade" id="RequestReportModal1" tabindex="-1" aria-labelledby="RequestReportModal1Label"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="rs_dialog_content" style="width: auto;">
                        <div class="row">
                            <div class="col-md-12 form-floating mt-3">
                                <input type="email" class="form-control mx-2"
                                    name="email_address" class="form-control" placeholder=""
                                    id="email_address">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-floating mt-3">
                                <input type="text" class="form-control mx-2"
                                    name="first_name" class="form-control" placeholder=""
                                    id="first_name">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-floating mt-3">
                                <input type="text" class="form-control mx-2"
                                    name="last_name" class="form-control"  placeholder=""
                                    id="last_name">
                ...
                <div class="modal-footer">
                    <div class="controls">
                        <input type="button" data-wrapper-class="ui-recurring-select" class="rs_save btn gc_btn send_test_mail"
                            value="Send Test">
                        <input type="button" data-wrapper-class="ui-recurring-select" class="rs_cancel btn btn-danger"
...
@section('script')
    ...
    <script>
        ...
        function removerAddMoreOption(id) {
            $('.receipt-' + id).remove();
        }
