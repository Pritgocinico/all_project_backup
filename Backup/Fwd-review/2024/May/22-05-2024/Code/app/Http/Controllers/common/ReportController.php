...
class ReportController extends Controller
{
    ...
    public function generatedReportStore(Request $request)
    {
        ...
        $reportData = [
            ...
            'export_csv' => isset($request->csv_report) ? '1' : '0',
            'export_pdf' => isset($request->pdf_report) ? '1' : '0',
            'language' => 'en',
        ];
    ...
    public function scheduleReport(Request $request)
    {
        ...
        return view('client.schedule_report.schedule', compact('page', 'icon', 'business', 'reports', 'emailTemplate'));
    }
    ...
    public function storeSchedule(Request $request)
    {
        ...
        $data = [
            ...
            'report_schedule' => implode(",", $request->report_schedule),
