...
class AuthController extends Controller
{
    ...
    public function settingPage(){
        ...
        $logoUrl = storage_path($settings->logo);
        $faUrl = storage_path($settings->favicon);
        return view('admin.setting.setting',compact('page','icon','business','settings','logoUrl','faUrl'));
    }
    ...
    public function saveSetting(Request $request){
        ...
        if($request ->hasFile('favicon')){
            $faIcon = $request->file('favicon')->store('public/fa_icon');
            $settings->favicon = $faIcon;
        }
