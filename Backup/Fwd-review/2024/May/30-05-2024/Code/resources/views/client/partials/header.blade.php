        ...
        <div class="row header_row mx-0 py-2 sticky-top">
            <div class="col-2 p-0 d-none d-md-block">
                <div class="header_logo ps-5 mt-2">
                    <a href="{{ route('client.dashboard') }}"><img
                            src="{{ url('/') }}\assets\Images\footer-logo.png" alt=""
                            class="header_logo "></a>
                </div>
            </div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex ms-auto align-items-center">
                            @if (!blank($client_business))
                                <div class="me-2">
                                    <select name="client_business" id=""
                                        class="form-select p-2 client_business">
                                        ...
                                        @foreach ($client_business as $businesses)
                                            ...
                                            <option value="{{ $businesses->id }}" {{ $type }}
                                                @if (!blank($business)) @if ($business->id == $businesses->id) selected @endif
                                        ...
                                        <div class="notification_clear mh-550px scroll-y">
                                            ...
                                            @else
                                                <div class="py-2 text-left border-top">
                                                    <p
                                                        class="mb-0 fw-bold houmanity-color d-flex justify-content-between">
                                                        No New Notification
                                                    </p>
                                                </div>
                                            @endif
