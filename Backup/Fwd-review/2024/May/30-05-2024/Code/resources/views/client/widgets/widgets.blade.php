        ...
        <div class="card mt-3">
            <div class="card-body">
                ...
                <div class="justify-content-center">
                    ...
                    <a href="{{url('/')}}/{{$business->shortname}}">{{url('/')}}/{{$business->shortname}}</a>
                </div>
            </div>
        </div>
        <div class="card mt-3">
            <div class="card-body">
                ...
                <hr>
                <a href="{{url('/')}}/{{$business->shortname}}" style="background-color: #298CFF;color: #FFFFFF;display: inline-block;padding: 10px 20px;margin: 0 2px;font-weight: normal;font-size: 15px;text-decoration: none;text-transform: uppercase;border-width: 0;border-radius: 2px;cursor: pointer;border-width: 1px 1px 3px;" data-content="Review Us" data-replace="true">Review Us</a>
                <div class="mt-3">
                    <p>Embed code:</p>
