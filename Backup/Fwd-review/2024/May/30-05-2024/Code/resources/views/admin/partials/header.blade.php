    ...
    <div class=" gc-main px-0">
        <div class="row header_row mx-0 py-2 sticky-top">
            <div class="col-2 p-0 d-none d-md-block">
                <div class="header_logo ps-5 ms-2 mt-3">
                    <a href="{{url('/')}}"><img src="{{url('/')}}\assets\Images\footer-logo.png" alt="" class="header_logo "></a>
                </div>
            </div>
            <div class="col-md-10 col-12 p-0">
                <div class="header py-1 px-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-block d-md-none"><a href="{{url('/')}}/"><img src="{{url('/')}}\assets\Images\thumb.png" alt="" class="header_logo "></a></div>
                        <div class="d-flex ms-auto align-items-center">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" >
                                    <li class=''><a class="dropdown-item fs-6 py-2" href="{{route('admin.view')}}">My Profile</a> </li>
                                    <li class=''><a class="dropdown-item fs-6 py-2" href="{{route('admin.edit')}}">Edit Profile</a> </li>
                                    <li class=''><a class="dropdown-item fs-6 py-2" href="{{route('setting.page')}}">Settings</a> </li>
