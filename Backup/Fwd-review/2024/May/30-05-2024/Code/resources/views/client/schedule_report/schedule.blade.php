...
@section('content')
    <div class="gc_row px-md-4 px-2">
        ...
        @php $emailArray = explode(',',$schedule->add_recipient); @endphp
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
...
@section('script')
    ...
    <script>
        ...
        $('#add_more_button_report_button').on('click', function(e) {
            ...
            html +=
                `<img src="{{ url('/') }}/assets/Images/delete.png" alt="" class="ed_btn add_more_button_report" onclick="removerAddMoreOption(` +i + `,'add')">`;
            html += '</div>';
            html += '</div>';
            html += '</div>';
