...
<div class="gc_row px-md-4 px-2">
    <div class="card mt-md-3 mb-3">
        <div class="card-body d-flex align-items-center p-lg-3 p-2 staff_header">
            <div class="pe-4 fs-5">Edit Email</div>
            <div class="ms-auto">
                <a href="{{route('client.email.settings')}}" class="btn gc_btn">Go Back</a>
            </div>
        </div>
    </div>
    <form action="{{route('client.edit.email.data')}}" method="post" class="row g-3">
        @csrf
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 form-floating mt-4">
                                <input type="text" class="form-control" name="name" id="Name" value="{{$email->email_name}}" placeholder="" autofocus />
                            ...
                            <div class="col-md-6 form-floating mt-4">
                                <select class="form-control" name="delay_days" id="delayDays">
                                    <option value="0" @if($email->delay_days == 0) selected @endif>Immediately</option>
                                    <option value="1" @if($email->delay_days == 1) selected @endif>next day</option>
                                    <option value="2" @if($email->delay_days == 2) selected @endif>in 2 days</option>
                                    <option value="3" @if($email->delay_days == 3) selected @endif>in 3 days</option>
                                    <option value="4" @if($email->delay_days == 4) selected @endif>in 4 days</option>
                                    <option value="5" @if($email->delay_days == 5) selected @endif>in 5 days</option>
                                    <option value="6" @if($email->delay_days == 6) selected @endif>in 6 days</option>
                                    <option value="7" @if($email->delay_days == 7) selected @endif>in 7 days</option>
                                    <option value="14" @if($email->delay_days == 14) selected @endif>in 14 days</option>
                                </select>
                            ...
                            <div class="col-md-12 form-floating mt-4">
                                <input type="text" class="form-control" name="subject" id="Subject" value="{{$email->subject}}" placeholder="" />
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <textarea id="summernote" name="email_html" >{!! $email->email_html !!}</textarea>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-floating mt-4">
                            <input type="text" class="form-control" name="from_name" id="FromName" value="{{$email->from_name}}" placeholder="" />
                        ...
                        <div class="form-floating mt-4">
                            <input type="text" class="form-control" name="from_email" id="FromEmail" value="{{$email->from_email}}" placeholder="" />
                        ...
                        <div class="form-floating mt-4">
                            <input type="text" class="form-control" name="reply_to" id="ReplyTo" value="{{$email->reply_to}}" placeholder="" />
                            ...
                            <select name="timezone" class="form-control select2" id="TimeZone">
                                @if(!blank($timezones))
                                    @foreach ($timezones as $timezone)
                                        <option value="{{$timezone['id']}}" @if($email->timezone == $timezone['id']) selected @endif>{{$timezone['name']}}</option>
                                    @endforeach
                                @endif
                            </select>
