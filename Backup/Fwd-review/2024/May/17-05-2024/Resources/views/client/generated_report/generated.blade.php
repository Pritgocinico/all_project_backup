                                ...
                                @foreach ($reports as $report)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            data-bs-placement="top" title="Export CSV" ><img src="{{url('/')}}/assets/Images/svg/csv-icon.svg" alt=""></a>
                                            @endif
                                            @if($report->export_pdf == "1")
                                            <a href="{{route('client.report-export',$report->id)}}?type=pdf" target="_blank"  data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="Export PDF"><img src="{{url('/')}}/assets/Images/svg/pdf-icon.svg" alt=""></a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
