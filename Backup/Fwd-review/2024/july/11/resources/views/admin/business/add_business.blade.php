                ...
                <div class="row">
                    <div class="col-md-6">
                        <form action="{{ route('admin.add.business.data') }}" method="post" class="row g-3">
                            ...
                            <div class="col-md-12 form-floating mt-4 @if(old('payment_option') == null ||old('payment_option' == "cash")) d-none @endif" id="transaction_id_div">
                    ...
                    <div class="col-md-6">
                        ...
                        <iframe src="{{ url('/') }}/assets/Images/pdf/find place id.pdf" class="col-d-12 w-100" width="700"
