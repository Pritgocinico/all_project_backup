    ...
    <script>
        $(document).ready(function() {
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function(data) {
                                Swal.fire({
                                    title: 'Deleted!',
                                    text: "Business Subscription Stop Successfully.",
                                    icon: 'success',
            ...
            $(document).on('click', '.cancel-btn', function() {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: "Are you sure you want to cancel edit business request?",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
            ...
            $(document).on('click', '.approve-btn', function() {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: "Are you sure you want to approve edit business request?",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
