    ...
    <div id="side" class=" ">
        <div class="p-3 sidebar_menu side-bar ">
            ...
            <div class="menu">
                ...
                <div class="item @if (
                    \Request::route()->getName() == 'detail.plan') active @endif">
                    <a href="{{ route('detail.plan') }}" class="d-flex align-items-center">
                        <img src="{{ url('/') }}/assets/Images/add-user.png" alt="">
                ...
                <div class="item @if (\Request::route()->getName() == 'admin.payment-detail') active @endif">
                    <a href="{{ route('admin.payment-detail') }}" class="d-flex align-items-center">
                        <img src="{{ url('/') }}/assets/Images/Sidebar_Icons/notification.png" alt="">
                ...
                <div class="item @if (\Request::route()->getName() == 'admin.logs') active @endif">
                    <a href="{{ route('admin.logs') }}" class="d-flex align-items-center">
                        <img src="{{ url('/') }}/assets/Images/logs.png" alt="" class="logs_image_sidebar">
                        <span>Logs</span>
                    </a>
                </div>
            </div>
