            ...
            <div class="card-body">
                <ul class="nav nav-pills gap-2 justify-content-center" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a href="#pills-links" class="nav-link active" id="pills-links-tab" data-bs-toggle="pill" data-bs-target="#pills-links" type="button" role="tab" aria-controls="pills-links" aria-selected="true">Report Setting</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a href="#pills-content" class="nav-link" id="pills-content-tab" data-bs-toggle="pill" data-bs-target="#pills-content" type="button" role="tab" aria-controls="pills-content" aria-selected="false">Test Mail Report</a>
                    </li>
                </ul>
            </div>
        </div>
                                        ...
                                        <div class="" id="add_recipient_detail">
                                            ...
                                            @empty
                                                <div class="row receipt-default">
                                                    ...
                                                    <div class="col-md-2">
                                                        <input type="button" class="btn gc_btn add_more_button_report"
                                                            id="add_more_button_report_button" value="Add" />
                                                    </div>
                                                </div>
                                            @endforelse
                                        ...
                                        <div class="mail-template-preview">
                                            ...
                                            <div class="mail-footer mt-3" id="mail-footer">
                                                <div class="controls float-end">
                                                    <button class="btn gc_btn add-test-recipient"
