...
<div class="gc_row px-md-4 px-2">
    <div class="card mt-md-3 mb-3">
        <div class="card-body d-flex align-items-center p-lg-3 p-2 staff_header">
            ...
            <div class="ms-auto">
                <a href="{{route('client.business')}}" class="btn gc_btn">Go Back</a>
            </div>
        </div>
    </div>
    <div class="card">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form action="{{$route}}" method="post" class="row g-3">
                        ...
                        <div class="col-md-12 form-floating mt-4">
                            <input type="text" class="form-control" name="name" id="Name" value="{{$business->name}}" placeholder="" readonly/>
                        ...
                        <div class="col-md-12 form-floating mt-4">
                            <input type="text" class="form-control" name="api_key" id="ApiKey" value="{{$setting->api_key}}" placeholder="" readonly/>
                ...
                <div class="col-md-6">
                    ...
                    <iframe src="{{url('/')}}/assets/Images/pdf/find place id.pdf" class="col-d-12 w-100" width="700" height="400" frameborder="0"></iframe>
                </div>
            </div>
        </div>
    </div>
