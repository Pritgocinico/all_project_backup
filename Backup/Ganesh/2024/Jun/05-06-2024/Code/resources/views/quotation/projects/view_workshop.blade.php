...
@section('pages')
    ...
    @endif-->
                    ...
                    <div class="d-flex gap-3">
                        @if ($projects->add_work == 1)
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="add_cutting_option"
                                    id="cutting_option_radio1" @if ($additionalProject->cutting_selection == 1) checked @endif
                                    value="1">
                                <label class="form-check-label" for="flexRadioDefault1"> Yes </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="add_cutting_option"
                                    id="cutting_option_radio2" value="0"
                                    @if ($additionalProject->cutting_selection == 0) checked @endif>
                                <label class="form-check-label" for="flexRadioDefault2"> No </label>
                            </div>
                        @else
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="cutting_option"
                                    id="cutting_option_radio1" @if ($projects->cutting_selection == 1) checked @endif
                                    value="1">
                                <label class="form-check-label" for="flexRadioDefault1"> Yes </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="cutting_option"
                                    id="cutting_option_radio2" value="0"
                                    @if ($projects->cutting_selection == 0) checked @endif>
                                <label class="form-check-label" for="flexRadioDefault2"> No </label>
                            </div>
                        @endif
                    </div>
                        ...
                        <div class="d-flex gap-3">
                            <div class="">
                                @php
                                    ...
                                    if ($projects->add_work == 1) {
                                        if ($additionalProject->cutting_date) {
                                            $formattedDateTime = date(
                                                'Y-m-d\TH:i',
                                                strtotime($additionalProject->cutting_date),
                                            );
                                        }
                                    } else {
            ...
            <div class="form-group mt-4">
                <form class="" action="{{ route('quotation_updateShutter') }}" enctype="multipart/form-data"
                    method="POST">
                    @csrf
                    <div class="d-flex align-items-center pb-3">
                    ...
                    <div class="d-flex gap-3">
                        @if ($projects->add_work == 1)
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="add_shutter_joinery"
                                    id="shutter_joinery_radio1" @if ($additionalProject->shutter_selection == 1) checked @endif
                                    value="1">
                                <label class="form-check-label" for="flexRadioDefault1"> Yes </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="add_shutter_joinery"
                                    id="shutter_joinery_radio2" value="0"
                                    @if ($additionalProject->shutter_selection == 0) checked @endif>
                                <label class="form-check-label" for="flexRadioDefault2"> No </label>
                            </div>
                        @else
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="shutter_joinery"
                                    id="shutter_joinery_radio1" @if ($projects->shutter_selection == 1) checked @endif
                                    value="1">
                                <label class="form-check-label" for="flexRadioDefault1"> Yes </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="shutter_joinery"
                                    id="shutter_joinery_radio2" value="0"
                                    @if ($projects->shutter_selection == 0) checked @endif>
                                <label class="form-check-label" for="flexRadioDefault2"> No </label>
                            </div>
                        @endif
                    </div>
                    <div id="shutter-date-container" class="form-group mt-4">
                        ...
                        <div class="d-flex gap-3">
                            <div class="">
                                @php
                                    if ($projects->add_work == 1) {
                                        if ($additionalProject->shutter_date) {
                                            $formattedDateTime = date(
                                                'Y-m-d\TH:i',
                                                strtotime($additionalProject->shutter_date),
                                            );
                                        }
                                    } else {
            ...
            <div class="form-group mt-4">
                <form class="" action="{{ route('quotation_updateGlassmeasure') }}" enctype="multipart/form-data"
                    method="POST">
                    @csrf
                    <div class="d-flex align-items-center pb-3">
                    ...
                    <div class="d-flex gap-3">
                        @if ($projects->add_work == 1)
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="add_glass_measurement"
                                    id="glass_measurement_radio1" @if ($additionalProject->glass_measurement == 1) checked @endif
                                    value="1">
                                <label class="form-check-label" for="flexRadioDefault1"> Yes </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="add_glass_measurement"
                                    id="glass_measurement_radio2" value="0"
                                    @if ($additionalProject->glass_measurement == 0) checked @endif>
                                <label class="form-check-label" for="flexRadioDefault2"> No </label>
                            </div>
                        @else
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="glass_measurement"
                                    id="glass_measurement_radio1" @if ($projects->glass_measurement == 1) checked @endif
                                    value="1">
                                <label class="form-check-label" for="flexRadioDefault1"> Yes </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="glass_measurement"
                                    id="glass_measurement_radio2" value="0"
                                    @if ($projects->glass_measurement == 0) checked @endif>
                                <label class="form-check-label" for="flexRadioDefault2"> No </label>
                            </div>
                        @endif
                    </div>
                        ...
                        <div class="d-flex gap-3">
                            <div class="">
                                @php
                                    $formattedDateTime = date('Y-m-d\TH:i');
                                    if ($projects->add_work == 1) {
                                        if ($additionalProject->glass_date) {
                                            $formattedDateTime = date(
                                                'Y-m-d\TH:i',
                                                strtotime($additionalProject->glass_date),
                                            );
                                        }
                                    } else {
            ...
            <div class="form-group mt-4">
                <form class="" action="{{ route('quotation_updateGlassReceive') }}" enctype="multipart/form-data"
                    method="POST">
                    @csrf
                    <div class="d-flex align-items-center pb-3">
                    ...
                    <div class="d-flex gap-3">
                        @if ($projects->add_work == 1)
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="add_glass_receive"
                                    id="glass_receive_radio1" @if ($additionalProject->glass_receive == 1) checked @endif
                                    value="1">
                                <label class="form-check-label" for="flexRadioDefault1"> Yes </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="add_glass_receive"
                                    id="glass_receive_radio2" value="0"
                                    @if ($additionalProject->glass_receive == 0) checked @endif>
                                <label class="form-check-label" for="flexRadioDefault2"> No </label>
                            </div>
                        @else
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="glass_receive"
                                    id="glass_receive_radio1" @if ($projects->glass_receive == 1) checked @endif
                                    value="1">
                                <label class="form-check-label" for="flexRadioDefault1"> Yes </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="glass_receive"
                                    id="glass_receive_radio2" value="0"
                                    @if ($projects->glass_receive == 0) checked @endif>
                                <label class="form-check-label" for="flexRadioDefault2"> No </label>
                            </div>
                        @endif
                    </div>
                        ...
                        <div class="d-flex gap-3">
                            <div class="">
                                @php
                                    $formattedDateTime = date('Y-m-d\TH:i');
                                    if ($projects->add_work == 1) {
                                        if ($additionalProject->glass_receive_date) {
                                            $formattedDateTime = date(
                                                'Y-m-d\TH:i',
                                                strtotime($additionalProject->glass_receive_date),
                                            );
                                        }
                                    } else {
                                        if ($projects->glass_receive_date) {
                                            $formattedDateTime = date(
                                                'Y-m-d\TH:i',
                                                strtotime($projects->glass_receive_date),
                                            );
                                        }
                                    }
                                @endphp
                                <input class="form-control" type="datetime-local" name="glass_receive_date"
                                    id="glass_receive_date"
                                    @if ($formattedDateTime) value="{{ $formattedDateTime }}" @endif>
                            </div>
                        </div>
                    </div>
            ...
            <div class="form-group mt-4">
                <form class="" action="{{ route('quotation_updateShutterReady') }}" enctype="multipart/form-data"
                    method="POST">
                    @csrf
                    <div class="d-flex align-items-center pb-3">
                        <h4 class="mb-0">WorkShop Fitting </h4>
                    ...
                    <div class="d-flex gap-3">
                        @if ($projects->add_work == 1)
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="add_shutter_ready"
                                    id="shutter_ready_radio1" @if ($additionalProject->shutter_ready == 1) checked @endif
                                    value="1">
                                <label class="form-check-label" for="flexRadioDefault1"> Yes </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="add_shutter_ready"
                                    id="shutter_ready_radio2" value="0"
                                    @if ($additionalProject->shutter_ready == 0) checked @endif>
                                <label class="form-check-label" for="flexRadioDefault2"> No </label>
                            </div>
                        @else
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="shutter_ready"
                                    id="shutter_ready_radio1" @if ($projects->shutter_ready == 1) checked @endif
                                    value="1">
                                <label class="form-check-label" for="flexRadioDefault1"> Yes </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="shutter_ready"
                                    id="shutter_ready_radio2" value="0"
                                    @if ($projects->shutter_ready == 0) checked @endif>
                                <label class="form-check-label" for="flexRadioDefault2"> No </label>
                            </div>
                        @endif
                    </div>
                        ...
                        <div class="d-flex gap-3">
                            <div class="">
                                @php
                                    $formattedDateTime = date('Y-m-d\TH:i');
                                    if ($projects->add_work == 1) {
                                        if ($additionalProject->shutter_ready_date) {
                                            $formattedDateTime = date(
                                                'Y-m-d\TH:i',
                                                strtotime($additionalProject->shutter_ready_date),
                                            );
                                        }
                                    } else {
                                        if ($projects->shutter_ready_date) {
                                            $formattedDateTime = date(
                                                'Y-m-d\TH:i',
                                                strtotime($projects->shutter_ready_date),
                                            );
                                        }
                                    }
                                @endphp
                                <input class="form-control" type="datetime-local" name="shutter_ready_date"
                                    id="shutter_ready_date"
                                    @if ($formattedDateTime) value="{{ $formattedDateTime }}" @endif>
                            </div>
                        </div>
                    </div>
            ...
            <form class="" action="{{ route('quotation_storeInvoiceStatus') }}" enctype="multipart/form-data"
                method="POST">
                @csrf
                <div class="row mt-3">
                    <div class="d-flex align-items-center pb-3">
                    ...
                    <div class="d-flex gap-3">
                        @if ($projects->add_work == 1)
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="add_invoice_status"
                                    id="invoice_yes_radio" @if ($additionalProject->invoice_status == 1) checked @endif
                                    value="1">
                                <label class="form-check-label" for="flexRadioDefault1"> Yes </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="add_invoice_status"
                                    ...
                                    @if ($additionalProject->invoice_status == 0) checked @endif>
                                <label class="form-check-label" for="flexRadioDefault2"> No </label>
                            </div>
                        @else
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="invoice_status"
                                    id="invoice_yes_radio" @if ($projects->invoice_status == 1) checked @endif
                                    value="1">
                                <label class="form-check-label" for="flexRadioDefault1"> Yes </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="invoice_status"
                                    id="flexRadioDefault2" value="0"
                                    @if ($projects->invoice_status == 0) checked @endif>
                                <label class="form-check-label" for="flexRadioDefault2"> No </label>
                            </div>
                        @endif
                    </div>
                        ...
                        <div class="d-flex gap-3">
                            <div class="">
                                @php
                                    $formattedDateTime = date('Y-m-d\TH:i');
                                    if ($projects->add_work == 1) {
                                        if ($additionalProject->invoice_date) {
                                            $formattedDateTime = date(
                                                'Y-m-d\TH:i',
                                                strtotime($additionalProject->invoice_date),
                                            );
                                        }
                                    } else {
                                ...
                                @endphp
                                <input class="form-control" type="datetime-local" name="invoice_date" id="invoice_date"
                                    @if ($formattedDateTime) value="{{ $formattedDateTime }}" @endif>
                            </div>
                        </div>
                    </div>
            ...
            <form action="{{ route('quotation_storeMaterialStatus') }}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="row mt-3">
                    <div class="d-flex align-items-center pb-3">
                    ...
                    <div class="d-flex gap-3">
                        @if ($projects->add_work == 1)
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="add_material_delivered"
                                    id="material_partial_radio" @if ($additionalProject->material_delivered == 2) checked @endif
                                    value="2">
                                <label class="form-check-label" for="flexRadioDefault1">Partially delivered</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="add_material_delivered"
                                    id="material_yes_radio" @if ($additionalProject->material_delivered == 1) checked @endif
                                    value="1">
                                <label class="form-check-label" for="flexRadioDefault1">Yes</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="add_material_delivered"
                                    id="material_no_radio" value="0"
                                    @if ($additionalProject->material_delivered == 0) checked @endif>
                                <label class="form-check-label" for="flexRadioDefault2">No</label>
                            </div>
                        @else
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="material_delivered"
                                    id="material_partial_radio" @if ($projects->material_delivered == 2) checked @endif
                                    value="2">
                                <label class="form-check-label" for="flexRadioDefault1">Partially delivered</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="material_delivered"
                                    id="material_yes_radio" @if ($projects->material_delivered == 1) checked @endif
                                    value="1">
                                <label class="form-check-label" for="flexRadioDefault1">Yes</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="material_delivered"
                                    id="material_no_radio" value="0"
                                    @if ($projects->material_delivered == 0) checked @endif>
                                <label class="form-check-label" for="flexRadioDefault2">No</label>
                            </div>
                        @endif
                    </div>
                    <div id="yes_deliver_detail">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" type="text" name="delivered_by" placeholder="Driver Name"
                                    id="delivered_by"
                                    @if ($projects->delivered_by) value="{{ $projects->delivered_by }}" @endif>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="flexRadioDefault">Driver Number</label>
                                <input type="text" class="form-control" name="driver_numbers"
                                    placeholder="Driver Number" pattern="\d{10}" maxlength="10"
                                    @if ($projects->driver_number) value="{{ $projects->driver_number }}" @endif
                                    title="Driver Number must be a 10-digit number">
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                @endphp
                                <input class="form-control" type="datetime-local" name="deliver_date" id="deliver_date"
                                    @if ($formattedDateTime) value="{{ $formattedDateTime }}" @endif>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="partial_detail form-row row" style="display: none">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="partial_deliver_by"
                                    placeholder="Driver Name" id="partial_deliver_by">
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                @endphp
                                <input class="form-control" type="datetime-local" name="partial_deliver_date"
                                    id="partial_deliver_date" value="{{ $currentDateTime }}">
                            </div>
            ...
            @if (!blank($partialDeliverDatas))
                <div class="card bg-light card-body mt-3">
                    ...
                    @foreach ($partialDeliverDatas as $deliveryby)
                        <div class="d-flex align-items-center">
                            <div class="me-2">
                                <span class="fs-6 ">Driver Name : </span> <span class="fw-bold fs-6 ">
                                    {{ $deliveryby->partial_deliver_by }} </span>
                                <br><span class="fs-6 ">Driver Number : </span><span
                                    class="fw-bold fs-6 ">{{ $deliveryby->driver_number }} </span>
                                <br><span class="fs-6 ">Delivery Date : </span><span class="mb-0 text-danger">
                                    {{ date('d/m/Y - H:i:s', strtotime($deliveryby->partial_deliver_date)) }}</span>
                            </div>

                            <div class="ms-auto">
                                <a href="javascript:void(0);" data-id="{{ $deliveryby->id }}"
                                    class="btn btn-danger delete_partial"><i class="fa fa-trash"></i></a>
                            </div>
                        </div>
                        <hr>
                    @endforeach
            ...
            <div class="d-flex align-items-center justify-content-end mt-3">
                @if ($projects->status == 1)
                    <a href="{{ route('quotation_view.material', $projects->id) }}" class="btn btn-primary me-3"><i
                ...
                @else
                    <a href="{{ route('quotation_view.quotation', $projects->id) }}" class="btn btn-primary me-3"><i
                            data-feather="arrow-left" class="me-2 fw-bold"></i>Previous</a>
                @endif
                <a href="{{ route('quotation_view.fitting', $projects->id) }}" class="btn btn-primary">Next<i
...
@section('script')
    <script>
        ...
        $(document).ready(function() {
            ...
            $('input[name="add_material_delivered"]').change(function() {
                toggleSelectionDate();
            });
        });
        ...
        $(document).ready(function() {
            ...
            $('input[name="add_invoice_status"]').change(function() {
                toggleSelectionDate();
            });
        });
        ...
        $(document).ready(function() {
            ...
            $('input[name="add_cutting_option"]').change(function() {
                toggleSelectionDate();
            });
        });
        ...
        $(document).ready(function() {
            ...
            $('input[name="add_shutter_joinery"]').change(function() {
                toggleSelectionDate();
            });
        });
        ...
        $(document).ready(function() {
            ...
            $('input[name="add_glass_measurement"]').change(function() {
                toggleSelectionDate();
            });
        });
        ...
        $(document).ready(function() {
            ...
            $('input[name="add_glass_receive"]').change(function() {
                toggleSelectionDate();
            });
        });
        ...
        $(document).ready(function() {
            ...
            $('input[name="add_shutter_ready"]').change(function() {
                toggleSelectionDate();
            });
        });
    </script>
    <script>
        ...
        $(".add_workshop").click(function() {
            ...
            html +=
                '<label for="mesurement" class="form-label">Measurement <span class="text-danger">*</span></label>';
            html += '<input class="form-control" type="text" id="mesurement" name="workshop[' + i +
                '][measurement]" required>';
            html += '</div>';
            html += '<div class="col-md-7">';
            html +=
                '<label for="description" class="form-label">Description <span class="text-danger">*</span></label>';
            html += '<input class="form-control" type="text" id="description" name="workshop[' + i +
