...
@section('pages')
    ...
    <div class="fieldset">
        ...
        @endif
        <hr>
        <form class="" action="{{ route('quotation_store.quotations') }}" enctype="multipart/form-data"
            method="POST">
            @csrf
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item rejectQuotation" href="#"
                                                    data-bs-toggle="modal" data-bs-target="#staticBackdrop" data-reason="1"
                                                    data-id="{{ $quo->id }}">Delayed/Cool of</a></li>
                                            <li><a class="dropdown-item rejectQuotation" href="#"
                                                    data-bs-toggle="modal" data-bs-target="#staticBackdrop" data-reason="2"
                                                    data-id="{{ $quo->id }}">Cancel</a></li>
                                            <li><a class="dropdown-item rejectQuotation" href="#"
                                                    data-bs-toggle="modal" data-bs-target="#staticBackdrop" data-reason="3"
                                                    data-id="{{ $quo->id }}">Addon</a></li>
                                        </ul>
                                    </div>
                                @else
                                    {{-- @if ($quo->status == 1)
