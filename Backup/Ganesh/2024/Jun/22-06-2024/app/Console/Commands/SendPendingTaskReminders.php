                ...
                if ($projectDetail->shutter_selection == 0) {
                    ...
                    foreach ($usersWithPendingTasks as $key => $user) {
                        try {
                            ...
                            $mobileNumber = $user->phone;
                            $message = "Workshop shutter joinery for ".$customerDetail->name. " - " .$projectDetail->project_generated_id." is not done. Kindly complete it within next 24 hours. Shree Ganesh Aluminum";
