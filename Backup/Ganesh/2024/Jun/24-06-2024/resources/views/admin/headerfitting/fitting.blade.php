                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action=""
                            ...
                            @method('PUT')
                            <div class="form-group">
                                <label for="adminName">Site Installation User Name <span class="text-danger">*</span></label>
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('delete.fitting.user', '') }}" + "/" + employee_id,
                            type: 'GET',
                            dataType: 'json',
                            success: function(data) {
                                Swal.fire({
