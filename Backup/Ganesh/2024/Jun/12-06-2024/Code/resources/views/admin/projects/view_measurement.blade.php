...
@endif
                        ...
                        <div class="card card-body">
                            <form class="" action="{{ route('edit.measurement', $measure->id) }}"
                                ...
                                @if (!blank($measurements))
                                    ...
                                    <div class="measurement_f">
                                        <div class=" measurement_div" name="{{ $measurementId ?? '' }}">
                                            <input class="form-control" type="file" id="sitephotos" name="sitephotos[]"
                                                multiple />
                                            <div class="d-flex gap-4">
                                        ...
                                        @if ($file->measurement_id == $measure->id)
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-auto">
                                                    ...
                                                    <a href="javascript:void(0);" data-id="{{ $file->id }}"
                                                        class="btn btn-danger delete_file" download><i
                                            ...
                                            @if ($sfile->measurement_id == $measure->id)
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-auto">
                                                        ...
                                                        <a href="javascript:void(0);" data-id="{{ $sfile->id }}"
                                                            class="btn btn-danger delete_sfile" download><i
                                                                class="fa fa-trash"></i></a>
                                                    </div>
                                                </div>
                                                <hr>
    ...
    @endif
        @if (!blank($measurements))
            <form class="" action="{{ route('update_material_status') }}" enctype="multipart/form-data"
                method="POST">
                @csrf
