                            ...
                            @foreach ($projects as $project)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                            Issue Work - {{ $project->total_issue_work }} - {{ $lastAdditionalProjectDetail->sub_step }}  {{-- <br> --}}
                                        @endif
                                        @if ($project->status == 0)
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        {{-- <a href="{{ route('generate.project.report', $project->id) }}"
                                            data-bs-toggle="tooltip" data-bs-placement="top" title="Generate Report"
                                            class="generateReport"><i class="fa fa-file" aria-hidden="true"
                                                style="width: 22px;"></i>
                                        </a> --}}
