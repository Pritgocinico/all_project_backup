            ...
            <h4 class="pb-2">
               @if ($projects->type == 1)
                    @if ($projects->sub_project_id !== null)
                        ...
                        @php
                             $lastProjectDetail = \App\Models\Project::where('id', $projects->sub_project_id)->latest()->first();
                        @endphp
                        <br><h6>Main project ID: {{ $lastProjectDetail->project_generated_id }}</h6>
                    @else
                        Project Details
                    @endif
                @else
            ...
            <div class="row w-100 view_project">
                ...
                <div>
                    ...
                    @if ($projects->material_received_selection == 1)
                        ...
                        Material Received By:- <span class="mb-0 text-danger">{{ $projects->material_received_by }}</span>
                    @else
            ...
            <div class="row w-100 view_project">
                ...
                @foreach ($subProjectData as $subProject)
                    ...
                    <div>
                        ...
                        <p class="mb-0"><strong>Purchase Cost : &#8377; </strong>{{ $subProject->quotation_cost }}</p>
                        <p class="mb-0"><strong>Transport Cost : &#8377; </strong>{{ $subProject->transport_cost }}</p>
                ...
                @endforeach
                    ...
                    <div>
                        ...
                        @if ($subProject->material_received_selection == 1)
                            ...
                            Material Received By:- <span class="mb-0 text-danger">{{ $subProject->material_received_by }}</span>
                        @else
                            No
                        @endif
                        @endforeach
        ...
        <div class="card-body">
            ...
            <div>
                ...
                @if ($projects->cutting_selection == 1)
                    Yes <span class="mb-0 text-danger">({{ date('d/m/Y - H:i:s', strtotime($projects->cutting_date)) }})</span>
                @else
            ...
            @if ($projects->shutter_selection == 1)
                Yes <span class="mb-0 text-danger">({{ date('d/m/Y - H:i:s', strtotime($projects->shutter_date)) }})</span>
            @else
            ...
            @if ($projects->glass_measurement == 1)
                Yes <span class="mb-0 text-danger">({{ date('d/m/Y - H:i:s', strtotime($projects->glass_date)) }})</span>
            @else
            ...
            @if ($projects->invoice_status == 1)
                Yes <span class="mb-0 text-danger">({{ date('d/m/Y - H:i:s', strtotime($projects->invoice_date)) }})</span>
            @else
        ...
        <div class="card-body">
            ...
            <div>
                ...
                @if ($subProject->cutting_selection == 1)
                    Yes <span class="mb-0 text-danger">({{ date('d/m/Y - H:i:s', strtotime($subProject->cutting_date)) }})</span>
                @else
                    No
                @endif
            ...
            @if ($subProject->shutter_selection == 1)
                Yes <span class="mb-0 text-danger">({{ date('d/m/Y - H:i:s', strtotime($subProject->shutter_date)) }})</span>
            @else
                No
            @endif
            ...
            @if ($subProject->glass_measurement == 1)
                Yes <span class="mb-0 text-danger">({{ date('d/m/Y - H:i:s', strtotime($subProject->glass_date)) }})</span>
            @else
                No
            @endif
            ...
            @if ($subProject->invoice_status == 1)
                Yes <span class="mb-0 text-danger">({{ date('d/m/Y - H:i:s', strtotime($subProject->invoice_date)) }})</span>
            @else
                No
            @endif
            ...
            <div class="card-body">
                <div class="row view_project">
                    ...
                    @foreach ($fitting_doneTasks as $d_item)
                                    @if ($d_item->chk == 'on')
                                        <div class="form-group col-12">
                                            <span class="fw-bold fs-6 ">{{ $d_item->question->fitting_question }} - </span>
                                            <strong><span class="text-success">Done </span></strong>
                                        </div>
                                    @endif
            ...
            <div class="card-body">
                <div class="row view_project">
                    ...
                    @foreach ($fitting_questions as $w_item)
                                    @if ($w_item->chk == 'on')
                                        <div class="form-group col-12">
                                            <span class="fw-bold fs-6 ">{{ $w_item->fitting_question }} - </span>
                                            <strong><span class="text-success">Done </span></strong>
                                        </div>
                                    @endif
...
@if (!blank($projects->transit_date))
    <div class="card">
        <div class="card-body">
            <div class="row view_project">
                <div class="d-flex align-items-center pb-3">
                    <h4 class="mb-0">Delivery Details </h4> <span class="ms-2">({{ $projects->transit_date }})</span>
                </div>
                <div class="form-group col-12">
...
@if (!blank($projects->fitting_date))
    <div class="card">
        <div class="card-body">
            <div class="row view_project">
                <div class="d-flex align-items-center pb-3">
                    <h4 class="mb-0">Fitting Details </h4> <span class="ms-2">({{ $projects->fitting_date }})</span>
                </div>
                <div class="form-group col-12">
...
@if (
        isset($issueProject) &&
        ($issueProject->cutting_selection == 1 ||
            $issueProject->shutter_selection == 1 ||
            $issueProject->glass_measurement == 1 ||
            $issueProject->glass_receive == 0 ||
            $issueProject->shutter_ready == 1 ||
            $issueProject->invoice_status == 1 ||
            $issueProject->delivered_by == 1 ||
            isset($issueProject->margin_cost))
    )
    <div class="card">
        <div class="card-body">
            <div class="row view_project">
                <div class="d-flex align-items-center pb-3">
                    <h4 class="mb-0">Issue In Work Details </h4>
                </div>
                @if (isset($issueProject->margin_cost))
                    <div class="form-group col-12">
                        <hr>
                        <h5>Project Margin Calculation</h5>
                        <div>
                            <p class="mb-0"><strong>Selling Cost : &#8377;
                                </strong>{{ $issueProject->project_cost }}
                            </p>
                            <p class="mb-0"><strong>Purchase Cost : &#8377;
                                </strong>{{ $issueProject->quotation_cost }}
                            </p>
                            <p class="mb-0"><strong>Transport Cost : &#8377;
                                </strong>{{ $issueProject->transport_cost }}
                            </p>
                            <p class="mb-0"><strong>Labor Cost : &#8377; </strong>{{ $issueProject->laber_cost }}
                            </p>
                            <p><strong>Project Margin : &#8377;
                                </strong>{{ $issueProject->project_cost - $issueProject->quotation_cost }}</p>
                        </div>
                    </div>
                @endif
                ...
                <div class="form-group col-12">
                    ...
                    <div>
                        <div>
                            ...
                            <span class="fw-bold fs-6 ">Is Cutting Done ? : </span>
                            @if ($issueProject->cutting_selection == 1)
                                Yes <span
                                    class="mb-0 text-danger">({{ date('d/m/Y - H:i:s', strtotime($issueProject->cutting_date)) }})</span>
                            @else
                        ...
                        <span class="fw-bold fs-6 ">Is Shutter Joinery Done ? : </span>
                        @if ($issueProject->shutter_selection == 1)
                            Yes <span
                                class="mb-0 text-danger">({{ date('d/m/Y - H:i:s', strtotime($issueProject->shutter_date)) }})</span>
                        @else
                        ...
                        <span class="fw-bold fs-6 ">Is Glass Measurement Done ? : </span>
                        @if ($issueProject->glass_measurement == 1)
                            Yes <span
                                class="mb-0 text-danger">({{ date('d/m/Y - H:i:s', strtotime($issueProject->glass_date)) }})</span>
                        @else
                        ...
                        <span class="fw-bold fs-6 ">Is Glass Received ? : </span>
                        @if ($issueProject->glass_receive == 1)
                            Yes <span
                                class="mb-0 text-danger">({{ date('d/m/Y - H:i:s', strtotime($issueProject->glass_receive_date)) }})</span>
                        @else
                        ...
                        <span class="fw-bold fs-6 ">Is shutter ready with glass fitting ? : </span>
                        @if ($issueProject->shutter_ready == 1)
                            Yes <span
                                class="mb-0 text-danger">({{ date('d/m/Y - H:i:s', strtotime($issueProject->shutter_ready_date)) }})</span>
                        @else
                        ...
                        <span class="fw-bold fs-6 ">Is Invoice generated ? : </span>
                        @if ($issueProject->invoice_status == 1)
                            Yes <span
                                class="mb-0 text-danger">({{ date('d/m/Y - H:i:s', strtotime($issueProject->invoice_date)) }})</span>
                        @else
                        ...
                        <span class="fw-bold fs-6 ">Is material delivered ? : </span>
                        @if ($issueProject->material_delivered == 1)
                            Yes - delevered by: {{ $issueProject->delivered_by }} <span
                                class="mb-0 text-danger">({{ date('d/m/Y - H:i:s', strtotime($issueProject->deliver_date)) }})</span>
                        @elseif($issueProject->material_delivered == 2)
                                    Partially Delivered
                            <h6>Partial Deliveries By</h6>
                            @foreach ($partialDeliverDatas as $deliveryby)
                                            <div class="d-flex align-items-center">
