    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-2">
                    <a class="btn btn-primary" href="{{route('quotation.reports.export')}}">Export</a>
                </div>
            </div>
            <table id="report_table" class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $loop->index + 1 }}</td>
                        <td><a href="{{ route('quotation_view.project', $d_project->id) }}">{{
                                $d_project->project_generated_id }} - {{ $d_project->customer->name }}</a></td>
