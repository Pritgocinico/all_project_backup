...
class WorkshopController extends Controller
{
    ...
    public function viewworkshop(Request $request, $id)
    {
        ...
        $issueProject = AdditionalProjectDetail::where('project_id', $id)->where('status', 'issue')->orderBy('id', 'desc')->first();
        ...
        if (Auth::user()->role == 1) {
            ...
            return view('quotation.projects.view_workshop', compact('additionalProject', 'type', 'page', 'projects', 'purchases', 'workshops', 'quotations', 'quotationfiles', 'measurements', 'measurementfiles', 'measurementphotos', 'fittings', 'workshop_questions', 'workshop_doneTasks', 'sitephotos', 'taskLists', 'invoiceFiles', 'fitting_questions', 'fitting_doneTasks', 'partialDeliverDatas'));
        }
    }
