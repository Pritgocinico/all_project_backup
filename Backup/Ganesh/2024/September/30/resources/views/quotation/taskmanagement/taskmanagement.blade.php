...
@section('content')
    <div class="project">
        <div class="page-header d-md-flex justify-content-between align-items-center">
            ...
            <div class="">
                <a href="{{ route('quotation_addTask') }}" class="btn btn-primary ms-auto">
                            ...
                            @foreach ($tasks as $task)
                                @if(!blank($task->project))
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <a href="{{route('quotation_editTask', $task->id)}}" class="editTask"><i
            ...
            $(document).on('click', '.task_delete_btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('quotation_deleteTask', '') }}" + "/" + task_id,
                            type: 'GET',
                            dataType: 'json',
