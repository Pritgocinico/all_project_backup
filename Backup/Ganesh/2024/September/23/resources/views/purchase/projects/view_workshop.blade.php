@extends('purchase.layouts.viewproject')
...
@section('pages')
    <div class="fieldset">
        ...
        <div>
            <form class="" action="{{ route('purchase_storeworkshopquestion') }}" enctype="multipart/form-data" method="POST">
                @csrf
        ...
        <div class="mt-3">
            <form class="" action="{{ route('purchase_storeworkshop') }}" enctype="multipart/form-data" method="POST">
                @csrf
                <input type="hidden" name="project_id" value="{{ $projects->id }}">
                <table class="table">
                    <tr>
                    ...
                    @if (count($workshop_doneTasks) != 0)
                        @foreach ($workshop_doneTasks as $d_item)
                            <tr>
                                <th>{{ $d_item->wquestion->question }}</th>
    ...
    @endif-->
            ...
            <div class="form-group mt-4">
                <form class="" action="{{ route('purchase_updateCutting') }}" enctype="multipart/form-data" method="POST">
                    @csrf
            ...
            <div class="form-group mt-4">
                <form class="" action="{{ route('purchase_updateShutter') }}" enctype="multipart/form-data"
                    method="POST">
                    @csrf
                    <div class="d-flex align-items-center pb-3">
            ...
            <div class="form-group mt-4">
                <form class="" action="{{ route('purchase_updateGlassmeasure') }}" enctype="multipart/form-data"
                    method="POST">
                    @csrf
                    <div class="d-flex align-items-center pb-3">
            ...
            <div class="form-group mt-4">
                <form class="" action="{{ route('purchase_updateGlassReceive') }}" enctype="multipart/form-data"
                    method="POST">
                    @csrf
                    <div class="d-flex align-items-center pb-3">
            ...
            <div class="form-group mt-4">
                <form class="" action="{{ route('purchase_updateShutterReady') }}" enctype="multipart/form-data"
                    method="POST">
                    @csrf
                    <div class="d-flex align-items-center pb-3">
            ...
            <form class="" action="{{ route('purchase_storeInvoiceStatus') }}" enctype="multipart/form-data"
                method="POST">
                @csrf
                <div class="row mt-3">
                    <div class="d-flex align-items-center pb-3">
            ...
            <form action="{{ route('purchase_storeMaterialStatus') }}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="row mt-3">
                    <div class="d-flex align-items-center pb-3">
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="material_delivered"
                                id="material_yes_radio" @if ($projects->material_delivered == 1) checked @endif value="1">
                            <label class="form-check-label" for="flexRadioDefault1">Yes</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="material_delivered"
                                id="material_no_radio" value="0" @if ($projects->material_delivered == 0) checked @endif>
                            <label class="form-check-label" for="flexRadioDefault2">No</label>
                        </div>
                    </div>
            ...
            <div class="d-flex align-items-center justify-content-end mt-3">
                @if ($projects->status == 1)
                    <a href="{{ route('purchase_view.material', $projects->id) }}" class="btn btn-primary me-3"><i
                            data-feather="arrow-left" class="me-2 fw-bold"></i>Previous</a>
                @else
                    <a href="{{ route('purchase_view.quotation', $projects->id) }}" class="btn btn-primary me-3"><i
                            data-feather="arrow-left" class="me-2 fw-bold"></i>Previous</a>
                @endif
                <a href="{{ route('purchase_view.fitting', $projects->id) }}" class="btn btn-primary">Next<i
    ...
    <script>
        ...
        $(".delete_partial").click(function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('purchase_delete.partial', '') }}" + "/" + partial_id,
                        type: 'GET',
                        dataType: 'json',
        ...
        $(".delete_file").click(function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('purchase_delete.invoice', '') }}" + "/" + invoicefile_id,
                        type: 'GET',
                        dataType: 'json',
                        success: function(data) {
                            Swal.fire({
        ...
        $(document).ready(function() {
            $(document).on('click', '.delect_btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('purchase_delete.workshop', '') }}" + "/" +
                                employee_id,
                            type: 'GET',
                            dataType: 'json',
                            success: function(data) {
