    ...
    <div class="navigation">
        ...
        <div class="navigation-menu-body">
            <ul>
                ...
                <li>
                    <a class="@if(\Request::route()->getName() == 'quotation.customers') active @endif" href="{{route('quotation.customers')}}">
                        <span class="nav-link-icon">
                            <i data-feather="users"></i>
                        </span>
                        <span>Customer</span>
...
<!--</li>-->
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a class="@if(\Request::route()->getName() == 'quotation_reports') active @endif" href="{{route('quotation_reports')}}">Complete Project</a>
                        </li>
                       <li>
