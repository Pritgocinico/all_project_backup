...
@section('pages')
    ...
    <div class="fieldset">
        ...
        <div>
            ...
            <form class="" action="{{ route('purchase_store_qa_question') }}" enctype="multipart/form-data" method="POST">
        ...
        <div class="mt-3">
            ...
            <form class="fitting_form" action="{{ route('purchase_store_qa_data') }}" enctype="multipart/form-data" method="POST">
