...
class AdminController extends Controller
{
    ...
    public function dashboard(Request $request)
    {
        ...
        if ($role == 1) {
            ...
            return view('purchase.dashboard', compact('feedback','cancelLead','page', 'icon', 'monthWiseSales', 'projects', 'runningProjects', 'leads', 'completedProjects', 'completedTasks', 'pendingTasks', 'sales'));
        }
    }
