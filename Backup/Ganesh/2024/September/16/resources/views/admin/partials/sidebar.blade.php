            ...
            <ul>
                ...
                <li>
                    ...
                    <ul>
                       ...
                       <li>
                            <a class="@if(\Request::route()->getName() == 'pending.reports') active @endif" href="{{route('admin.add.measurement')}}">Measurement</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="@if(\Request::route()->getName() == 'header.fitting.create') active @endif" href="{{route('header.fitting.create')}}">Site Installation</a>
                        </li>
                        <li>
                            <a class="@if(\Request::route()->getName() == 'header.purchase.create') active @endif" href="{{route('header.purchase.create')}}">Purchase</a>
                        </li>
                    </ul>
                </li>
                <li>
...
<!--</li>-->
                ...
                <li>
                    <a href="{{route('admin_project_question')}}" class="@if(\Request::route()->getName() == 'task-management' || \Request::route()->getName() == 'addTask' || \Request::route()->getName() == 'editTask') active @endif">
                        <span class="nav-link-icon">
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a class="@if(\Request::route()->getName() == 'reports') active @endif" href="{{route('reports')}}">Complete Projects</a>
                        </li>
                       <li>
                            <a class="@if(\Request::route()->getName() == 'pending.reports') active @endif" href="{{route('pending.reports')}}">Pending Projects</a>
                        </li>
                    </ul>
                </li>
