...
class FittingController extends Controller
{
    ...
    public function view_store_fitting(Request $request)
    {
        ...
        if (Auth::user()->role == 1) {
            ...
            return redirect()->route('purchase_view.fitting', $request->project_id)->with('success', 'Measurement created successfully.');
        } else if(Auth::user()->role == 10){
            return redirect()->route('qa_view.fitting', $request->project_id)->with('success', 'Measurement created successfully.');
        }
    ...
    public function store_fitting_question(Request $request)
    {
        ...
        if (Auth::user()->role == 1) {
            ...
            return redirect()->route('purchase_view.fitting', $request->project_id)->with('success', 'Fitting question submitted successfully.');
        } else if(Auth::user()->role == 10){
            return redirect()->route('qa_view.fitting', $request->project_id)->with('success', 'Fitting question submitted successfully.');
        }
