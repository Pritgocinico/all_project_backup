            ...
            <table id="projects_table" class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$project->id}}</td>
                        <td>{{$key+1}}</td>
                        <td><a href="{{ route('purchase_view.completed.project', $project->id) }}">{{ $project->project_generated_id }}</a>
                        </td>
                        <td>
                            @if ($project->customer)
                        ...
                        <td>
                            ...
                            @endif
                            <a href="{{ route('purchase_view.project', $project->id) }}" class="editUser"><i data-feather="edit"></i></a>
                        </td>
                    </tr>
                    @endforeach
                    @endif
