...
<div class="card w-100">
    <div class="card-body pb-0">
        <div class="row w-100 view_project">
            <h4 class="pb-2">
                @if ($projects->type == 1)
                    Project Details <a href="{{ route('quotation_view.project', $projects->id) }}" class="editUser"><i
                        data-feather="edit"></i></a>
                @else
                    Lead Details <a href="{{ route('quotation_view.lead', $projects->id) }}" class="editUser"><i
                        data-feather="edit"></i></a>
                @endif
            </h4>
            <hr>
