...
@section('content')
    <div class="project">
        ...
        <div class="card">
            <div class="card-body">
                <form class="alert-repeater" action="{{ route('quotation_update.leads', $leads->id) }}" enctype="multipart/form-data"
                    method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form id="updateUserForm" name="updateuserform"
                                action="{{ isset($customer) ? route('quotation.update.customer', ['id' => $customer->id]) : '#' }}"
                                method="POST">
                                @csrf
