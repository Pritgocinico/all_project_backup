...
class ProjectController extends Controller
{
    ...
    public function viewproject(WorldHelper $world, Request $request, $id)
    {
        ...
        if (Auth::user()->role == 1) {
            ...
            if ($projects->step == 0) {
                return view('purchase.projects.view_project', compact('subPurchases', 'subProjectData', 'subPartialDeliverDatas', 'subInvoiceFiles', 'issueProject', 'page', 'projects', 'users', 'cities', 'quotationfiles', 'measurements', 'measurementfiles', 'measurementphotos', 'quotations', 'quotationfiles', 'workshops', 'fittings', 'business', 'customer', 'purchases', 'type', 'states', 'sitephotos', 'workshop_questions', 'workshop_doneTasks', 'invoiceFiles', 'fitting_questions', 'fitting_doneTasks', 'measurementtaskUsers', 'measurement_users', 'partialDeliverDatas'));
            } elseif ($projects->step == 1) {
            ...
            if ($projects->step == 0) {
                return view('quotation.projects.view_project', compact('subPurchases', 'subProjectData', 'subPartialDeliverDatas', 'subInvoiceFiles', 'issueProject', 'page', 'projects', 'users', 'cities', 'quotationfiles', 'measurements', 'measurementfiles', 'measurementphotos', 'quotations', 'quotationfiles', 'workshops', 'fittings', 'business', 'customer', 'purchases', 'type', 'states', 'sitephotos', 'workshop_questions', 'workshop_doneTasks', 'invoiceFiles', 'fitting_questions', 'fitting_doneTasks', 'measurementtaskUsers', 'measurement_users', 'partialDeliverDatas'));
            } elseif ($projects->step == 1) {
    ...
    public function viewCompletedproject(WorldHelper $world, Request $request, $id = NULL)
    {
        ...
        if (Auth::user()->role == 1) {
            ...
            return view('purchase.projects.view_completedproject', compact('page', 'projects', 'users', 'type'));
        }
