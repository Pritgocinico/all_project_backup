                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin.edit.customer', $customers->id) }}"
                                                class="editCustomer" onclick="getCustomer({{ $customers->id }})"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="customer_id" class="form-control userName"
                                            id="customer_id" aria-describedby="edit_id_Error"
                                            placeholder="Enter Customer ID" value="{{ old('customer_id') }}" readonly>
                                        <small id="edit_id_Error" class="form-text text-danger"></small>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <small id="state_edit_Error" class="form-text text-danger"></small>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="city">City <span class="text-danger">*</span></label>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#updateCustomerBtn', function() {
            ...
            var state_value = document.updatecustomerform.stateedit.value;
            ...
            var stateError = document.getElementById('state_edit_Error');
            var i = 0;
            ...
            if (state_value == "") {
                i = 1;
                stateError.innerHTML = "State must be filled out!";
