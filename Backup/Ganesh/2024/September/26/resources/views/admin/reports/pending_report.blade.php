        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <a class="btn btn-primary" href="{{ route('pending.reports.export') }}">Export</a>
                    </div>
                </div>
                    ...
                    <tbody>
                        @if (!blank($projects))
                            @foreach ($projects as $project)
                                <tr>
                                    <td>{{ $loop->index + 1 }}</td>
                                    <td><a href="{{ route('view.project', $project->id) }}" class="text-dark">{{ $project->project_generated_id }}
