...
<div class="fieldset">
        ...
        <label for="flexRadioDefault">Selection Date</label>
                    <div class="d-flex gap-3">
                        <div class="">
                            ...
                            @endphp
                            <input class="form-control" type="datetime-local" name="selection_date" id="selection_date" @if ($formattedDateTime) value="{{ $formattedDateTime }}" @endif>
                        </div>
                    </div>
    ...
    <form class="" action="{{ route('quotation_store.project.cost') }}" enctype="multipart/form-data" method="POST">
        @csrf
        <div class="row mt-3">
    ...
    <div class="d-flex align-items-center justify-content-end mt-3">
        <a href="{{ route('quotation_view.quotation', $projects->id)  }}" class="btn btn-primary me-3"><i data-feather="arrow-left"
