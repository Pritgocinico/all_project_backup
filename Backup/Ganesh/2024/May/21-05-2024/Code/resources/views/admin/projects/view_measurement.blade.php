...
@section('pages')
    <div class="fieldset">
        ...
        <hr>
        <form class="" action="{{ route('storemeasurement') }}" enctype="multipart/form-data" method="POST">
            @csrf
            ...
            @foreach ($measurements as $measure)
                ...
                <div class="collapse" id="collapseExample{{ $i }}">
                    <div class="card card-body">
                        <form class="" action="{{ route('edit.measurement', $measure->id) }}"
        ...
        <div class="d-flex align-items-center justify-content-end mt-3">
            <a href="{{ route('view.project', $projects->id) }}" class="btn btn-primary me-3"><i
                    data-feather="arrow-left" class="me-2 fw-bold"></i>Previous</a>
            <a class="{{ !blank($measurements) ? 'active_btn' : 'disabled' }} btn btn-primary"
                href="{{ !blank($measurements) ? route('view.quotation', $projects->id) : '#' }}">Next<i
