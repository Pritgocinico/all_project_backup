                ...
                <div class="card-body">
                    <table id="example2" class="table table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <td>{{ $fitting->email }}</td>
                            <td>{{ $fitting->phone }}</td>
                            <td>{{ $fitting->created_at->format('d/m/Y') }}</td>
                            <td>
    ...
    <div class="modal-dialog modal-dialog-centered  modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Edit Fitting user</h5>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action=""
                            ...
                            @method('PUT')
                            <div class="form-group">
                                <label for="adminName">Fitting User Name <span class="text-danger">*</span></label>
