                ...
                <div class="d-flex align-items-center pb-3">
                    ...
                    <p class="mb-0 ms-auto"><strong>Selction Done ? : </strong>
                        @if ($projects->material_selection == 1)
                            Yes <span class="mb-0 text-danger">({{ date('d/m/Y - H:i:s',strtotime($projects->selection_date)) }})</span>
                        @else
                            No
                        @endif
                    </p>
            ...
            <div class="card-body">
                ...
                <span class="fw-bold fs-6 ">Is Glass Received ? : </span>
                    @if ($projects->glass_receive == 1)
                        Yes <span class="mb-0 text-danger">({{ date('d/m/Y - H:i:s',strtotime($projects->glass_receive_date)) }})</span>
                    @else
                        No
                    @endif
                </p>
                ...
                <span class="fw-bold fs-6 ">Is shutter ready with glass fitting ? : </span>
                    @if ($projects->shutter_ready == 1)
                        Yes <span class="mb-0 text-danger">({{ date('d/m/Y - H:i:s',strtotime($projects->shutter_ready_date)) }})</span>
                    @else
                        No
                    @endif
                </p>
                ...
                <span class="fw-bold fs-6 ">Is material delivered ? : </span>
                    ...
                    @elseif($projects->material_delivered == 2)
                        ...
                        <div class="d-flex align-items-center">
                            <div class="me-2">
                                <span class="fw-bold fs-6 ">{{ $deliveryby->partial_deliver_by }} </span> <span class="mb-0 text-danger">({{ date('d/m/Y - H:i:s',strtotime($deliveryby->partial_deliver_date)) }})</span>
                            </div>
                        </div>
                        <hr>
                        @endforeach
            ...
            <div class="card-body">
                ...
                <span class="fw-bold fs-6 ">Is material delivered ? : </span>
                    ...
                    @elseif($projects->material_delivered == 2)
                        ...
                        <div class="d-flex align-items-center">
                            <div class="me-2">
                                <span class="fw-bold fs-6 ">{{ $deliveryby->partial_deliver_by }} - {{ $deliveryby->driver_number }} </span> <span class="mb-0 text-danger">({{ date('d/m/Y - H:i:s',strtotime($deliveryby->partial_deliver_date)) }})</span>
                            </div>
                        </div>
                        <hr>
                        @endforeach
