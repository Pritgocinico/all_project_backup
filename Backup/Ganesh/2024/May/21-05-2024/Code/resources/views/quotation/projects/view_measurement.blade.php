            ...
            <div class="measurement_show_hide" style="display: none">
                <div class="form-group">
                    ...
                    <div class="me-2" id="loader" style="display:none">
                        <img src="{{ url('/') }}/public/ZKZg.gif" alt=""
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="measurementdesc" rows="5" name="description">@if (!blank($measurements))@if (!empty($measurements->description)){{ $measurements->description }}@endif @else{{ old('description') }}@endif</textarea>
                                        ...
                                        @if ($file->measurement_id == $measure->id)
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-auto">
                                                    ...
                                                    <a href="javascript:void(0);" data-id="{{$file->id}}" class="btn btn-danger delete_file" download><i
                                        ...
                                        @if ($sfile->measurement_id == $measure->id)
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-auto">
                                                    ...
                                                    <a href="javascript:void(0);" data-id="{{$sfile->id}}" class="btn btn-danger delete_sfile" download><i
                                                        class="fa fa-trash"></i></a>
                                                </div>
                                            </div>
                                            <hr>
                    ...
                    <div class="card card-body">
                        <form class="" action="{{ route('quotation_edit.measurement', $measure->id) }}"
                            ...
                            @if (!blank($measurements))
                                <div class="measurement_f">
                                    <div class=" measurement_div" name="{{ $measurementId ?? '' }}">
                                        <input class="form-control" type="file" id="files"
                                            name="measurementfileupdated[]" multiple />
                                ...
                                <div class="measurement_f">
                                    <div class=" measurement_div" name="{{ $measurementId ?? '' }}">
                                        <input class="form-control" type="file" id="sitephotos"
                                            name="sitephotos[]" multiple />
                                        <div class="d-flex gap-4">
                                            @foreach ($measurementphotos->groupBy('measurement_id') as $measurementId => $sfiles)
                                                @foreach ($sfiles as $sfile)
                                                    @if ($sfile->measurement_id == $measure->id)
