            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form action="{{ route('admin.add.admin.data') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="tel" name="mobile" class="form-control" id="adminMobile"
                ...
                <table id="example2" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.edit.customer', $admin->id) }}" class="editCustomer"
                                    data-id="{{ $admin->id }}" data-bs-toggle="modal"
                                    data-bs-target="#staticBackdrop"><i data-feather="edit"></i></a>
                                <a href="javascript:void(0);" data-id="{{ $admin->id }}" class="ms-2 delete-btn"><i
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action=""
                            ...
                            <div class="form-group">
                                <label for="adminName">Admin Name <span class="text-danger">*</span></label>
                                <input type="text" name="name" class="form-control" id="editadminName"
                                    placeholder="Enter Name" value="{{ old('name') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" name="mobile" class="form-control" id="editadminMobile"
                                    placeholder="Enter Mobile Number" value="{{ old('mobile') }}">
                            ...
                            <div class="form-group">
                                <label for="adminEmail">Email address </label>
                                <input type="email" name="email" class="form-control" id="editadminEmail"
                                    placeholder="Enter Email" value="{{ old('email') }}">
                            </div>
                            <div class="form-group">
...
@section('script')
    <script>
        ...
        $(document).on('click', '#updateCustomerBtn', function() {
            var name_value = document.adminForm.name.value;
            var phone_value = document.adminForm.mobile.value;
            ...
            if (i == 0) {
                $.ajax({
                    type: 'POST',
                    url: "{{ route('admin.update.admin', '') }}" + '/' + hiddenvalue,
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('delete.admin', '') }}" + "/" + employee_id,
                            type: 'GET',
                            dataType: 'json',
                            success: function(data) {
                                Swal.fire({
