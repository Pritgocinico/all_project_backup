                        ...
                        <tbody>
                            @foreach ($workshops as $workshop)
                                <tr>
                                    ...
                                    <td>
                                        @if ($workshop->app_user_active == '0')
                                            <a href="javascript:void(0);" data-id="{{ $workshop->id }}"
        ...
        <div class="modal-dialog modal-dialog-centered  modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="" method="POST" id="workshopForm" name="workshopForm">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
        ...
        $(document).ready(function() {
            $(document).on('click', '.delete-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('delete.workshop.user', '') }}" + "/" +
                                employee_id,
                            type: 'GET',
                            dataType: 'json',
                            success: function(data) {
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function(data) {
                                Swal.fire({
                                    title: 'Success!',
                                    text: "WorkShop User has been Verified.",
                                    icon: 'success',
                                    showCancelButton: false,
                                    confirmButtonColor: '#3085d6',
                                    cancelButtonColor: '#d33',
