        ...
        <div class="col-md-6 mb-2">
            <div class="card p-2">
                ...
                <div class="card-body text-center mt-3">
                    <?php $image=URL::asset("public/settings/".Auth::user()->image); ?>
                    @if (!blank(Auth::user()->image))
                        <img id="image" class="br-50" src="{{ $image }}"
                         alt="" style="height: 100px; width:100px;">
                    @else
                        <img id="image" class="br-50" src="{{url('/')}}/public/settings/user-profile.png"
                        alt="" style="height: 100px; width:100px;">
                    @endif
                    ...
                    <div class="my-2">
                        ...
                        <a href="{{ route('quotation_edit.profile') }}" class="btn btn-primary mt-2">Edit Profile</a>
                    </div>
                </div>
            </div>
        </div>
