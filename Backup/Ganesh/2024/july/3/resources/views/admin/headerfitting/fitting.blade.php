    ...
    <div class="row">
        <div class="col-md-4">
            <div class="page-header">
                <div>
                    <h3>Add New Site Installation Role</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="{{ route('header.fitting.store') }}" method="POST">
                                        @csrf
        ...
        <div class="col-md-8">
            <div class="page-header d-md-flex justify-content-between">
                <div>
                    <h3 class="mb-0">Site Installation</h3>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($fittings as $fitting)
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="editFitting" data-id="{{ $fitting->id }}"
        ...
        <div class="modal-dialog modal-dialog-centered  modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Edit Site Installation user</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="" method="POST" id="fittingForm" name="fittingForm">
                                ...
                                @method('PUT')
                                <div class="form-group">
                                    <label for="adminName">Site Installation User Name <span
    ...
    <script>
        ...
        $(document).on('click', '#updateCustomerBtn', function() {
            ...
            if (i == 0) {
                $.ajax({
                    type: 'POST',
                    url: "{{ route('header.fitting.update', '') }}" + '/' + hiddenvalue,
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function(data) {
                                Swal.fire({
                                    title: 'Deleted!',
                                    text: "Fitting User has been deleted.",
                                    icon: 'success',
                                    showCancelButton: false,
                                    confirmButtonColor: '#3085d6',
                                    cancelButtonColor: '#d33',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function(data) {
                                Swal.fire({
                                    title: 'Success!',
                                    text: "Site Installation User has been Verified.",
                                    icon: 'success',
                                    showCancelButton: false,
                                    confirmButtonColor: '#3085d6',
                                    cancelButtonColor: '#d33',
