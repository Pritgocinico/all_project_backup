...
use App\Http\Controllers\api\QaUserController;
...
Route::get('all-role', [AuthController::class, 'getRoleList']);
...
Route::middleware('auth.api')->group(function () {
    ...
    Route::get('customerDetail', [CustomerController::class,'customerDetail']);
    ...
    Route::get('resumeWork', [ProjectController::class, 'resumeWork']);
    ...
    // Customers
    Route::get('listPurchaseUser', [PurchaseController::class,'listPurchaseUser']);
    Route::post('/addPurchase', [PurchaseController::class, 'addPurchase']);
    Route::post('/updatedPurchase', [PurchaseController::class, 'updatedPurchase']);
    Route::get('/notUploadPurchaseProjectList', [PurchaseController::class, 'notUploadPurchaseProjectList']);
    Route::get('deletedPurchase/{id}', [PurchaseController::class,'deletedPurchaseUser']);
    Route::post('materialReceiveStatus', [PurchaseController::class, 'materialReceiveStatus']);
    Route::get('add-clone-project', [ProjectController::class, 'addCloneProject']);

    Route::post('change-password', [AuthController::class, 'changePassword']);
    Route::get('delete-account', [AuthController::class, 'deleteAccount']);
    Route::get('update-profile', [AuthController::class, 'updateProfile']);

    Route::get('complete-project-report',[ReportController::class,'completeProjectReport']);
    Route::get('pending-project-report',[ReportController::class,'pendingProjectReport']);

    Route::get('listQaQuestion',[ProjectQuestionController::class,'index']);
    Route::post('addQaQuestion',[ProjectQuestionController::class,'store']);
    Route::post('updateQaQuestion',[ProjectQuestionController::class,'update']);
    Route::get('deleteQaQuestion/{id}',[ProjectQuestionController::class,'update']);
    Route::post('/checkQaQuestion', [ProjectQuestionController::class, 'checkQaQuestion']);

    Route::get('listQaUser',[QaUserController::class,'index']);
    Route::post('addQaUser',[QaUserController::class,'store']);
    Route::post('updateQaUser',[QaUserController::class,'update']);
    Route::get('deleteQaUser/{id}',[QaUserController::class,'delete']);
