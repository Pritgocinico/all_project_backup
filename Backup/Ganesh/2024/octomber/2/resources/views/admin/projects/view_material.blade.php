...
@section('pages')
    <div class="fieldset">
        ...
        <hr>
        <h4 class="mt-3">Final Measurement Files</h4>
        <form class="" action="{{route('final-storemeasurement')}}" method="POST" enctype="multipart/form-data" id="finalMeasurementForm">
            @csrf
            <div class="form-group">
                <label for="projectdesc">Upload Final Measurement<span class="text-danger">*</span></label>
                <input class="form-control" type="file" id="final_measurement_file" name="final_measurement_file[]" required
                    multiple />
            </div>
            <div class="form-group">
                <label for="projectdesc">Description<span class="text-danger">*</span></label>
                <textarea class="form-control" id="final_description" name="final_description" placeholder="Enter Description"></textarea>
            </div>
