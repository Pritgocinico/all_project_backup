...
@endif
    ...
    <div class="d-flex align-items-center justify-content-end mt-3">
        <a href="{{ route('quotation_view.project', $projects->id) }}" class="btn btn-primary me-3"><i data-feather="arrow-left" class="me-2 fw-bold"></i>Previous</a>
        <a class="{{ !blank($measurements) ? 'active_btn' : 'disabled' }} btn btn-primary" href="{{ !blank($measurements) ? route('quotation_view.quotation', $projects->id) : '#' }}">Next<i data-feather="arrow-right" class="ms-2 fw-bold"></i></a>
    </div>
</div>
@endsection
@section('script')
