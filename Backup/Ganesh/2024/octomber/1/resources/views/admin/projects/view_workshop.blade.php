...
@section('pages')
                ...
                <table class="table">
                    ...
                    @if (count($workshop_doneTasks) != 0)
                        @foreach ($workshop_doneTasks as $d_item)
                            @if(isset($d_item->wquestion) && $d_item->wquestion->question !== null)
                            <tr>
    ...
    @endif-->
            ...
            <div class="form-group mt-4">
                <form class="" action="{{ route('updateShutter') }}" enctype="multipart/form-data"
                    method="POST">
                    @csrf
                    <div class="d-flex align-items-center pb-3">
            ...
            <div class="form-group mt-4">
                <form class="" action="{{ route('updateGlassmeasure') }}" enctype="multipart/form-data"
                    method="POST">
                    @csrf
                    <div class="d-flex align-items-center pb-3">
                    ...
                    <div id="glass-file-container" class="form-group mt-4">
                        <label for="glass_fil">Glass File</label>
                        <div class="d-flex gap-3">
                            <div class="">
                                <input class="form-control" type="file" name="glass_file" id="glass_file">
                            </div>
                        </div>
                    </div>
            ...
            <div class="form-group mt-4">
                <form class="" action="{{ route('updateGlassReceive') }}" enctype="multipart/form-data"
                    method="POST">
                    @csrf
                    <div class="d-flex align-items-center pb-3">
            ...
            <div class="form-group mt-4">
                <form class="" action="{{ route('updateShutterReady') }}" enctype="multipart/form-data"
                    method="POST">
                    @csrf
                    <div class="d-flex align-items-center pb-3">
            ...
            <form class="" action="{{ route('storeInvoiceStatus') }}" enctype="multipart/form-data"
                method="POST">
                @csrf
                <div class="row mt-3">
                    <div class="d-flex align-items-center pb-3">
            ...
            <div class="d-flex align-items-center justify-content-end mt-3">
                @if ($projects->status == 1)
                    <a href="{{ route('view.material', $projects->id) }}" class="btn btn-primary me-3"><i
                ...
                @else
                    <a href="{{ route('view.quotation', $projects->id) }}" class="btn btn-primary me-3"><i
                            data-feather="arrow-left" class="me-2 fw-bold"></i>Previous</a>
                @endif
                <a href="{{ route('view.fitting', $projects->id) }}" class="btn btn-primary">Next<i
        ...
        $(document).ready(function() {
            function toggleSelectionDate() {
                if ($('#glass_measurement_radio1').is(':checked')) {
                    ...
                    $('#glass-file-container').show();
                } else {
                    $('#glass-date-container').hide();
                    $('#glass-file-container').hide();
                }
            }
