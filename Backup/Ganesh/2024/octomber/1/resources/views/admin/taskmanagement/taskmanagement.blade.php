...
@section('content')
    <div class="project">
        <div class="page-header d-md-flex justify-content-between align-items-center">
            ...
            <div class="">
                <a href="{{ route('addTask') }}" class="btn btn-primary ms-auto">
                            ...
                            @foreach ($tasks as $task)
                                @if(!blank($task->project))
                                    <tr>
                                        ...
                                        <td>
                                            {{ date('d/m/Y H:i:s', strtotime($task->task_date)) }}
                                        </td>
                                        <td>
                                            {{ date('d/m/Y - H:i:s', strtotime($task->created_at)) }}
                                        </td>
                                        <td class="d-flex">
                                            <a href="{{route('editTask', $task->id)}}" class="editTask"><i
