...
@section('content')
    <div class="project">
        <div class="page-header d-md-flex justify-content-between align-items-center">
            ...
            <div class="">
                <a href="{{ route('task-management') }}" class="btn btn-primary ms-auto">
        ...
        <div class="card">
            <div class="card-body">
                <form class="alert-repeater" action="{{ route('updateTask', $task->id) }}" enctype="multipart/form-data"
                    method="POST">
                    @csrf
                    <div class="form-row row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control select2-example" id="task_type" name="task_type">
                                ...
                                <option <?php if($task->task_type == 'qa'){ echo "selected"; } ?> value="qa">Quality Analyst</option>
