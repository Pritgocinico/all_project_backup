...
<div class="row">
    <div class="col-lg-6">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <a href="{{route('task-management')}}?task_status=completed">
                        <div class="card-body">
    ...
    <div class="col-lg-6">
        <div class="row">
                    ...
                    <a href="{{route('projects')}}">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="font-weight-bold ml-1 font-size-30 ml-3" id="total_project_count">
                                    {{count($projects)}}</div>
                            </div>
                            {{-- <p class="mb-0"><a href="#" class="link-1">See comments</a> and respond to customers'
                                comments.</p> --}}
                        </div>
                    </a>
                </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <a href="{{route('projects')}}?status=1">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="font-weight-bold ml-1 font-size-30 ml-3" id="running_project_count">
                                    {{count($runningProjects)}}</div>
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="font-weight-bold ml-1 font-size-30 ml-3 d-inline" id="">&#x20B9; <p
                                    id="sales_amount" class="d-inline">{{number_format($sales,2)}}</p>
                            </div>
                        </div>
                    ...
                    <a href="{{route('leads')}}">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="font-weight-bold ml-1 font-size-30 ml-3" id="total_lead_queue">
                                    {{count($leads)}}</div>
                            </div>
                            {{-- <p class="mb-0"><a class="link-1" href="#">See referring</a> domains that sent most
                                visits
                                last month.</p> --}}
                        </div>
                    </a>
            ...
            <div class="col-md-6">
                <div class="card">
                    <a href="{{route('task-management')}}?task_status=pending">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="font-weight-bold ml-1 font-size-30 ml-3" id="pending_task_count">
                                    {{count($pendingTasks)}}</div>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="font-weight-bold ml-1 font-size-30 ml-3" id="cancel_lead_count">{{$cancelLead}}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <a href="{{route('projects')}}?status=2">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="font-weight-bold ml-1 font-size-30 ml-3" id="complete_project_count">
                                    {{count($completedProjects)}}</div>
                            </div>
                            {{-- <p class="mb-0"><a class="link-1" href="#">See clients</a> that accepted your
                                invitation to
                                connect.</p> --}}
            ...
            <div class="modal-body text-center">
                <div class="row my-3">
                    <div class="col-md-6 ml-auto mr-auto">
                        <figure>
                            <img class="img-fluid" src="https://gogi.laborasyon.com/assets/media/svg/upgrade.svg"
                                alt="upgrade">
                        </figure>
                    </div>
                </div>
                ...
                <div class="row my-3">
                    <div class="col-md-10 ml-auto mr-auto">
                        <p class="text-muted">Get additional 500 GB space for your documents and files. Expand your
                            storage and enjoy your business. Change plan for more space.</p>
...
<script>
    ...
    function allDashboardCount() {
        var date_range = $('#dashboard_daterange').val();
        $.ajax({
            ...
            success: function (data) {
                console.log(data);
                $('#cancel_lead_count').html(data.cancelLead);
                $('#total_project_count').html(data.projects);
                $('#running_project_count').html(data.runningProjects);
                $('#complete_project_count').html(data.completedProjects);
                $('#sales_amount').html(data.sales);
                $('#total_lead_queue').html(data.leads);
                $('#pending_task_count').html(data.pendingTasks);
                $('#total_feedback_count').html(data.feedback);
            }
        });
    }
</script>
