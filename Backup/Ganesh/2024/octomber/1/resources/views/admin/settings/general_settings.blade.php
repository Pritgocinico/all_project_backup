    ...
    <div class="col-md-12">
        ...
        <form action="{{ route('save_general_settings') }}" method="POST" class="row g-3" enctype="multipart/form-data">
           ...
           <div class="col-md-6">
            ...
            <div class="col-md-6 mt-5">
                <?php $logo=URL::asset("settings/".$settings->logo); ?>
                    ...
                    <img id="preview-image-before-upload" src="{{ $logo }}"
                      alt="" style="max-height: 100px; width:150px;">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-12">
                <label for="whatsapp_msg" class="form-label">Whatsapp Message</label>
                <div class="form-check form-switch">

                    <input class="form-check-input" type="checkbox" name="status" style="width: 50px; height: 30px;"
                        id="status" {{$setting->wa_message_sent == 1 ? "checked" : "-"}}>
