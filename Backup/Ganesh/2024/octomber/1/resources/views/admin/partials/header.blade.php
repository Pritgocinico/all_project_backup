                    ...
                    <div class="header-body-right">
                        <ul class="navbar-nav">
                            <li class="list-unstyled">
                                <a href="{{route('admin_project_question')}}" class="@if(\Request::route()->getName() == 'admin_project_question' || \Request::route()->getName() == 'admin.add.purchase' || \Request::route()->getName() == 'admin.edit.project.question') active @endif">
                            ...
                            <li class="nav-item dropdown">
                                <a href="{{ route('settings') }}" class="nav-link" title="Settings"
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
                                    ...
                                    <div class="list-group">
                                        <a href="{{ route('edit.profile') }}" class="list-group-item">View Profile</a>
