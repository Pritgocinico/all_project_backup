...
@section('content')
    <div class="project">
        <div class="page-header d-md-flex justify-content-between align-items-center">
            ...
            <div class="">
                <a href="{{ route('quotation_task-management') }}" class="btn btn-primary ms-auto">
        ...
        <div class="card">
            <div class="card-body">
                <form class="alert-repeater" action="{{ route('quotation_updateTask', $task->id) }}" enctype="multipart/form-data"
                    method="POST">
                    @csrf
                    <div class="form-row row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control select2-example read-only" id="task_type" name="task_type">
                                ...
                                <option {{ $task->task_type == "qa" ? "selected" :"" }} value="qa">Quality Analytic</option>
