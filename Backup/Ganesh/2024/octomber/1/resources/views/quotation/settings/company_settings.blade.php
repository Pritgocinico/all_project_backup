@extends('quotation.layouts.setting')
...
<div class="row">
    <div class="col-md-12">
        ...
        @endif
        <form action="{{ route('quotation_save_company_settings') }}" method="POST" class="row g-3" enctype="multipart/form-data">
           @csrf
            <div class="col-12">
            ...
            <div class="col-12">
                ...
                <select class="form-control select2-example" id="cityname" name="city">
                    @foreach($cities as $city)
                        <option <?php if($settings->city==$city['name']){ echo "selected"; } ?> value="{{ $settings['id'] }}">{{$city['name']}}</option>
                    @endforeach
                </select>
            </div>
            <div class="col-12">
                ...
                @endif --}}
                <select class="form-control" id="statename" name="state" disabled>
