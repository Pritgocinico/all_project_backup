    ...
    <div class="col-md-7">
        <div class="card">
            <div class="card-body m-2">
                ...
                @endif
                <form action="{{ route('quotation_save.profile') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        if(!empty($user->image)){
                            $image=URL::asset("public/settings/".$user->image);
                        }else{
                            $image = URL::asset('public/settings/user-profile.png');
                        }
                        ?>
    ...
    <div class="col-md-5">
        <div class="card">
            <div class="card-body m-2">
                ...
                <form id="change-password-form" name="change-password-form" action="{{ route('quotation.change.password') }}" method="POST">
                    @csrf
                    <div class="col-md-12">
