                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="{{ route('quotation.add.customer.data') }}" method="POST">
                                        @csrf
                            ...
                            @if (!blank($customer))
                                @foreach ($customer as $customers)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('quotation.edit.customer', $customers->id) }}" class="editCustomer"
                                                data-id="{{ $customers->id }}" data-bs-toggle="modal"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form id="updateCustomerForm" name="updatecustomerform"
                                action="{{ isset($customers) ? route('quotation.update.customer', ['id' => $customers->id]) : '#' }}"
                                method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="state">State <span class="text-danger">*</span></label>
                                        <select class="form-control select2-example" id="stateedit" name="stateedit">
                                            <option value="">Select State</option>
    ...
    <script>
        ...
        $(document).on('click', '#updateCustomerBtn', function() {
            ...
            if (i == 0) {
                $.ajax({
                    type: 'POST',
                    url: '{{ route('quotation.update.customer', '') }}' + '/' + hiddenvalue,
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('quotation_delete.customer', '') }}" + "/" + employee_id,
                            type: 'GET',
                            dataType: 'json',
                            success: function(data) {
                                if(data == 'success'){
