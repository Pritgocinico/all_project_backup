...
<div class="fieldset">
    ...
    @endif
    @if($projects->type == 0)
        <form class="" action="{{route('quotation_store.selection')}}" enctype="multipart/form-data" method="POST">
            @csrf
    ...
    @else
        ...
        <a href="{{route('quotation_view.project',$projects->id)}}" class="btn btn-primary">View Project</a>
    @endif
