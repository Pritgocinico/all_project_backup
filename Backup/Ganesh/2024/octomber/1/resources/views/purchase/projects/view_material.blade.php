...
@section('pages')
    <div class="fieldset">
        ...
        <form class="" action="{{ route('purchase_store.project.materials') }}" enctype="multipart/form-data" method="POST">
            @csrf
        ...
        <div class="form-group mt-4">
            <form class="" action="{{ route('purchase_update.material.received') }}" enctype="multipart/form-data"
                method="POST">
                @csrf
        ...
        <form class="" action="{{ route('purchase_store.project.cost') }}" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="row mt-3">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="number" class="form-control" step="0.01" name="project_cost"
                        id="project_cost" placeholder="Selling Cost" min="0"
                        value="{{ $projects->project_cost ?? 0 }}">
        ...
        <div class="d-flex align-items-center justify-content-end mt-3">
            ...
            <a class="{{ !blank($purchases) ? 'active_btn' : 'disabled' }} btn btn-primary"
                href="{{ !blank($purchases) ? route('purchase_view.workshop', $projects->id) : '#' }}">Next<i
