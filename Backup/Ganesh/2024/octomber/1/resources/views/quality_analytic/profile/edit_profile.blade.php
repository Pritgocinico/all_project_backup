    ...
    <div class="col-md-7">
        <div class="card">
            <div class="card-body m-2">
                ...
                @endif
                <form action="{{ route('qa_save.profile') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                @csrf
    ...
    <div class="col-md-5">
        <div class="card">
            <div class="card-body m-2">
                ...
                <form id="change-password-form" name="change-password-form" action="{{ route('qa.change.password') }}" method="POST">
                    @csrf
                    <div class="col-md-12">
