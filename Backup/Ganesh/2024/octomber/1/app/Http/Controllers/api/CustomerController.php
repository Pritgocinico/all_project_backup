    ...
    public function Customers(Request $request)
    {
        ...
        if (!blank($customers)) {
            foreach ($customers as $customer) {
                ...
                $array['city']          = ($customer->city != NULL && $customer->cityDetail != NULL) ? $customer->cityDetail->name : "";
                $array['state']          = ($customer->state != NULL && $customer->stateDetail != NULL) ? $customer->stateDetail->name : "";
