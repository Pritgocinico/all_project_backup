...
class TaskManagementController extends Controller
{
    ...
    public function taskmanagement(){
        ...
        if(Auth()->user()->role == 8){
            $tasks = $tasks->where('task_type', 'like', '%Purchase%');
        }
        if(Auth()->user()->role == 4){
            $tasks = $tasks->where('task_type', 'like', '%quotation%');
        }
        if(Auth()->user()->role == 10){
            $tasks = $tasks->where('task_type', 'like', '%qa%');
        }
        ...
        if(Auth::user()->role == 1){
            ...
            return view('quality_analytic.taskmanagement.taskmanagement', compact('tasks', 'page'));
        }
    ...
    public function addTask(){
        ...
        if(Auth::user()->role == 1){
            ...
            return view('quality_analytic.taskmanagement.add_task', compact('projects'));
        }
    ...
    public function storetask(Request $request){
        ...
        if(Auth::user()->role == 1){
            ...
            return redirect()->route('qa_task-management')->with('success', 'Task created successfully.');
        }
    ...
    public function editTask($id){
        ...
        if(Auth::user()->role == 1){
            ...
            return view('quality_analytic.taskmanagement.edit_task', compact('task', 'projects'));
        }
    ...
    public function updateTask(Request $request, $id){
        ...
        if(Auth::user()->role == 1){
            ...
            return redirect()->route('qa_task-management')->with('success', 'Task updated successfully.');
        }
