...
class AuthController extends Controller
{
        ...
        if (Auth::attempt(array($fieldType => $input['email'], 'password' => $input['password']))) {
            ...
            if ($user->status == 1) {
                ...
                if ($role == 1) {
                    ...
                    return redirect()->intended('qa/dashboard')
                    ->withSuccess('Signed in');
                } else {
    ...
    public function contactUs(Request $request)
    {
        ...
        return view('auth.contact_us', compact('settings'));
    }
    ...
    public function storeContactUs(Request $request)
    {
        ...
        $content .= 'You have received a new contact form submission. Here are the details:<br><br>';
        $content .= 'Name: ' . $request->name . '<br>';
        $content .= 'Email: ' . $request->email . '<br>';
        $content .= 'Phone: ' . $request->phone_number . '<br>';
        $content .= 'Message: ' . $request->message . '<br><br><br>';
        $content .= 'Best Regards, <br> Ganesh Aluminum';
        ...
        if ($insert) {
            $email = "info@sganeshaluminium.com";
            Mail::send([], [], function ($message) use ($email, $content) {
                $message->from('info@sganeshaluminium.com', 'Ganesh Aluminium')
                    ->to($email)
