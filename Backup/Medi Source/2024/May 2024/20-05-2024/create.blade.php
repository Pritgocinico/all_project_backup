                ...
                <div class="card-body">
                    <form action="{{ route('admin.doctors.store') }}" method="POST" id="createDoctorForm">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="account_manager_name" value="{{ old('account_manager_name') }}"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control" id="speciality" name="speciality" required>
                                ...
                                <option value="Optometry" @if (old('speciality') == 'Optometry') {{ 'selected' }} @endif>
                                    Optometry</option>
                                ...
                                <option value="Derm/Aesthetics"
                                    @if (old('speciality') == 'Derm/Aesthetics') {{ 'selected' }} @endif>Derm/Aesthetics</option>
                                <option value="Dentist" @if (old('speciality') == 'Dentist') {{ 'selected' }} @endif>
                                    Dentist</option>
                                <option value="Integrative/Other"
                                    @if (old('speciality') == 'Integrative/Other') {{ 'selected' }} @endif>Integrative/Other
                                </option>
                                <option value="other" @if (old('speciality') == 'other') {{ 'selected' }} @endif>Other
                                </option>
                            </select>
                        ...
                        <div class="form-group mb-3 @if (old('speciality') !== 'other') d-none @endif"
                            id="other_speciality_div">
                            <label for="speciality">Other Speciality <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="practice_address_street"
                                name="practice_address_street" required>
                            ...
                            <select class="form-select" id="state" name="state" required>
                                ...
                                @foreach (NumberFormat::stateListDropdown() as $state)
                                    <option value="{{ $state['code'] }}"
                                        @if (old('state') == $state['code']) {{ 'selected' }} @endif>{{ $state['name'] }}
                                    </option>
                                @endforeach
                            </select>
