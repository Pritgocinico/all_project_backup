    ...
    $( document ).ready(function() {
        ...
        if(width < 991) {
            ...
            function getHeight() {
                ...
                var divHeight = $('.top-f').height();

                // Assign the height as padding-top to the second div
                $('.index-sec').css('padding-top', divHeight);
                $('.banner-section').css('margin-top', divHeight );
                $('.product-list-banner').css('margin-top', divHeight );
            ...
            $(window).on('resize orientationchange', function() {
                // Your function to be called when resize or orientation change happens
                getHeight();
            });
        ...
        $(window).scroll(function(){
              if ($(this).scrollTop() > 1) {
                  $('.top-f').addClass('fixed');
              } else {
                  $('.top-f').removeClass('fixed');
              }
        });
