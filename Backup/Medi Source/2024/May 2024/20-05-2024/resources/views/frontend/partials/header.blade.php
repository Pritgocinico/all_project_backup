...
<head>
    ...
    <link rel="stylesheet" href="{{ url('/') }}/frontend/assets/style.css?v=0.1" class="stylesheet">
    <link rel="stylesheet" href="{{ url('/') }}/frontend/assets/media.css?v=0.1" class="stylesheet">
