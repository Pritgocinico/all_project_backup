    ...
    <div class="border-top: 1px solid black; border-bottom: 1px solid black;">
                        ...
                        <tbody>
                            <tr>
                                <td valign="top"
                                    ...
                                    <p style="font-size:14px;padding:0;margin:0;">{{$orders->address1}},</p>
                                ...
                                <td valign="top"
                                    ...
                                    <p style="font-size:14px;padding:0;margin:0;">{{$orders->billing_address1}}</p>
        ...
        <table style="border-collapse: collapse;margin-left: auto; border: 1px solid black; margin-top: 15px;">
            ...
            <tr style="text-align: center;">
                ...
                <td style="border-right: 1px solid black;padding: 10px 10px;color: black; font-size: 12px; text-align: center;">&nbsp;</td>
                <td style="border-right: 1px solid black;padding: 10px 10px;color: black; font-size: 12px; text-align: center;">&nbsp;</td>
                <td style="border-right: 1px solid black;padding: 0px 10px;color: black; font-size: 16px; text-align: center;">Sub Total:-</td>
                <td style="border-right: 1px solid black;padding: 10px 10px;color: black; font-size: 12px; text-align: center;">&nbsp;</td>
            ...
            <tr style="text-align: center;">
                ...
                <td style="border-right: 1px solid black;padding: 10px 10px;color: black; font-size: 12px; text-align: center;">&nbsp;</td>
                <td style="border-right: 1px solid black;padding: 10px 10px;color: black; font-size: 12px; text-align: center;">&nbsp;</td>
                <td style="border-right: 1px solid black;padding: 0px 10px;color: black; font-size: 16px; text-align: center;">Shipping Charge</td>
                <td style="border-right: 1px solid black;padding: 10px 10px;color: black; font-size: 12px; text-align: center;">&nbsp;</td>
