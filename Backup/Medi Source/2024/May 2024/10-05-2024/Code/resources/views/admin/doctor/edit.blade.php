                ...
                <div class="card-body">
                    <form action="{{ route('admin.doctor.update', ['id' => $user->id]) }}" method="POST"
                        ...
                        <label for="speciality">Speciality <span class="text-danger">*</span></label>
                            @php $array = ['DO','MD','NP','PA'] @endphp
                            <select class="form-control" id="speciality" name="speciality" required>
                                <option value="DO" {{ $user->speciality == 'DO' ? 'selected' : '' }}>DO</option>
                                <option value="MD" {{ $user->speciality == 'MD' ? 'selected' : '' }}>MD</option>
                                <option value="NP" {{ $user->speciality == 'NP' ? 'selected' : '' }}>NP</option>
                                <option value="PA" {{ $user->speciality == 'PA' ? 'selected' : '' }}>PA</option>
                                @foreach($array as $option)
                                    <option value="{{ $option }}" {{ $user->speciality == $option ? 'selected' : '' }}>{{ $option }}</option>
                                @endforeach
                                <option value="other" @if (!in_array($user->speciality, $array)) {{ 'selected' }} @endif>Other</option>
                            </select>
                        ...
                        <div class="rgs-w  mb-3 @if (in_array($user->speciality, $array)) d-none @endif" id="other_speciality_div">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="city" value="{{ old('city', $user->city) }}" class="form-control py-2" id="city" required>
