...
@section('content')
                ...
                <section class="banner-section second-slide py-md-5 py-4 index-sec ">
                    <div class="container">
                        <div class="row align-items-center justify-content-start banner-inner">
                            <!-- <img class="img-fluid banner-img" src="./assets/images/banner-ing.png" alt="about-img"> -->
                            <div class="col-xl-6 col-lg-6 col-md-12 main-banner-left-inner">
                                <p class="text-white fw-bold">California Licensed Order from 503B Compounding Pharmacy Outsourcing Facility</p>
                                <h1 class="text-white">
                    ...
                    <div class="container">
                        <div class="row align-items-center justify-content-start banner-inner">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 main-banner-left-inner">
                                <p class="text-white fw-bold">California Licensed Order from 503B Compounding Pharmacy Outsourcing Facility</p>
                                <h1 class="text-white">
                                    Your Outsourcing Partner for High Quality Pharmaceuticals
                                </h1>
        ...
        <div class="container">
            <div class="row about-info  margin-bottoms align-items-center">
                <div class="col-md-6">
                    ...
                    <p class="clr-lightblack ">MedisourceRx is an FDA Registered Outsourcing facility based in Los
                        Alamitos, California. We are a leader in customized sterile production for hospitals, surgery
                        centers, and wellness clinics.</p>
                </div>
                <div class="col-md-6">
            ...
            <div class="row py-0 py-sm-0 align-items-start gap-4 gap-sm-5 gap-lg-0 justify-content-between">
                <div class="col-lg-4 col-md-12">
                    <div class="inner-about-parent text-center  px-4 py-4 py-xxl-5">
                        <img class="img-fluid about-img" src="./frontend/assets/images/medeitation.png" alt="medeitation">
                        <h4 class="text-white mt-4">Accessible Medication</h4>
                        <p class="text-white text-start mt-4 mb-0">We partner with researchers to guarantee that
                            patients
                            can access medications manufactured.
                        </p>
                        <div class="parent-banner-btn mt-3 mt-lg-4 mt-xxl-5 mb-2">
                        <a href="{{ route('about') }}">
                            <button type="button" class="banner-button border-0 text-white py-2 px-4 ">READ
                                MORE</button>
                                </a>       
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="inner-about-parent text-center px-4 py-4 py-xxl-5">
                        ...
                        <p class="text-white text-start mt-4 mb-0">We are here to help you grow your practice with our
                            full-service 503B compliant pharmacy.</p>
                        <div class="parent-banner-btn mt-3 mt-lg-4 mt-xxl-5 mb-2">
                        <a href="{{ route('about') }}">
                            <button type="button" class="banner-button border-0 text-white py-2 px-4 ">READ
                                MORE</button>
        ...
        <div class="container">
            <div class="row my-4 my-sm-5 align-items-center">
                <div class="col-xl-6 col-lg-8 col-md-12">
                    ...
                    <h2>
                        California Licensed Order from 503B Compounding Pharmacy Outsourcing Facility
                    </h2>
                </div>
                ...
                @if (!blank($products))
                    ...
                    <div class="item">
                        <div class="pro-in-cart">
                            ...
                            <p class="mx-auto fw-bold product-name mt-3">{{ $product->productname }}</p>
                                ...
                                <div class="dw-btn">
                                    @auth
                                        <form action="{{ route('add.to.cart', $product->id) }}" method="post">
                                            ...
                                            @endauth
                                            @php 
                                                $packages = DB::table('product_packages')->where('product_id',$product->id)->first();
                                            @endphp
                                            @if(!blank($packages))
    ...
    <section class="contact-main-section">
        <div class="container">
            ...
            <h4 class="text-center fw-normal">M-F 7:00 AM to 5:00 PM (PST)</h4>
                ...
                <div class="col-md-6">
                    <div class="row px-1 px-xl-5 align-items-center parent-inner-box">
                        <div class="col-md-12 mb-md-0 mb-4 text-center">
                            <a class="text-decoration-none text-call-mail-color text-decoration-none" href="mailto:sales@medisourcerx.com">
                                <div class="inner-contact-main-box py-4 py-lg-5">
                                    <img class="img-fluid" src="./frontend/assets/images/email.svg" alt="chat">
                                    <p class="clr-black mt-3 text-call-mail-color text-decoration-none fw-bold">sales@medisourcerx.com</p>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="row px-1 px-xl-5 align-items-center parent-inner-box mt-4">
                        <div class="col-md-12  mb-md-0 mb-4 text-center">
                            <a class="text-decoration-none" href="tel:+(714)455-1300">
                                <div class="inner-contact-main-box py-4 py-lg-5">
...
<div class="open-bottom-card">
    ...
    <div  >
        <p ><span>We use cookies to analyze website traffic and optimize your website experience. By accepting our use of cookies, your data will be aggregated with all other user data.</span></p>
    </div>
