            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.product-details.update', $product->slug) }}" method="post"
                        ...
                        <div class="mb-3">
                            <label for="inactive_ingredients" class="form-label">Inactive Ingredients</label>
                                ...
                                @foreach ($product->images as $image)
                                    <div class="mb-2">
                                        ...
                                        <a href="javascript:void(0);"
                                            class="btn btn-danger btn-sm ml-2 remove-image">Remove</a>
                                ...
                                <div class="mb-3 product_package_{{$product_package->id}}" id="packageContentField">
                                    <div class="package-content-field row align-items-end">
                                        ...
                                        <div class="col-2">
                                            ...
                                            <input type="number" class="form-control" name="vial_price[]" id="vialPrice_{{$key+1}}" onchange="fill({{$key+1}})" placeholder="Price Per Vial" value="{{ $product_package->vial_price }}">
                                        </div>
                                        <div class="col-2">
                                            <label for="quantity" class="form-label">Quantity</label>
                                            <input type="number" class="form-control" name="vial_quantity[]" id="vialQuantity_{{$key+1}}" onchange="fill({{$key+1}})" placeholder="Quantity" value="{{ $product_package->vial_quantity }}">
                                        </div>
                                        <div class="col-2">
                                            <label for="total" class="form-label">Total</label>
                                            <input type="number" class="form-control" name="vial_total[]" id="vialTotal_{{$key+1}}" placeholder="Total" value="{{ $product_package->vial_total }}">
                                        </div>
