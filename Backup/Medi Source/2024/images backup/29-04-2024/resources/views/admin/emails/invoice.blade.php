...
<body style="width: 700px; border-left:1px solid #eaeaea; border: 1px solid gray;">
        ...
        <tr style="background-color: #00A0AA;">
            <td style="text-align:center;">
                <p
                    ...
                    <img src="https://beta.medisourcerx.com/frontend/assets/images/main-logo-b.png" height="55px"
                        alt=""></p>
            </td>
        </tr>
    </table>
    ...
    <table style="padding: 0px 10px; width:100%; margin-bottom:15px;">
        ...
        <tr>
            <td>
                <p style="font-size: 14px; line-height: 20px; margin: 0; padding: 0px 10px">Thank you for your order
                    with Medi Source. Upon shipment, we shall send you an email with a link to track the shipment. You
                    can check the order status by <a href="{{ route('myaccount') }}"
                        style="color: blue; text-decoration: underline;">logging into your account.</a></p>
            </td>
        </tr>
        <tr>
            <td>
                <p style="font-size: 14px; line-height: 14px; margin-top: 17px;padding: 0px 10px;"><strong>ANY
                        QUESTIONS? </strong>Please contact us at: <a href="mailto:info@monarchrugs.com"
                        style="color: blue; text-decoration: underline;">sales@medisourcerx.com</a> or call: <a
                        href="tel:+(714)455-1300" style="color: blue; text-decoration: underline;">+(714)455-1300</a>
                </p>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <p style="padding: 0px 10px; margin-bottom:20px;"><span style="font-size: 15px; ">Order Email Id: <a
                            href="mailto:shaival@repletesoftware.com" target="_blank"
                            style="color: blue; text-decoration: underline;">shaival@repletesoftware.com</a></span></p>
            </td>
        </tr>
    </table>
                ...
                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td valign="top"
                                style="font-size:12px;padding:7px 9px 9px 9px;border-left:1px solid #eaeaea;border-bottom:1px solid #eaeaea;border-right:1px solid #eaeaea">
                                <p style="font-size:12px;padding:0;margin:0"> <strong><u>Credit/Debit Card</u></strong>
                                </p>
                                <p style="font-size:12px;padding:0;margin:0"> <strong>Credit Card Type:</strong> </p>

                                <p style="font-size:12px;padding:0;margin:0"> Visa</p>
                                <p style="font-size:12px;padding:0;margin:0"> <strong>Credit Card Number:</strong></p>
                                <p style="font-size:12px;padding:0;margin:0"> {{ $cardDetail->card_number }}</p>
                ...
                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td valign="top"
                                style="font-size:12px;padding:7px 9px 9px 9px;border-left:1px solid #eaeaea;border-bottom:1px solid #eaeaea;border-right:1px solid #eaeaea">
                                <p style="font-size:12px;padding:0;margin:0"> Standard Free Shipping </p>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table cellspacing="0" cellpadding="0" border="0" width="100%" style="border:1px solid #eaeaea">
                    <thead>
                        <tr>
                            ...
                            <th align="left" bgcolor="#EAEAEA" style="font-size:14px;padding:3px 9px">Rugpad</th>
                            <th align="left" bgcolor="#EAEAEA" style="font-size:14px;padding:3px 9px">Package Name</th>
                            <th align="left" bgcolor="#EAEAEA" style="font-size:14px;padding:3px 9px">Subtotal</th>
                    ...
                    <tbody>
                        ...
                        @forelse ($orders->orderItemDetail as $item)
                            <tr>
                                ...
                                <td align="left" valign="top"
                                    style="font-size:12px;padding:3px 9px;border-bottom:1px dotted #cccccc">No Pad</td>
                                <td align="right" valign="top"
                                    style="font-size:12px;padding:3px 9px;border-bottom:1px dotted #cccccc">
                                    <span>{{$item->package_name}}</span> </td>
                                <td align="left" valign="top"
                                    style="font-size:12px;padding:3px 9px;border-bottom:1px dotted #cccccc"> ${{number_format($item->total/$item->quantity,2)}}</td>
                                <td align="left" valign="top"
                                    style="font-size:12px;padding:3px 9px;border-bottom:1px dotted #cccccc"> {{$item->quantity}}</td>
                                <td align="center" valign="top"
                                    style="font-size:12px;padding:3px 9px;border-bottom:1px dotted #cccccc">${{number_format($item->total,2)}}</td>
                    ...
                    <tbody bgcolor="#F6F6F6">
                        <tr>
                            <td colspan="5" align="right" style="padding:5px 9px; font-size:12px;"> Subtotal
                            </td>
                            <td align="right" style="padding:5px 9px  font-size:12px;"> <span
                                    style="padding:5px 9px;">${{number_format($total,2)}}</span> </td>
                        </tr>
                        <tr>
                            <td colspan="5" align="right" style="padding:5px 9px;  font-size:12px;"> Shipping
                                &amp; Handling </td>
                            <td align="right" style="padding:5px 9px  font-size:12px;"> <span
                                    style="padding:5px 9px;">${{number_format($orders->shipping_charge,2)}}</span> </td>
                        </tr>
                        <tr>
                            <td colspan="5" align="right" style="padding:5px 9px;  font-size:12px;"> Discount
                            </td>
                            <td align="right" style="padding:5px 9px  font-size:12px;"> <span
                                    style="padding:5px 9px;">$0.00</span> </td>
                        </tr>
                        <tr>
                            <td colspan="5" align="right" style="padding:5px 9px;  font-size:12px;">
                                <strong>Grand Total</strong> </td>
                            <td align="right" style="padding:5px 9px  font-size:12px;"> <strong><span
                                        style="padding:5px 9px;">${{number_format($orders->total ,2)}}</span></strong> </td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <tbody>
                        <tr>
                            <td bgcolor="#EAEAEA" align="center"
                                ...
                                <center>
                                    <p style="font-size:14px;margin:0">Thank you, <strong>Medisource</strong></p>
                                </center>
                            </td>
                        </tr>
                    </tbody>
