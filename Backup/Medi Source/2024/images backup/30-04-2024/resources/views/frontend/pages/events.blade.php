...
@section('content')
<!-- 
<section class="banner-section prdct-parent position-relative  py-sm-4 py-1">
    <div class="container">
...
{{-- <div class="event-info-inner event-ins col-md-6">
    <img src="./assets/images/event.jpg" alt="">
    <div class="event-info">
...
<section class="main-for-generel-news">

    <div class="container">
        <div class="general-inner">
        <h2 class="mt-0">General News
        </h2>
        <div class="general-inner-img">
            <div class="g-img">
                <img src="{{url('/')}}/frontend/assets/images/event-new.png" alt="" class="img-fluid">
            </div>
            <div class="inner-past-event">

            <div class="g-info inner-ct">
                <h4>FDA INSPECTION RESULTS ARE IN!
                </h4>
                <p><b> MedisourceRx is proud to announce that NO observations were made by the FDA during our 2022
                        inspection of our facility.</b>

                </p>

                <p> <b>This is a rare achievement in an ever-evolving regulatory environment!</b> </p>
                <p>MedisourceRx is registered with the DEA, State Board of Pharmacy licensed, and registered with the
                    FDA as
                    a 503B outsourcing facility. As an outsourcing facility, we focus exclusively on sterile products
                    and
                    follow cGMP, GDP and cGLP guidelines.

                </p>
                <p>This dedication to sterile products has led to the development of systems that enhance quality
                    assurance
                    and patient safety. We have proved our dedication with our current inspection by the FDA and BOP
                    that
                    resulted in no Observations. We are proud of the team we have put together and the work we have
                    done.
                    Organizations we work with know they can rely on us to deliver consistently, in all our markets.
...
<!-- <section class="parent-history-event">
    <div class="container-fluid px-0">
    <div class="event-info-inner event-ins ">
                <img src="./assets/images/event.jpg" alt="">
                <div class="event-info">
                    <h2>History of our past events!
                    </h2>
...
<section>
    <div class="container">
        <h1 class="text-center history-head-text">History of our past events!
            </h1>
