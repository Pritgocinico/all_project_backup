        ...
        <tr>
            <td>
                <p style="font-size: 14px; line-height: 14px; margin-top: 17px;padding: 0px 10px;"><strong>ANY
                        ...
                        href="tel:+1-714-455-1300" style="color: blue; text-decoration: underline;">+1-714-455-1300</a>
                </p>
            </td>
        </tr>
        <tr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td valign="top"
                                ...
                                <p style="font-size:12px;padding:0;margin:0">Card</p>
                    ...
                    <tbody>
                        <tr>
                            <td bgcolor="#EAEAEA" align="center"
                                ...
                                <center>
                                    <p style="font-size:14px;margin:0">Thank you, <strong>Medisource RX</strong></p>
                                </center>
                            </td>
                        </tr>
                    </tbody>
