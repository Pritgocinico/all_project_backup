...
class ProductDetailController extends Controller
{
    ...
    public function show($id)
    {
        ...
        // Initialize the $isDoctor variable
        $isDoctor = true; // Set the appropriate value based on your logic
    
        // Retrieve associated images and titleContents
        $images = $product->images;
        $titleContents = $product->titleContents;

        return view('admin.product.show', compact('product', 'product_packages', 'images', 'titleContents', 'isDoctor' ));
    }
