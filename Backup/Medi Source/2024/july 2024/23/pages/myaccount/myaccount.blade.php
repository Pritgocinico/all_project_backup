                                    ...
                                    <div class="">
                                        ...
                                        <div class=" d-flex gap-2 name-f">
                                            ...
                                            <div class="rgs-w">
                                                ...
                                                @if ($errors->has('business_license_number'))
                                                    <span
                                                        class="text-danger">{{ $errors->first('business_license_number') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                        <div class=" d-flex gap-2 name-f">
                                        ...
                                        <div class="rgs-w">
                                            <label for="speciality" class="form-label">Speciality <span
                                                    class="text-danger">*</span></label>
                                                    @php $array = ['Ophthalmology','Optometry','Retina','Anesthesia','Derm/Aesthetics','Dentist','Integrative/Other'] @endphp
                                            <select name="speciality" class="form-control py-2" id="speciality"
                                                required="">
                                                <option value="Ophthalmology"
                                                    {{ $user->speciality == 'Ophthalmology' ? 'selected' : '' }}>
                                                    Ophthalmology</option>
                                                <option value="Optometry"
                                                    {{ $user->speciality == 'Optometry' ? 'selected' : '' }}>Optometry
                                                </option>
                                                <option value="Retina"
                                                    {{ $user->speciality == 'Retina' ? 'selected' : '' }}>Retina</option>
                                                <option value="Anesthesia"
                                                    {{ $user->speciality == 'Anesthesia' ? 'selected' : '' }}>Anesthesia
                                                </option>
                                                <option value="Derm/Aesthetics"
                                                    {{ $user->speciality == 'Derm/Aesthetics' ? 'selected' : '' }}>
                                                    Derm/Aesthetics</option>
                                                <option value="Dentist"
                                                    {{ $user->speciality == 'Dentist' ? 'selected' : '' }}>Dentist</option>
                                                <option value="Integrative/Other"
                                                    {{ $user->speciality == 'Integrative/Other' ? 'selected' : '' }}>
                                                    Integrative/Other</option>
                                                <option value="other"  @if(!in_array($user->speciality,$array)) {{'selected'}} @endif >
                                                    Other</option>
                                            </select>
                                        ...
                                        <div class="rgs-w @if(in_array($user->speciality,$array)) d-none @endif" id="other_speciality_div">
                                            <label for="speciality" class="form-label">Other Speciality <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="other_speciality" id="other_speciality" value="{{$user->speciality}}">
                                        ...
                                        <div class=" d-flex gap-2 name-f">
                                            ...
                                            <div class="rgs-w">
                                                ...
                                                @if ($errors->has('practice_address_street'))
                                                    <span
                                                        class="text-danger">{{ $errors->first('practice_address_street') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                        <div class=" d-flex gap-2 name-f">
                                            ...
                                            <div class="rgs-w">
                                                ...
                                                <input type="text" name="city" value="{{ $user->city }}"
                                                    class="form-control py-2 select2">
                                                @if ($errors->has('city'))
                                ...
                                <form action="{{ route('change.password') }}" method="post">
                                    ...
                                    <div class="rgs-w">
                                        <label for="old_password" class="form-label">Current password <span
                                                class="text-danger">*</span></label>
                                        <input type="password" name="old_password" class="form-control py-2"
                                    ...
                                    <div class="form-control-btn mt-3 text-start submit-btns">
                                        <button type="submit"
                                            class="header-btn profile-btn bg-dark border-0 mt-lg-0 mt-lg-3 mb-lg-0 mb-4 text-white py-2 px-4">Save
                                            Changes</button>
                                    </div>
                                </form>
                            </div>
