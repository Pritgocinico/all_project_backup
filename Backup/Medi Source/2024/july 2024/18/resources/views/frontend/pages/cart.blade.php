                    ...
                    <div class="inner-cart">
                        ...
                        <div class="shopping-cart">
                            <div class="column-labels">
                                ...
                                <label class="product-quantity d-none">Quantity</label>
                            ...
                            @foreach ($cart_items as $item)
                                ...
                                @php $total = $total + $item->total; @endphp
                                    <div class="product">
                                        ...
                                        <div class="p-in md-color md-price">
                                        ...
                                        <div class="product-quantity d-none"> {{ $item->quantity }}</div>
                            ...
                            <div class="update-cart-sec">
                                ...
                                <div class="totals">
                                    ...
                                    <div class="totals-item">
                                        ...
                                        <div class="totals-values" id="cart-shipping">OnChekout</div>
                                    </div>
