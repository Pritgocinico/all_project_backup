                ...
                <div class="registration-in">
                        ...
                        <div class="res-shadow">
                          <div class="d-lg-flex flex-lg-row flex-column  gap-2 name-f">
                            ...
                            <div class="rgs-w">
                                ...
                                <input type="text" name="vat_reg_no" class="form-control py-2" id="vat_reg_no" value="{{ old('vat_reg_no') }}">
                              </div>
                            </div>
                            <div class="d-lg-flex flex-lg-row flex-column  gap-2 name-f">
                                <div class="rgs-w">
                            ...
                            <div class="d-lg-flex flex-lg-row flex-column  gap-2 name-f">
                              <div class="rgs-w">
                                <label for="ENI_number" class="form-label">EIN Number</label>
                            ...
                            <label for="speciality" class="form-label">Speciality <span class="text-danger">*</span></label>
                                <select name="speciality" class="form-control py-2" id="speciality" required onchange="specialityCheck()">
                                    <!-- Placeholder option -->
                                    <option value="" disabled selected>Select your speciality</option>
                                    <!-- Add options for the dropdown -->
                                    <option value="DO" @if (old('speciality') == 'DO') selected @endif>DO</option>
                                    <option value="MD" @if (old('speciality') == 'MD') selected @endif>MD</option>
                                    <option value="NP" @if (old('speciality') == 'NP') selected @endif>NP</option>
                                    <option value="PA" @if (old('speciality') == 'PA') selected @endif>PA</option>
                                    <option value="ND" @if (old('speciality') == 'ND') selected @endif>ND</option>
                                    <option value="other" @if (old('speciality') == 'other') selected @endif>Other</option>
                                </select>
                            ...
                            <div class="rgs-w @if(old('userCreateArray') !== 'other')d-none @endif" id="other_speciality_div">
                                <label for="speciality" class="form-label">Other Speciality <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="other_speciality" id="other_speciality" class="form-control">
                    ...
                    @endif
                            ...
                            <div class="d-lg-flex flex-lg-row flex-column  gap-2 name-f">
                                ...
                                <div class="rgs-w">
                                    <label for="city" class="form-label">City <span
                                            class="text-danger">*</span></label>
                                        <input type="text" name="city" value="{{old('city')}}" class="form-control py-2" id="city" required>
                                    <div class="invalid-feedback">
                                        Please enter a city.
                                    </div>
                                    @if ($errors->has('city'))
                            ...
                            <div class="parent-upload-btn-lice">
                                ...
                                <div class="text"><label for="fileupload"><i class="fa-solid fa-upload me-2"></i>Upload copy of Business & DEA License</label><input multiple id='fileupload' type="file"
                        ...
                        <span class="text-danger" id="file_upload_error"></span>
                            ...
                            <div class="rgs-w mt-4 d-flex align-items-start gap-3">
                                ...
                                <label class="form-check-label" for="consent"><a href="{{ route('pharmacy-agreement') }}" target="_blank">By submitting this form, I agree to the Prescriber & Pharmacy Agreementt</a></label>
                                    </div>
                            ...
                            <div class="rgs-w mt-4 d-flex align-items-start gap-3">
                                ...
                                <label class="form-check-label" for="consent"><a
                                            href="{{ route('terms') }}" target="_blank">Terms & Conditions</a></label>
                                        </div>
