...
Route::get('/refresh-token', [QuickbooksController::class, 'refreshQuickbookToken'])->name('refresh-token');
...
Route::post('reset-password', [AuthController::class, 'submitResetPassword'])->name('submit.reset.password');
...
Route::middleware(['auth:admin', 'role:admin,user'])->group(function () {
    ...
    Route::get('admin-delete-document/{id}', [UserController::class, 'deleteDocument'])->name('admin.delete.document');
    ...
    Route::get('admin/order-detail-pdf/{id}', [OrderController::class, 'orderDetailPdfForm'])->name('order.detail.pdf');
    Route::get('admin/order-quickbooks/{id}', [QuickbooksController::class, 'addOrderInQuickBooks'])->name('order.quickbooks');
    Route::get('admin/user-quickbooks/{id}', [QuickbooksController::class, 'addCustomerToQuickBooks'])->name('user.quickbooks');
    Route::post('admin/store-order-detail-pdf', [OrderController::class, 'submitOrderDetailPdfForm'])->name('store.order.pdf.detail');
});
