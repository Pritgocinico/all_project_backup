          ...
          <tr style="margin-top: 20px;">
            <td style="padding: 30px;">
              ...
              <div style="margin:12px 0; list-style-type: none; background-color: #00A0AA; color: #fff; padding: 22px; gap: 12px;">
                ...
                <a href="{{url('/')}}/login" target="_blank" style="background-color:#00A0AA;color:white;padding: 15px 44px;outline: none;display: block;margin: auto;border-radius: 0px;font-weight: bold;margin-top: 25px;margin-bottom: 25px;border: none;text-transform:uppercase;width: 80px;text-decoration: none;">Login</a>
              <p style="margin:0;padding-bottom: 5px;line-height: 2; font-size: 15px;">Please ensure to keep your login details safe and secure. If you have any concerns about your account security or need assistance, don't hesitate to reach out to our support team at <b>[<a href="mail:sales@medisourcerx.com">sales@medisourcerx.com</a> and <a href="tel:+17144551300">(714) 455-1300</a>]</b>.</p>
