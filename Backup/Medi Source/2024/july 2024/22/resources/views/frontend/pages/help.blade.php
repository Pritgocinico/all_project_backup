...
@section('content')
                        ...
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href=""
                                        class="text-decoration-none text-white"> How can we help?</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <section class="help-sec">
        <div class="container">
            <div class="help-inner">
                <div class="help-form">
                    ...
                    <form class="needs-validation" novalidate action="{{ route('submit.help.inquiry') }}" method="post">
                        ...
                        <div class="help-w mb-3">
                            <label for="exampleFormControlTextarea2" class="form-label">Team Member You're
                                Contacting?</label>
                    ...
                    {{-- <p class="mt-3">
                        This site is protected by reCAPTCHA and the Google <a href="{{ route('privacy.policy') }}">Privacy
                            Policy</a> and <a href="{{ route('terms') }}">Terms of Service</a> apply.
                    </p> --}}
                </div>
                ...
                <div class="help-info">
                    ...
                    <p class="mb-sm-4 mb-2">10525 Humbolt St, Los Alamitos, CA 90720</p>
                    <p><span><a class="text-call-mail-color text-decoration-none"
                                href="tel:+17144551300">(714) 455-1300</a> |</span> Main Phone Number</p>
                    <p><span><a class="text-call-mail-color text-decoration-none"
                                href="tel:+17144551395">(714) 455-1395</a> |</span> Facsimile (FAX) Number</p>

                    <p class="mt-sm-4 mt-2"><span><a class="text-call-mail-color text-decoration-none"
                                href="mailto:info@medisourcerx.com">info@medisourcerx.com</a> |</span> Company General
                        Email Address</p>

                    <h3>HOURS
                    </h3>
                    <div class="ddpp-div">
                        <p id="P">M-F 5:00 AM to 4:00 PM (PST)</p>
                    </div>
            ...
            <div class="help-inner">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1657.5557052370689!2d-118.06704337139394!3d33.80943788733427!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80dd2f774c1bcc0b%3A0xaf8391a9302ba13c!2sMedisourceRx!5e0!3m2!1sen!2sin!4v1714983310805!5m2!1sen!2sin" width="1200" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>            
        </div>    
        </div>
