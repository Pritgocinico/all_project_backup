...
<head>
    ...
    <link rel="stylesheet" href="{{ url('/') }}/frontend/assets/style.css?v=0.3" class="stylesheet">
    <link rel="stylesheet" href="{{ url('/') }}/frontend/assets/media.css?v=0.3" class="stylesheet">
                                ...
                                <li class="nav-item position-relative email-dropdown">
                                    ...
                                    <ul class="navbar-nav  gap-xl-2 gap-1 mx-auto">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <p> For Orders :</p>
                                                <a class="" href="mailto:Order@medisourcerx.com">orders@medisourcerx.com</a> 
                                        </li>
                                        <li>
                        ...
                        <div class="ms-lg-0 ms-0 mb-lg-0 mb-5 dekstop nav-menus-ms mt-lg-0 mt-4 collapse navbar-collapse"
                            ...
                            <ul class="navbar-nav  gap-xl-2 gap-1 mx-auto mb-5 mb-lg-0">
                                ...
                                <li class="nav-item position-relative">
                                    ...
                                    <li><a class="dropdown-item"  href="{{route('meet-lead-pharmacy')}}">Meet Lead Pharmacist</a></li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-white" href="{{ route('help') }}">CONTACT US</a>
                                </li>
                            </ul>
        ...
        <div class="ms-lg-5 ms-0 mb-lg-0 mb-5 nav-menus-ms mt-lg-0 mt-xl-4 collapse navbar-collapse m-nav" id="navbarText">
            <ul class="navbar-nav gap-2 mx-auto mb-4 mb-lg-0">
                ...
                <li class="nav-item position-relative">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{route('about')}}">About MedisourceRx</a></li>
                        <li><a class="dropdown-item" href="{{route('meet-lead-pharmacy')}}">Meet Lead Pharmacist</a>
                    </ul>
                </li>
            ...
            @auth
                                    ...
                                    <a href="{{route('myaccount')}}" class="text-decoration-none me-3">
                                        <span class="header-btn border-0 mt-lg-0 mt-4 text-white py-2 px-4 ">
                                            MY ACCOUNT
                                        </span>
                                    </a>
                                   <span class="navbar-text" style="line-height: 84px;">
                                    <a href="{{route('logout')}}" class="text-decoration-none pt-3">
                                        <i class="ri-logout-box-line fs-18 align-middle me-1"></i>
                                        <span class="header-btn border-0 mt-lg-0 mt-4 text-white py-2 px-4 ">
                                            Logout
                                        </span>
