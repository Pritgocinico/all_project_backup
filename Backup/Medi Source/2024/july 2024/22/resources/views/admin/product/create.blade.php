            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.product-details.store') }}" method="post" id="productForm"
                        ...
                        <div class="mb-3">
                            <label for="description" class="form-label">BUD</label>
                        ...
                        <div class="mb-3" id="packageContentField">
                            <div class="package-content-field row">
                                ...
                                <div class="col-2">
                                    ...
                                    <input type="number" class="form-control" step="0.01"  name="vial_price[]" id="vialPrice_1" onchange="fill(1)" placeholder="Price Per Vial">
                                </div>
                                <div class="col-2">
                                    <label for="quantity" class="form-label">Quantity</label>
                                    <input type="number" class="form-control" step="0.01" name="vial_quantity[]" id="vialQuantity_1" onchange="fill(1)" placeholder="Quantity">
                                </div>
                                <div class="col-2">
                                    <label for="total" class="form-label">Total</label>
                                    <input type="number" class="form-control" step="0.01" name="vial_total[]" id="vialTotal_1" placeholder="Total">
                                </div>
                            </div>
                        </div>
                        <div>
