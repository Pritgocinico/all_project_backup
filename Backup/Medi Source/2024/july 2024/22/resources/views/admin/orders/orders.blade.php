                            ...
                            @if (!blank($orders))
                                @foreach ($orders as $order)
                                    <tr>
                                        ...
                                        <td><a
                                            href="{{ route('admin.users.show', $order->user_id) }}">{{ $order->organization_name ?? '-'}}</a>
                                        </td>
                                        <td>
                                        @php
                                            $usr = \App\Models\User::find($order->user_id);
                                            $manager = \App\Models\User::find($usr->account_manager_name);
