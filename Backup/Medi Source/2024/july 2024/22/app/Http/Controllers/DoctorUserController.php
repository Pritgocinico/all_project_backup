...
class DoctorUserController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        $userCreateArray =[
            ...
            'vat_reg_no' => $request->input('vat_reg_no'),
    ...
    public function edit($id)
    {
        ...
        $sales_manager = User::where('role', 2)->where('role_name', 'Sales Representative')->orderBy('id','desc')->get();
        return view('admin.doctor.edit', compact('user', 'cities', 'states', 'sales_manager'));
    }
