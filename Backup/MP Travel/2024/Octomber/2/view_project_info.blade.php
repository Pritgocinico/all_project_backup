...
@endif
@if (!blank($finalMeasurements))
    <div class="card">
        <div class="card-body pb-0">
            <div class="row w-100 view_project">
                <div class="d-flex align-items-center pb-3">
                    <h4 class="mb-0">Final Measurement Details </h4>
                    
                </div>
                <hr>
                @if (!blank($finalMeasurementFiles))
                    <div class="col-12">
                        <h5 class="mb-0">Final Measurement Files</h5>
                    </div>
                    <div class="col-12 ">
                        <div class="mt-3">
                            @foreach ($finalMeasurementFiles as $file)
                                <?php $image = URL::asset('public/measurementfile/' . $file->measurement); ?>
                                <div class="d-flex align-items-center">
                                    <div class="me-2">
                                        <img src="{{ url('/') }}/assets/media/image/docs.png" alt=""
