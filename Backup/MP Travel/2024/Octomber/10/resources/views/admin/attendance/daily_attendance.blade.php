            ...
            <div class="px-6 px-lg-7 pt-6">
                <div class="table-responsive custom-scrollbar">
                    <table class="table table-hover table-sm table-nowrap table-responsive mt-6 border" id="daily_attendance_table">
                        ...
                        <tbody>
                            @foreach ($dailyAttendanceListsPaginated as $key => $today_Attendance)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td><a
                                    ...
                                    <td>{{ $today_Attendance->login_time ? Utility::convertDmyAMPMFormat($today_Attendance->login_time) : '-' }}
                                    </td>
                                    <td>{{ $today_Attendance->logout_time ? Utility::convertDmyAMPMFormat($today_Attendance->logout_time) : '-' }}
                                    </td>
