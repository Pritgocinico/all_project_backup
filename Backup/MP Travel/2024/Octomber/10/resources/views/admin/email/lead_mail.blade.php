            ...
            <tr>
                ...
                <td bgcolor="#EAEAEA" align="center"
                    ...
                    <center>
                        ...
                        <a href="{{ route('follow-up.show',$followUpEvent->id) }}" style="font-size:18px;margin:0">View Follow Up</a>
            ...
            <tr>
                ...
                <td bgcolor="#EAEAEA" align="center"
                    ...
                    <center>
                        ...
                        <a href="{{ route('leads.index') }}" style="font-size:18px;margin:0;color:#6e6e6e;">View In Asana</a>
