...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="number" name="other_content"  id="other_content"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <select name="type_of_policy" id="type_of_policy" class="form-select">
            ...
            <option value="normal" {{ $insuranceData->policy_type == 'normal' ? 'selected' : '' }}>Normal</option>
            <option value="floter" {{ $insuranceData->policy_type == 'floter' ? 'selected' : '' }}>Floter</option>
        </select>
    </div>
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <textarea name="past_year_claim_history" id="past_year_claim_history" class="form-control"
            placeholder="Enter PAST 3 YEAR CLAIM history">{{ $insuranceData->three_year_claim_history }}</textarea>
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <select name="insure_premises" class="form-control" id="insure_premises">
            ...
            <option value="yes" {{ $insuranceData->insured_premises == 'yes' ? 'selected' : '' }}>Yes</option>
            <option value="no" {{ $insuranceData->insured_premises == 'no' ? 'selected' : '' }}>No</option>
        </select>
        @error('basement')
            <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
    <div class="col-md-2"><label class="form-label mb-0">Risk is located in a thickly populated area </label></div>
    <div class="col-md-4 col-xl-4">
        <select name="rick_located_area_access" class="form-control" id="rick_located_area_access">
            <option value="">Select Risk is located in a thickly populated area</option>
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="age_building" id="age_building" value="{{ $insuranceData->age_of_building }}"
