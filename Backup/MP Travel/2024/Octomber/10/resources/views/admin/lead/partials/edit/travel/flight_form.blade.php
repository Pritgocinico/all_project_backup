<div class="flight_form_first_step">
    <div class="row align-items-center g-3 mt-6">
        ...
        <div class="col-md-4 col-xl-4">
            <input type="text" name="flight_form" class="form-control" id="flight_form" placeholder="Enter Flight Form"
                value="{{ isset($travelData) && $travelData->flight_form }}">
            @error('flight_form')
    ...
    <div class="row align-items-center g-3 mt-6">
        ...
        <div class="col-md-4 col-xl-4">
            <input type="date" name="travel_form_date" class="form-control" id="travel_form_date"
                placeholder="Enter Flight Form" value="{{ isset($travelData) && $travelData->travel_form_date }}">
        ...
        <div class="col-md-4">
            <input type="date" name="travel_to_date" class="form-control" value="{{ isset($travelData) && $travelData->travel_to_date }}"
    ...
    <div class="row align-items-center g-3 mt-6">
        ...
        <div class="col-md-4">
            <input type="number" name="no_of_passengers" class="form-control" placeholder="Enter Number of Passengers"
                id="no_of_passengers" value="{{ isset($travelData) && $travelData->no_of_passengers }}">
        ...
        <div class="col-md-4">
            <select name="travel_sector" class="form-select" id="travel_sector">
                ...
                <option value="domestic" {{ isset($travelData) && $travelData->travel_sector == 'domestic' ? 'selected' : '' }}>Domestic
                </option>
                <option value="international" {{ isset($travelData) && $travelData->travel_sector == 'international' ? 'selected' : '' }}>
    ...
    <div class="row align-items-center g-3 mt-6">
        ...
        <div class="col-md-4 col-xl-4">
            <select name="travel_mode" class="form-select" id="travel_mode">
                ...
                <option value="one_way" {{ isset($travelData) && $travelData->travel_mode == 'one_way' ? 'selected' : '' }}>One Way</option>
                <option value="return" {{ isset($travelData) && $travelData->travel_mode == 'return' ? 'selected' : '' }}>Return</option>
                <option value="multi_city" {{ isset($travelData) && $travelData->travel_mode == 'multi_city' ? 'selected' : '' }}>Multi City
                </option>
            </select>
            @error('travel_mode')
                <div class="text-danger">{{ $message }}</div>
        ...
        <div class="col-md-4 col-xl-4">
            <select name="all_passengers_are_traveling_back" class="form-select"
                ...
                <option value="">Select</option>
                <option value="yes"
                    {{ isset($travelData) && $travelData->all_passengers_are_traveling_back == '"yes"' ? 'selected' : '' }}>Yes</option>
                <option value="no"
                    {{ isset($travelData) && $travelData->all_passengers_are_traveling_back == '"no"' ? 'selected' : '' }}>No</option>
            </select>
    ...
    <div class="row align-items-center g-3 mt-6">
        ...
        <div class="col-md-4 col-xl-4">
            <input type="text" name="passenger_travel_other_sector" class="form-control"
                ...
                value="{{ isset($travelData) && $travelData->passenger_travel_other_sector }}">
    ...
    <div class="row align-items-center g-3 mt-6">
        ...
        <div class="col-md-4 col-xl-4">
            <select name="booking_status" class="form-select" id="booking_status" onchange="getTravelType()">
                ...
                <option value="pending" {{ isset($travelData) && $travelData->booking_status == 'pending' ? 'selected' : '' }}>Pending
                </option>
                <option value="hold_ticket" {{ isset($travelData) && $travelData->booking_status == 'hold_ticket' ? 'selected' : '' }}>Hold
                    Ticket</option>
                <option value="confirm" {{ isset($travelData) && $travelData->booking_status == 'confirm' ? 'selected' : '' }}>Confirm
                </option>
            </select>
    ...
    <div class="row align-items-center g-3 mt-6 pending_booking_div_status {{ isset($travelData) && $travelData->booking_status == 'pending' ? '' : "d-none" }}">
        ...
        <div class="col-md-4 col-xl-4">
            <input type="date" name="followup_date" class="form-control" id="followup_date"
                value="{{ isset($travelData) && $travelData->followup_date }}">
            @error('followup_date')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="col-md-4 col-xl-4">
            <textarea name="pending_remarks" class="form-control" id="pending_remarks" class="form-control">{{ isset($travelData) && $travelData->pending_remarks }}</textarea>
        </div>
    </div>
</div>
