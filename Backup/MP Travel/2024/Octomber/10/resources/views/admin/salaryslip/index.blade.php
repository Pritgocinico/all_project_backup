                    ...
                    <div class="vstack gap-1">
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            <div class="col-md-2">
                                ...
                                <label class="form-label">Month<span class="error_span">*</span></label>
                            ...
                            <div class="col-md-10 col-xl-10">
                                ...
                                <span id="salary_slip_month_error" style="color: red;"></span>
...
<script>
    function createGenerateSlip() {
        var month = $('#month').val();
        if (month == "") {
            $('#salary_slip_month_error').html('Please Select Month.');
            return false;
        }
