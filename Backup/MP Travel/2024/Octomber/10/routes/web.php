...
use App\Http\Controllers\Common\DocumentCheckListController;
use App\Http\Controllers\Common\FollowUpController;
use App\Http\Controllers\Common\LeadCheckListController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('remove-card-customer',[CustomerController::class,'removeCardCustomer'])->name('remove.card.customer');

    Route::resource('leave',LeaveController::class);
    Route::get('leave-status', [LeaveController::class, 'changeLeaveStatus'])->name('leave.status');
    Route::get('remove-card-leave', [LeaveController::class,'removeCardLeave'])->name('remove.card.leave');
    Route::get('reply-leave/{id}',[LeaveController::class,'replyLeave'])->name('reply-leave');
    Route::POST('leave-comment-store',[LeaveController::class,'addCommentLeave'])->name('leave-comment-store');
    ...
    Route::POST('followup_checklist_item', [FollowUpController::class, 'followup_checklist_item'])->name('followup_checklist_item');
    Route::post('add_follow_up_data', [FollowUpController::class, 'add_followUp_data'])->name('add_follow_up_data'); 
    Route::post('add_followup_checklist_item', [FollowUpController::class, 'add_followup_checklist_item'])->name('add_followup_checklist_item');
    Route::post('update_checklist_status', [FollowUpController::class, 'update_checklist_status'])->name('update_checklist_status');
    Route::post('upload_follow_up_file', [FollowUpController::class, 'uploadFollowUpFile'])->name('upload_follow_up_file');
    Route::post('follow-up-add-comment', [FollowUpController::class, 'followUpComment'])->name('follow_up.comment');
    Route::post('update_due_date', [FollowUpController::class, 'update_due_date'])->name('update_due_date');
    Route::post('update_checklist_note', [FollowUpController::class, 'update_checklist_note'])->name('update_checklist_note');
    Route::get('delete-checklist-item/{id}',[FollowUpController::class,'deleteChecklistItem'])->name('delete.checklist_item');
    Route::post('change_task_status', [FollowUpController::class, 'change_status'])->name('change_task_status'); 
    Route::post('change_priority', [FollowUpController::class, 'change_priority'])->name('change_priority'); 
    Route::post('task_employee', [FollowUpController::class, 'taskEmployee'])->name('task.employee');
    Route::post('add-lead-follow-up', [FollowUpController::class, 'addLeadFollowUp'])->name('add_lead_follow_up');
    ...
    Route::POST('lead-status',[LeadController::class,'leadStatusChange'])->name('lead.status');
    Route::POST('lead-follow-up-add',[LeadController::class,'storeLeadFollowUp'])->name('lead-follow-up-add');
    ...
    Route::get('remove-exist-copy',[LeadController::class,'removeExistCopy'])->name('remove-exist-copy');
    Route::get('remove-photo-copy',[LeadController::class,'removePhotoCopy'])->name('remove-photo-copy');
    Route::get('remove-investigation-copy',[LeadController::class,'removeInvestigation'])->name('remove-investigation-copy');
    Route::get('remove-fire_other-copy',[LeadController::class,'removeFireOther'])->name('remove-fire_other-copy');
    Route::get('remove-emp_sheet-copy',[LeadController::class,'removeEmpDataSheet'])->name('remove-emp_sheet-copy');
    Route::get('remove-discharge_summary-copy',[LeadController::class,'removeDischargeSummary'])->name('remove-discharge_summary-copy');
    Route::get('remove-pa-policy',[LeadController::class,'removePaPolicy'])->name('remove-pa-policy');
    Route::get('remove-member-detail',[LeadController::class,'removeInsuranceMember'])->name('remove-member-detail');
    Route::get('remove-claim-history',[LeadController::class,'removeClaimHistory'])->name('remove-claim-history');
    Route::get('remove-gpa-dump',[LeadController::class,'removeGpaDump'])->name('remove-gpa-dump');
    Route::get('remove-invoice-copy',[LeadController::class,'removeInvoiceCopy'])->name('remove-invoice-copy');
    Route::get('remove-survey-report',[LeadController::class,'removeSurveyReport'])->name('remove-survey-report');
    Route::get('remove-travel-child-data',[LeadController::class,'removeTravelChildData'])->name('remove-travel-child-data');
    Route::get('remove-passport-file',[LeadController::class,'removePassportFile'])->name('remove.passport.file');

    Route::get('edit-sub-task',[LeadController::class,'editSubTask'])->name('edit-sub-task');

    Route::resource('document-checklist',DocumentCheckListController::class);
    Route::get('document-checklist-ajax',[DocumentCheckListController::class,'ajaxList'])->name('document-checklist-ajax');
    Route::get('document-checklist-export',[DocumentCheckListController::class,'exportCSV'])->name('document-checklist-export');
    Route::get('get-country-document',[DocumentCheckListController::class,'countryDocument'])->name('get-country-document');

    Route::resource('lead-checklist',LeadCheckListController::class);
    Route::get('lead-checklist-ajax',[LeadCheckListController::class,'ajaxList'])->name('lead-checklist-ajax');
    Route::get('lead-checklist-export',[LeadCheckListController::class,'exportCSV'])->name('lead-checklist-export');
    Route::get('lead-checklist-remove',[LeadCheckListController::class,'removeItem'])->name('lead-checklist-remove');
