                                        ...
                                        @if ($type == 0)
                                            <select name="invest_type" class="form-control" id="invest_type">
                                                ...
                                                <option value="investments"
                                                    @if ($lead->invest_type == 'investments') selected @endif>
                                                    Investments</option>
                                                <option value="general insurance"
                                                    @if ($lead->invest_type == 'general insurance') selected @endif>
                                                    General Insurance</option>
                                                <option value="travel" @if ($lead->invest_type == 'travel') selected @endif>
                                                    Travel
                                                </option>
                                            </select>
                                        @else
                                ...
                                <div class="row align-items-center gap-3 mt-6">
                                    <div class="col-md-6 row align-items-center g-3">
                                        ...
                                        <div class="col-md-8 col-xl-6" id="customer_name">
                                            {{ isset($lead->customerDetail) ? $lead->customerDetail->name_title . ' ' . $lead->customerDetail->name : '-' }}
                                        </div>
                                    </div>
                                    <div class="col-md-6 row align-items-center g-3">
                                ...
                                <div class="row align-items-center gap-3 mt-6">
                                    ...
                                    <div class="col-md-6 row align-items-center g-3">
                                        ...
                                        <div class="col-md-8 col-xl-6" id="customer_mobile">
                                            {{ isset($lead->customerDetail) && isset($lead->customerDetail->phone_code) ? '+' . $lead->customerDetail->phone_code : '' }}{{ isset($lead->customerDetail) ? $lead->customerDetail->mobile_number : '-' }}
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6 row align-items-center g-3">
                                        ...
                                        <div class="col-md-8 col-xl-6" id="cust_aadhar_card_file">
                                            @if (isset($lead->customerDetail) && $lead->customerDetail->aadhar_card_file !== null)
                                                @if (json_decode($lead->customerDetail->aadhar_card_file))
                                                    @foreach (json_decode($lead->customerDetail->aadhar_card_file) as $aadhar)
                                    ...
                                    <div class="col-md-6 row align-items-center g-3">
                                        ...
                                        <div class="col-md-8 col-xl-6" id="cust_pan_card_file">
                                            @if (isset($lead->customerDetail) && $lead->customerDetail->pan_card_file !== null)
                                                @if (json_decode($lead->customerDetail->pan_card_file))
                                                    @foreach (json_decode($lead->customerDetail->pan_card_file) as $pan)
                                    ...
                                    <div class="col-md-6 row align-items-center g-3">
                                        ...
                                        <div class="col-md-4" id="gst_certificate_file">
                                            @if (isset($lead->customerDetail) && $lead->customerDetail->gst_certificate !== null)
                                                @if (json_decode($lead->customerDetail->gst_certificate))
                                                    @foreach (json_decode($lead->customerDetail->gst_certificate) as $gst)
...
@section('script')
    <script>
        ...
        <div class="col-md-2">
            <a href="javascript:void(0)" class="btn btn-sm btn-dark" onclick="removeRow(${i})" data-id="${i}"><i class="fa-solid fa-trash-can"></i></a>
        </div>
    </div>
        </div>`;
        ...
        $('#customer_id').on('change', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#customer_name').html(res.name_title + " " + res.name);
        ...
        function removePassportFile(id) {
            Swal.fire({
                title: 'Are you sure?',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('remove.passport.file') }}",
                        type: 'get',
                        data: {
                            id: id
                        },
                        success: function(data) {
                            toastr.success(data.message);
                            $(`.passport_file_view_${id}`).remove();
                            $(`.passport_file_remove_${id}`).remove();
                        },
                        error: function(error) {
                            toastr.error(error.responseJSON.message);
                        }
        ...
        function getCountryDocument(){
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var res = data.data
                    var html = `<a href="{{ asset('storage/${res.document_file}') }}" class='btn btn-dark btn-sm' target='_blank'>View</a>`;
