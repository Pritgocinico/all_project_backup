        ...
        <main class="container-fluid px-3 py-5 p-lg-6 p-xxl-8">
            ...
            <div
                ...
                <main class="container-fluid px-6 pb-10">
                    <form enctype="multipart/form-data" method="POST" id="lead_create_form">
                        @php
                        ...
                        <div id="first_step_div">
                            <div class="row align-items-center gap-3 mt-6">
                                <div class="col-md-6 row align-items-center g-3">
                                    <div class="col-md-4"><label class="form-label mb-0">Customer</label><span
                                            class="text-danger required-msg">*</span></div>
                                    <div class="col-md-6 col-xl-7">
                                        ...
                                        <div id="customer_error" class="text-danger required-msg"></div>
                                        @error('customer_id')
                                    ...
                                    <div class="col-md-8 col-xl-6">
                                        <select name="invest_type" class="form-control" id="invest_type">
                                            ...
                                            <option value="general insurance"
                                                {{ 'general insurance' == old('invest_type') ? 'selected' : '' }}>
                                                General Insurance</option>
                                            <option value="travel" {{ 'travel' == old('invest_type') ? 'selected' : '' }}>
                                                Travel</option>
                                        </select>
                                        <div id="invest_type_error" class="text-danger required-msg"></div>
                                        @error('invest_type')
                                            <div class="text-danger required-msg">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div id="customer_detail_div"
                                ...
                                <div class="row align-items-center gap-3 mt-6">
                                    ...
                                    <div class="col-md-6 row align-items-center g-3">
                                        ...
                                        <div class="col-md-8 col-xl-6" id="customer_mobile">
                                            {{ isset($customerData) && $customerData->phone_code ? '+' . $customerData->phone_code : '' }}{{ $customerData->mobile_number ?? '' }}
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6 row align-items-center g-3">
                                        ...
                                        <div class="col-md-8 col-xl-6" id="cust_aadhar_card_file">
                                            @if (isset($customerData) && $customerData->aadhar_card_file)
                                                @if (json_decode($customerData->aadhar_card_file))
                                                    @foreach (json_decode($customerData->aadhar_card_file) as $aadhar)
                                                        <a href="{{ asset('storage/' . $aadhar) }}" class="btn btn-dark"
                                    ...
                                    <div class="col-md-6 row align-items-center g-3">
                                        ...
                                        <div class="col-md-8 col-xl-6" id="cust_pan_card_file">
                                            @if (isset($customerData) && $customerData->pan_card_file)
                                                @if (json_decode($customerData->pan_card_file))
                                                    @foreach (json_decode($customerData->pan_card_file) as $pan)
                                                        <a href="{{ asset('storage/' . $pan) }}" class="btn btn-dark"
                                                            target="_blank">View</a>
                                                    @endforeach
                                                @else
                                ...
                                <div class="row align-items-center gap-3 mt-6">
                                    ...
                                    <div class="col-md-6 row align-items-center g-3">
                                        <div class="col-md-4 "><label class="form-label mb-0">GST Certificate</label>
                                        </div>
                                        <div class="col-md-8 col-xl-6" id="gst_certificate_file">
                                            @if (isset($customerData) && $customerData->gst_certificate)
                                                @if (json_decode($customerData->gst_certificate))
                                                    @foreach (json_decode($customerData->gst_certificate) as $gst)
                                                        <a href="{{ asset('storage/' . $gst) }}" class="btn btn-dark"
                                                            target="_blank">View</a>
                                                    @endforeach
                                                @else
                                ...
                                <div class="row align-items-center gap-3 mt-6">
                                    <div class="col-md-6 row align-items-center g-3">
                                        <div class="col-md-4"><label class="form-label mb-0">Customer Reference</label>
                                        </div>
                                        <div class="col-md-8 col-xl-6" id="customer_reference">
                                            {{ $customerData->reference ?? '' }}</div>
                                    </div>
                                </div>
                                <div id="serviceTagDetail"></div>
                                <div class="row align-items-center gap-3 mt-6">
                                    <div class="col-md-6 row align-items-center g-3">
                                ...
                                <div class="col-md-6 row align-items-center g-3">
                                    ...
                                    <div class="col-md-8 col-xl-6">
                                        <input type="text" name="name" class="form-control"
                                            placeholder="Enter Name" id="modal_customer_name"
                                            value="{{ old('name') }}">
                                        @error('name')
                                            <div class="text-danger required-msg">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6 row align-items-center g-3">
                                    ...
                                    <div class="col-md-8 col-xl-6">
                                        <input type="number" name="mobile_number" class="form-control" min="0"
                                            id="modal_customer_phone" placeholder="Enter Phone Number"
                                ...
                                <div class="col-md-6 row align-items-center g-3">
                                    ...
                                    <div class="col-md-8 col-xl-6">
                                        <input type="text" name="email" class="form-control"
                                            placeholder="Enter Email" id="modal_customer_email"
                                            value="{{ old('email') }}">
                                        @error('email')
                                            <div class="text-danger required-msg">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6 row align-items-center g-3">
                                    ...
                                    <div class="col-md-8 col-xl-6">
                                        <input type="text" name="aadhaar_number" class="form-control"
                                            id="aadhaar_number" placeholder="Enter Aadhar Card Number"
                            ...
                            <div class="row align-items-center gap-3 mt-6">
                                ...
                                <div class="row align-items-center gap-3 mt-6">
                                    <div class="col-md-6 row align-items-center g-3">
                                        ...
                                        <div class="col-md-8 col-xl-6">
                                            <select name="state" class="form-control risk_location_state"
                                                id="modal_state" onchange="getCity()">
                                    ...
                                    <div class="col-md-6 row align-items-center g-3">
                                        ...
                                        <div class="col-md-8 col-xl-6">
                                            <select name="city" class="form-control risk_location_city"
                                                id="city">
    ...
    <div class="modal fade " id="leadSaveDetail" tabindex="-1" aria-labelledby="leadSaveDetailLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content overflow-hidden">
                ...
                <form class="vstack" method="POST" id="leadFormData" enctype="multipart/form-data"
                    action="{{ route('add_lead_follow_up') }}">
                    @csrf
                    <input type="hidden" name="lead_id" id="edit_lead_id" value="">
                    <div class="modal-body undefined">
                        <div class="row align-items-center g-3 mt-6 mb-2">
                            <div class="col-md-3"><label class="form-label mb-0">Follow Up Remarks<span
                                        class="error_span">*</span></label></div>
    ...
    <script>
        ...
        $('#lead_create_form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var customer = data.data.customer_detail;
                    var cityName = "";
                    ...
                    if (customer.last_service_take != null) {
                        ...
                        tagAt = moment(customer.last_service_take.created_at).format(
                    ...
                    var code = "";
                    if (res.phone_code != null) {
                        code = "+" + res.phone_code;
                    }
                    $('#lead_customer_mobile').html(code + " " + customer.mobile_number);
                    ...
                    if (lead.invest_type == "general insurance") {
                        ...
                        $('#lead_insurance_type').html(removeUnderscoresAndCapitalize(lead
                            .insurance_type));
                    }
                    var memberName = "";
        ...
        <div class="row align-items-center mt-6">
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" name="travel_member_name[]" placeholder="Enter Name" id="travel_member_name_${i}" onchange="setMemberName(${i})">
            </div>
            <div class="col-md-3">
                <label class="form-label">Member DOB</label>
                <input type="date" class="form-control" name="member_dob[]" placeholder="Enter Name" onchange="calculateAge(${i})" id="member_dob_${i}">
                Age:- <span class="age_calculate_${i}">0</span>
            </div>
            <div class="col-md-3">
                <label class="form-label">Member Document</label>
                <input type="file" class="form-control" name="member_doc[][${i}]" placeholder="Enter Age" multiple>
            </div>
            <div class="col-md-2">
                ...
                <select class="form-select" name="child_type[]">
                    ...
                    <div class="col-md-1">
            <a href="javascript:void(0)" class="btn btn-sm btn-dark" onclick="removeTravelChildData(${i})" data-id="${i}"><i class="fa-solid fa-trash-can"></i></a>
        </div>
        </div>
        `;
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (res != null) {
                        ...
                        var title = "";
                        if (res.name_title != null) {
                            title = res.name_title;
                        }
                        $('#customer_name').html(title + " " + res.name);
                        var cityName = "";
                        ...
                        if (res.state_detail != null) {
                            stateName = res.state_detail.name + ", <br />";
                        }
                        var countryName = "";
                        ...
                        var pinCode = "";
                        if (res.pin_code != null) {
                            pinCode = " - " + res.pin_code;
                        }

                        var html = address + " " + cityName + " " + stateName + " " +
                            countryName + "  " + pinCode;
                        if (cityName == "" && stateName == "" && countryName == "" && address == "" &&
                            pinCode ==
                            "") {
                            html = "-";
                        }
                        ...
                        $('#customer_mobile').html(code + "" + res.mobile_number);
                        var aadharFile = "";
                        $('#aadhar_card_number').html(res.aadhar_number ?? "-");
                        try {
                            var aadharArray = JSON.parse(res.aadhar_card_file);
                            $.each(aadharArray, function(key, value) {
                                aadharFile +=
                                    `<a href="{{ asset('storage/${value}') }}" class='btn btn-dark btn-sm ms-2' target='_blank'>View</a>`;
                            })
                        } catch (error) {
                            aadharFile =
                        ...
                        var panFile = "";
                        try {
                            var panArray = JSON.parse(res.pan_card_file);
                            $.each(panArray, function(key, value) {
                                panFile +=
                                    `<a href="{{ asset('storage/${value}') }}" class='btn btn-dark btn-sm ms-2' target='_blank'>View</a>`;
                            })
                        } catch (error) {
                        ...
                        var gstFile = "";
                        try {
                            var gstArray = JSON.parse(res.pan_card_file);
                            $.each(gstArray, function(key, value) {
                                gstFile +=
                                    `<a href="{{ asset('storage/${value}') }}" class='btn btn-dark btn-sm ms-2' target='_blank'>View</a>`;
                            })
                        } catch (error) {
                        ...
                        var tagDiv = "";
                        $.each(res.service_preference_tag_detail, function(key, value) {
                            var date = moment(value.created_at).format('DD-MM-YYYY hh:mm:ss A')
                            tagDiv = `<div class="row align-items-center g-3 mt-6">
                                <div class="col-md-4">
                                    Tag Name:- ${value.service_preference_detail.name}</div>
                                <div class="col-md-4">
                                    Tag Created By:- ${value.user_detail.name}</div>
                                <div class="col-md-4">
                                    Tag Created At:- ${date}</div>
                                </div>`
                        })
        ...
        $('#travel_inquiry_type').on('change', function(e) {
            var type = $(this).val();
            $('.passenger_mobile_number_div').addClass('d-none');
            if (type != "") {
                $('.passenger_mobile_number_div').removeClass('d-none');
            }
            if (type == 'flight') {
                $('#flight_form_div').removeClass('d-none');
                $('#visa_form_div').addClass('d-none');
                $('#domestic_form_div').addClass('d-none');
                $('#international_form_div').addClass('d-none');
                $('#hotel_form_div').addClass('d-none');
                $('#transport_form_div').addClass('d-none');
            }
            if (type == 'visa') {
                $('#flight_form_div').addClass('d-none');
                $('#visa_form_div').removeClass('d-none');
                $('#domestic_form_div').addClass('d-none');
                $('#international_form_div').addClass('d-none');
                $('#hotel_form_div').addClass('d-none');
                $('#transport_form_div').addClass('d-none');
                $('#travel_country').select2();
            }
            if (type == 'domestic') {
                $('#flight_form_div').addClass('d-none');
                $('#visa_form_div').addClass('d-none');
                $('#domestic_form_div').removeClass('d-none');
                $('#international_form_div').addClass('d-none');
                $('#hotel_form_div').addClass('d-none');
                $('#transport_form_div').addClass('d-none');
                $('#domestic_other_services').select2();
            }
            if (type == 'international') {
                $('#flight_form_div').addClass('d-none');
                $('#visa_form_div').addClass('d-none');
                $('#domestic_form_div').addClass('d-none');
                $('#international_form_div').removeClass('d-none');
                $('#hotel_form_div').addClass('d-none');
                $('#transport_form_div').addClass('d-none');
                $('#international_other_services').select2();
            }
            if (type == 'hotel') {
                $('#flight_form_div').addClass('d-none');
                $('#visa_form_div').addClass('d-none');
                $('#domestic_form_div').addClass('d-none');
                $('#international_form_div').addClass('d-none');
                $('#hotel_form_div').removeClass('d-none');
                $('#transport_form_div').addClass('d-none');
            }
            if (type == 'transport') {
                $('#flight_form_div').addClass('d-none');
                ...
                $('#international_form_div').addClass('d-none');
                $('#hotel_form_div').addClass('d-none');
                $('#transport_form_div').removeClass('d-none');
            }
        })
        $('#flight_next_button').on('click', function(e) {
            var passengerCount = $('#no_of_passengers').val();
            var html = "";
            for (let i = 0; i < passengerCount; i++) {
                html += `<div id="add_child_option_${i}">
        <div class="row align-items-center mt-6">
            <div class="col-md-3">
                <label class="form-label">Member Name</label>
                <input type="text" class="form-control" name="travel_member_name[]" placeholder="Enter Name" id="travel_member_name_${i}" onchange="setMemberName(${i})">
            ...
            <div class="col-md-3">
                <label class="form-label">Member DOB</label>
                <input type="date" class="form-control" name="member_dob[]" placeholder="Enter Name" id="member_dob_${i}" onchange="calculateAge(${i})">
                Age:- <span class="age_calculate_${i}">0</span>
            </div>
            <div class="col-md-3">
                <label class="form-label">Member Document</label>
        ...
        `;
            ...
            $('#travel_child_detail').append(html);
            $('.flight_second_step_div').removeClass('d-none');
            $('.flight_second_step_button').addClass('d-none');
        })
        $('#filight_hide_previous').on('click', function(e) {


            $('.flight_second_step_div').addClass('d-none');
            $('.flight_second_step_button').removeClass('d-none');
        })
        ...
        function getTravelType() {
            ...
            $('.aadhar_card_number_div').addClass('d-none');
            $('.passport_number_div').addClass('d-none');
            $('.pending_booking_div_status').addClass('d-none');
            if (booking_status == 'hold_ticket') {
                if (sector == "domestic") {
                    $('.aadhar_card_number_div').removeClass('d-none');
                    $('.passport_number_div').addClass('d-none');
                    $('#aadhar_card_number_travel').setAttribute('required', true);
                    $('#passport_number_travel').removeAttribute('required', true);
                }
                if (sector == "international") {
                    $('.aadhar_card_number_div').addClass('d-none');
                    $('.passport_number_div').removeClass('d-none');
                    $('#aadhar_card_number_travel').removeAttribute('required', true);
                    $('#passport_number_travel').setAttribute('required', true);
                }
            }
            if (booking_status == 'pending') {
                $('.pending_booking_div_status').removeClass('d-none');
            }
        }
        $('#visa_rejection').on('change', function(e) {
            var visa_rejection = $(this).val();
            $('.visa_rejection_detail_div').addClass('d-none');
            if (visa_rejection == 'yes') {
                $('.visa_rejection_detail_div').removeClass('d-none');
                $('#visa_rejection_country').select2();
            }
        })
        $('#travel_other_services').on('change', function(e) {
            var visa_rejection = $(this).val();
            $('.other_service_yes_div').addClass('d-none');
            if (visa_rejection == 'yes') {
                $('.other_service_yes_div').removeClass('d-none');
            }
        })
        $(function() {
            $('.flexible_dates').daterangepicker();
            $('.fixed_dates').daterangepicker();
        });

        function calculateAge(id) {
            var dob = $('#member_dob_' + id).val();
            var today = new Date();
            ...
            $('.age_calculate_' + id).text(age);
        }

        function showVisaRejectionDetail() {
            var visa_rejection = $('#visa_rejection').val();
            $('.visa_rejection_div').addClass('d-none');
            if (visa_rejection == 'yes') {
                $('.visa_rejection_div').removeClass('d-none');
            }
        }

        function showTravelHistory() {
            var fristTravel = $('#first_time_traveler').val();
            $('.show_travel_history_div').addClass('d-none');
            if (fristTravel == 'no') {
                $('.show_travel_history_div').removeClass('d-none');
            }
        }

        function getDepartureTime() {
            var departure = $('#departure_date').val();
            $('.flexible_date_select').addClass('d-none')
            $('.fixed_date_select').addClass('d-none')
            $('.any_time_date_select').addClass('d-none')
            if (departure == 'flexible') {
                $('.flexible_date_select').removeClass('d-none')
                $('.fixed_date_select').addClass('d-none')
                $('.any_time_date_select').addClass('d-none')
            ...
            if (departure == 'fixed') {
                $('.flexible_date_select').addClass('d-none')
                $('.fixed_date_select').removeClass('d-none')
                $('.any_time_date_select').addClass('d-none')
                $('#domestic_fixed_date').daterangepicker({
                    minDate: moment(),
                    format: 'DD-MM-YYYY',
                });
            }
            if (departure == 'anytime') {
                $('.flexible_date_select').addClass('d-none')
                $('.fixed_date_select').addClass('d-none')
                $('.any_time_date_select').removeClass('d-none')
            }
        }

        function setTravelToDate() {
            var date = $('#travel_form_date').val();
            $('#travel_to_date').val(date);
            $('#travel_to_date').attr('min', date);
        }

        function setDropDate() {
            var date = $('#pickup_date').val();
            $('#drop_date').val(date);
            $('#drop_date').attr('min', date);
        }

        function getInternationalDepartureTime() {
            var departure = $('#international_departure_date').val();
            $('.flexible_date_select').addClass('d-none')
            $('.fixed_date_select').addClass('d-none')
            $('.any_time_date_select').addClass('d-none')
            if (departure == 'flexible') {
                ...
                $('.fixed_date_select').addClass('d-none')
                $('.any_time_date_select').addClass('d-none')
                $('#international_monthYear').datepicker({
                    format: "mm/yyyy",
                    viewMode: "months",
                    minViewMode: "months",
                    startDate: new Date(new Date().getFullYear(), new Date().getMonth(), 1),
            ...
            if (departure == 'fixed') {
                ...
                $('.fixed_date_select').removeClass('d-none')
                $('.any_time_date_select').addClass('d-none')
                $('#international_fixed_date').daterangepicker({
                    minDate: moment(),
                    format: 'DD-MM-YYYY',
                });
            }
        ...
        function getTransportDepartureTime() {
            var departure = $('#transport_departure_date').val();
            $('.flexible_date_select').addClass('d-none')
            $('.fixed_date_select').addClass('d-none')
            $('.any_time_date_select').addClass('d-none')
            if (departure == 'flexible') {
                ...
                $('.fixed_date_select').addClass('d-none')
                $('.any_time_date_select').addClass('d-none')
                $('#transport_monthYear').datepicker({
                    format: "mm/yyyy",
                    viewMode: "months",
                    minViewMode: "months",
                    startDate: new Date(new Date().getFullYear(), new Date().getMonth(), 1),
            ...
            if (departure == 'fixed') {
                ...
                $('.fixed_date_select').removeClass('d-none')
                $('.any_time_date_select').addClass('d-none')
                $('#transport_fixed_date').daterangepicker({
                    minDate: moment(),
                    format: 'DD-MM-YYYY',
                });
            }
        ...
        function getHotelDepartureTime() {
            var departure = $('#hotel_departure_date').val();
            $('.flexible_date_select').addClass('d-none')
            $('.fixed_date_select').addClass('d-none')
            $('.any_time_date_select').addClass('d-none')
            if (departure == 'flexible') {
            ...
            if (departure == 'fixed') {
                ...
                $('.fixed_date_select').removeClass('d-none')
                $('.any_time_date_select').addClass('d-none')
                $('#hotel_fixed_date').daterangepicker({
                    minDate: moment(),
                    format: 'DD-MM-YYYY',
                });
            }
        ...
        function addVisaChildData() {
            visa++;
            var html = "";
            html += `<div id="add_more_visa_option_${visa}">
                <div class="row align-items-center mb-3 g-3">
                        <div class="col-md-3">
                            <label class="form-label">Given Name</label>
                            <input type="text" name="given_name[]" class="form-control" placeholder="Enter Given Name">
                        </div>
                        <div class="col-md-3">
                ...
                <div class="row align-items-center mb-3 g-3">
                        ...
                        <div class="col-md-3">
                            <label class="form-label">Issuing place</label>
                            <input type="text" name="issuing_place[]" class="form-control" placeholder="Enter Issuing place">
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-1">
                            <a href="javascript:void(0)" class="d-flex justify-content-end" onclick="removeDivTagVisa(${visa})"><i class="fa-solid fa-trash-can"></i></a>
                </div>
                </div>
                </div>
                `;
            $('#visa_member_detail').append(html);
        }

        function removeDivTagVisa(id) {
            $('#add_more_visa_option_' + id).remove();
        }
        var domestic = 0;
        $('#domestic_more_button').on('click', function(e) {
            domestic = domestic + 1;
            var html = `<div id="domestic_child_option_${domestic}">
        <div class="row align-items-center mt-6">
            <div class="col-md-3">
                <label class="form-label">Member Name</label>
            ...
            <div class="col-md-3">
                <label class="form-label">Member DOB</label>
                <input type="date" class="form-control" name="member_dob[]" placeholder="Enter Name" onchange="calculateAge(${domestic})" id="member_dob_${domestic}">
                Age:- <span class="age_calculate_${domestic}">0</span>
            </div>
            <div class="col-md-3">
                <label class="form-label">Member Document</label>
                <input type="file" class="form-control" name="member_doc[][${domestic}]" placeholder="Enter Age" multiple>
            </div>
            <div class="col-md-2">
                <label class="form-label">Other Type</label>
                <select class="form-select" name="child_type[]">
                    ...
                    <div class="col-md-1">
            <a href="javascript:void(0)" class="btn btn-sm btn-dark" onclick="removeDomestic(${domestic})" data-id="${i}"><i class="fa-solid fa-trash-can"></i></a>
        </div>
        </div>
        `;

            $('#domestic_child_detail').append(html);
        });

        function removeDomestic(id) {
            $('#domestic_child_option_' + id).remove();
        }

        var intertional = 0;
        $('#international_more_button').on('click', function(e) {
            intertional = intertional + 1;
            var html = `<div id="intertional_child_option_${intertional}">
        <div class="row align-items-center mt-6">
            <div class="col-md-3">
                <label class="form-label">Member Name</label>
                <input type="text" class="form-control" name="travel_member_name[]" placeholder="Enter Name">
            ...
            <div class="col-md-3">
                <label class="form-label">Member DOB</label>
                <input type="date" class="form-control" name="member_dob[]" placeholder="Enter Name" onchange="calculateAge(${intertional})" id="member_dob_${intertional}">
                Age:- <span class="age_calculate_${intertional}">0</span>
            </div>
            <div class="col-md-3">
                <label class="form-label">Member Document</label>
                <input type="file" class="form-control" name="member_doc[][${intertional}]" placeholder="Enter Age" multiple>
            </div>
            <div class="col-md-2">
                <label class="form-label">Other Type</label>
                <select class="form-select" name="child_type[]">
                    ...
                    <div class="col-md-1">
            <a href="javascript:void(0)" class="btn btn-sm btn-dark" onclick="removeIntertional(${intertional})" data-id="${i}"><i class="fa-solid fa-trash-can"></i></a>
        </div>
        </div>
        `;

            $('#international_child_detail').append(html);
        });

        function removeIntertional(id) {
            console.log(id);

            $('#intertional_child_option_' + id).remove();
        }
        var hotel = 0;
        $('#hotel_more_button').on('click', function(e) {
            hotel = hotel + 1;
            var html = `<div id="hotel_child_option_${hotel}">
        <div class="row align-items-center mt-6">
            <div class="col-md-3">
                <label class="form-label">Member Name</label>
                <input type="text" class="form-control" name="travel_member_name[]" placeholder="Enter Name">
            ...
            <div class="col-md-3">
                <label class="form-label">Member DOB</label>
                <input type="date" class="form-control" name="member_dob[]" placeholder="Enter Name" onchange="calculateAge(${hotel})" id="member_dob_${hotel}">
                Age:- <span class="age_calculate_${hotel}">0</span>
            </div>
            <div class="col-md-3">
                <label class="form-label">Member Document</label>
                <input type="file" class="form-control" name="member_doc[][${hotel}]" placeholder="Enter Age" multiple>
            </div>
            <div class="col-md-2">
                <label class="form-label">Other Type</label>
                <select class="form-select" name="child_type[]">
                    ...
                    <div class="col-md-1">
            <a href="javascript:void(0)" class="btn btn-sm btn-dark" onclick="removeHotel(${hotel})" data-id="${i}"><i class="fa-solid fa-trash-can"></i></a>
        </div>
        </div>
        `;

            $('#hotel_child_detail').append(html);
        });

        function removeHotel(id) {

            $('#hotel_child_option_' + id).remove();
        }
        var transport = 0;
        $('#transport_more_button').on('click', function(e) {
            transport = transport + 1;
            var html = `<div id="transport_child_option_${transport}">
        <div class="row align-items-center mt-6">
            <div class="col-md-3">
                <label class="form-label">Member Name</label>
                <input type="text" class="form-control" name="travel_member_name[]" placeholder="Enter Name">
            ...
            <div class="col-md-3">
                <label class="form-label">Member DOB</label>
                <input type="date" class="form-control" name="member_dob[]" placeholder="Enter Name" onchange="calculateAge(${transport})" id="member_dob_${transport}">
                Age:- <span class="age_calculate_${transport}">0</span>
            </div>
            <div class="col-md-3">
                <label class="form-label">Member Document</label>
                <input type="file" class="form-control" name="member_doc[][${transport}]" placeholder="Enter Age" multiple>
            </div>
            <div class="col-md-2">
                <label class="form-label">Other Type</label>
                <select class="form-select" name="child_type[]">
                    ...
                    <div class="col-md-1">
            <a href="javascript:void(0)" class="btn btn-sm btn-dark" onclick="removeTransport(${transport})" data-id="${i}"><i class="fa-solid fa-trash-can"></i></a>
        </div>
        </div>
        `;
            $('#transport_child_detail').append(html);
        });

        function removeTransport(id) {
            $('#transport_child_option_' + id).remove();
        }

        function showTravelOtherSector(id) {
            var type = $('#all_passengers_are_traveling_back').val();
            $('.travel_other_sector_div').addClass('d-none');
            if (type == "no") {
                $('.travel_other_sector_div').removeClass('d-none');
                $('#passenger_travel_other_sector').select2();
            }
        }

        function setMemberName(id) {
            var name = $('#travel_member_name_' + id).val();
            var html = `<option value="${name}">${name}</option>`;
            $('#passenger_travel_other_sector').html(html);
        }

        function showTravelOtherServicesDetail() {
            var type = $('#travel_other_services').val();
            $('.visa_other_service_document_div').addClass('d-none');
            if (type == "yes") {
                $('.visa_other_service_document_div').removeClass('d-none');
            }
        }

        function getCountryDocument() {
            var country = $('#country_document').val();
            var url = "{{ route('get-country-document') }}";
            $.ajax({
                type: "GET",
                url: url,
                data: {
                ...
                success: function(data) {
                    $('.document_check_list_doc').removeClass('d-none');
                    var res = data.data
                    var html =
                        `<a href="{{ asset('storage/${res.document_file}') }}" class='btn btn-dark btn-sm' target='_blank'>View</a>`;
                    $('#doc_file_country').html(html);
                    $('#country_doc_not_file').html("");
                    $('#doc_check_list_id').val(res.id)
                },
                error: function(data) {
                    $('#doc_check_list_id').val()
                    $('#country_doc_not_file').html("File Not Found.");
                    $('.document_check_list_doc').addClass('d-none');
                }
            });
        }
    </script>
