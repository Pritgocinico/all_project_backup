<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4">
        <input type="text" name="travel_destination" class="form-control" value="{{ isset($travelData) && $travelData->travel_destination }}"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 flexible_date_select {{ isset($travelData) && $travelData->departure_date == 'flexible' ? '' : 'd-none' }}">
        <input type="text" name="domestic_monthYear" class="form-control" id="monthYear"
            value="{{ isset($travelData) && $travelData->flexible_month_year }}" placeholder="Select Month and Year">
    </div>
    ...
    <div class="col-md-4 fixed_date_select {{ isset($travelData) && $travelData->departure_date == 'fixed' ? '' : 'd-none' }}">
        <input type="text" name="domestic_fixed_date" class="form-control" id="domestic_fixed_date"
            value="{{ isset($travelData) && $travelData->domestic_fixed_date }}" placeholder="Select Month and Year">
    </div>
    ...
    <div class="col-md-4 any_time_date_select {{ isset($travelData) && $travelData->departure_date == 'anytime' ? '' : 'd-none' }}">
        <input type="text" name="any_time_days" class="form-control" id="any_time_days"
            value="{{ isset($travelData) && $travelData->number_of_day }}" placeholder="Enter Number Of Days">
    </div>
</div>

<div
    class="row align-items-center g-3 mt-6 flexible_date_select {{ isset($travelData) && $travelData->departure_date == 'flexible' ? '' : 'd-none' }}">
    <div class="col-md-2">
    ...
    <div class="col-md-4">
        <input type="number" name="domestic_flexible_number_days" class="form-control"
            id="domestic_flexible_number_days" placeholder="Enter Days" value="{{ isset($travelData) && $travelData->number_of_day }}">
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="travel_type" class="form-control" id="travel_type"
            value="{{ isset($travelData) && $travelData->travel_type }}" placeholder="Enter Travel Type">
        @error('travel_type')
            <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="hotel_category" class="form-control" id="hotel_category"
            placeholder="Enter Hotel Category" value="{{ isset($travelData) && $travelData->hotel_category }}">
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" class="form-control" name="meal_plan_preference"
            placeholder="Enter Meal Plan Preference" value="{{ isset($travelData) && $travelData->meal_plan_preference }}"></textarea>
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="transport_category" class="form-control"
            value="{{ isset($travelData) && $travelData->transport_category }}" placeholder="Enter Transport Category">
        ...
        <select name="domestic_other_services" class="form-select" id="domestic_other_services">
            ...
            @foreach ($serviceList as $service)
                <option value="{{ $service->id }}"
                    {{ isset($travelData) && $travelData->domestic_other_services == $service->id ? 'selected' : '' }}>{{ $service->name }}
                </option>
            @endforeach
        </select>
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-10 col-xl-10">
        <textarea name="domestic_other_services_remarks" id="domestic_other_services_remarks"class="form-control"
            placeholder="Enter Other Services Remarks">{{isset($travelData) &&  $travelData->domestic_other_services_remarks }}</textarea>
