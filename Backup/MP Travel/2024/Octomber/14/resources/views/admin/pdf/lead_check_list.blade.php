...
<body>
    ...
    <table class="table">
        ...
        <thead>
            ...
            <th class="table">Lead Type</th>
            <th class="table">Check List Item</th>
        ...
        <tbody>
            ...
            @forelse ($leadCheckList as $key=>$lead)

                <tr>

                    <td class="table">{{ $key +1 }}</td>

                    <td class="table">{{ $lead->type }}</td>
                    <td class="table">
                        @if (isset($lead->leadCheckListItems))
