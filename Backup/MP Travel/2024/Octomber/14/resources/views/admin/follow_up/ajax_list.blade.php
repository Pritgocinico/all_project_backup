        ...
        <div class="houmanity-card card">
                            ...
                            <div class="row">
                                <div class="col-md-8 border-end">
                                    <div class="row align-items-center g-3 mt-6">
                                        ...
                                        <div class="col-md-4 col-xl-4" id="customer_name">
                                            {{ isset($lead->customerDetail) ? $lead->customerDetail->name_title : '' }}{{ isset($lead->customerDetail) ? $lead->customerDetail->name : '-' }}
                                        </div>
                                    ...
                                    <div class="row align-items-center g-3 mt-6">
                                        ...
                                        <div class="col-md-4 col-xl-4" id="customer_mobile">
                                            {{ isset($lead->customerDetail) ? $lead->customerDetail->phone_code : '' }}{{ isset($lead->customerDetail) ? $lead->customerDetail->mobile_number : '-' }}
                                        </div>
                                    </div>
                                    ...
                                    @if (isset($lead->customerDetail) && isset($customer->lastServiceTake))
                                        <div class="row align-items-center g-3 mt-6">
                                            ...
                                            <div class="col-md-4">
                                                Create At:-
                                                {{ Utility::convertDmyAMPMFormat($customer->lastServiceTake->created_at) }}
                                            </div>
                                        </div>
                                    @endif
                                </div>
                                <div class="col-md-4">
                                    <div class="row align-items-center g-3 mt-6">
                                        ...
                                        <div class="col-md-6 col-xl-6" id="customer_name">
                                    ...
                                    @if ($lead->invest_type == 'general insurance')
                                        <div class="row align-items-center g-3 mt-6">
                                            ...
                                            <div class="col-md-6 col-xl-6" id="customer_email">
                                    ...
                                    <div class="row align-items-center g-3 mt-6" id="customer_detail_aadhar_div">
                                        ...
                                        <div class="col-md-6 col-xl-6" id="aadhar_card_number">
                                            {{ $lead->lead_date }}
                                        </div>
                                    </div>
                                    <div class="row align-items-center g-3 mt-6" id="customer_detail_aadhar_div">
                                        ...
                                        <div class="col-md-6 col-xl-6" id="aadhar_card_number">
                                            @foreach ($lead->leadMemberDetail as $member)
                                                {{ isset($member->userDetail) ? $member->userDetail->name . ',' : '' }}
                                            @endforeach
                                        </div>
                                    </div>
                                    <div class="row align-items-center g-3 mt-6" id="customer_detail_aadhar_div">
                                        <div class="col-md-6"><label class="form-label mb-0">Lead Status</label></div>
                                        <div class="col-md-6 col-xl-6" id="aadhar_card_number">
                                    ...
                                    @if (
                                        $lead->lead_complete_remarks != null ||
                                            $lead->lead_hold_remarks != null ||
                                            $lead->lead_in_process_remarks != null ||
                                            $lead->lead_pending_remarks != null)
                                        <div class="row align-items-center g-3 mt-6" id="customer_detail_aadhar_div">
                                            <div class="col-md-6"><label class="form-label mb-0">Lead Status
                                                    Remark</label></div>
                                            <div class="col-md-6 col-xl-6" id="aadhar_card_number">
                                                @if ($lead->lead_status == 4)
                                    ...
                                    <div class="row align-items-center g-3 mt-6" id="customer_detail_aadhar_div">
                                        ...
                                        <div class="col-md-6 col-xl-6" id="aadhar_card_number">
                                            @if ($lead->lead_status == 4 && $lead->lead_complete_date_time != null)
                                                {{ Utility::convertDmyAMPMFormat($lead->lead_complete_date_time) }}
                                            @elseif ($lead->lead_status == 3 && $lead->hold_date_time != null)
                                                {{ Utility::convertDmyAMPMFormat($lead->hold_date_time) }}
                                            @elseif ($lead->lead_status == 2 && $lead->lead_in_process_date_time != null)
                                                {{ Utility::convertDmyAMPMFormat($lead->lead_in_process_date_time) }}
                                            @elseif ($lead->lead_status == 1 && $lead->lead_pending_date_time != null)
            ...
            <div class="card-body">
                                ...
                                <div class="text-end ms-auto">
                                    <div class="d-flex float-end">
                                        ...
                                        <a href="javascript:void(0);" class="p-1 text-dark due_date"
                                            ...
                                            title="Change Due Date" id="changeDueDate"
                                            onclick="changeDueDate({{ $followUp->id }} , '{{ $followUp->event_end }}')"
                                            data-id="{{ $followUp->id }}">
                                        ...
                                        <div class="btn-group ml-5">
                                            ...
                                            <ul class="dropdown-menu task-status">
                                                <li><a class="dropdown-item status @if ($followUp->event_status == 1) hide @endif"
                                                        ...
                                                        onclick="changeStatus(1,{{ $followUp->id }})"
                                                ...
                                                <li><a class="dropdown-item status @if ($followUp->event_status == 5) hide @endif"
                                                        ...
                                                        onclick="changeStatus(5,{{ $followUp->id }})"
                                                ...
                                                <li><a class="dropdown-item status @if ($followUp->event_status == 2) hide @endif"
                                                        ...
                                                        onclick="changeStatus(2,{{ $followUp->id }})"
                                            ...
                                            <div class="btn-group ml-5">
                                                ...
                                                <ul class="dropdown-menu priority">
                                                    <li><a class="dropdown-item status @if ($followUp->priority == 1) hide @endif"
                                                            ...
                                                            onclick="changePriority(1,{{ $followUp->id }})"
                                                    ...
                                                    <li><a class="dropdown-item status @if ($followUp->priority == 2) hide @endif"
                                                            ...
                                                            onclick="changePriority(2,{{ $followUp->id }})"
                                                    ...
                                                    <li><a class="dropdown-item status @if ($followUp->priority == 3) hide @endif"
                                                            ...
                                                            onclick="changePriority(3,{{ $followUp->id }})"
                                                    ...
                                                    <li><a class="dropdown-item status @if ($followUp->priority == 4) hide @endif"
                                                            ...
                                                            onclick="changePriority(4,{{ $followUp->id }})"
                                ...
                                @foreach ($followUp->subTaskData as $sub)
                                    <li class="row1 sub_task ui-state-default list-unstyled py-1 ui-sortable-handle"
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="mr-25">
                                                <div class="round">
                                                    <input type="checkbox" id="checkbox-{{ $sub->id }}"
                                                        onchange="changeSubTaskStatue({{ $sub->id }})"
                                            ...
                                            <div class="ms-2">
                                                @if ($sub->task_status == 1)
                                                    ...
                                                    <span class="badge bg-light text-dark"
                                                        style="width: 48%">Completed :
                                                        {{ date('d F, Y', strtotime($sub->complete_date)) }}</span>-
                                                    <b>{{ $sub->sub_follow_up_code }}</b>
                                                @else
                                                    {{ $sub->note }} \ Created :
                                            ...
                                            <div class="text-end ms-auto">
                                                <div class="d-flex float-end">
                                                    <a href="javascript:void(0);" class="p-1 text-dark editsubtask"
                                                        onclick="openEditSubTaskModal({{ $sub->id }})"
                ...
                <a class="mt-2 select-id collapsed" data-bs-toggle="collapse"
                    ...
                    <span class="lh-lg" onclick="setSelectTwo({{ $i }})"> <i
                                ...
                                <div class="card-body">
                                    <form action="{{ route('add_follow_up_data') }}" id="add_follow_up_data"
                                        ...
                                        <div class="row align-items-center gap-3 mt-6">
                                            <div class="col-12 row align-items-center g-3">
                                                <label for="Subject" class="form-label col-md-2">Subject <span
                                        ...
                                        <div class="row align-items-center gap-3 mt-6">
                                            <div class="col-md-6 row align-items-center g-3">
                                                ...
                                                <label for="StartDate" class="form-label col-md-4">Start Date
                                                    <span class="text-danger">*</span></label>
                                                <div class="col-md-8 col-xl-6">
                                                    <input type="date" name="start_date"
                                                        class="form-control start_date" id="start_date" required
                                                        data-id="{{ $i }}" value="{{ date('Y-m-d') }}"
                                                        min="{{ date('Y-m-d') }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6 row align-items-center g-3">

                                                <label for="EndDate" class="form-label col-md-4">Due
                                                    Date</label>
                                                <div class="col-md-8 col-xl-6">
                                                    <input type="date" name="due_date" required
                                                        class="form-control" id="due_date_{{ $i }}"
                                        ...
                                        <div class="row align-items-center gap-3 mt-6">
                                            <div class="col-md-6 row align-items-center g-3">
                                                ...
                                                <label for="Assignees" class="form-label col-md-4">Assignees</label>
                                                <div class="col-md-8 col-xl-6">
                                            ...
                                            <div class="col-md-6 row align-items-center g-3">
                                                ...
                                                <label for="Priority" class="form-label col-md-4">Priority
                                                </label>
                                                <div class="col-md-8 col-xl-6">
                                        ...
                                        <div class="row align-items-center gap-3 mt-6">
                                            <div class="col-12 row align-items-center g-3">
                                                <label for="exampleFormControlTextarea1"
                                                    class="form-label col-md-2">Description</label>
                                                <div class="col-md-10 col-xl-6">
