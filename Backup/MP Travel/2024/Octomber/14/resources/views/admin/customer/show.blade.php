            ...
            <div class="row ">
                <div class="col-md-8">
                    ...
                    <div class="row align-items-center g-3 mt-6">
                        ...
                        @foreach ($aadharDocument as $aadhar)
                            <div class="col-md-2 col-xl-2">
                                <a href="{{ asset('storage/' . $aadhar->attachment) }}" target="_blank" class="btn btn-primary">View</a>
                            </div>
                        @endforeach
                    ...
                    <div class="row align-items-center g-3 mt-6">
                        ...
                        @foreach ($panDocument as $pan)
                            <div class="col-md-2 col-xl-2">
                                <a href="{{ asset('storage/' . $pan->attachment) }}" target="_blank" class="btn btn-primary">View</a>
                            </div>
                        @endforeach
                    ...
                    <div class="row align-items-center g-3 mt-6">
                        ...
                        @foreach ($gstDocument as $gst)
                            <div class="col-md-2 col-xl-2">
                                <a href="{{ asset('storage/' . $gst->attachment) }}" target="_blank" class="btn btn-primary">View</a>
                            </div>
                        @endforeach
                    ...
                    <div class="row align-items-center g-3 mt-6">
                        <div class="col-md-2"><label class="form-label mb-0">Passport</label></div>
                        @foreach ($passportDocument as $passport)
                            <div class="col-md-2 col-xl-2">
                                <a href="{{ asset('storage/' . $passport->attachment) }}" target="_blank" class="btn btn-primary">View</a>
                            </div>
                        @endforeach
                        @if ($customer->passport_file)
                            @if (json_decode($customer->passport_file) != null)
                                @foreach (json_decode($customer->passport_file) as $key => $gst)
                                    <div class="col-md-2 col-xl-2">
                                        <a href="{{ asset('storage/' . $gst) }}" target="_blank"
                                            class="btn btn-primary">View</a>
                                    </div>
