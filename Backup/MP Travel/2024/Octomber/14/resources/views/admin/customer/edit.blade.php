                ...
                <main class="container-fluid px-6 pb-10">
                    ...
                    <form action="{{ route('customer.update', $customer->id) }}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="col-md-6 row align-items-center g-3">
                                ...
                                <div class="col-md-2">
                                    <select name="name_title" class="form-select" id="name_title">
                                        <option value="Mr." {{ $customer->name_title == 'Mr.' ? 'selected' : '' }}> Mr.
                                        </option>
                                        <option value="Mrs." {{ $customer->name_title == 'Mrs.' ? 'selected' : '' }}> Mrs.
                                        </option>
                                        <option value="Miss" {{ $customer->name_title == 'Miss' ? 'selected' : '' }}> Miss
                                        </option>
                                        <option value="Ms." {{ $customer->name_title == 'Ms.' ? 'selected' : '' }}> Ms.
                                        </option>
                                        <option value="Dr." {{ $customer->name_title == 'Dr.' ? 'selected' : '' }}> Dr.
                                        </option>
                                    </select>
                                </div>
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            ...
                            <div class="col-md-6 row align-items-center g-3">
                                <div class="col-md-4"><label class="form-label mb-0">Phone Code <span
                                            class="text-danger required-msg">*</span></label></div>
                                    ...
                                    <select name="phone_code" id="phone_code" class="form-select">
                                        ...
                                        @foreach ($countryList as $country)
                                            <option value="{{ $country->phone_code }}"
                                                {{ $customer->phone_code == $country->phone_code ? 'selected' : '' }}
                                                data-id="{{ $country->iso2 }}">
                            ...
                            <div class="col-md-6 row align-items-center g-3">
                                ...
                                <div class="col-md-2 col-xl-2 gst_certificate_div">
                                    <label for="gst_certificate" class="btn btn-sm btn-neutral"><span>Upload</span>
                                        ...
                                        <input type="file" name="gst_certificate"[] id="gst_certificate"
                                            class="visually-hidden gst_certificate"
                                            value="{{ $customer->gst_certificate }}">
                                ...
                                @if (isset($customer->gst_certificate))
                                    @if (json_decode($customer->gst_certificate) != null)
                                        @php $gstArray = json_decode($customer->gst_certificate) @endphp
                                        @foreach ($gstArray as $gst)
                                            <div class="col-md-2 col-xl-2 adhar_image_div">
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            ...
                            <div class="col-md-6 row align-items-center g-3">
                                ...
                                <div class="col-md-8 col-xl-6">
                                    ...
                                    <input type="date" class="form-control" name="birth_date" id="birth_date"
                                        max="{{ date('Y-m-d') }}" value="{{ $customer->birth_date }}"
                            ...
                            <div class="col-md-6 row align-items-center g-3">
                                ...
                                <div class="col-md-8 col-xl-6">
                                    <input type="hidden" name="age" id="customer_age"
                                        value="{{ $customer->age }}">
                                    <span id="age_customer">{{ $customer->age }}</span>
                                    @error('age')
                                        <div class="text-danger required-msg">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 row align-items-center g-3">
                                ...
                                <div class="col-md-8 col-xl-6">
                                    ...
                                    <input type="text" name="pan_card_number" class="form-control"
                                        ...
                                        value="{{ $customer->pan_card_number }}">
                            ...
                            <div class="col-md-6 row align-items-center g-3">
                                ...
                                @if (isset($customer->pan_card_file))
                                    @if (json_decode($customer->pan_card_file) != null)
                                        @php $panFileArray = json_decode($customer->pan_card_file) @endphp
                                        @foreach ($panFileArray as $pan)
                                            <div class="col-md-2 col-xl-2 adhar_image_div">
                        ...
                        <div class="row align-items-center gap-3 mt-6" id="aadhar_card_div">
                            ...
                            <div class="col-md-6 row align-items-center g-3">
                                ...
                                <div class="col-md-8 col-xl-6-xl-4">
                            ...
                            <div class="col-md-6 row align-items-center g-3">
                                ...
                                @if (isset($customer->aadhar_card_file))
                                    @if (json_decode($customer->aadhar_card_file) != null)
                                        @php $aadharFileArray = json_decode($customer->aadhar_card_file) @endphp
                                        @foreach ($aadharFileArray as $aadhar)
                                            <div class="col-md-2 col-xl-2 adhar_image_div">
                                    ...
                                    @else
                                        <div class="col-md-2 col-xl-2 adhar_image_div">
                                            <a href="{{ asset('storage/' . $customer->aadhar_card_file) }}"
                                                target="_blank" class="btn btn-sm btn-dark"><span>View</span></a>
                                        </div>
                                    @endif
                                @endif
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            ...
                            <div class="col-md-6 row align-items-center g-3">
                                ...
                                @if (isset($customer->passport_file))
                                    @if (json_decode($customer->passport_file) != null)
                                        @php $passportFileArray = json_decode($customer->passport_file) @endphp
                                        @foreach ($passportFileArray as $passport)
                                            <div class="col-md-2 col-xl-2 adhar_image_div">
                                                <a href="{{ asset('storage/' . $passport) }}" target="_blank"
                                                    class="btn btn-sm btn-dark "><span>View</span></a>
                                            </div>
                                        @endforeach
                                    @else
