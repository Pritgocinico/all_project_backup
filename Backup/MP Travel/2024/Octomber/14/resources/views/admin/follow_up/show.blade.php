        ...
        <main class="container-fluid px-3 py-5 p-lg-6 p-xxl-8">
                    ...
                    <div class="col text-end">
                        ...
                        <ul class="dropdown-menu task-status">
                            ...
                            <li><a class="dropdown-item status lead_status_dropdown @if ($lead->lead_status == 4) d-none @endif"
                                    href="javascript:void(0)" data-status="4">Completed Lead</a></li>
            ...
            <div class="row g-3 mt-6">
                <div class="col-md-8">
                    ...
                    @else
                        ...
                        @if ($lead->travelLeadData)
                            ...
                            <div class="row align-items-center g-3 mt-6">
                                ...
                                <div class="col-md-2"><label class="form-label mb-0">Country Name</label></div>

                                <div class="col-md-4 col-xl-4">
                                    {{ ucfirst($lead->travelLeadData->document_country) }}
                                ...
                                @if (isset($documentCheckList) && $documentCheckList->document_file != null)
                                    ...
                                    <div class="col-md-4 col-xl-4">
                                        <a href="{{ asset('storage/' . $documentCheckList->document_file) }}"
                                            class="btn btn-dark" target="_blank">View</a>
                                    </div>
                                @endif
                            ...
                            @if ($lead->travelLeadData->travel_inquiry_type == 'flight')
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-4 col-xl-4">
                                        ...
                                        @endphp
                                        <span
                                            class="badge bg-{{ $class }}">{{ ucfirst($lead->travelLeadData->booking_status) }}</span>
                                    </div>
                                </div>
                            ...
                            @if ($lead->travelLeadData->travel_inquiry_type == 'visa')
                                ...
                                @if ($lead->travelLeadData->visa_rejection == 'yes')
                                    <div class="row align-items-center g-3 mt-6">
                                        <div class="col-md-2"><label class="form-label mb-0">Reject Country Name</label>
                                        </div>
                                ...
                                @if ($lead->travelLeadData->travel_other_services == 'yes')
                                    <div class="row align-items-center g-3 mt-6">
                                        <div class="col-md-2"><label class="form-label mb-0">Other Service
                                                Document</label>
                                        </div>
                            ...
                            @if ($lead->travelLeadData->travel_inquiry_type == 'domestic')
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-2"><label class="form-label mb-0">Travel Destination To</label>
                                    </div>
                            ...
                            @if ($lead->travelLeadData->travel_inquiry_type == 'international')
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-2"><label class="form-label mb-0">Transport Category</label>
                                    </div>
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    @if ($lead->travelLeadData->departure_date == 'flexible')
                                        <div class="row align-items-center g-3 mt-6">
                                            <div class="col-md-2"><label class="form-label mb-0">Month and Year</label>
                                            </div>
                                            <div class="col-md-4">
                                                {{ $lead->travelLeadData->flexible_month_year }}
                                            </div>
                                        ...
                                        <div class="row align-items-center g-3 mt-6">
                                            <div class="col-md-2"><label class="form-label mb-0">Number Of Day</label>
                                            </div>
                                            <div class="col-md-4">
                                                {{ $lead->travelLeadData->number_of_day }}
                                            </div>
                                    ...
                                    @if ($lead->travelLeadData->departure_date == 'fixed')
                                        <div class="row align-items-center g-3 mt-6">
                                            <div class="col-md-2"><label class="form-label mb-0">Fixed Date</label>
                                            </div>
                                            <div class="col-md-4">
                                                {{ $lead->travelLeadData->domestic_fixed_date }}
                                            </div>
                            ...
                            @if ($lead->travelLeadData->travel_inquiry_type == 'hotel')
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-2"><label class="form-label mb-0">Preferable Area for
                                            stay</label>
                                    </div>
                    ...
                    @endif
                    @if ($lead->hold_complete_date_time !== null)
                        <div class="row align-items-center g-3 mt-6">
                            <div class="col-md-2"> Hold Compelete At</div>

                            <div class="col-md-4">

                                {{ Utility::convertDmyAMPMFormat($lead->hold_complete_date_time) }}
                    ...
                    @if ($lead->lead_complete_date_time !== null)
                        <div class="row align-items-center g-3 mt-6">
                            <div class="col-md-2"> Completed Lead At</div>
                            ...
                            <div class="col-md-2">Completed Remarks</div>
                        ...
                        @if (isset($lead->travelLeadData) &&
                                $lead->travelLeadData->eligible_tcs_amount == 'yes' &&
                                $lead->travelLeadData->tcs_declaration_form !== '')
                            <div class="row align-items-center g-3 mt-6">
                                <div class="col-md-2">TCS Declaration Form</div>

                                <div class="col-md-4">
                                    <a href="{{ asset('storage/' . $lead->travelLeadData->tcs_declaration_form) }}"
                                        target="_blank" class="btn btn-dark">View</a>

                                </div>
                            </div>
                        @endif
                        <div class="row align-items-center g-3 mt-6">
                            <div class="col-md-2">Lead Check List</div>
                            <div class="col-md-2">
                                @forelse ($completeCheckList as $key=>$complete)
                                    {{ $key+1 }}. {{ isset($complete->checkListItem) ? $complete->checkListItem->name : "-" }}<br>
                                @empty
                                    -
                                @endforelse
                            </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="cus-card-body customer" style="background-color: #dfdfdf; display: block;">
                            <div class="timeline">
                                @foreach ($lead->followUpDetail as $followUp)
                                    <div>
                                        ...
                                        <span class="time">
                                                ...
                                                {{ Utility::convertDmyAMPMFormat($followUp->created_at) }}
    ...
    <div class="modal fade" id="depositLiquidityModal" tabindex="-1" aria-labelledby="depositLiquidityModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            ...
            <div class="modal-content overflow-hidden">
                ...
                <form class="vstack" method="POST" id="completeLeadForm" enctype="multipart/form-data">
                            ...
                            <div id="customer_data_Model_div" class="d-none">
                                    ...
                                    @if ($customer->pan_card_number == null)
                                        ...
                                        <div class="col-md-3 col-xl-3">
                                            <input type="text" name="pan_card_number" class="form-control"
                                                id="pan_card_number" placeholder="Enter Pan Card Number" multiple>
                                ...
                                @if ($lead->invest_type == 'travel')
                                    <div class="row align-items-center g-3 mt-6">
                                        ...
                                        @if ($customer->passport_file == null)
                                            ...
                                            <div class="col-md-3 col-xl-3">
                                                <input type="file" name="passport_file[]" class="form-control" multiple>
                                            </div>
                                        @endif
                                    </div>
                                @endif
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    <div class="col-md-3"><label class="form-label mb-0">Lead Customer Type<span
                                                class="error_span">*</span></label></div>
                                    <div class="col-md-3">
                                        <select class="form-select" name="lead_customer_type" id="lead_customer_type">
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    <div class="col-md-3">Lead Check List 1</div>
                                    <div class="col-md-1">
                                        <input type="checkbox" name="completed_lead_check[]" id="completed_lead_check_1" class="form-control">
                                    </div>
                                    <div class="col-md-3">
                                        <select class="form-select" name="completed_lead_id[]" id="completed_lead_id_1" onchange="getOtherOption(1)">
                                            <option value="">Select</option>
                                            @foreach ($leadCheckListItem as $item)
                                                <option value="{{ $item->id }}">{{ $item->name }}</option>        
                                            @endforeach
                                            <option value="other">Other</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3 other_option_div_1 d-none">
                                        <input type="text" name="other_option[]" id="other_option_1" class="form-control" placeholder="Enter Other Option">
                                    </div>
                                    <div class="col-md-2">
                                        <a href="javascript:void(0)" id="addMoreCheckList" class="btn btn-dark">Add More</a>
                                    </div>
                                </div>
                                <div class="add_more_check_div"></div>
                            </div>
                            <div class="row align-items-center g-3 mt-6">
    ...
    <div class="modal fade" id="otherModalProcess" tabindex="-1" aria-labelledby="otherModalProcessLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            ...
            <div class="modal-content overflow-hidden">
                ...
                <form class="vstack" method="POST" id="updateLeadStatus" enctype="multipart/form-data">
                    ...
                    <div class="modal-body undefined">
                        ...
                        <div class="vstack gap-1">
                            ...
                            <div class="row align-items-center g-3 mt-6 hold_complete_date_time_div d-none">
                                <div class="col-md-2"><label class="form-label mb-0">Hold Complete Time<span
                                            class="error_span">*</span></label></div>
                                <div class="col-md-10 col-xl-10">
                                    <input type="datetime-local" name="hold_complete_date_time"
                                        id="hold_complete_date_time" class="form-control"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-dark otherSaveButtonStatus"
                            id="submitBtn">Submit</button>
                    </div>
...
@section('script')
    <script>
        ...
        $('.lead_status_dropdown').on('click', function(e) {
            ...
            $('.hold_complete_date_time_div').addClass('d-none')

            $('#customer_data_Model_div').addClass('d-none')
            if (status == 4) {

                var headerModalText = "Completed Lead Remark";
            ...
            if (status == 3) {
                ...
                $('.hold_complete_date_time_div').removeClass('d-none')
        ...
        $('.completeSaveButtonStatus').on('click', function(e) {
            e.preventDefault();
            ...
            Swal.fire({
                ...
                var formData = new FormData($('#completeLeadForm')[0]);
        ...
        $('.otherSaveButtonStatus').on('click', function(e) {
            e.preventDefault();
            ...
            Swal.fire({
                ...
                var formData = new FormData($('#updateLeadStatus')[0]);
        ...
        function getOtherOption(id){
            var type = $(`#completed_lead_id_${id}`).val();
            $(`#completed_lead_check_${id}`).attr('checked',true)
            $(`.other_option_div_${id}`).addClass('d-none');

            if (type == "other") {
                $(`.other_option_div_${id}`).removeClass('d-none');
            }
        }
        var numberCheck = 1;
        $('#addMoreCheckList').on('click', function(e) {
            e.preventDefault();
            numberCheck = numberCheck + 1;
            var html = `<div id="add_more_check_list_${numberCheck}"><div class="row align-items-center g-3 mt-6">
                                    <div class="col-md-3">Lead Check ${numberCheck}</div>
                                    <div class="col-md-1">
                                        <input type="checkbox" name="completed_lead_check[]" id="completed_lead_check_${numberCheck}" class="form-control">
                                    </div>
                                    <div class="col-md-3">
                                        <select class="form-select" name="completed_lead_id[]" id="completed_lead_id_${numberCheck}" onchange="getOtherOption(${numberCheck})">
                                            <option value="">Select</option>
                                            @foreach ($leadCheckListItem as $item)
                                                <option value="{{ $item->id }}">{{ $item->name }}</option>        
                                            @endforeach
                                    ...
                                    <div class="col-md-3 other_option_div_${numberCheck} d-none">
                                        <input type="text" name="other_option[]" id="other_option_${numberCheck}" class="form-control" placeholder="Other Option">
                                    </div>
                                    <div class="col-md-2">
                                        <a href="javascript:void(0)" onclick="removeAddMoreCheck(${numberCheck})" class="btn btn-dark">Remove</a>
                                    </div>
                                </div>
                                </div>
                            </div>`;
                            $('.add_more_check_div').append(html);
        })
        function removeAddMoreCheck(number){
            $('#add_more_check_list_'+number).remove();
        }
    </script>
@endsection
