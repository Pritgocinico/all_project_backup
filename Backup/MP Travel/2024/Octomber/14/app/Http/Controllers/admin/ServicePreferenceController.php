...
use App\Http\Requests\CreateServicePreferenceRequest;
use App\Models\Log;
...

{
    ...
    public function store(CreateServicePreferenceRequest $request)
    ...
    public function update(CreateServicePreferenceRequest $request, ServicePreference $servicePreference)
...

    {
        ...
        $servicePreferenceList = $this->servicePreference->latest()->get();
