...
<div id="travel_div" style="display: @if ($type !== 3) none @endif;">
    ...
    <div class="row align-items-center g-3 mt-6">
        ...
        <div class="col-md-2"><label class="form-label mb-0">Number Of Pax</label></div>
        <div class="col-md-4 col-xl-4">
        ...
        <div class="col-md-4 col-xl-4">
            <select name="other_services[]" class="form-control" id="other_services" multiple>
                ...
                <option value="domestic_air_ticket"
                    {{ str_contains($travelData->other_service, 'domestic_air_ticket') ? 'selected' : '' }}>
                    Domestic
                    Air Ticket</option>
                <option value="visa" {{ str_contains($travelData->other_service, 'visa') ? 'selected' : '' }}>
                    Visa
                </option>
                ...
                <option value="rent_cab"
                    {{ str_contains($travelData->other_service, 'rent_cab') ? 'selected' : '' }}>Rent a Cab
                </option>
    ...
    <div class="row align-items-center g-m mt-6">
        ...
        <div class="col-md-4 col-xl-4">
            <select name="travel_mode" id="travel_mode" class="form-control">
                ...
                <option value="individual" {{ $travelData->travel_mode == 'individual' ? 'selected' : '' }}>
                    Individual</option>
            </select>
        </div>
        <div class="col-md-2"><label class="form-label mb-0">Other Attachment</label></div>
        <div class="col-md-4 col-xl-4">
            <input type="file" name="travel_other_attachment[]" id="travel_other_attachment" multiple
                class="form-control">
        </div>
    </div>
    <div class="row align-items-center g-3 mt-6">
    ...
    <div class="lead_child_travel_div_{{ $travel->id }}">
        <input type="hidden" name="lead_travel_id[]" value="{{ $travel->id }}">
        <div class="row align-items-center g-3 mt-6">
            <div class="col-md-4">
            ...
            <div class="col-md-3">
                ...
                <input type="number" class="form-control" name="child_age[]" placeholder="Enter Age"
                    value="{{ $travel->child_age }}">
            </div>
            <div class="col-md-1">
                <a href="javascript:void(0)" class="btn btn-primary btn-sm " id="remove_add_child_option"
                    onclick="removeTravelChildData({{ $travel->id }})"
                    data-id="{{ $travel->id }}"><i class="fa-solid fa-trash-can"></i></a>
            </div>
        </div>
        <div class="row align-items-center g-3 mt-6">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" name="passport_number[]"
                    value="{{ $travel->passport_number }}" placeholder="Enter Passport Number"
                    id="passport_number">
            </div>
            <div class="col-md-2">
                <label class="form-label btn-neutral">Passport File</label>
                <div class="hstack">

                    <label for="file_upload" class="btn btn-sm btn-neutral"><span>Upload</span>

                        <input type="file" name="passport_file" id="file_upload"
                            class="visually-hidden passport_file" value="">
            ...
            @if(isset($travel->passport_file))
            <div class="col-md-1 passport_file_view_{{ $travel->id }}">
                <a href="{{ asset('storage/' . $travel->passport_file) }}" class="btn btn-dark btn-sm" target="_blank"><i class="fa-solid fa-eye"></i></a>
            </div>
            <div class="col-md-1 passport_file_remove_{{ $travel->id }}">
                <a href="javascript:void(0)" class="btn btn-primary btn-sm " id="remove_add_child_option"
                    onclick="removePassportFile({{ $travel->id }})"
                    data-id="{{ $travel->id }}"><i class="fa-solid fa-trash-can"></i></a>
            </div>
            @endif
        </div>
