...
class LeadController extends Controller
{
    ...
    public function store(CreateLeadRequest $request)
    {
        ...
        if ($insert) {
            if ($request->invest_type == "investments") {
                ...
                $travelLead->name = $request->client_name;
                ...
                if (isset($request->other_services)) {
            ...
            if ($request->child_type !== null) {
                foreach ($request->child_type as $key => $child) {
                    ...
                    if (isset($request->passport_file[$key])) {
                        ...
                        $leadTravelDetail->passport_file = $pathLogo2;
                    }
            ...
            $leadDetail = $this->lead->find($lead->id);
            $leadData = [
                'lead' => $leadDetail,
    ...
    public function show(string $id)
    {
        ...
        if ($lead) {
            ...
            return view('admin.lead.show', compact('lead', 'userList','customer'));
        }
        ...
        if ($update) {
            ...
            if ($lead->invest_type == "travel") {
                ...
                if($travelLead){   
                    ...
                    $travelLead->tcs_amount = $request->tcs_amount;
                    $travelLead->save();
                }
            }
            Log::create([
