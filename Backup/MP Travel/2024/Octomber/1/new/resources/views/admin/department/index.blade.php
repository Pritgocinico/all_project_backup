        ...
        <div class="modal fade" id="addDepartmentModal" tabindex="-1" aria-labelledby="depositLiquidityModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content overflow-hidden">
                    ...
                    <form class="vstack" method="POST" id="addForm" action="#">
                        @csrf
        ...
        <div class="modal fade" id="editDepartmentModal" tabindex="-1" aria-labelledby="depositLiquidityModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content overflow-hidden">
                    ...
                    <form class="vstack" method="POST" id="updateForm" action="#">
                        @csrf
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-10 col-xl-10">
                                        <input type="text" name="name" class="form-control" id="edit_name"
                                            placeholder="Enter Department Name">
                                        <span class="error_span" id="edit_name_error"></span>
                                    </div>
                                </div>
...
@section('script')
    <script>
        ...
        function updateDepartment() {
            ...
            if (name.trim() == "") {
                $('#edit_name').focus();
                $('#edit_name_error').html("Please Enter a Name")
                editDepartment(id)
