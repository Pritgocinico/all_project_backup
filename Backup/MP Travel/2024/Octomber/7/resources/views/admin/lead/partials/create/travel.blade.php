<div id="travel_div" style="display:  @if (old('invest_type') !== 'travel') none @endif;">
    ...
    <div class="row align-items-center g-3 mt-6">
        ...
        <div class="col-md-4 col-xl-4">
            <input type="text" name="client_name" class="form-control" value="{{old('client_name')}}" placeholder="Enter Client Name">
            @error('client_name')
    ...
    <div class="row align-items-center g-3 mt-6">
        ...
        <div class="col-md-4 col-xl-4">
            <input type="number" name="number_of_prex" class="form-control" placeholder="Enter Number of Prex" min="0">
    ...
    <div class="row align-items-center g-3 mt-6">
        ...
        <div class="col-md-4 col-xl-4">
            <select name="other_services[]" class="form-control" id="other_services" multiple>
                ...
                <option value="domestic_air_ticket" {{in_array('domestic_air_ticket', old('other_services')?? []) ? 'selected' : '' }}>Domestic Air Ticket</option>
                <option value="visa" {{in_array('visa', old('other_services')?? []) ? 'selected' : '' }}>Visa</option>
                <option value="railway_ticket" {{in_array('railway_ticket', old('other_services')?? []) ? 'selected' : '' }}>Railway Ticket</option>
                <option value="hotel" {{in_array('hotel', old('other_services')?? []) ? 'selected' : '' }}>Hotel</option>
                <option value="passport" {{in_array('passport', old('other_services')?? []) ? 'selected' : '' }}>Passport</option>
                <option value="rent_cab" {{in_array('rent_cab', old('other_services')?? []) ? 'selected' : '' }}>Rent a Cab</option>
                <option value="other" {{in_array('other', old('other_services') ?? []) ? 'selected' : '' }}>Other</option>
            </select>
