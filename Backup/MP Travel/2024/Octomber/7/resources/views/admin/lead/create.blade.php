            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var html = address +" " + cityName + " " + stateName + " " +
                        countryName + "  " + pinCode;
                        if(cityName == "" && stateName == "" && countryName == "" && address == "" && pinCode == ""){
                            html = "-";
                    }
                    ...
                    var tagCreate = "-";
                    var tagAt = "-";
                    if (res.last_service_take !== null) {
                        if(res.last_service_take.service_preference_detail !== null){
                            tagName = res.last_service_take.service_preference_detail.name;
                        }
                        if(res.last_service_take.service_preference_detail !== null){
                            tagCreate = res.last_service_take.user_detail.name;
                        }
                        tagAt = moment(res.last_service_take.created_at).format("DD-MM-YYYY hh:mm:ss A")
                    }
                    $('#last_service_take').html(tagName);
                    $('#last_service_create_by').html(tagCreate);
                    $('#last_service_create_at').html(tagAt);
