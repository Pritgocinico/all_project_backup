...

{
...

    {
        ...
        $menus = ['dashboard', 'department', 'designation', 'role', 'user','Service Preference', 'customer', 'info sheet', 'holiday', 'leave', 'ticket', 'attendance', 'daily attendance', 'certificate', 'pay salary', 'shift', 'lead','follow_up','log','document_checklist'];
