<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4">
        <input type="date" name="visa_travel_date" class="form-control" value="{{ isset($travelData) && $travelData->visa_travel_date }}"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4">
        <input type="text" name="duration_of_stay" class="form-control" value="{{ isset($travelData) && $travelData->duration_of_stay }}"
...
<div class="row align-items-center g-3 mt-6">
        ...
        <select name="travel_country" class="form-select" id="travel_country">
            ...
            @foreach ($countryList as $country)
                <option value="{{ $country->iso2 }}"
                    {{ isset($travelData) && $travelData->travel_country == $country->iso2 ? 'selected' : '' }}>{{ $country->name }}
                </option>
            @endforeach
        </select>
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="purpose_of_travel" class="form-control"
            value="{{ isset($travelData) && $travelData->purpose_of_travel }}" placeholder="Enter Purpose of Travel">
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="visa_type" class="form-control" id="visa_type"
            value="{{ isset($travelData) && $travelData->visa_type }}" placeholder="Enter Visa Type">
        @error('visa_type')
            <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="col-md-4 col-xl-4">
        <select name="expense_bearer" class="form-select" id="expense_bearer">
            ...
            <option value="Yes" {{ isset($travelData) && $travelData->expense_bearer == 'Yes' ? 'selected' : '' }}>Yes</option>
            <option value="No" {{ isset($travelData) && $travelData->expense_bearer == 'No' ? 'selected' : '' }}>No</option>
        </select>
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <select name="first_time_traveler" class="form-select" id="first_time_traveler"
            ...
            <option value="Yes" {{ isset($travelData) && $travelData->first_time_traveler == 'Yes' ? 'selected' : '' }}>Yes</option>
            <option value="No" {{ isset($travelData) && $travelData->first_time_traveler == 'No' ? 'selected' : '' }}>No</option>
        </select>
    ...
    <div class="col-md-4 col-xl-4 show_travel_history_div d-none">
        <textarea class="form-control" name="travel_history" placeholder="Enter Travel History">{{ isset($travelData)  ?$travelData->travel_history : "" }}</textarea></textarea>
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <select name="visa_rejection" class="form-select" id="visa_rejection" onchange="showVisaRejectionDetail()">
            <option value="">Select Expense bearer</option>
            <option value="Yes" {{ isset($travelData) && $travelData->visa_rejection == 'Yes' ? 'selected' : '' }}>Yes</option>
            <option value="No" {{ isset($travelData) && $travelData->visa_rejection == 'No' ? 'selected' : '' }}>No</option>
        </select>
    ...
    <div class="col-md-4 col-xl-4">
        <select name="travel_other_services" class="form-select" id="travel_other_services">
            <option value="">Select Country</option>
            <option value="yes" {{ isset($travelData) && $travelData->travel_other_services == 'yes' ? 'selected' : '' }}>Yes</option>
            <option value="no" {{ isset($travelData) && $travelData->travel_other_services == 'no' ? 'selected' : '' }}>No</option>
        </select>
...
<div class="row align-items-center g-3 mt-6 visa_rejection_detail_div d-none">
    ...
    <div class="col-md-4 col-xl-4">
        <select name="visa_rejection_country" class="form-select" id="visa_rejection_country">
            ...
            @foreach ($countryList as $country)
                <option value="{{ $country->iso2 }}"
                    {{ isset($travelData) && $travelData->visa_rejection_country == $country->iso2 ? 'selected' : '' }}>{{ $country->name }}
                </option>
            @endforeach
        </select>
    ...
    <div class="col-md-4 col-xl-4">
        <textarea class="form-control" name="visa_rejection_reason" placeholder="Enter Visa Rejection Reason">{{ isset($travelData) && $travelData->visa_rejection_reason }}</textarea></textarea>
