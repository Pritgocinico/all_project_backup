    ...
    */
    ...
    protected function authenticated(Request $request, $user)
    {
        ...
        if ($id != 1) {
            ...
            if ($attendance !== null) {
                $data['status'] = UtilityHelper::calculateHalfDay();
                ...
                $data = [
                    'status' => UtilityHelper::calculateHalfDay(),
                    'login_time' => Carbon::now(),
        ...
        if ($id != 1) {
            ...
            if ($attendance !== null) {
                if ($attendance->login_time != null) {
                    ...
                    $totalWorkHour =UtilityHelper::getHourBetweenTwoTimes($attendance->login_time,$attendance->logout_time,Auth()->user()->id);
                    $status = "0";
