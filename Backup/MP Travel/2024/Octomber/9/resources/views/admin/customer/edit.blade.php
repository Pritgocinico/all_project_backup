                            ...
                            <div class="col-md-6 row align-items-center g-3">
                                ...
                                <div class="col-md-2">
                                    <select name="name_title" class="form-select" id="name_title">
                                        <option value="Mr." {{ $customer->name_title == 'Mr.' ? 'selected' : ''}}> Mr.</option>
                                        <option value="Mrs." {{ $customer->name_title == 'Mrs.' ? 'selected' : ''}}> Mrs.</option>
                                        <option value="Miss" {{ $customer->name_title == 'Miss' ? 'selected' : ''}}> Miss</option>
                                        <option value="Ms." {{ $customer->name_title == 'Ms.' ? 'selected' : ''}}> Ms.</option>
                                        <option value="Dr." {{ $customer->name_title == 'Dr.' ? 'selected' : ''}}> Dr.</option>
                                    </select>
                                </div>
