<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4">
        <input type="text" name="travel_destination" class="form-control" value="{{ $travelData->travel_destination }}"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 flexible_date_select {{ $travelData->departure_date == 'flexible' ? '' : 'd-none' }}">
        <input type="text" name="domestic_monthYear" class="form-control" id="monthYear"
            value="{{ $travelData->flexible_month_year }}" placeholder="Select Month and Year">
    </div>
    ...
    <div class="col-md-4 fixed_date_select {{ $travelData->departure_date == 'fixed' ? '' : 'd-none' }}">
        <input type="text" name="domestic_fixed_date" class="form-control" id="domestic_fixed_date"
            value="{{ $travelData->domestic_fixed_date }}" placeholder="Select Month and Year">
    </div>
    ...
    <div class="col-md-4 any_time_date_select {{ $travelData->departure_date == 'anytime' ? '' : 'd-none' }}">
        <input type="text" name="any_time_days" class="form-control" id="any_time_days"
            value="{{ $travelData->number_of_day }}" placeholder="Enter Number Of Days">
    </div>
</div>

<div
    class="row align-items-center g-3 mt-6 flexible_date_select {{ $travelData->departure_date == 'flexible' ? '' : 'd-none' }}">
    <div class="col-md-2">
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="travel_type" class="form-control" id="travel_type"
            value="{{ $travelData->travel_type }}" placeholder="Enter Travel Type">
        @error('travel_type')
            <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="hotel_category" class="form-control" id="hotel_category"
            placeholder="Enter Hotel Category" value="{{ $travelData->hotel_category }}">
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" class="form-control" name="meal_plan_preference"
            placeholder="Enter Meal Plan Preference" value="{{ $travelData->meal_plan_preference }}"></textarea>
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="transport_category" class="form-control"
            value="{{ $travelData->transport_category }}" placeholder="Enter Transport Category">
        ...
        <select name="domestic_other_services" class="form-select" id="domestic_other_services">
            ...
            @foreach ($serviceList as $service)
                <option value="{{ $service->id }}"
                    {{ $travelData->domestic_other_services == $service->id ? 'selected' : '' }}>{{ $service->name }}
                </option>
            @endforeach
        </select>
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-10 col-xl-10">
        <textarea name="domestic_other_services_remarks" id="domestic_other_services_remarks"class="form-control"
            placeholder="Enter Other Services Remarks">{{ $travelData->domestic_other_services_remarks }}</textarea>
