<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="hotel_duration_stay" class="form-control" value="{{ $travelData->duration_of_stay }}"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="area_stay" class="form-control" id="area_stay"
            placeholder="Enter Preferable Area for stay" value="{{$travelData->inquiry_date}}">
        @error('area_stay')
            <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" class="form-control" name="hotel_hotel_category" placeholder="Enter Hotel Category"
            value="{{ $travelData->hotel_category }}"></textarea>
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="hotel_meal_plan" class="form-control" value="{{ $travelData->meal_plan_preference }}"
