                ...
                <main class="container-fluid px-6 pb-10">
                    ...
                    <form action="{{ route('leave.update', $leave->id) }}" enctype="multipart/form-data" method="POST">
                        ...
                        @else
                            <div class="row align-items-center gap-3 mt-6">
                                <div class="col-md-6 row align-items-center g-3">
                                    <div class="col-md-4"><label class="form-label mb-0">User<span
                                        ...
                                        <select name="user_id" class="form-control" id="user_id">
                                            ...
                                            @foreach ($userList as $user)
                                                <option value="{{ $user->id }}"
                                                    @if ($leave->user_id == $user->id) selected @endif>{{ $user->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('user_id')
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            ...
                            <div class="col-md-6 row align-items-center g-3">
                                <div class="col-md-4"><label class="form-label mb-0">Leave Type</label></div>
                                ...
                                <div class="col-md-8 col-xl-6">
                                    ...
                                    <select name="leave_type" class="form-control">
                                        ...
                                        <option value="sick_leave" @if ($leave->leave_type == 'sick_leave') selected @endif>Sick
                                            Leave

                                        </option>

                                        <option value="casual_leave" @if ($leave->leave_type == 'casual_leave') selected @endif>
                                            Casual
                            ...
                            <div class="col-md-6 row align-items-center g-3">
                                <div class="col-md-4"><label class="form-label mb-0">Leave Feature</label></div>
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            <div class="col-md-6 row align-items-center g-3">
                                <div class="col-md-4"><label class="form-label mb-0">Leave From</label></div>

                                <div class="col-md-8 col-xl-6">

                                    <input type="date" name="leave_from" class="form-control"
                                        placeholder="Enter Leave From" min="{{ $leave->leave_from }}" id="leave_from"
                            ...
                            <div class="col-md-6 row align-items-center g-3">
                                <div class="col-md-4"><label class="form-label mb-0">Leave To</label></div>

                                <div class="col-md-8 col-xl-6">

                                    <input type="date" name="leave_to" class="form-control"
                                        placeholder="Enter Leave From" min="{{ date('Y-m-d') }}" id="leave_to"
                        ...
                        <div class="row align-items-center gap-3 mt-6">
                            <div class="col-md-6 row align-items-center g-3">
                                <div class="col-md-4"><label class="form-label mb-0">Leave Reason</label></div>
                            ...
                            <div class="col-md-6 row align-items-center g-3">
                                <div class="col-md-4"><label class="form-label mb-0">Attachment</label></div>

                                <div class="col-md-8 col-xl-6">

                                    <label for="attachment" class="btn btn-sm btn-neutral"><span>Upload</span>

                                        <input type="file" name="attachment" id="attachment"
                                            class="visually-hidden attachment" value="{{ $leave->attachment }}">
                                ...
                                <div class="col-md-2 col-xl-2">
                                    @if (isset($leave->attachment))
                                        <a href="javascript:void(0)" class="btn btn-sm btn-danger remove_document"
                                            data-type="attachment"><span>Remove</span></a>
                                    @endif
                                </div>
                            </div>
...
@section('script')
    <script>
        $('#attachment').on('change', function() {
            ...
            $('#attachment_preview').html(resultString);
