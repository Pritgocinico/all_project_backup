                                    ...
                                    @if (Auth()->user()->role_id == 1)
                                        <select name="invest_type" class="form-control" id="invest_type">
                                            ...
                                            <option value="investments"
                                                @if (old('invest_type') == 'investments') {{ 'selected' }} @endif>Investments
                                            </option>
                                            <option value="general insurance"
                                                @if (old('invest_type') == 'general insurance') {{ 'selected' }} @endif>General
                                                Insurance</option>
                                            <option value="travel"
                                                @if (old('invest_type') == 'travel') {{ 'selected' }} @endif>Travel</option>
                                        </select>
                                    @else
                                ...
                                <div class="row justify-content-end">
                                    <div class="col-md-2">
                                        <a href="javascript:void(0)" id="add_more_button"
                                            class="btn btn-sm btn-primary">Add More</a>
                                    </div>
                                </div>
                ...
                <form class="vstack" method="POST" id="addForm">
                    ...
                    <div class="modal-body undefined">
                        <div class="vstack gap-1">
                            ...
                            <div class="row align-items-center g-3 mt-6" id="aadhar_card_div" style="display: none">
