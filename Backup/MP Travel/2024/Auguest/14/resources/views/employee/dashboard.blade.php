                            ...
                            <a href="{{ route('leads.index') }}?type=assign">
                                <div class="card bg-style1">
                                    <div class="p-7 dashboard-inner-card">
                                        <div>
                                            <span class="d-block h3">{{ $assignLead }}</span>
                        ...
                        <div class="col">
                            <a href="{{ route('leads.index') }}?type=create">
                                <div class="card bg-style2">
                                    <div class="p-7 dashboard-inner-card">
                                        <div>
                                            <span class="d-block h3">{{ $createdLead }}</span>
                        ...
                        <div class="col">
                            <a href="{{ route('follow-up.index') }}">
                                <div class="card bg-style3">
                                    <div class="p-7 dashboard-inner-card">
                                        <div>
                                            <span class="d-block h3">{{ $followUpCount }}</span>
                        ...
                        <div class="col">
                            <a href="{{ route('salary-slip.index') }}">
                                <div class="card bg-style3">
                                    <div class="p-7 dashboard-inner-card">
                                        <div>
                                            <span class="d-block h3">{{ $salarySlipMonth?$salarySlipMonth->month: 0 }}</span>
                    ...
                    <div class="inner-single-card">
                        <div class="card">
                            <div class="card-body d-flex flex-center flex-column  em-dashbord-counter">
                                ...
                                <div class="d-flex flex-center gap-6">
                                    <div class="border border-gray-300 border-dashed rounded mr-0 min-w-80px py-3 px-4 emp-dash-attadance">
                                        <div class="fs-6 fw-bold text-gray-700" id="working_day" style="font-size: 36px;"></div>
                                        <div class="fw-semibold text-gray-500">Total Working Days</div>
                                    </div>
                                    <div class="border border-gray-300 border-dashed rounded mr-0 min-w-80px py-3 px-4 emp-dash-attadance">
                                        <div class="fs-6 fw-bold text-gray-700" id="present_count" style="font-size: 36px;"></div>
                                        <div class="fw-semibold text-gray-500">Present Days</div>
                                    </div>

                                    <div class="border border-gray-300 border-dashed rounded mr-0 min-w-80px py-3 px-4 emp-dash-attadance">
                                        <div class="fs-6 fw-bold text-gray-700" id="absent_count" style="font-size: 36px;"></div>
                                        <div class="fw-semibold text-gray-500">Absent Days</div>
                                    </div>

                                    <div class="border border-gray-300 border-dashed rounded mr-0 min-w-80px py-3 px-4 emp-dash-attadance">
                                        <div class="fs-6 fw-bold text-gray-700" id="leave_balance" style="font-size: 36px;"></div>
                        ...
                        <div class="card bg-style2">
                            <div class="px-6 px-lg-7 pt-6 pb-5">
                                ...
                                <div id="lead_table_ajax" class="table-responsive custom-scrollbar">
                                    <table class="table table-hover table-sm table-nowraps mt-6 border dataTable no-footer" id="lead_table">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Lead</th>
                        ...
                        <div class="card bg-style2">
                            <div class="pb-5 px-6 px-lg-7 pt-6">
                                ...
                                <div id="follow_up_ajax" class="table-responsive custom-scrollbar">
                                    <table class="table table-hover table-sm table-nowraps mt-6 border dataTable no-footer"
                                        id="follow_up_table">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                        ...
                                        <tbody>
                                            @forelse ($followUpList as $key=>$follow)
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        @if (collect($accesses)->where('menu_id', '19')->first()->status == 2)
                                                            <div class="dropdown"><a class="text-bg-dark rounded-circle"
                                                                    href="#" role="button"
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <a class="dropdown-item text-dark"
                                                                        href="{{ route('follow-up.edit', $follow->id) }}"><i
                                                                            class="bi bi-pencil-square me-3"></i>Edit
                                                                        Follow Up</a>
                                                                    <div class="dropdown-divider"></div>
                                                                    <a class="dropdown-item text-dark"
                                                                        href="javascript:void(0)"
                                                                        onclick="deleteFollow({{ $follow->id }})"><i
                                                                            class="bi bi-trash me-3"></i>Delete Follow Up
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        @endif
