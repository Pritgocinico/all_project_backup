...
class SalarySlipController extends Controller
{
    ...
    public function generateSalarySlip(Request $request)
    {
        ...
        if (isset($employee)) {
            ...
            $dompdf = new Dompdf();
            $viewFile = view('admin.pdf.salary_slip', compact('totalLeave','holidayCount','shiftDetail', 'salaryDetail', 'employee', 'deductionDetail', 'departmentDetail', 'designationDetail'))->render();
