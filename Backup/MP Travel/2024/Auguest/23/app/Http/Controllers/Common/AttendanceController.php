...
class AttendanceController extends Controller
{
    ...
    public function dailyAttendance()
    {
        ...
        $dailyAttendanceListsPaginated = $employees->map(function ($employee) use ($attendances,$today) {
    ...
    public function attendanceExport(Request $request){
        ...
        if ($request->format == "pdf") {
            ...
            $html = view('admin.pdf.attendance', ['userList'=>$userList,'attendanceData' => $attendanceData, 'mainLogoUrl' => $mainLogoUrl])->render();
    ...
    public function dailyAttendanceExport(Request $request){
        ...
        if ($request->format == "pdf") {
            $mainLogoUrl = asset('storage/logo/UQcj8rCZqMmTVJ89a4zx0Vzz7UZ5AtbbWazxf2cd.png');
            $html = view('admin.pdf.daily_attendance', ['dailyAttendanceLists'=>$dailyAttendanceLists, 'mainLogoUrl' => $mainLogoUrl])->render();
