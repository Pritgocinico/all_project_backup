    ...
    <div
        ...
        <main class="container-fluid p-0">
                    ...
                    <div class="hstack gap-2 ms-auto">
                        ...
                        @if(Auth()->user()->role_id !== 2)
                            <a href="#" class="btn btn-sm btn-dark" data-bs-toggle="modal"
                                ...
                                Export</a>
                            @endif
                            <a href="{{ route('customer.create') }}?type={{ $type }}" class="btn btn-sm btn-dark"><i
                                    class="bi bi-plus-lg me-2"></i>
                                Create Customers</a>
                        @endif
                    </div>
            ...
            <div class="px-6 px-lg-7 pt-8">
                <div id="customer_table_ajax" class="mt-6 table-responsive custom-scrollbar">
