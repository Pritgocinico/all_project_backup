                    ...
                    <div class="hstack gap-2 ms-auto">
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-user-table-filter="search" id="search_data"
                                class="form-control w-250px ps-13" onkeyup="salaryslipAjax()"
                                placeholder="Search Salary Slip" />
                        </div>
            ...
            <div class="modal-content overflow-hidden">
                ...
                <form class="vstack" method="POST" id="addForm" action="{{ route('salary-slip.store') }}">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" onclick="createGenerateSlip()" class="btn btn-primary" id="submitBtn">Submit</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-content overflow-hidden">
                ...
                <form id="" class="form" action="#">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="submitExport" onclick="exportCSV()">Submit</button>
                    </div>
                </form>
            </div>
        </div>
