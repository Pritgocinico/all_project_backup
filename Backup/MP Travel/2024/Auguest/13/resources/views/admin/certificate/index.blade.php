            ...
            <div class="px-6 px-lg-7 pt-8 border-bottom">
                <div class="d-flex align-items-center mb-5">
                    ...
                    <div class="hstack gap-2 ms-auto">
                        ...
                        <a href="#" class="btn btn-sm btn-dark" id="export_modal" data-bs-toggle="modal" data-bs-target="#kt_modal_export_users"
                ...
                @elseif(collect($accesses)->where('menu_id', '14')->first()->status == 1 || collect($accesses)->where('menu_id', '14')->first()->status == 3)
                    <ul class="nav nav-tabs nav-tabs-flush gap-8 overflow-x border-0 mt-4">
                        <li class="nav-item">
            ...
            <div class="">
                <div>
                    ...
                    <div id="generate-certificate-section"
                        @if (collect($accesses)->where('menu_id', '14')->first()->status == 2) style="" @else style="display: none;" @endif>
                    ...
                    <div id="certificate-list-section"
                        @if (collect($accesses)->where('menu_id', '14')->first()->status == 1 || collect($accesses)->where('menu_id', '14')->first()->status == 3) @else  style="display: none;"   @endif>
                        <div class="px-6 px-lg-7 pt-6">
