<div class="d-none d-lg-flex py-3">
    <div class="row align-items-center g-3 ms-5">
        <h4>Hello, {{Auth()->user()->name}} <span style="font-size: 1rem">{{ isset(Auth()->user()->departmentDetail)? " ( ". Auth()->user()->departmentDetail->name  . " ) " : "" }}</span></h4>
    </div>
    <div class="hstack flex-fill justify-content-end flex-nowrap gap-3 ms-auto px-6 px-xxl-8">
        ...
        @if (Auth()->user() !== null && Auth()->user()->role_id == '2')
            ...
            <div class="app-navbar-item ms-2 ms-lg-6">
                <ul class="navbar-nav justify-content-end">
                    ...
                    @else
                        <li class="nav-item">
                            <a href="javascript:void(0);" class="btn btn-primary take_break mx-xs-3 mx-0 text-nowrap btn-sm">
                                <span>Take a Break</span>
                                <i class="fa-solid fa-clock"></i>
                            </a>
                        </li>
        ...
        @endif
        <div class="app-navbar-item ms-2 ms-lg-6">
            <a href="{{ url('/') }}/chatify" class="btn btn-dark mx-xs-3 mx-0 text-nowrap btn-sm d-nav-btn" target="_blank">
                <span class="chat-text">Chat</span>
                &nbsp; <i class="bi bi-chat-dots"></i></a>
        </div>
        @if (Route::currentRouteName() !== 'dashboard')
            <a href="#" class="main-cmn-back-btn text-dark header-btn-arrows btn-dark" onclick="window.history.back();"
            ...
            <div class="dropdown-menu dropdown-menu-end">
                ...
                @if (Auth()->user(0)->role_id == 1)
                    <a class="dropdown-item" href="{{ route('business-setting') }}"><i
                            class="bi bi-pencil-square me-3"></i>Business Setting</a>
                ...
                @if(Auth()->user()->role_id !== 1)
                    <a class="dropdown-item" href="{{ route('user.show',Auth()->user()->id) }}"><i
                            class="bi bi-person-circle me-3"></i>User Profile</a>
                    
                @endif
                <a class="dropdown-item" href="{{ route('change.password') }}"><i
                    class="bi bi-pencil-square me-3"></i>Change Password</a>
                <div class="dropdown-divider"></div>
