                ...
                <main class="container-fluid px-6 pb-10">
                    <form action="{{ route('leads.store') }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div id="first_step_div">
                            ...
                            <div class="row align-items-center g-3 mt-6">
                                <div class="col-md-2"><label class="form-label mb-0">Type</label></div>
                                <div class="col-md-4 col-xl-4">
                                    <select name="type" class="form-control" id="invest_type">
        ...
        $('#customer_id').on('change', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#aadhar_card_number').html(res.aadhar_card);
                    $('#pan_card_number').html(res.aadhar_card);
