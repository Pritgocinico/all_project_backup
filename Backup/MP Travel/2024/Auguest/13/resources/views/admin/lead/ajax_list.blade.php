        ...
        @forelse ($leads as $key=>$lead)
            <tr>
                ...
                <td class="text-end">
                    ...
                    <a href="{{ route('leads.edit', $lead->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit lead"><i
                        class="bi bi-pencil-square"></i></a>
                    <a href="javascript:void(0)" onclick="deletelead({{$lead->id}})" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete lead"><i
