        ...
        <main class="container-fluid px-3 py-5 p-lg-6 p-xxl-8">
            <div class="mb-6 mb-xl-10">
                <div class="row g-3 align-items-center">
                    <div class="col">
                        <h1 class="ls-tight">Ticket Details</h1>
                    </div>
                </div>
            </div>
            <hr class="my-6" />
            <div class="row align-items-center g-3">
                ...
                <div class="col-md-4">{{ $ticket->ticket_id }}</div>
                <div class="col-md-2">Subject</div>
                <div class="col-md-4">{{ $ticket->subject }}</div>
            </div>
            <div class="row align-items-center mt-6">
                <div class="col-md-2">Description</div>
                <div class="col-md-4">{{ $ticket->description }}</div>
                <div class="col-md-2">Ticket Raised For Department</div>
                <div class="col-md-4">{{ isset($ticket->departmentDetail) ? $ticket->departmentDetail->name : '-' }}</div>
            </div>
            <div class="row align-items-center mt-6">
                <div class="col-md-2">Created By / Department Name</div>
                <div class="col-md-4">{{ isset($ticket->userDetail) ? $ticket->userDetail->name : '-' }} -
                    {{ isset($ticket->userDetail) && isset($ticket->userDetail->departmentDetail) ? $ticket->userDetail->departmentDetail->name : '-' }}
                </div>
                <div class="col-md-2">Created At</div>
                <div class="col-md-4">{{ Utility::convertDmyAMPMFormat($ticket->created_at) }}</div>
            </div>
            <div class="row align-items-center mt-6">
                <div class="col-md-2">Ticket Type</div>
                <div class="col-md-4">{{ $ticket->ticket_type }}</div>
            ...
            <div
                ...
                <main class="container-fluid px-6 pb-10">
                    <div class="card-header" id="kt_chat_messenger_header">
                        <div class="card-title">
                            <div class="d-flex justify-content-center flex-column p-3">
                                <span
                                    class="fs-4 fw-bold text-gray-900 text-hover-primary me-1 mb-2 lh-1">{{ $ticket->subject }}
                    ...
                    <div id="uploded_image_div" class="position-relative" style="width: 50px; height: 50px;">
                        ...
                        <i class="bi bi-x text-danger d-none position-absolute pe-auto" id="cross_icon_for_image"
                            style="font-size: 20px !important;cursor: pointer;" onclick="removeUploadImage()"></i>
                    </div>
                    <div class="card-footer pt-4" id="kt_chat_messenger_footer">
                        <form id="send_message_form" action="{{ route('ticket-comment-store') }}" method="POST"
