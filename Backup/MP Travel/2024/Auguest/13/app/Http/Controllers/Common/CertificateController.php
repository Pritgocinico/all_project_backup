...
class CertificateController extends Controller
{
    ...
    {
        $page = "Certificate";
        $this->certificate = resolve(Certificate::class)->with('userDetail');
    ...
    public function index()
    {
        ...
        return view('admin.certificate.index', compact('certificateList', 'employeeList', 'monthList'));
    }
    ...
    public function exportFile(Request $request)
    {
        ...
        if ($request->format == "pdf") {
            ...
            $html = view('admin.pdf.certificate', ['certificateList' => $certificateList, 'mainLogoUrl' => $mainLogoUrl])->render();
    ...
    public function store(CreateCertificateRequest $request)
    {
        ...
        $logoUrl = 'data:image/png;base64,' . base64_encode(file_get_contents(public_path('assets/media/svg/AgroJivanLogoDash.png')));
