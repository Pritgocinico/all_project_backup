            ...
            <div
                ...
                <main class="container-fluid px-6 pb-10">
                    <form action="{{ route('leads.store') }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div id="first_step_div">
                            ...
                            <div id="customer_detail_div" style="display: none">
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-4 col-xl-4" id="service_preference"></div>
                                ...
                                <div class="row align-items-center g-3 mt-6" id="customer_detail_gst_div">
                        ...
                        @include('admin.lead.partials.investment_field')
                        @include('admin.lead.partials.third_step')
                    </form>
                </main>
            </div>
        </main>
        ...
        $('#customer_id').on('change', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var aadharFile = "-";
                    if (res.customer_department == "individual") {
                        $('#customer_detail_gst_div').addClass('d-none');
                    ...
                    if(res.customer_department == "corporate"){
                        $('#customer_detail_aadhar_div').addClass('d-none');
                        var gstFile = "-";
