                    ...
                    <form action="{{ $route }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            <div class="col-md-4 col-xl-4">
                                <input class="form-check-input" type="radio" name="insurance_type" id="insurance_type"
                                    value="0" required
                                    {{ request('type') == '0' || (isset($customer) && $customer->insurance_type == '0') ? 'checked' : '' }}>
                                <label class="form-check-label" for="disabled">
                                    Investment
                                </label>
                                <input class="form-check-input" type="radio" name="insurance_type" id="insurance_type"
                                    value="1"
                                    {{ request('type') == '1' || (isset($customer) && $customer->insurance_type == '1') ? 'checked' : '' }}>
                                <label class="form-check-label" for="view">
                                    General Insurance
                                </label>
                                <input class="form-check-input" type="radio" name="insurance_type" id="insurance_type"
                                    value="2"
                                    {{ request('type') == '2' || (isset($customer) && $customer->insurance_type == '2') ? 'checked' : '' }}>
                                <label class="form-check-label" for="corporate">
                                    Travel
                                </label>
                            </div>
                            <div class="col-md-2"><label class="form-label mb-0">Customer Department</label></div>
                            <div class="col-md-4">
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control"
                                    value="{{ $customerId ?? ($customer->customer_id ?? '') }}" name="customer_id" readonly>
                            </div>
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            <div class="col-md-2 gst_certificate_div" style="display: @if((old('customer_department') &&  old('customer_department') !== 'individual') || isset($customer) && $customer->customer_department !== 'individual') 'none' @endif"><label
                                    class="form-label mb-0">GST Certificate</label></div>
                            <div class="col-md-4 col-xl-4 gst_certificate_div" style="display: @if((old('customer_department') &&  old('customer_department') !== 'individual') || isset($customer) && $customer->customer_department !== 'individual') 'none' @endif">
