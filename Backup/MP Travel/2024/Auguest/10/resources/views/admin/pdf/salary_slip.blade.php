    ...
    <table>
        ...
        @forelse ($deductionDetail as $key => $deduct)
            <tr>
                ...
                <td style="1px solid black">{{ $deduct->amount ?? 0 }}</td>
                <th style="1px solid black"></th>
                <td style="1px solid black"></td>
                @php $totalDeduction += $deduct->amount ??0; @endphp
            </tr>
        @empty
            <tr>
                <th style="1px solid black">Paid Days</th>
        ...
        <tr>
            <th colspan="3" style="text-align: end;">Total Earning</th>
            <td>{{ $salaryDetail->payable_salary }}</td>
            <th colspan="2" style="text-align: end;">Total Deduction</th>
            <td colspan="2" style="text-align: end;">{{ $totalDeduction }}</td>
        </tr>
        <tr>
            @php
                $netSalary = $salaryDetail->payable_salary - $totalDeduction;
            ...
            <th colspan="2" style="text-align: end;">Net Salary</th>
