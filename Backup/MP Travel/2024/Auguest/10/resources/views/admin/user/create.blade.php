                    ...
                    <form action="{{ $route }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            @if(isset($user->aadhar_card))
                                <div class="col-md-1 col-xl-1 adhar_image_div">
                                    <a href="{{ asset('storage/'.$user->aadhar_card) }}" target="_blank" class="btn btn-sm btn-primary "><span>View</span></a>
                                </div>
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            @if(isset($user->pan_card))
                                <div class="col-md-1 col-xl-1 adhar_image_div">
                                    <a href="{{ asset('storage/'.$user->pan_card) }}" target="_blank" class="btn btn-sm btn-primary "><span>View</span></a>
                                </div>
                                <div class="col-md-1 col-xl-1">
                            ...
                            @if(isset($user->pan_card))
                                <div class="col-md-1 col-xl-1 adhar_image_div">
                                    <a href="{{ asset('storage/'.$user->user_agreement) }}" target="_blank" class="btn btn-sm btn-primary "><span>View</span></a>
                                </div>
                                <div class="col-md-1 col-xl-1">
