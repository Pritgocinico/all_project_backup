                    ...
                    <div class="hstack gap-2 ms-auto">
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-user-table-filter="search" id="search_data"
                                class="form-control w-250px ps-13" onkeyup="ticketAjax()"
                        ...
                        <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_export_users"
                                ...
                                Export</a>
                        @endif
                        @if (collect($accesses)->where('menu_id', '11')->first() !== null && collect($accesses)->where('menu_id', '11')->first()->status == 2 && Auth()->user()->role_id !== 1)
