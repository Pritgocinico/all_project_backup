<li class="nav-item my-1">
    <a class="nav-link d-flex align-items-center rounded-pill {{ request()->routeIs('role.*') || request()->routeIs('user.*') ? 'active collapsed' : '' }}" href="#sidebar-user" data-bs-toggle="collapse"
