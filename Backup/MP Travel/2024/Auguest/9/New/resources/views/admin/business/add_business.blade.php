            ...
            <div class="card-body">
                <div class="row">
                        ...
                        <form action="{{ route('admin.add.business.data') }}" method="post" class="row g-3">
                            ...
                            <div class="col-md-12 form-floating mt-4">
                                <input type="text" class="form-control" name="api_key" id="ApiKey"
                                    value="{{ $setting->api_key }}" placeholder="" readonly />
                            ...
                            <div class="col-md-12 form-floating mt-4">
                                <select name="plan" class="form-control" id="plan" onchange="getPlanPrice()">
                            ...
                            <div class="col-md-12 form-floating mt-4 @if (old('plan')) d-block @else d-none @endif"
                                id="plan_price_div">
                                <input type="text" name="plan_price" class="form-control" id="plan_price" readonly>
                                <label for="plan" class="form-label">Plan Price *</label>
                            </div>
                            ...
                            <div class="col-md-12 form-floating mt-4 @if (old('payment_option') == null || old('payment_option' == 'cash')) d-none @endif"
                                id="transaction_id_div">
                    ...
                    <div class="col-md-6">
                        ...
                        <iframe src="{{ url('/') }}/assets/Images/pdf/find place id.pdf" class="col-d-12 w-100"
                            width="700" height="400" frameborder="0" style="width: 100%;"></iframe>
                    </div>
                </div>
            </div>
        </div>
            ...
            if (plan !== null) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#plan_price').val(data.data.price);
                    },
                })
            }
        }
