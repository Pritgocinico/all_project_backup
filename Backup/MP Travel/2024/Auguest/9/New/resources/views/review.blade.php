        ...
        <div class="card-body">
            <div class="content-area">
                <div class="header-content"  style="background:@if(!blank($business->brand_color)) {{$business->brand_color}} @else #111111 @endif">
                    ...
                    @if($business->show_business_name == 'on')
                        <h3 clss="b-name">{{$business->name}}</h3>
                    @endif
                </div>
                <div class="body-content">
                    <div class="mb-5">
                        ...
                        <div class="review-thumbs">
                            <a href="http://search.google.com/local/reviews?placeid={{$business->place_id}}" target="_blank" class="thumbup" data-action="Clicked Thumbs Up">
                        ...
                        <div class="footer-content">
                            <div class="d-flex justify-content-center">
                                @if($business->facebook_url != '' || $business->facebook_url != NULL)
                                    <a href="https://www.facebook.com/{{$business->facebook_url}}" target="_blank"><img src="{{url('/')}}/assets/Images/facebook.png" class="review-icon" alt="facebook"></a>
                                @endif
                                @if($business->twitter_url != '' || $business->twitter_url != NULL)
                                    <a href="https://x.com/{{$business->twitter_url}}" target="_blank"><img src="{{url('/')}}/assets/Images/twitter.png" class="review-icon" alt="facebook"></a>
                                @endif
                                @if($business->instagram_url != '' || $business->instagram_url != NULL)
                                    <a href="https://www.instagram.com/{{$business->instagram_url}}" target="_blank"><img src="{{url('/')}}/assets/Images/instagram.png" class="review-icon" alt="facebook"></a>
                                @endif
                                @if($business->instagram_url != '' || $business->instagram_url != NULL)
                                    <a href="https://in.linkedin.com/{{$business->linked_url}}" target="_blank"><img src="{{url('/')}}/assets/Images/linkedin.png" class="review-icon" alt="facebook"></a>
                                @endif
                            </div>
                        </div>
                    @endif
    ...
    <div class="modal fade" id="contactModule" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-body">
                <div class="">
                    <div class="text-center model-header-custom bg-dark">
                    ...
                    <div class="mb-5 mt-4 px-4">
                        <form action="{{route('customer.feedback')}}" method="POST" id="customerFeedback">
                            ...
                            <div class="text-center">
                                ...
                                <button type="button" class="btn btn-primary submitfor-feed feedbackBtn gc_btn">SEND MESSAGE</button>
                            </div>
                        </form>
                    </div>
                </div>
