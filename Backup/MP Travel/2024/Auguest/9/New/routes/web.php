...
Route::get('update-plan-detail', [PlanController::class, 'updatePlanDetail'])->name('update-plan-detail');
...
Route::get('/client', [AuthController::class, 'index'])->name('login');
...
Route::middleware('auth','role:admin')->group(function () {
    ...
    Route::get('admin/business-request',[BusinessController::class,'businessRequestDetail'])->name('admin.business-request');
    ...
    Route::get('admin/plan-detail', [PlanController::class, 'index'])->name('detail.plan');
    Route::post('admin/store-plan', [PlanController::class, 'storePlan'])->name('store.plan');
    Route::get('admin/edit-plan', [PlanController::class, 'editPlan'])->name('edit.plan');
    Route::post('admin/update-plan', [PlanController::class, 'updatePlan'])->name('update.plan');
    Route::get('admin/delete-plan/{id}', [PlanController::class, 'deletePlan'])->name('delete.plan');
    Route::get('admin/get-plan', [PlanController::class, 'getPlan'])->name('get.plan');

    Route::get('client/update-business-request', [BusinessController::class, 'updateBusinessRequestStatus'])->name('update.business.request');
    // Notification
...
Route::middleware('auth','role:user')->group(function () {
    ...
    Route::get('client/funnel-remove-logo',[ClientController::class,'removeLogoFunnel'])->name('remove.logo.funnel');

    Route::get('client/reviews', [ClientController::class, 'reviews'])->name('client.reviews');
    Route::get('client/reviews-export', [ClientController::class, 'reviewsExport'])->name('business.review.export');
    ...
    Route::post('client/update-business', [BusinessController::class, 'updateBusinessRequest'])->name('client.update.business');
    ...
    Route::get('client/business-detail/{id}', [BusinessController::class, 'businessDetail'])->name('client.business.detail');
});
