                ...
                <main class="container-fluid px-6 pb-10">
                    ...
                    <form action="{{ $route }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            <div class="col-md-1">
                                <a href="javascript:void(0)" class="btn btn-white mx-xs-3 mx-0 text-nowrap openAddCustomerDataForm">
                            ...
                            <div class="col-md-4 col-xl-4">
                                <input type="number" name="lead_amount" class="form-control" id="lead_amount"
                                    placeholder="Enter Lead Amount" value="{{ $lead->lead_amount }}">
                                @error('lead_amount')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            <div class="col-md-4 col-xl-4">
                                @if (Auth()->user()->role_id == 1)
                                    <select name="invest_type" class="form-control" id="invest_type">
                                        ...
                                        <option value="investments" @if (old('invest_type', $lead->invest_type ?? '') == 'investments') selected @endif>
                                            Investments</option>
                                        <option value="general insurance" @if (old('invest_type', $lead->invest_type ?? '') == 'general insurance') selected @endif>
                                            General Insurance</option>
                                        <option value="travel" @if (old('invest_type', $lead->invest_type ?? '') == 'travel') selected @endif>Travel
                                        </option>
                                    </select>
                                @else
                            ...
                            <div class="col-md-2 insurance_label"
                                style="display: {{ in_array(old('invest_type', $lead->invest_type ?? ''), ['investments', 'general insurance']) ? '' : 'none' }};">
                                <label class="form-label mb-0">Insurance Type</label>
                            </div>
                            <div class="col-md-4 col-xl-4" id="investmentRadio"
                                style="display: {{ old('invest_type', $lead->invest_type ?? '') == 'investments' ? '' : 'none' }};">
                                <input class="form-check-input" type="radio" name="insurance_type" id="pms_type"
                                    value="pms"
                                    {{ old('insurance_type', $lead->insurance_type ?? '') == 'pms' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4 col-xl-4" id="generalRadio"
                                ...
                                <input class="form-check-input" type="radio" name="insurance_type" id="motor_insurance"
                                    value="motor"
                                    {{ old('insurance_type', $lead->insurance_type ?? '') == 'motor' ? 'checked' : '' }}>
                                ...
                                <input class="form-check-input" type="radio" name="insurance_type" id="sme_insurance"
                                    value="sme"
                                    {{ old('insurance_type', $lead->insurance_type ?? '') == 'sme' ? 'checked' : '' }}>
                            ...
                            <div class="row align-items-center g-3 mt-6" id="mf_sip" style="display: none;">
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <input type="number" name="sip_amount" id="sip_amount" class="form-control"
                                        value="{{ old('sip_amount', $lead->sip_amount ?? '') }}">
                                    @error('sip_amount')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-4 col-xl-4">
                                        <select name="vehicle" class="form-control">
                                            ...
                                            <option value="Two Wheeler" @if (old('vehicle', $customer->vehicle ?? '') == 'Two Wheeler') selected @endif>
                                                Two Wheeler</option>
                                            <option value="Four Wheeler" @if (old('vehicle', $customer->vehicle ?? '') == 'Four Wheeler') selected @endif>
                                                Four Wheeler</option>
                                            <option value="Commercial Vehicle"
                                                @if (old('vehicle', $customer->vehicle ?? '') == 'Commercial Vehicle') selected @endif>Commercial Vehicle
                                            </option>
                                            <option value="TP Policy Only"
                                                @if (old('vehicle', $customer->vehicle ?? '') == 'TP Policy Only') selected @endif>TP Policy Only</option>
                                        </select>
                                        @error('vehicle')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-4 col-xl-4">
                                        ...
                                        @if (isset($lead->rc_copy))
                                            <a href="{{ Storage::url($lead->rc_copy) }}" target="_blank">View current
                                                file</a>
                                        @endif
                                        @error('rc_copy')
                                            <div class="text-danger">{{ $message }}</div>
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <select name="other_services" class="form-control">
                                        ...
                                        <option value="domestic_air_ticket"
                                            @if (old('other_services', $lead->other_services ?? '') == 'domestic_air_ticket') selected @endif>Domestic Air Ticket</option>
                                        <option value="visa" @if (old('other_services', $lead->other_services ?? '') == 'visa') selected @endif>Visa
                                        </option>
                                        <option value="railway_ticket" @if (old('other_services', $lead->other_services ?? '') == 'railway_ticket') selected @endif>
                                            Railway Ticket</option>
                                        <option value="hotel" @if (old('other_services', $lead->other_services ?? '') == 'hotel') selected @endif>Hotel
                                        </option>
                                        <option value="passport" @if (old('other_services', $lead->other_services ?? '') == 'passport') selected @endif>
                                            Passport</option>
                                        <option value="rent_cab" @if (old('other_services', $lead->other_services ?? '') == 'rent_cab') selected @endif>Rent a
                                            Cab</option>
                                        <option value="other" @if (old('other_services', $lead->other_services ?? '') == 'other') selected @endif>Other
                                        </option>
                                    </select>
                        ...
                        <div class="modal-body undefined">
                            <div class="vstack gap-1">
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-4 col-xl-4">
                                        <select name="country" class="form-select" id="country" onchange="getState()">
