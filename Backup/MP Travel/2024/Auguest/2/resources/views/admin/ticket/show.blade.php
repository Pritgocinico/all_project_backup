        ...
        <main class="container-fluid px-3 py-5 p-lg-6 p-xxl-8">
            <div class="mb-6 mb-xl-10">
                <div class="row g-3 align-items-center">
                    <div class="col">
                        <h1 class="ls-tight">Ticket Comment</h1>
                    </div>
                </div>
            </div>
            <div
                ...
                <main class="container-fluid px-6 pb-10">
                    <div class="card-header" id="kt_chat_messenger_header">
                        <div class="card-title">
                            <div class="d-flex justify-content-center flex-column me-3">
                                <span
                                    class="fs-4 fw-bold text-gray-900 text-hover-primary me-1 mb-2 lh-1">{{ $ticket->subject }} ( {{ $ticket->ticket_id }})</span>
                                <div class="mb-0 lh-1">
                                    ...
                                    <div class="d-flex justify-content-start mb-10 ">
                                        <div class="d-flex flex-column align-items-start">
                                            <div class="d-flex align-items-center mb-2">
                                                <div class="symbol  symbol-35px symbol-circle" style="width: 5%"><img alt="Pic"
                                                        src="{{ Utility::getImageUrl($ticketComment->userDetail->profile_image) }}">
                                                </div>
                                                <div class="ms-3">
                                                    <a href="#"
                                    ...
                                    <div class="d-flex justify-content-end mb-10" id="add_new_message_div">
                                        <div class="d-flex flex-column align-items-end">
                                            <div class="d-flex align-items-center mb-2 justify-content-end">
                                                ...
                                                <div class="symbol  symbol-35px symbol-circle" style="width: 5%"><img alt="Pic"
                                                        src="{{ Utility::getImageUrl(Auth()->user()->profile_image) }}">
                                                </div>
                                            </div>
                    ...
                    <div class="card-footer pt-4" id="kt_chat_messenger_footer">
                        <form id="send_message_form" action="{{ route('ticket-comment-store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
