                        ...
                        <div class="container mt-6">
                            <div id="deduction-container">
                                        ...
                                        <select name="emp_id" class="form-control" id="employee">
                                            ...
                                            @foreach ($userList as $employee)
                                                <option value="{{ $employee->id }}"
                                                    @if ($salaryDetail->emp_id == $employee->id) {{ 'selected' }} @endif>
                                ...
                                <div class="row align-items-center g-3 mt-3">
                                    @foreach ($deductionDetail as $key=>$deduct)
                                    <input type="hidden" name="deduction_id[]" value="{{$deduct->id}}">
                                        ...
                                        <div class="col-md-2 col-xl-2 text-end">
                                            <button type="button" class="btn btn-danger remove-deduction" data-type="remove" data-id="{{$deduct->id}}"><i
