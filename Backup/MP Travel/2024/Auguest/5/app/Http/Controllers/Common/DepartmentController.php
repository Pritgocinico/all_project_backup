...
class DepartmentController extends Controller
{
    ...
    public function exportFile(Request $request)
    {
        ...
        if ($request->format == "csv" || $request->format == "excel") {
            ...
            $columns = array('Department Name', 'Created At');
            $callback = function () use ($departList, $columns) {
                ...
                foreach ($departList as $department) {
                    ...
                    fputcsv($file, array($department->name, $date));
                }
                fclose($file);
            };
        ...
        if ($request->format == "pdf") {
            ...
            $html = view('admin.pdf.department', ['departList' => $departList, 'mainLogoUrl' => $mainLogoUrl])->render();
