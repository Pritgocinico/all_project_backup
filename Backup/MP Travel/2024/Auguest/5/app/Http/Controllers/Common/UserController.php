...
class UserController extends Controller
{
    ...
    public function exportFile(Request $request)
    {
        ...
        if ($request->format == "csv" || $request->format == "excel") {
            ...
            $columns = array('Name', 'Email', 'Shift Detail', 'Phone Number', 'Department Name', 'Designation Name', 'Salary', 'Role Name', 'Created At');
            $callback = function () use ($userList, $columns) {
                ...
                foreach ($userList as $user) {
                    ...
                    fputcsv($file, array($user->name, $user->email, $shift, $user->phone_number, $department, $designation, $user->employee_salary, $roleDetail, $date));
                }
                fclose($file);
            };
