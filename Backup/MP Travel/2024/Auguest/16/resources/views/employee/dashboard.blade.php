                        ...
                        <div class="col">
                            <a href="{{ route('salary-slip.index') }}">
                                <div class="card bg-style3">
                                    <div class=" dashboard-inner-card">
                                        <div>
                                            <span class="d-block h3 d-inner-title">{{ $salarySlipMonth?$salarySlipMonth->month: 0 }}</span>
                        ...
                        <div class="card">
                            <div class="card-body d-flex flex-center flex-column  em-dashbord-counter">
                                ...
                                <div class="d-flex flex-center  employe-counter">
                                    <div class="border border-gray-300 employe-counter-card border-dashed employe-counter-inner rounded mr-0 min-w-80px  emp-dash-attadance">
                                        <div class="fs-6 fw-bold text-gray-700 employe-count" id="working_day" style="font-size: 36px;"></div>
                                        <div class="fw-semibold text-gray-500 employe-title">Total Working Days</div>
                                    </div>
                                    <div class="border border-gray-300  employe-counter-card border-dashed employe-counter-inner rounded mr-0 min-w-80px  emp-dash-attadance">
                                        <div class="fs-6 fw-bold text-gray-700 employe-count" id="present_count" style="font-size: 36px;"></div>
                                        <div class="fw-semibold text-gray-500 employe-title">Present Days</div>
                                    </div>

                                    <div class="border border-gray-300 employe-counter-card border-dashed employe-counter-inner rounded mr-0 min-w-80px  emp-dash-attadance">
                                        <div class="fs-6 fw-bold text-gray-700 employe-count" id="absent_count" style="font-size: 36px;"></div>
                                        <div class="fw-semibold text-gray-500 employe-title">Absent Days</div>
                                    </div>

                                    <div class="border border-gray-300 employe-counter-card border-dashed employe-counter-inner rounded mr-0 min-w-80px  emp-dash-attadance">
                                        <div class="fs-6 fw-bold text-gray-700 employe-count" id="leave_balance" style="font-size: 36px;"></div>
