        ...
        <main class="container-fluid px-3 py-5 p-lg-6 p-xxl-8">
            <div class="mb-6 mb-xl-10">
                <div class="row g-3 align-items-center">
                    <div class="col">
                        <h1 class="ls-tight">{{ isset($user) ? 'Update' : 'Create' }} Employee</h1>
                    </div>
                </div>
            </div>
            <div
                ...
                <main class="container-fluid px-6 pb-10">
                    ...
                    <form action="{{ $route }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            <div class="col-md-4 col-xl-4">
                                <input type="date" name="joining_date" class="form-control" value="{{old('joining_date',$user->joining_date ?? date('Y-m-d'))??date('Y-m-d')}}" max="{{date('Y-m-d')}}">
                                @error('joining_date')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row align-items-center g-3 mt-6" id="salary-input" style="display: none;">
                            ...
                            <div class="col-md-4 col-xl-4">
                                <input type="number" name="employee_salary" class="form-control"
                                    ...
                                    value="{{ old('employee_salary', $user->employee_salary ?? '') }}">
                                ...
                                <select name="shift" class="form-control" id="shift">
                                    ...
                                    @foreach ($shiftList as $shift)
                                        <option value="{{ $shift->id }}"
                                            @if (old('shift', $user->shift_id ?? '') == $shift->id) selected @endif>
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            @if(isset($user->aadhar_card))
                                <div class="col-md-1 col-xl-1 adhar_image_div">
                                    <a href="{{ asset('storage/'.$user->aadhar_card) }}" target="_blank" class="btn btn-sm btn-dark "><span>View</span></a>
                                </div>
                                <div class="col-md-1 col-xl-1">
                                    <a href="#" class="btn btn-sm btn-danger remove_document" data-type="aadhar_card"><span>Remove</span></a>
                                </div>
                            @endif
                        </div>
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            @if(isset($user->pan_card))
                                <div class="col-md-1 col-xl-1 adhar_image_div">
                                    <a href="{{ asset('storage/'.$user->pan_card) }}" target="_blank" class="btn btn-sm btn-dark "><span>View</span></a>
                                </div>
                                <div class="col-md-1 col-xl-1">
                                    <a href="#" class="btn btn-sm btn-danger remove_document"  data-type="pan_card"><span>Remove</span></a>
                                </div>
                                @else
                            ...
                            @if(isset($user->pan_card))
                                <div class="col-md-1 col-xl-1 adhar_image_div">
                                    <a href="{{ asset('storage/'.$user->user_agreement) }}" target="_blank" class="btn btn-sm btn-dark "><span>View</span></a>
                                </div>
                                <div class="col-md-1 col-xl-1">
                                    <a href="#" class="btn btn-sm btn-danger remove_document" data-type="user_agreement"><span>Remove</span></a>
                                </div>
                            @endif
                        </div>
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            <div class="col-md-4 col-xl-4">
                                ...
                                value="{{ old('basic_amount', $user->basic_amount ?? 0)??0}}">
                                @error('basic_amount')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 col-xl-4">
                                <input type="number" name="hra_amount" class="form-control"
                                    ...
                                    value="{{ old('hra_amount', $user->hra_amount ?? 0)??0 }}">
                                @error('hra_amount')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            <div class="col-md-4 col-xl-4">
                                <input type="number" name="allowance_amount" class="form-control"
                                    ...
                                    value="{{ old('allowance_amount', $user->allowance_amount ?? 0)??0 }}">
                            ...
                            <div class="col-md-4 col-xl-4">
                                <input type="number" name="petrol_amount" class="form-control"
                                    ...
                                    value="{{ old('petrol_amount', $user->petrol_amount ?? 0)??0 }}">
                                @error('petrol_amount')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                                        ...
                                        <div class="row align-items-center g-3 mt-3">
                                            ...
                                            <div class="col-md-3 col-xl-3">
                                                <input type="text" name="deduction_type[]" class="form-control"
                                                    ...
                                                    value="{{ old('deduction_type.' . $i, $deductionDetail[$i]['deduction_type'] ?? '') }}">
                                            ...
                                            <div class="col-md-3 col-xl-3">
                                                <input type="number" name="amount[]" class="form-control"
                                                    ...
                                                    value="{{ old('amount.' . $i, $deductionDetail[$i]['amount'] ?? '') }}">
                                                @error('amount')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="col-md-1 text-end">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        {{ old('deduction_status.' . $i, $deductionDetail[$i]['status'] == 1) ? 'checked' : '' }}>
                                                </div>
                                            </div>
                                            <div class="col-md-1 text-end">
                                                <button type="button" class="btn btn-sm btn-danger"
                                                    id="remove-deduction"><i class="bi bi-trash"></i></button>
                                            </div>
                                        </div>
                                    @endfor
                                @endif
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12 text-end">
                                    <button type="button" class="btn btn-primary" id="add-deduction"><i
                                            class="bi bi-plus"></i> Add Deduction</button>
                                </div>
                            </div>
                        </div>
                        <hr class="my-6">
