                    ...
                    <form action="{{ route('leads.store') }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div id="first_step_div">
                            <div class="row align-items-center g-3 mt-6">
                                <div class="col-md-2"><label class="form-label mb-0">Customer</label><span class="text-danger">*</span></div>
                            ...
                            <div class="row align-items-center g-3 mt-6">
                                <div class="col-md-2"><label class="form-label mb-0">Type<span class="text-danger">*</span></label></div>
                                <div class="col-md-4 col-xl-4">
                            ...
                            <div class="row align-items-center g-3 mt-6">
                                ...
                                <div class="col-md-4 col-xl-4" id="birth_date">
                            ...
                            <div class="row align-items-center g-3 mt-6">
                                ...
                                <div class="col-md-4 col-xl-4" id="customer_status">
                            ...
                            <div class="row align-items-center g-3 mt-6 first_step_div">
                                ...
                                <div class="col-md-4 text-end">
                                    ...
                                    <button type="button" id="next_first_step_button" class="btn btn-primary btn-sm">Next<i
                        ...
                        <div id="second_step_div" style="display: none;">
                            ...
                            <div id="type_of_investments" style="display: none;">
                                ...
                                <div class="row align-items-center g-3 mt-6" id="maturity_amount_interest" style="display: none;">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" name="maturity_amount" id="maturity_amount" class="form-control" placeholder="Enter Maturity Amount">
                ...
                <form class="vstack" method="POST" id="addForm">
                    ...
                    <div class="modal-body undefined">
                        <div class="vstack gap-1">
                            ...
                            <div class="row align-items-center g-3 mt-6">
                                ...
                                <div class="col-md-4">
                                    <input class="form-check-input customer_department" type="radio"
                                        ...
                                        {{ old('customer_department') ?? 'individual' == 'individual' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="disabled">
                                        Individual
                                    </label>
                                    <input class="form-check-input customer_department" type="radio"
                            ...
                            <div class="row align-items-center g-3 mt-6" id="gst_certificate_div" style="display: none">
                                <div class="col-md-2"><label class="form-label mb-0">GST Certificate</label></div>
                                <div class="col-md-4">
        ...
        $('#customer_id').on('change', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var html = res.address + ",<br/>" + cityName + ", " + stateName + ", <br />" +countryName + " - " + res.pin_code;
                    ...
                    $('#customer_status').html('<span class="badge bg-'+className+'">'+text+'</span>')
                    var html1 = "";
