    ...
    <div class="container-fluid px-3 px-md-4 px-lg-6">
        ...
        @php
            ...
            if (Auth()->user()->role_id == 2) {
                ...
                $dashRoute = route('emp-dashboard');

            }

            if (Auth()->user()->role_id == 4) {

                $dashRoute = route('hr-dashboard');
        ...
        <a class="navbar-brand d-inline-block py-lg-1 mb-lg-5" href="{{ route('dashboard') }}">
            ...
            <img src="{{ isset($settings) ? asset('/storage/' . $settings->logo) : asset('assets/img/login/mp-group.png') }}"
            ...
            <div class="dropdown">
                ...
                <a class="d-flex align-items-center" href="#" role="button" data-bs-toggle="dropdown"
                    ...
                    <div>
                        ...
                        <div class="d-none d-md-block ms-md-2"><i class="fa-solid fa-chevron-down text-muted text-xs"></i>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    @if (Auth::user()->role_id == 1)
                        ...
                        <a class="dropdown-item" href="#"><i class="fa-solid fa-pen-to-square me-3"></i>Business Setting</a>

                        <a class="dropdown-item" href="{{ route('setting') }}"><i class="fa-solid fa-gear me-3"></i>Dashboard
        ...
        <div class="collapse navbar-collapse overflow-x-hidden" id="sidebarCollapse">
            ...
            <ul class="navbar-nav">
                ...
                @foreach ($accesses as $access)
                    ...
                    @if ($access->status > 0 && isset($access->menu))

                        @if (view()->exists('components.'.$access->menu->name))
