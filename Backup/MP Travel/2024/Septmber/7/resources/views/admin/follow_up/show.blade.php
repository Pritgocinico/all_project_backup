...
@section('content')
    <div
        ...
        <main class="container-fluid px-3 py-5 p-lg-6 p-xxl-8">
            ...
            <div
                class="flex-fill overflow-y-lg-auto scrollbar bg-body rounded-top-4 rounded-top-start-lg-4 rounded-top-end-lg-0 border-top border-lg shadow-2 follow-up-outer">
                <main class="container-fluid px-6 py-10 follow-up-inner">
                    ...
                    <div class="card-footer pt-4" id="kt_chat_messenger_footer">
                        <form id="send_message_form" action="{{ route('follow-comment-store') }}" method="POST"
                            ...
                            <input type="hidden" name="lead_id" value="{{ isset($ticket->leadDetail)?$ticket->leadDetail->id :"-" }}" />
