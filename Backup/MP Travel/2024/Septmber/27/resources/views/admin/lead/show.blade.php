        ...
        <div class="row g-3 mt-6">
            <div class="col-md-8">
                ...
                <div class="row align-items-center g-3 mt-6">
                    ...
                    <div class="col-md-4 col-xl-4">
                        <a href="{{ asset('storage/' . $lead->investmentLeadData->cancel_cheque) }}" class="btn btn-dark">View</a>
                    </div>
                    @endif
                ...
                <div class="row align-items-center g-3 mt-6">
                    ...
                    <div class="col-md-4">Other Passport File:-
                        ...
                        <a href="{{ asset('storage/' . $child->passport_file) }}"
                            class="btn btn-dark" target="_blank">View</a>
                        @endif
                    </div>
                </div>
        ...
        <div class="modal-content overflow-hidden">
            ...
            <form class="vstack" method="POST" id="addForm" enctype="multipart/form-data">
                    ...
                    <div class="vstack gap-1">
                        ...
                        <div id="customer_data_Model_div" class="d-none">
                            <div class="row align-items-center g-3 mt-6">
                                ...
                                <div class="col-md-3 col-xl-3">
                                    <input type="text" name="pan_card_number" class="form-control"
                                        id="pan_card_number" placeholder="Enter Pan Card Number" required>
                            ...
                            <div class="row align-items-center g-3 mt-6">
                                ...
                                <div class="col-md-3 col-xl-3">
                                    <input type="file" name="aadhar_card_file" class="form-control" required>
                                </div>
                                @endif
                            </div>
                            ...
                            <div class="row align-items-center g-3 mt-6">
                                <div class="col-md-2"><label class="form-label mb-0">GST Cartificate<span
                                            class="error_span">*</span></label>
                                </div>
                            ...
                            @if ($lead->invest_type == 'travel')
                            <div class="row align-items-center g-3 mt-6">
                                <div class="col-md-3"><label class="form-label mb-0">Eligible TCS Amount<span
                                            class="error_span">*</span></label></div>
                                <div class="col-md-3 col-xl-3">
                                    <select class="form-select" name="eligible_tcs_amount" id="eligible_tcs_amount" required>
                                        <option value="">Select Eligible TCS</option>
                                        <option value="yes">Yes</option>
                                        <option value="no">No</option>
                                    </select>
                                </div>
                                <div class="col-md-3 tcs_amount_div d-none"><label class="form-label mb-0">TCS Amount<span
                                            class="error_span">*</span></label></div>
                                <div class="col-md-3 col-xl-3 tcs_amount_div d-none">
                                    <input type="number" name="tcs_amount" class="form-control" id="tcs_amount"
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-dark completeSaveButtonStatus" id="submitBtn">Submit</button>
                </div>
        ...
        <div class="modal-content overflow-hidden">
            ...
            <form class="vstack" method="POST" id="updateForm" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-dark otherSaveButtonStatus" id="submitBtn">Submit</button>
                </div>
