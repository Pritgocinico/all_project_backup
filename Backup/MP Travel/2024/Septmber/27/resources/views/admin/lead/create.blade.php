                    ...
                    <form enctype="multipart/form-data" method="POST" 
                        ...
                        <div id="first_step_div">
                            <div class="row align-items-center g-3 mt-6">
                                ...
                                <div class="col-md-2"><label class="form-label mb-0">Lead Type<span
                            ...
                            <div id="customer_detail_div"
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-4 col-xl-4" id="customer_name">{{ $customerData->name ?? '' }}
                                    </div>
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-4 col-xl-4" id="customer_email">{{ $customerData->email ?? '' }}
                                    </div>
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-2"><label class="form-label mb-0">Service Preference Tagging:-
                                        </label></div>
                                    <div class="col-md-4 col-xl-4" id="last_service_take">
                                        {{ isset($customer->lastServiceTake) ? $customer->lastServiceTake->servicePreferenceDetail->name : '-' }}
                                    </div>
                                </div>
                                <div class="row align-items-center g-3 mt-6">
                                    <div class="col-md-2"><label class="form-label mb-0">Create By:-
                                        </label></div>
                                    <div class="col-md-4 col-xl-4" id="last_service_create_by">
                                        {{ isset($customer->lastServiceTake) ? $customer->lastServiceTake->userDetail->name : '-' }}
                                    </div>
                                    <div class="col-md-2"><label class="form-label mb-0">Create At:-
                                        </label></div>
                                    <div class="col-md-4 col-xl-4" id="last_service_create_at">
                        ...
                        <div class="row">
                            <div class="col-md-8 border-end">
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-4 col-xl-4" id="lead_customer_name">

                                    </div>
                                    <div class="col-md-2"><label class="form-label mb-0">Customer
                                            Id</label></div>
                                    <div class="col-md-4 col-xl-4" id="lead_customer_id_div">
                                    </div>
                                </div>
                                <div class="row align-items-center g-3 mt-6">
                                    <div class="col-md-2"><label class="form-label mb-0">Email</label>
                                    </div>
                                    <div class="col-md-4 col-xl-4" style="word-wrap: break-word;"
                                        id="lead_customer_email">
                                    </div>
                                    <div class="col-md-2"><label class="form-label mb-0">Phone
                                            Number</label></div>
                                    <div class="col-md-4 col-xl-4" id="lead_customer_mobile">
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center g-3 mt-6" id="customer_detail_aadhar_div">
                                    <div class="col-md-2"><label class="form-label mb-0">Aadhar
                                            Card</label></div>
                                    <div class="col-md-4 col-xl-4" id="lead_aadhar_card_number">
                                    </div>
                                    <div class="col-md-2"><label class="form-label mb-0">Aadhar Card
                                            File</label></div>
                                    <div class="col-md-4 col-xl-4" id="lead_cust_aadhar_card_file">
                                    </div>
                                </div>
                                <div class="row align-items-center g-3 mt-6">
                                    <div class="col-md-2"><label class="form-label mb-0">Pan
                                            Card</label></div>
                                    <div class="col-md-4 col-xl-4" id="lead_pan_card_number">
                                    </div>
                                    <div class="col-md-2"><label class="form-label mb-0">Pan Card
                                            File</label></div>
                                    <div class="col-md-4 col-xl-4" id="lead_cust_pan_card_file">
                                    </div>
                                </div>
                                <div class="row align-items-center g-3 mt-6">
                                    <div class="col-md-2"><label class="form-label mb-0">Address</label>
                                    </div>
                                    <div class="col-md-4 col-xl-4" id="lead_customer_address">
                                    </div>
                                    <div class="col-md-2"><label class="form-label mb-0">Customer
                                            Reference</label></div>
                                    <div class="col-md-4 col-xl-4" id="lead_customer_reference">
                                    </div>
                                </div>
                                <div class="row align-items-center g-3 mt-6">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-6 col-xl-6" id="lead_amount">
                                    </div>
                                </div>
                                <div class="row align-items-center g-3 mt-6">
        ...
        $('#lead_create_form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#lead_amount').html(lead.lead_amount);
                },
