                                                    ...
                                                    <div class="text-end ms-auto">
                                                        <div class="d-flex float-end">
                                                            <a href="javascript:void(0);" class="p-1 text-dark SubTask"
                                                                ...
                                                                data-bs-toggle="tooltip" title="Add SubFollowUp">
                                                            ...
                                                            <a href="javascript:void(0);" class="p-1 text-dark due_date"
                                                                data-id="{{ $followUp->id }}" data-bs-toggle="modal"
                                                    ...
                                                    <form action="#" method="POST" class="row g-3"
                                                        ...
                                                        <div class="col-md-6">
                                                            <label for="StartDate" class="form-label">Start Date <span
                                                                    class="text-danger">*</span></label>
                                                            <input type="date" name="start_date" class="form-control start_date" id="start_date" data-id="{{$i}}"
                                                                value="{{date('Y-m-d')}}" min="{{date('Y-m-d')}}">
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label for="EndDate" class="form-label">Due Date</label>
                                                            <input type="date" name="due_date" class="form-control" id="due_date_{{$i}}"
                                                                value="{{date('Y-m-d',strtotime('+1 day'))}}" min="{{date('Y-m-d')}}">
                                                        </div>
                                                        <input type="hidden" name="lead_id" id="lead_id" value="{{$followUp->id ?? ""}}">
                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <textarea class="form-control" id="exampleFormControlTextarea1" name="description" rows="5" placeholder="Enter Description"></textarea>
                                                        </div>
                                                        <div class="col-md-12">
