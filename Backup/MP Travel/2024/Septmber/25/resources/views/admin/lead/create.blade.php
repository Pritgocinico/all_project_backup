                ...
                <main class="container-fluid px-6 pb-10">
                    <form action="{{ route('leads.store') }}" enctype="multipart/form-data" method="POST"
                        ...
                        <div id="first_step_div">
                                    ...
                                    <select name="customer_id" class="form-control" id="customer_id"
                                        ...
                                        @foreach ($customers as $customer)
                                            <option value="{{ $customer->id }}"
                                                {{ $customer->id == old('customer_id') || $customer->id == $customerId ? 'selected' : '' }}>{{ $customer->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4 col-xl-4">
                                    @if ($type == 0)
                                        <select name="invest_type" class="form-control" id="invest_type">
                                            ...
                                            <option value="investments" {{ 'investments' == old('invest_type') ? 'selected' : '' }}>Investments</option>
                                            <option value="general insurance" {{ 'general insurance' == old('invest_type') ? 'selected' : '' }}>General Insurance</option>
                                            <option value="travel" {{ 'travel' == old('invest_type') ? 'selected' : '' }}>Travel</option>
                                        </select>
                                    @else
                            ...
                            <div id="customer_detail_div" style="display: {{ isset($customerData) || old('customer_id') ? '' : 'none' }}">
                                <div class="row align-items-center g-3 mt-6">
