<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="date" name="gpa_policy_period_start_date" class="form-control" value="{{$insuranceData->policy_start_date}}"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="gpa_sum_insured" class="form-control"  value="{{$insuranceData->total_sum_insured}}"
            id="gpa_sum_insured">
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" value="{{$insuranceData->accident_coverage}}" name="accident_death_cover"class="form-control" placeholder="Enter Accidental Death Cover"
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" value="{{$insuranceData->permanent_total_disability}}" name="permanent_total_disability"  class="form-control"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" value="{{$insuranceData->permanent_partial_disability}}" name="permanent_partial_disability" class="form-control"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" value="{{$insuranceData->road_ambulance_cover}}" name="ambulance_cover" id="ambulance_cover"
            class="form-control">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="accidental_hospital_cover" id="accidental_hospital_cover" value="{{$insuranceData->accidental_hospital_cover}}"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" value="{{$insuranceData->cashless_facility_hospital}}" name="cashless_facility_hospital" id="cashless_facility_hospital"
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" value="{{$insuranceData->burn_expense}}" name="burn_expense" id="burn_expense" class="form-control" placeholder="Enter Burn Expenses">
        @error('burn_expense')
            <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" value="{{$insuranceData->broken_bone_cover}}" name="broken_bone_cover" id="broken_bone_cover" class="form-control" placeholder="Enter Broken Bone Cover">
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" value="{{$insuranceData->carriage_dead_body}}" name="carriage_dead_body" id="carriage_dead_body" placeholder="Enter Carriage of dead body" class="form-control">
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="daily_cash_allowance" value="{{$insuranceData->daily_cash_allowance}}" id="daily_cash_allowance" class="form-control" placeholder="Enter Daily cash allowances">
