                ...
                <main class="container-fluid px-6 pb-10">
                    ...
                    <form action="{{ route('user.update', $user->id) }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            <div class="col-md-2"><label class="form-label mb-0">Password<span
                                        class="error_span">*</span></label></div>
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            <div class="col-md-2"><label class="form-label mb-0">Role<span
                                        class="error_span">*</span></label></div>
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            <div class="col-md-2 manger_list_div {{ $user->is_manager !== 'yes' ? 'd-none' : '' }}"><label
                                    class="form-label mb-0">User List</label></div>

                            <div
                                class="col-md-4 col-xl-4 manger_list_div {{ $user->is_manager !== 'yes' ? 'd-none' : '' }}">
                                ...
                                <select name="user_id[]" class="form-control js-example-basic-single" id="user_id"
                                    ...
                                    @foreach ($userList as $user)
                                        <option value="{{ $user->id }}"
                                            {{ in_array($user->id, $userManagerData ?? []) ? 'selected' : '' }}>
                                            {{ $user->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row align-items-center g-3 mt-6" id="salary-input" style="display: none;">
                            ...
                            <div class="col-md-2"><label class="form-label mb-0">Salary<span
                                        class="error_span">*</span></label></div>
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            <div class="col-md-2"><label class="form-label mb-0">Profile Image<span
                                        class="error_span">*</span></label></div>
                            ...
                            <div class="col-md-1 col-xl-1 adhar_image_div p-0">
                            ...
                            <div class="col-md-1 col-xl-1 p-0">
                                @if (isset($user->profile_image))
                            ...
                            <div class="col-md-2"><label class="form-label mb-0 ms-1">Aadhar Card Image</label></div>
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            <div class="col-md-2"><label class="form-label mb-0 ms-1">Agreement</label></div>
