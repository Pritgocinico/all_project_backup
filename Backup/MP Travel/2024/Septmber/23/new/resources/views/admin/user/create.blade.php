                ...
                <main class="container-fluid px-6 pb-10">
                    ...
                    <form action="{{ route('user.store') }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            <div class="col-md-2 manger_list_div {{old('is_manager') !== "yes" ? "d-none" : ""}}"><label class="form-label mb-0">User List</label></div>

                            <div class="col-md-4 col-xl-4 manger_list_div {{old('is_manager') !== "yes" ? "d-none" : ""}}">
