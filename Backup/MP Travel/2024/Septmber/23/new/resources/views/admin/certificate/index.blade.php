                        ...
                        <main class="container-fluid px-6 pb-10">
                            <form id="certificateForm" enctype="multipart/form-data">
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    <div class="col-md-2"><label class="form-label mb-0">Title<span class="error_span">*</span></label></div>
                                    ...
                                    <div class="col-md-2"><label class="form-label mb-0">Employee<span class="error_span">*</span></label></div>
                                    <div class="col-md-4 col-xl-4">
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    <div class="col-md-2"><label class="form-label mb-0">Director<span class="error_span">*</span></label></div>
                                    <div class="col-md-4 col-xl-4">
                                    ...
                                    <div class="col-md-2"><label class="form-label mb-0">Manager<span class="error_span">*</span></label></div>
                                    <div class="col-md-4 col-xl-4">
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    <div class="col-md-2"><label class="form-label mb-0">Director Signature<span class="error_span">*</span></label>
                                    </div>
                                    <div class="col-md-4 col-xl-4">
                                    ...
                                    <div class="col-md-2"><label class="form-label mb-0">Manager Signature<span class="error_span">*</span></label>
                                    </div>
                                    <div class="col-md-4 col-xl-4">
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    <div class="col-md-2"><label class="form-label mb-0">Description<span class="error_span">*</span></label></div>
                                ...
                                <div class="row align-items-center g-3 mt-6" id="">
                                    <div class="col-md-2"><label class="form-label mb-0">Month</label></div>
                                    <div class="col-md-4">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#certificateForm').on('submit', function(e) {
                ...
                if (managerSignature == "") {
                    $('#director_signature_file_error').html('Please Select Manager Signature.');
                    cnt = 0;
                }
