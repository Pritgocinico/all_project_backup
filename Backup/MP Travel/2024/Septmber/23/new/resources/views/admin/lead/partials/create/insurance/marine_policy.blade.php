<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-2 marine_policy_other_div d-none"><label class="form-label mb-0">Other Marine Policy</label></div>
    <div class="col-md-4 marine_policy_other_div d-none">
        <input type="text" name="other_marine_policy" id="other_marine_policy" placeholder="Enter Other Marine Policy"
            class="form-control">
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="hyphenation" class="form-control"id=" hyphenation" placeholder="Enter Hyothecation">
        @error('hyphenation')
            <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="previous_policy_number" class="form-control" id=" previous_policy_number" placeholder="Enter Previous Policy Number">
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="date" name="marine_policy_period_start_date" class="form-control" value="{{ date('Y-m-d') }}"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="commodity_description" class="form-control" id="commodity_description" placeholder="Enter Commodity Description">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="transit_mode" class="form-control" id="transit_mode" placeholder="Enter Mode of Transit">
        @error('transit_mode')
            <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="voyage_type" class="form-control"
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="voyage_detail" class="form-control" id="voyage_detail"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="number" name="marine_sum_insured" class="form-control" id="marine_sum_insured"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="per_bottom_limit" id="per_bottom_limit" class="form-control" placeholder="Enter Per Bottom Limit">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="per_location_limit" id="per_location_limit" class="form-control"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="vehicle_type" id="vehicle_type" placeholder="Enter Type of Vehicle"
            class="form-control">
        @error('vehicle_type')
            <div class="text-danger">{{ $message }}</div>
        @enderror
