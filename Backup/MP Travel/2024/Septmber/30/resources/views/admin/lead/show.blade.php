                                    ...
                                    <div class="row align-items-center g-3 mt-6">
                                        ...
                                        <div class="col-md-3 col-xl-3">
                                            <select class="form-select" name="eligible_tcs_amount"
                                                id="eligible_tcs_amount" required>
                                        ...
                                        <div class="col-md-3 tcs_amount_div d-none"><label class="form-label mb-0">TCS
                                                Amount<span class="error_span">*</span></label></div>
                            ...
                            <div class="row align-items-center g-3 mt-6">
                                ...
                                <div class="col-md-4 col-xl-4">
                                    <input type="date" name="end_date" class="form-control"
                                        placeholder="Enter Subject" id="end_date" value="{{date('Y-m-d',strtotime('+1 day'))}}">
                                    <span class="error_span" id="lead_assign_to_error"></span>
                                </div>
                            </div>
                            <div class="row align-items-center g-3 mt-6">
                ...
                success: function(data) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            window.location.href = `{{ route('follow-up.index') }}?lead_id=${data.data.lead_id}`;
                        }
                    })
                },
                error: function(error) {
