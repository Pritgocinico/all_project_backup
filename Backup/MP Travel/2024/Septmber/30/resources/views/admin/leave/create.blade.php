                ...
                <main class="container-fluid px-6 pb-10">
                    <form action="{{ route('leave.store') }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            <div class="col-md-2"><label class="form-label mb-0">Leave Type<span class="error_span">*</span></label></div>
                            ...
                            <div class="col-md-2"><label class="form-label mb-0">Leave Feature<span class="error_span">*</span></label></div>
                            <div class="col-md-4 col-xl-4">
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            <div class="col-md-2"><label class="form-label mb-0">Leave Reason<span class="error_span">*</span></label></div>
                            <div class="col-md-4 col-xl-4">
