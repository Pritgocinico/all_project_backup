                ...
                <main class="container-fluid px-6 pb-10">
                    <form action="{{ route('leads.store') }}" enctype="multipart/form-data" method="POST"
                        ...
                        <div id="first_step_div">
                                    ...
                                    <select name="customer_id" class="form-control" id="customer_id"
                                        ...
                                        @foreach ($customers as $customer)
                                            <option value="{{ $customer->id }}"
                                                {{ $customer->id == $customerId ? 'selected' : '' }}>{{ $customer->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4 col-xl-4">
                                    ...
                                    @else
                                        <select name="invest_type" class="form-control read-only" id="invest_type">
                                            <option value="">Select Type</option>
                                            <option value="investments" {{$type == 1 ? "selected" : ""}}>Investments</option>
                                            <option value="general insurance" {{$type == 2 ? "selected" : ""}}>General Insurance</option>
                            ...
                            <div id="customer_detail_div" style="display: {{ isset($customerData) ? '' : 'none' }}">
                                <div class="row align-items-center g-3 mt-6">
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-4">
                                        Create At:-
                                        {{ Utility::convertDmyAMPMFormat(isset($customer->lastServiceTake) ? $customer->lastServiceTake->created_at : '') }}
                                    </div>
                                </div>
                            </div>
                            <hr class="my-6">
