<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4">
        <input type="text" value="{{$insuranceData->pa_company_name}}" name="gmc_policy_name" id="gmc_policy_name" placeholder="Enter Company Name" class="form-control">
    ...
    <div class="col-md-4">
        <input type="text" value="{{$insuranceData->previoud_policy}}" name="gmc_previous_policy" id="gmc_previous_policy" placeholder="Enter Previous Policy" class="form-control">
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="date" name="gmc_policy_period_start_date" class="form-control" value="{{$insuranceData->policy_start_date}}"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="number" value="{{$insuranceData->total_sum_insured}} name="gmc_sum_insured" class="form-control" id="gmc_sum_insured">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text"value="{{$insuranceData->exist_diseases}}" name="exist_diseases" class="form-control" id="exist_diseases">
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" value="{{$insuranceData->nine_month_period}}" name="nine_month_period"class="form-control"
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" value="{{$insuranceData->one_year_waiting}}" name="one_year_waiting" class="form-control" id="one_year_waiting"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" value="{{$insuranceData->room_rent_capping}}" name="room_rent_capping" class="form-control"
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" value="{{$insuranceData->maternity_benefit}}" name="maternity_benefit" class="form-control" id="maternity_benefit"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" value="{{$insuranceData->pre_post_hospital}}" name="pre_post_hospital" id="pre_post_hospital" class="form-control">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" value="{{$insuranceData->ambulance_charge}}" name="ambulance_charge" id="ambulance_charge" class="form-control"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" value="{{$insuranceData->day_care_procedures}}" name="day_care_procedures" id="day_care_procedures" class="form-control"
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" value="{{$insuranceData->terrorism}}" name="terrorism" id="terrorism" class="form-control"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" value="{{$insuranceData->organ_donor}}" name="organ_donor" id="organ_donor" class="form-control"
    ...
    <div class="col-md-4 col-xl-4">
        <textarea name="air_ambulance" id="air_ambulance" class="form-control"
            placeholder="Enter Air Ambulance">{{$insuranceData->air_ambulance}}</textarea>
        @error('air_ambulance')
            <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" value="value="{{$insuranceData->internal_external_disease}}"" name="internal_external_disease" id="internal_external_disease"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="attendant_charge" id="attendant_charge" value="{{$insuranceData->attendant_charge}}"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" value="{{$insuranceData->dental_treatment_accident}}" name="dental_treatment_accident" id="dental_treatment_accident"
    ...
    <div class="col-md-4 col-xl-4">
        <textarea name="automatic_sum_insured" id="automatic_sum_insured" class="form-control"
            placeholder="Enter Automatic Sum Insured Reinstatement"> value="{{$insuranceData->sum_insurance}}"</textarea>
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="modern_treatment" id="modern_treatment" value="{{$insuranceData->modern_treatment}}"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="ayush_treatment" id="ayush_treatment" value="{{$insuranceData->ayush_treatment}}"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4">
        <input type="file" name="three_year_claim_history[]" class="form-control" multiple
