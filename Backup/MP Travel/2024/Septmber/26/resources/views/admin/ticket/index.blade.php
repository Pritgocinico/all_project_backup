...
@section('content')
    ...
    <div
                        ...
                        <div class="modal-body undefined">
                            ...
                            <div class="vstack gap-1">
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-3"><label class="form-label mb-0">Department<span class="error_span">*</span></label></div>
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-3"><label class="form-label mb-0">Ticket Type<span class="error_span">*</span></label></div>
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-3"><label class="form-label mb-0">Subject<span class="error_span">*</span></label></div>
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-3"><label class="form-label mb-0">Description<span class="error_span">*</span></label></div>
        ...
        <div class="modal fade" id="editticketLiquidityModal" tabindex="-1" aria-labelledby="depositLiquidityModalLabel"
