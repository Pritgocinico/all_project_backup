...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="date" name="policy_period_start_date" class="form-control" value="{{ $insuranceData->policy_start_date }}"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="financier_interest_hypo" class="form-control" value="{{ $insuranceData->financier_interest_hypo }}"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="number" name="building_value" value="{{ $insuranceData->building_value }}" class="form-control total_sum_insured"
            id="building_value">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="number" name="plant_machinary_value" value="{{ $insuranceData->plant_machinary_value }}" class="form-control total_sum_insured"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="number" name="total_stock_in_process" value="{{ $insuranceData->total_stock_in_process }}" class="form-control total_sum_insured"
    ...
    <div class="col-md-4 col-xl-4">
        <input type="number" name="fff_other_ee" class="form-control total_sum_insured" value="{{ $insuranceData->fff_other_ee }}"
            id="fff_other_ee">
        @error('fff_other_ee')
            <div class="text-danger">{{ $message }}</div>
        @enderror
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="number" name="other_content" value="0" id="other_content" value="{{ $insuranceData->other_content }}"
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="number" value="{{ $insuranceData->burglary_sum_insured }}" name="burglary_sum_insured" id="burglary_sum_insured" placeholder="Enter Burglary Sum Insured (Rs.)" class="form-control">
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="number" value="{{ $insuranceData->first_loss_percentage }}" name="first_loss_percentage" id="first_loss_percentage" placeholder="Enter First Loss Percentage" class="form-control">
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <select name="maintain_electrical" id="maintain_electrical" class="form-select">
            ...
            <option value="yes" {{ $insuranceData->maintain_electrical == "yes" ? selected  : ""}}>Yes</option>
            <option value="no" {{ $insuranceData->maintain_electrical == "no" ? selected  : ""}}>No</option>
        </select>
    </div>
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <select name="security_and_cctv" id="security_and_cctv" class="form-select">
            ...
            <option value="yes" {{ $insuranceData->security_and_cctv == "yes" ? selected  : ""}}>Yes</option>
            <option value="no" {{ $insuranceData->security_and_cctv == "no" ? selected  : ""}}>No</option>
        </select>
    </div>
...
<div class="row align-items-center g-3 mt-6">
    ...
    <div class="col-md-4 col-xl-4">
        <input type="text" name="age_building" id="age_building" value="{{ $insuranceData->age_building }}" class="form-control" placeholder="Enter Age Of Building">
        @error('age_building')
            <div class="text-danger">{{ $message }}</div>
        @enderror
    </div>
