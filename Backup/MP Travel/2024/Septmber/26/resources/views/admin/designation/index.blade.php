    ...
    <div
        ...
        <main class="container-fluid p-0">
            ...
            <div class="px-6 px-lg-7 pt-8">
                ...
                <div id="designation_table_ajax" class="table-responsive custom-scrollbar">
        ...
        <div class="modal fade" id="addDesignationModel" tabindex="-1" aria-labelledby="depositLiquidityModalLabel"
                            ...
                            <div class="vstack gap-1">
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-9 col-xl-9">
                                        ...
                                        <div id="department_error" class="error_span"></div>
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-9 col-xl-9">
                                        ...
                                        <div id="name_error" class="error_span"></div>
                                    </div>
        ...
        <div class="modal fade" id="editDesignationModel" tabindex="-1" aria-labelledby="depositLiquidityModalLabel"
            style="display: none;" aria-hidden="true">
                            ...
                            <div class="vstack gap-1">
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-9 col-xl-9">
                                        ...
                                        <div id="edit_department_error" class="error_span"></div>
                                    </div>
                                ...
                                <div class="row align-items-center g-3 mt-6">
                                    ...
                                    <div class="col-md-9 col-xl-9">
                                        ...
                                        <input type="text" name="name" class="form-control" id="edit_name"
                                            placeholder="Enter Designation Name">
                                        <div id="edit_name_error" class="error_span"></div>
                                    </div>
...
@section('script')
    <script>
        ...
        function updateDesignation() {
            ...
            if (designation.trim() == "") {
                $('#edit_name_error').html('Please Enter Designation.');
                cnt = 1;
            }
            if (cnt == 1) {
                editDesignation(id)
