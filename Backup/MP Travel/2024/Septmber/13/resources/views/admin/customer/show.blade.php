                ...
                <div class="col-md-8">
                    <div class="row align-items-center g-3 mt-6">
                        ...
                        <div class="col-md-4 col-xl-4">
                            {{ ucfirst($customer->customer_department) }}
                        </div>
                    ...
                    <div class="row align-items-center g-3 mt-6">
                            ...
                            <div class="col-md-4">
                                Create By:- {{ isset($customer->lastServiceTake) ? $customer->lastServiceTake->userDetail->name : '-' }}
                            </div>
                            <div class="col-md-4">
                                Create At:- {{ Utility::convertDmyAMPMFormat(isset($customer->lastServiceTake) ? $customer->lastServiceTake->created_at : '') }}
                            </div>
                    </div>
                </div>
                <div class="col-md-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <h3 class="timeline-header">
                                               {{$followUp->event_name}}  <b>{{ isset($followUp->userDetail) ?  "- " .$followUp->userDetail->name : "-" }}</b>
                                            </h3>
                                            @foreach ($followUp->subTaskData as $subTask)  
                                                <div class="timeline-body">
                                                    {{$subTask->note}} - {{Utility::convertDmyAMPMFormat($followUp->cretaed_at)}} <br />
