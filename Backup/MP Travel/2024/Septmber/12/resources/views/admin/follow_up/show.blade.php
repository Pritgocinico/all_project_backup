                                        ...
                                        <div class="p-2 mt-3">
                                            ...
                                            <div class="btn-group ml-5">
                                                @if ($followUp->status == 1)
                                                    <span class="badge bg-light text-dark fs-14">Not Started</span>
                                                @elseif($followUp->status == 2)
                                                    <span class="badge bg-info fs-14">In Progress</span>
                                                @else
                                                    <span class="badge bg-success text-white fs-14">Complete</span>
                                                @endif
                                                <ul class="dropdown-menu task-status">
                                                    <li><a class="dropdown-item status @if ($followUp->status == 1) hide @endif"
                                                            href="#" data-status="1"
                                                            data-task="{{ $followUp->id }}">Not Started</a></li>
                                                    <li><a class="dropdown-item status @if ($followUp->status == 2) hide @endif"
                                                            href="#" data-status="2"
                                                            data-task="{{ $followUp->id }}">In Progress</a></li>
                                                    <li><a class="dropdown-item status @if ($followUp->status == 5) hide @endif"
                                                            href="#" data-status="5"
                        ...
                        <div class="card p-2">
                            <div class="card-body m-4">
                                ...
                                <div class="container mt-5">
                                    @if (isset($followUp->commentDetail))
                                        @foreach ($followUp->commentDetail as $comment)
                                            <div class="row mt-2">
                                                <div class="col-3 card p-2 dis-comments justify-content-center">
                                                    <div class="d-flex">
                                                ...
                                                <div class="col-9 card p-2 dis-comments ">
                                                    <div class="">
                                ...
                                <div class="col-md-12 mt-5">
                                    <div class="mb-3">
                                        <div class="label mb-2">Comment</div>
                                        <textarea name="comment" class="task-comment form-control" id="comment" rows="2"></textarea>
