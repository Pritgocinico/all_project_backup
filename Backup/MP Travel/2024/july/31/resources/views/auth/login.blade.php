...
<head>
    ...
    <link rel="shortcut icon" href="{{ $settings ? asset('/storage/' . $settings->fa_icon ) : '' }}" />
    <title>{{isset($page)?$page."-":""}}{{ $settings ? $settings->site_name : '' }}</title>
    <!-- Fonts -->
            ...
            <div class="p-12 py-xl-10 px-xl-20">
                <div class="mt-16">
                    ...
                    <p class="text-white text-opacity-75 pe-xl-24">
                        Seamless Financial Services & Travel Management of MP Group
                    </p>
                </div>
            </div>
            <div class="ps-16 ps-xl-20"><img src="{{ url('assets/img/login/mpfs - R.jpeg') }}"
                    ...
                    <div class="mb-5">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append login_button_password">
                                <span class="input-group-text" id="password_eye_button"><i class="bi bi-eye"></i></span>
                            </div>
                        </div>
                        @error('password')
                            <div class="text-danger">{{ $message }}</div>
