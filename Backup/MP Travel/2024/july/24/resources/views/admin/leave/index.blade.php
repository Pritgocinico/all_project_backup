                            ...
                            @if (Auth()->user()->role_id == 1)
                                <div class="dropdown"><a class="text-bg-dark rounded-circle" href="#" role="button"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a class="dropdown-item @if($leave->leave_status == 1) d-none @endif" href="javascript:void(0)" onclick="approveLeave({{ $leave->id }})"><i
                                                class="bi bi-pencil me-3"></i>Approve Leave</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item @if($leave->leave_status == 2) d-none @endif" href="javascript:void(0)"
                                            onclick="rejectLeave({{ $leave->id }})"><i
