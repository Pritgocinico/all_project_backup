...
class UserController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->users = resolve(User::class)->with('stateDetail', 'countryDetail', 'cityDetail', 'roleDetail');
    }
    ...
    public function create(Request $request)
    {
        ...
        $roleList = Role::get();
        return view('admin.user.create', compact('countryList', 'roleList'));
    }
    ...
    public function edit($id)
    {
        ...
        $countryList = Country::get();
        $roleList = Role::get();
        return view('admin.user.create', compact('user', 'countryList', 'roleList'));
    }
    ...
    public function destroy($id)
    {
        ...
        if ($delete) {
            ...
            return response()->json(['status' => 1, 'message' => 'User has been deleted successfully.'], 200);
        }
