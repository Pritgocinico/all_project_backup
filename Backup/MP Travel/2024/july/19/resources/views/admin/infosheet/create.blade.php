        ...
        <main class="container-fluid px-3 py-5 p-lg-6 p-xxl-8">
            ...
            <div
                ...
                <main class="container-fluid px-6 pb-10">
                    @php
                        $route = route('infosheet.store');
                        $method = 'POST';
                        if (isset($infosheet)) {
                            $route = route('infosheet.update', $infosheet->id);
                            $method = 'PUT';
                        }
                    @endphp
                    <form action="{{ $route }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row align-items-center g-3 mt-6">
                            ...
                            {{-- <div class="col-md-2">
                                ...
                                <img id="preview-image-before-upload" src="{{ asset('storage/'.$infosheet->info_sheet) }}" alt="" style="width:150px;">
                                @endif
                            </div> --}}
                        </div>
                        ...
                        <div class="d-flexjustify-content-end gap-2">
                            <a href="{{ route('infosheet.index') }}" class="btn btn-sm btn-neutral">Cancel</a>
