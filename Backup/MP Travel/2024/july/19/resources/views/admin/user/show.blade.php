        ...
        <main class="container-fluid px-3 py-5 p-lg-6 p-xxl-8">
            <div class="mb-6 mb-xl-10">
                <div class="row g-3 align-items-center">
                    <div class="col-auto">
                        <img src="{{ asset('storage/' . $user->profile_image) }}" class="img-fluid rounded-top-start-4" style="height: 100px !important" alt="...">
                    </div>
                    <div class="col">
                        <h1 class="ls-tight">{{ $user->name }} - {{ isset($user->departmentDetail) ? $user->departmentDetail->name : '-' }}</h1>
                    </div>
                </div>
            ...
            <div class="row align-items-center g-3 mt-6">
                ...
                <div class="col-md-4 col-xl-4">
                    @if ($user->pan_card)
                        <a href="{{ asset('storage/' . $user->pan_card) }}" target="_blank" class="btn btn-primary">View</a>
                    @endif
                </div>
            </div>
            <div class="row align-items-center g-3 mt-6">
