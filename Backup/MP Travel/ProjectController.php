...
class ProjectController extends Controller
{
        ...
        if (!blank($request->measurement_user)) {
            ...
            foreach ($measurementUsers as $user) {
                ...
                if ($setting->wa_message_sent == 1) {
                    $isSent = SmsHelper::sendSmsWithTemplate($mobileNumber, $message, false);
                } else {
    ...
    public function viewProgressBarproject(WorldHelper $world, Request $request, $id)
    {
        ...
        $measurements = Measurement::where('project_id', $id)->where('measurement_type',0)->orderBy('add_work', 'desc')->get();
        $measurementfiles = Measurementfile::where('project_id', $id)->where('file_type',0)->orderBy('id', 'desc')->get();
        $measurementphotos = MeasurementSitePhoto::where('project_id', $id)->get();
        ...
        $cities = City::where('state_id', $projects->statename)->get();
        $finalMeasurements = Measurement::where('project_id', $id)->where('measurement_type',1)->orderBy('add_work', 'desc')->get();
        $finalMeasurementFiles = Measurementfile::where('project_id', $id)->where('file_type',1)->orderBy('id', 'desc')->get();

        if (Auth::user()->role == 1) {
            return view('admin.projects.view_project', compact('finalMeasurements','finalMeasurementFiles','subInvoiceFiles', 'subPartialDeliverDatas', 'subProjectData', 'subPurchases', 'subquotations', 'subquotationfiles', 'sub_quotation_uploads', 'submeasurements', 'sumeasurementfiles', 'sumeasurementphotos', 'issueProject', 'addProject', 'page', 'projects', 'users', 'cities', 'quotationfiles', 'measurements', 'measurementfiles', 'measurementphotos', 'quotations', 'quotationfiles', 'workshops', 'fittings', 'business', 'customer', 'purchases', 'type', 'states', 'sitephotos', 'workshop_questions', 'workshop_doneTasks', 'invoiceFiles', 'fitting_questions', 'fitting_doneTasks', 'measurement_users', 'measurementtaskUsers', 'partialDeliverDatas'));
        } else if (Auth::user()->role == 8) {
            return view('purchase.projects.view_project', compact('finalMeasurements','finalMeasurementFiles','subInvoiceFiles', 'subPartialDeliverDatas', 'subProjectData', 'subPurchases', 'subquotations', 'subquotationfiles', 'sub_quotation_uploads', 'submeasurements', 'sumeasurementfiles', 'sumeasurementphotos', 'issueProject', 'addProject', 'page', 'projects', 'users', 'cities', 'quotationfiles', 'measurements', 'measurementfiles', 'measurementphotos', 'quotations', 'quotationfiles', 'workshops', 'fittings', 'business', 'customer', 'purchases', 'type', 'states', 'sitephotos', 'workshop_questions', 'workshop_doneTasks', 'invoiceFiles', 'fitting_questions', 'fitting_doneTasks', 'measurement_users', 'measurementtaskUsers', 'partialDeliverDatas'));
        } else if (Auth::user()->role == 10) {
            return view('quality_analytic.projects.view_project', compact('finalMeasurements','finalMeasurementFiles','subInvoiceFiles', 'subPartialDeliverDatas', 'subProjectData', 'subPurchases', 'subquotations', 'subquotationfiles', 'sub_quotation_uploads', 'submeasurements', 'sumeasurementfiles', 'sumeasurementphotos', 'issueProject', 'addProject', 'page', 'projects', 'users', 'cities', 'quotationfiles', 'measurements', 'measurementfiles', 'measurementphotos', 'quotations', 'quotationfiles', 'workshops', 'fittings', 'business', 'customer', 'purchases', 'type', 'states', 'sitephotos', 'workshop_questions', 'workshop_doneTasks', 'invoiceFiles', 'fitting_questions', 'fitting_doneTasks', 'measurement_users', 'measurementtaskUsers', 'partialDeliverDatas'));
        }
        return view('quotation.projects.view_project', compact('finalMeasurements','finalMeasurementFiles','subInvoiceFiles', 'subPartialDeliverDatas', 'subProjectData', 'subPurchases', 'subquotations', 'subquotationfiles', 'sub_quotation_uploads', 'submeasurements', 'sumeasurementfiles', 'sumeasurementphotos', 'issueProject', 'addProject', 'page', 'projects', 'users', 'cities', 'quotationfiles', 'measurements', 'measurementfiles', 'measurementphotos', 'quotations', 'quotationfiles', 'workshops', 'fittings', 'business', 'customer', 'purchases', 'type', 'states', 'sitephotos', 'workshop_questions', 'workshop_doneTasks', 'invoiceFiles', 'fitting_questions', 'fitting_doneTasks', 'measurement_users', 'measurementtaskUsers', 'partialDeliverDatas'));
    }
    ...
    public function updateMaterialStatus(Request $request)
    {
        ...
        $projectId = $project->lead_no;
        $text = "Lead";
        if ($project->type == 1) {
            $text = "Project";
            $projectId = $project->project_generated_id;
        }
        $setting = Setting::first();
        $customerAddress = $customer->address . " " . $customer->cityDetail->name . " " . $customer->stateDetail->name . " " . $customer->zipcode;
        $message = $message = "Dear " . $customer->name . ", your Material Selection has been done successfully and sent the quotation for this " . $text . " " . $projectId . " and address is " . $customerAddress . ". - Shree Ganesh Aluminum.";
        // $templateid = '1407171593897710905';
        if ($request->material_option == 1) {
            $isSent = SmsHelper::sendSelectMeasurementDone($mobileNumber, $message, $project->id, true);
            if ($setting->wa_message_sent == 1) {
                $quotationUserList = User::where('role', 4)->get();
                foreach ($quotationUserList as $quotation) {
                    $mobile = $quotation->phone;
                    $isSent = SmsHelper::sendSelectMeasurementDone($mobile, $message, $project->id, false);
                }
                $fittingUser = User::where('role', '3')->get();
    ...
    public function projectDone(Request $request)
    {
        ...
        if ($selection == 1) {
            ...
            try {
                ...
                $templateid = '1407171593897710905';
                if ($setting->wa_message_sent == 1) {
                    $message = "Dear " . $customer_name . ", your " . $project->project_generated_id . " has been completed. Kindly review us in this " . $route . " and address is " . $customerAddress . ". Shree Ganesh Aluminum.";
                    $isSent = SmsHelper::sendSmsWithImage($mobileNumber, $message, $request->project_id, true);
                    ...
                    foreach ($measurementList as $measurement) {
                        ...
                        $isSent = SmsHelper::sendSmsWithImage($mobile, $message, $request->project_id, false);
                    }
    ...
    public function updateCutting(Request $request)
    {
        ...
        if (isset($addProject) && $project->add_type == 2) {
            if ($request->cutting_option == 0) {
                ...
                $message = "Workshop cutting for " . $userDetail->name . " - " . $project->project_generated_id . " is not done, kindly complete it withing next 24 hours and address is " . $customerAddress . " . - Shri Ganesh Aluminum.";
                ...
                foreach ($quatationUser as $key => $quatation) {
                    ...
                    if ($setting->wa_message_sent == 1) {
                        $isSent = SmsHelper::sendSmsWithTemplate($mobile, $message, $status);
                    } else {
        ...
        // if ($setting->wa_message_sent == 1) {
        //     // if($request->project_id == 340){
        //     //     dd($mobileNumber);
        //     // }
        //     $message = "Dear " . $userDetail->name . ", your workshop cutting has been done and shifted to shutter joinery phase and address is " . $customerAddress . ". - Shree Ganesh Aluminum.";
        ...
        if (isset($addProject) && $project->add_type == 2) {
            if ($request->shutter_joinery == 0) {
                ...
                foreach ($quatationUser as $key => $quatation) {
                    ...
                    $mobile = $quatation->phone;
                    if ($setting->wa_message_sent == 1) {
                        $message = "Workshop shutter joinery for " . $userDetail->name . " - " . $project->project_generated_id . " is not done. Kindly complete it within next 24 hours and address is " . $customerAddress . ". Shree Ganesh Aluminum";
                        $isSent = SmsHelper::sendSmsWithTemplate($mobile, $message, $status);
                    } else {
                ...
                if ($setting->wa_message_sent == 1) {
                    $message = "Dear " . $userDetail->name . ", your workshop shutter joinery has been done and shifted to glass measurement and address is " . $customerAddress . ". - Shree Ganesh Aluminum.";
                    $isSent = SmsHelper::sendSmsWithTemplate($mobileNumber, $message, true);
                    $quatationUser = User::where('role', '5')->get();
                    foreach ($quatationUser as $quatation) {
                        $mobile = $quatation->phone;
        ...
        if (isset($addProject) && $project->add_type == 2) {
            if ($request->glass_measurement == 0) {
                ...
                foreach ($quatationUser as $key => $quatation) {
                    ...
                    if ($setting->wa_message_sent == 1) {
                        $message = "Workshop glass measurement for " . $userDetail->name . " - " . $project->project_generated_id . " is not done. Kindly complete it within next 24 hours and address is " . $customerAddress . ". Shree Ganesh Aluminum";
                        $isSent = SmsHelper::sendSmsWithTemplate($mobile, $message, $status);
                    } else {
                ...
                if ($setting->wa_message_sent == 1) {
                    $message = "Dear " . $userDetail->name . ", your workshop glass measurement has been done for your project " . $project->project_generated_id . " and address is " . $customerAddress . ". Shree Ganesh Aluminum";
                    $isSent = SmsHelper::sendSmsWithTemplate($mobileNumber, $message, true);
                    $quatationUser = User::where('role', '5')->get();
                    foreach ($quatationUser as $quatation) {
                        $mobile = $quatation->phone;
            ...
            if ($request->glass_measurement == 0) {
                ...
                if ($setting->wa_message_sent == 1) {
                    $message = "Dear " . $userDetail->name . ", your workshop glass measurement has been done for your project " . $project->project_generated_id . " and address is " . $customerAddress . ". Shree Ganesh Aluminum";
                    if ($request->hasFile('glass_file')) {
                        $isSent = SmsHelper::sedSmsWithGlassFile($mobileNumber, $message, $request->project_id, true);
                        $quatationUser = User::where('role', '5')->get();
                        foreach ($quatationUser as $quatation) {
                            $mobile = $quatation->phone;
                            $isSent = SmsHelper::sedSmsWithGlassFile($mobile, $message, $request->project_id, false);
                        }
                    } else {
                        $isSent = SmsHelper::sendSmsWithTemplate($mobileNumber, $message, true);
                        $quatationUser = User::where('role', '5')->get();
        ...
        if (isset($addProject) && $project->add_type == 2) {
            if ($request->glass_receive == 0) {
                ...
                foreach ($quatationUser as $key => $quatation) {
                    ...
                    if ($setting->wa_message_sent == 1) {
                        $message = "Workshop glass is not received for " . $userDetail->name . " - " . $project->project_generated_id . " and address is " . $customerAddress . ". Shree Ganesh Aluminum";
                        $isSent = SmsHelper::sendSmsWithTemplate($mobile, $message, $status);
                    } else {
                ...
                if ($setting->wa_message_sent == 1) {
                    $message = "Dear " . $userDetail->name . ", your workshop glass has been received and it is being ready for the workshop fitting for project " . $project->project_generated_id . " and address is " . $customerAddress . ". Shree Ganesh Aluminum";
                    $isSent = SmsHelper::sendSmsWithTemplate($mobileNumber, $message, true);
                    $quatationUser = User::where('role', '5')->get();
                    foreach ($quatationUser as $quatation) {
                        $mobile = $quatation->phone;
        ...
        if (isset($addProject) && $project->add_type == 2) {
            if ($request->shutter_ready == 0) {
                ...
                foreach ($quatationUser as $key => $quatation) {
                    ...
                    if ($setting->wa_message_sent == 1) {
                        $message = "Workshop glass fitting is not done for " . $userDetail->name . " - " . $project->project_generated_id . ". Kindly complete it within next 24 hours and address is " . $customerAddress . ". Shree Ganesh Aluminum";
                        $isSent = SmsHelper::sendSmsWithTemplate($mobile, $message, $status);
                    } else {
                        $message = "Workshop glass fitting is not done for " . $userDetail->name . " - " . $project->project_generated_id . ". Kindly complete it within next 24 hour. Shree Ganesh Aluminum";
                        $isSent = SmsHelper::sendSms($mobile, $message, $templateid, $status);
                    }
                }
                ...
                if ($setting->wa_message_sent == 1) {
                    $message = "Dear " . $userDetail->name . ", your workshop glass fitting has been done and invoice is being generated for the project " . $project->project_generated_id . " and address is " . $customerAddress . ". Shree Ganesh Aluminum";
                    $isSent = SmsHelper::sendSmsWithTemplate($mobileNumber, $message, true);
                    $quatationUser = User::where('role', '5')->get();
                    foreach ($quatationUser as $quatation) {
                        $mobile = $quatation->phone;
    ...
    public function qaQuestionList($id)
    {
        ...
        $quotationfiles = Quotationfile::where('project_id', $id)->get();
        $measurements = Measurement::where('project_id', $id)->where('measurement_type',0)->first();
        $fitting_questions = ProjectQuestion::whereIn('project_id', [$id, 0])->where('question_type', 1)->orderBy('id', 'DESC')->get();
        $fitting_doneTasks = FittingDoneTask::where('project_id', $id)->orderBy('id', 'DESC')->get();
        $partialDeliverDatas = PartialDeliverDetail::where('project_id', $id)->get();
        $measurementfiles = Measurementfile::where('project_id', $id)->where('file_type',0)->orderBy('add_work', 'desc')->get();
        $measurementphotos = MeasurementSitePhoto::where('project_id', $id)->get();
        $workshops = Workshop::where('project_id', $id)->get();
        $invoiceFiles = Invoicefile::where('project_id', $id)->get();
        $fittings = Fitting::where('project_id', $id)->get();
        ...
        $finalMeasurements = Measurement::where('project_id', $id)->where('measurement_type',1)->orderBy('id', 'desc')->get();
        $finalMeasurementFiles = Measurementfile::where('project_id', $id)->where('file_type',1)->orderBy('add_work', 'desc')->get();
        if (Auth::user()->role == 1) {
            return view('admin.projects.view_qa', compact('finalMeasurements','finalMeasurementFiles','qa_questions', 'qa_doneTasks', 'subPurchases', 'subProjectData', 'subPartialDeliverDatas', 'subInvoiceFiles', 'subquotations', 'subquotationfiles', 'sub_quotation_uploads', 'submeasurements', 'sumeasurementfiles', 'sumeasurementphotos', 'issueProject', 'additionalProject', 'type', 'page', 'projects', 'fittings', 'purchases', 'workshops', 'quotations', 'quotationfiles', 'measurements', 'measurementfiles', 'measurementphotos', 'fitting_questions', 'fitting_doneTasks', 'sitephotos', 'workshop_questions', 'workshop_doneTasks', 'invoiceFiles', 'partialDeliverDatas'));
        } else if (Auth::user()->role == 8) {
            return view('purchase.projects.view_qa', compact('finalMeasurements','finalMeasurementFiles','qa_questions', 'qa_doneTasks', 'subPurchases', 'subProjectData', 'subPartialDeliverDatas', 'subInvoiceFiles', 'subquotations', 'subquotationfiles', 'sub_quotation_uploads', 'submeasurements', 'sumeasurementfiles', 'sumeasurementphotos', 'issueProject', 'additionalProject', 'type', 'page', 'projects', 'fittings', 'purchases', 'workshops', 'quotations', 'quotationfiles', 'measurements', 'measurementfiles', 'measurementphotos', 'fitting_questions', 'fitting_doneTasks', 'sitephotos', 'workshop_questions', 'workshop_doneTasks', 'invoiceFiles', 'partialDeliverDatas'));
        } else if (Auth::user()->role == 10) {
            return view('qa.projects.view_qa', compact('finalMeasurements','finalMeasurementFiles','qa_questions', 'qa_doneTasks', 'subPurchases', 'subProjectData', 'subPartialDeliverDatas', 'subInvoiceFiles', 'subquotations', 'subquotationfiles', 'sub_quotation_uploads', 'submeasurements', 'sumeasurementfiles', 'sumeasurementphotos', 'issueProject', 'additionalProject', 'type', 'page', 'projects', 'fittings', 'purchases', 'workshops', 'quotations', 'quotationfiles', 'measurements', 'measurementfiles', 'measurementphotos', 'fitting_questions', 'fitting_doneTasks', 'sitephotos', 'workshop_questions', 'workshop_doneTasks', 'invoiceFiles', 'partialDeliverDatas'));
        }
        return view('quotation.projects.view_qa', compact('finalMeasurements','finalMeasurementFiles','qa_questions', 'qa_doneTasks', 'subPurchases', 'subProjectData', 'subPartialDeliverDatas', 'subInvoiceFiles', 'subquotations', 'subquotationfiles', 'sub_quotation_uploads', 'submeasurements', 'sumeasurementfiles', 'sumeasurementphotos', 'issueProject', 'additionalProject', 'type', 'page', 'projects', 'fittings', 'purchases', 'workshops', 'quotations', 'quotationfiles', 'measurements', 'measurementfiles', 'measurementphotos', 'fitting_questions', 'fitting_doneTasks', 'sitephotos', 'workshop_questions', 'workshop_doneTasks', 'invoiceFiles', 'partialDeliverDatas'));
    }
}
