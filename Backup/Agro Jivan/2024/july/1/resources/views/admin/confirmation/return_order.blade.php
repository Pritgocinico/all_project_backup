                                                ...
                                                <div class="px-7 py-5" data-kt-user-table-filter="form">
                                                    <div class="mb-10">
                                                        ...
                                                        <select class="form-select form-select-solid fw-bold"
                                                            ...
                                                            onchange="getSubDistrictDetail()" data-allow-clear="true"
...
@section('page')
    <script>
        ...
        function exportCSV() {
            ...
            window.open(exportFile + '?format=' + format + '&search=' + search + '&type=return&order_sub_district=' +
                order_sub_district, '_blank');
        }
