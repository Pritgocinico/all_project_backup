                ...
                <tr>
                    ...
                    <td style="padding: 5px 24px; width: 50%; text-align: left; margin-bottom: auto;">
                        ...
                        <p style="margin:3px 0px; font-size: 20px;">Name:-
                            <b>{{ isset($orders->orderDetail) ? $orders->orderDetail->customer_name : '' }}</b></p>
                        <p style="margin:3px 0px; font-size: 20px;">Address:-
                            <b>{{ isset($orders->orderDetail) ? $orders->orderDetail->address : '' }} </b></p>
                        ...
                        <p style="margin:3px 0px; font-size: 20px;">State:-
                            <b>{{ isset($orders->orderDetail->stateDetail) ? $orders->orderDetail->stateDetail->name : '' }}, {{ isset($orders->orderDetail) ? $orders->orderDetail->pincode: '' }}
                            </b></p>
                        <p style="margin:3px 0px; font-size: 20px;">Mobile Number:-
                            <b>{{ isset($orders->orderDetail) ? $orders->orderDetail->phoneno : '' }}</b> </p>
                    </td>
                </tr>
            </tbody>
        </table>
