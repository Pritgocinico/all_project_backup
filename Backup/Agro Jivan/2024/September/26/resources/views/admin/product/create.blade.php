                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                                ...
                                <select name="product_type" id="product_type" class="form-select">
                                    ...
                                    <option value="tax_product">Including Tax Product</option>
                                    <option value="without_tax_product">Excluding Tax Product</option>
                                </select>
                                <span class="text-danger"
                                    id="product_type_error">{{ $errors->getBag('default')->first('product_type') }}</span>
                            </div>
                            <div class="col-md-3 tax_div">
                                <label class="fs-6 fw-semibold mb-2">CGST (For example : 9)</label>
                                <input type="number" class="form-control" name="c_gst" min="0" id="c_gst" value="0">
                                <span class="text-danger"
                                    id="c_gst_error">{{ $errors->getBag('default')->first('c_gst') }}</span>
                            </div>
                            <div class="col-md-3 tax_div">
                                <label class="fs-6 fw-semibold mb-2">SGST (For example : 9)</label>
                                <input type="number" class="form-control" name="s_gst" min="0" id="s_gst" value="0">
                                <span class="text-danger"
