            ...
            <div id="kt_app_content" class="app-content  flex-column-fluid">
                <div id="kt_app_content_container" class="app-container  container-fluid">
                    <form class="form" action="{{ route('setting') }}" method="post"
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                                <label class="required fs-6 fw-semibold mb-2">Bill Amount Percentage</label>
                                <input type="text" class="form-control" placeholder="Enter Bill Amount Percentage"
                                    name="bill_amount_percentage" value="{{isset($setting)?$setting->bill_amount_percentage:''}}" id="bill_amount_percentage">
                            </div>
                        </div>
