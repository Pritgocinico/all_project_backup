...
class User extends Authenticatable
{
    ...
    public function cancelOrder(){
        return $this->hasMany(Order::class,'created_by','id')->where('order_status',4);
    }
    public function completeOrder(){
        return $this->hasMany(Order::class,'created_by','id')->where('order_status',6);
    }
    public function pendingOrder(){
        return $this->hasMany(Order::class,'created_by','id')->where('order_status',1);
    }
    public function onDeliveryOrder(){
        return $this->hasMany(Order::class,'created_by','id')->where('order_status',3);
    }
    public function confirmOrders(){
        return $this->hasMany(Order::class,'created_by','id')->where('order_status',2);
    }

    public function teamDetails()
    {
        return $this->hasMany(TeamDetail::class, 'user_id');
    }
}
