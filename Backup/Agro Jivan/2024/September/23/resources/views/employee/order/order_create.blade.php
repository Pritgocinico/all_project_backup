                ...
                <div id="kt_app_toolbar_container" class="container-fluid d-flex align-items-stretch ">
                    <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                        ...
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            ...
                            <a href="{{ route('orders.index') }}" class="btn btn-flex btn-primary h-40px fs-7 fw-bold">
                                Back
                            </a>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <select name="role" id="role" class="form-select" onchange="roleDropdown()">
                            <option value="">Select Search Call</option>
                        ...
                        <span class="text-danger" id="name_error">{{ $errors->getBag('default')->first('name') }}</span>
                    </div>
                </div>
            </form> --}}
            ...
            <div id="kt_app_content" class="app-content  flex-column-fluid">
                <div id="kt_app_content_container" class="app-container  container-fluid">
                    <form class="form" action="{{ route('orders.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control mb-3 mb-lg-0" placeholder="Enter Phone Number"
                                    name="phoneno" value="{{ old('phoneno') }}" id="phoneno">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" name="excepted_delievery_date"
                                    placeholder="Enter Pincode" value="{{ old('excepted_delievery_date') }}"
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                                <label for="Status" class="required fs-6 fw-semibold mb-2">Divert Order</label>
                                <div class="form-check form-switch">
                            ...
                            <div class="col-md-12 divert_order d-none">
                                ...
                                <textarea name="divert_note" id="" class="form-control"></textarea>
                            </div>
                        </div>
                        <hr class="mt-5">
                        <div class="col-md-12">
