                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                                ...
                                <select name="product_type" id="product_type" class="form-select">
                                    ...
                                    <option value="tax_product" @if($product->product_type == "tax_product") {{'selected'}} @endif>Including Tax Product</option>
                                    <option value="without_tax_product" @if($product->product_type == "without_tax_product") {{'selected'}} @endif>Excluding Tax Product</option>
                                </select>
                                <span class="text-danger"
