                    ...
                    <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                        <div class="row">
                            ...
                            <div class="col-xxl-8 col-xl-8 col-md-8 col-8 mb-2">
                                <input type="text" name="search_date" id="search_date"
                                    value="{{ date('Y-m-d') }}/{{ date('Y-m-d') }}" class="form-control search_date">
                            </div>
                        ...
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            <a href="{{ route('employees.create') }}"
                                class="btn btn-flex btn-outline btn-color-gray-700 btn-active-color-primary bg-body h-40px fs-7 fw-bold custom-button white">
                                <i class="fa-solid fa-plus"></i>&nbsp; Add Employee
                            </a>
                            <a href="{{ route('info-sheet.create') }}"
                                class="btn btn-flex btn-primary h-40px fs-7 fw-bold custom-button black">
                            ...
                            <a href="{{ route('daily-attendance') }}?type=all&status=present">
                                <div class="card h-lg-100 bg-custom-purple">
                                    <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                        ...
                                        <div class="d-flex flex-column my-7">
                                            <span
                                                class="fw-semibold fs-3x lh-1 ls-n2 text-white">{{ $totalEmployeePresent }}</span>
                                            <div class="m-0">
                                                <div class="m-0">
                                                    <span class="fw-semibold fs-2x text-white">
                                                        Total Present</span>
                            ...
                            <a href="{{ route('daily-attendance') }}?type=all&status=absent">
                                <div class="card h-lg-100 bg-custom-red">
                                    <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                        ...
                                        <div class="d-flex flex-column my-7">
                                            <span
                                                class="fw-semibold fs-3x lh-1 ls-n2 text-white">{{ $totalEmployeeAbsent }}</span>
                                            <div class="m-0">
                                                <span class="fw-semibold fs-2x text-white">
                                                    Total Absent</span>
                                            </div>
                            ...
                            <a href="{{ route('daily-attendance') }}?type=manager&status=present">
                                <div class="card h-lg-100 bg-custom-green">
                                    <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                        ...
                                        <div class="d-flex flex-column my-7">
                                            <span
                                                class="fw-semibold fs-3x lh-1 ls-n2 text-white">{{ $totalManagerPresent }}</span>
                                            <div class="m-0">
                                                <span class="fw-semibold fs-2x text-white">
                            ...
                            <a href="{{ route('daily-attendance') }}?type=manager&status=absent">
                                <div class="card h-lg-100 bg-custom-purple">
                                    <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                        ...
                                        <div class="d-flex flex-column my-7">
                                            <span
                                                class="fw-semibold fs-3x lh-1 ls-n2 text-white">{{ $totalManagerAbsent }}</span>
                                            <div class="m-0">
                                                <span class="fw-semibold fs-2x text-white">
                                                    Absent manager</span>
                                            </div>
                            ...
                            <a href="{{ route('admin-batch-list') }}?status=1">
                                <div class="card h-lg-100 bg-custom-red">
                                    <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                        ...
                                        <div class="d-flex flex-column my-7">
                                            <span
                                                class="fw-semibold fs-3x lh-1 ls-n2 text-white">{{ $totalBatchRoute }}</span>
                                            <div class="m-0">
                                                <span class="fw-semibold fs-2x text-white">
                    ...
                    <div class="row">
                            ...
                            <div id="kt_app_content_container" class="container-fluid mt-5">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="card-toolbar">
                                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                            <div class="parent-filter-menu">
                                                <input type="text" name="team_search_date" id="team_search_date"
                                                    value="{{ date('Y-m-d') }}/{{ date('Y-m-d') }}"
                                                    class="form-control team_search_date">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="card-title">
                                    <div class="d-flex align-items-center position-relative my-1">
                                        <h5>Order By Products</h5>
                                    </div>
                                </div>
                                <div class="card-toolbar">
                                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                        <div class="parent-filter-menu">
                                            <input type="text" name="chart_search_date" id="chart_search_date"
                                                value="{{ date('Y-m-d') }}/{{ date('Y-m-d') }}"
                                                class="form-control chart_search_date">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@section('page')
    ...
    <script>
        ...
        $(document).ready(function(e) {
            ...
            $(function() {
                $('.chart_search_date').daterangepicker({
                    autoUpdateInput: false,
                    maxDate: moment(),
                    startDate: moment(),
                    endDate: moment(),
                    ...
                    $('.chart_search_date').val(start.format('Y-MM-DD') + '/' + end.format(
                        'Y-MM-DD'));
                    chartDetail();
                });
            });
            $(function() {
                $('.team_search_date').daterangepicker({
                    ...
                    $('.team_search_date').val(start.format('Y-MM-DD') + '/' + end.format(
                        'Y-MM-DD'));
                    teamAjaxList();
                });
            });
        ...
        function chartDetail() {
            var search_date = $('#chart_search_date').val();
            $.ajax({
                method: 'get',
                url: '{{ route('admin-dashboard-product-chart') }}',
                data: {
