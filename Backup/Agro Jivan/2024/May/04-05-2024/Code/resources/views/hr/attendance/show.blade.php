...
<div class="app-main flex-column flex-row-fluid " id="kt_app_main">
                    ...
                    <div class="flex-lg-row-fluid ms-lg-15">
                        <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link text-active-primary pb-4 active" data-kt-countup-tabs="true" data-bs-toggle="tab" href="#kt_user_view_overview_security" data-kt-initialized="1" aria-selected="false" tabindex="-1" role="tab">Attendance</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                        ...
                                        <div id="kt_app_content" class="flex-column-fluid ">
                                            <div id="kt_app_content_container" class="container-fluid ">
                                                <div class="card-body py-4">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="card-body py-4 table-responsive attendance_table_scroll" id="attendance_table_scroll">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script>
        var id = "{{ $employee->id }}";
        var calendarUrl = "{{ route('hr-calendar-detail', 'id') }}";
        var attendanceData = "{{ route('hr_attendance_by_date') }}";
    ...
    <script>
        ...
        function loadDateData(page) {
            $.ajax({
                method: 'get',
                url: "{{ route('hr-attendance-date-ajax') }}",
                data: {
                    page: page
                },
