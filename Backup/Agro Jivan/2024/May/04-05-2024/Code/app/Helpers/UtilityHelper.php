...
class UtilityHelper
{
    ...
    public static function getCurrentMonth(){
        ...
        // Set the date to the end of the current month and format it
        $endOfMonth = Carbon::now()->endOfMonth()->format('Y-m-d');
        return $startOfMonth ."/".$endOfMonth;
    }
    public static function getTodayDate(){
        $startOfMonth = Carbon::now()->format('Y-m-d');
    ...
    public static function monthNumber($month)
    {
        ...
        // Use Carbon to parse the month name and get the month number
        $monthNumber = Carbon::parse($month)->month;
        
        return $monthNumber;
    }

    public static function getDiffBetweenDateLeave($start,$end){
