        ...
        <div class="d-flex flex-column flex-column-fluid">
            <div id="kt_app_content" class="app-content  flex-column-fluid">
                <div id="kt_app_content_container" class="app-container container-fluid">
                    ...
                    <form class="form" action="{{ route('employee-orders.store') }}" method="post"
                        enctype="multipart/form-data" id="create_order_form">
                        @csrf
                        <div class="row">
                            <div class="col-md-9">
                                <div class="">
                                        ...
                                        <div class="d-md-flex gap-4 align-items-center bg-white p-3">
                                            ...
                                            <div class="w-100 gap-4 align-items-center">
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-3 d-none" id="clear_detail_div_button">
                                                            ...
                                                            @foreach ($categoryList as $category)
                                                                ...
                                                                @else
                                                                    <option value="{{ $category->id }}"
                                                                        @if ($category->id == old('category.' . $i)) {{ 'selected' }} @endif>
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-6 order_lead_checkbox">
                                    ...
                                    <div class="col-md-6 lead_datetime d-none">
                                        ...
                                        <input type="datetime-local" name="lead_datetime" id="lead_datetime"
                                            class="form-control" value="{{ Utility::convertMDYAMPM() }}">
                                    </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-primary" onclick="setLoader()"
                        ...
                        <div class="mt-2">
                            ...
                            <button type="button" name="submit" value="button" class="btn btn-primary"
