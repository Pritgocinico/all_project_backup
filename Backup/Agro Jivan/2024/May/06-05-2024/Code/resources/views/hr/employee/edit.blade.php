        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content  flex-column-fluid">
                <div id="kt_app_content_container" class="app-container  container-fluid">
                    <form class="form" action="{{ route('hr.update', $employee->id) }}" method="post"
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-2">
                                <a href="{{ url('/') }}/public/assets/upload/{{ $employee->aadhar_card }}" download>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-2">
                                <a href="{{ url('/') }}/public/assets/upload/{{ $employee->pan_card }}" download>
                            ...
                            <div class="col-md-2">
                                <a href="{{ url('/') }}/public/assets/upload/{{ $employee->qualification }}"
                                    download>
                                    <img src="{{ url('/') }}/public/assets/media/png_images/file.png"
                                        width="60px">
                                </a>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 {{$show}}">
                                    <a href="{{ url('/') }}/public/assets/upload/{{ $employee->join_agreement }}"
                                        download>
                                        <img src="{{ url('/') }}/public/assets/media/png_images/file.png"
                                            width="60px">
                                    </a>
