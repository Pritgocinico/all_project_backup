...
class SalesManagerController extends Controller
{
    ...
    public function index(){
        ...
        $totalAbsent = Attendance::where('status',"0")->whereDate('attendance_date', Carbon::today())->count();
        return view('sale_manager.index',compact('pendingCount','confirmCount','deliverCount','cancelCount','returnCount','completeCount','inOutStockCount','totalEmployee','page','totalAbsent'));
    }
