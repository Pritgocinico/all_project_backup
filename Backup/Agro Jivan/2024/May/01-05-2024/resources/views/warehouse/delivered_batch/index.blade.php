        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div id="batch_product_detail"></div>
                </div>
...
@section('page')
    <script>
        ...
        function batchAjaxList(page) {
            $.ajax({
                method: 'get',
                url: "{{ route('delivered-batch-ajax') }}",
                data: {
                    page: page,
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $.each(res, function(i, v) {
                        if (v !== batchId) {
                            html += `<div class="row">
                                <div class="col-md-4"><b>` + v.product_name + `:</b></div>
                                <div class="col-md-6">` + v.quantity + `</div>
                                </div>`;
                        }
                    })
        ...
        function exportCSV() {
            ...
            window.open("{{route('delivered-batch-export')}}" + '?format=' + format + '&role=' + role + '&search=' + search, '_blank');
        }
    </script>
@endsection
