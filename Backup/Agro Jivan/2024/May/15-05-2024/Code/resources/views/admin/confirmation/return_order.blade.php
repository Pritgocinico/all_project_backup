...
@section('page')
    <script>
        var ajaxList = "{{ route('return-order-ajax') }}";
        var exportFile = "{{ route('manual-orders-export') }}";
        ...
        function exportCSV() {
            ...
            window.open(exportFile + '?format=' + format + '&search=' + search + '&type=return&order_sub_district='+order_sub_district, '_blank');
        }
