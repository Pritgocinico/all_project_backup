        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content  flex-column-fluid">
                <div id="kt_app_content_container" class="app-container  container-fluid">
                    <form class="form" action="{{ route('hr-employees-add-post') }}" method="post"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select name="shift_type" id="shift_type" class="form-select">
                                    ...
                                    <option value="1" @if (old('shift_type') == "1") selected @endif>Shift - 1 (08:30 AM to 05:30 PM)</option>
                        ...
                        <div class="mt-4">
                            <button type="submit" name="submit" value="submit" class="btn btn-primary btn-left">Submit</button>
                        </div>
                    </form>
