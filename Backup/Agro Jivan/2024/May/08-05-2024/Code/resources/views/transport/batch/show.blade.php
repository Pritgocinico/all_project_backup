...
@section('page')
    <script>
        ...
        function exportInvoice() {
            ...
            window.open("{{route('batch-order-invoice-pdf')}}" + '?search=' + search+'&date=' + batch_date+'&id=' + "{{$id}}"+"&order_status="+order_status, '_blank');
        }
        function exportBatchOrder(){
            ...
            window.open("{{route('export-batch-order')}}" + '?format='+format+'&search=' + search+'&date=' + batch_date+'&id=' + "{{$id}}" + "&order_status="+order_status, '_blank');
        }
