        ...
        <div class="d-flex flex-column flex-column-fluid">
            <div id="kt_app_content" class="app-content  flex-column-fluid">
                <div id="kt_app_content_container" class="app-container  container-fluid">
                    <form class="form" action="{{ route('employee-lead.store') }}" method="post"
                            ...
                            <div class="col-md-9">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="search-1 d-none">
                                                    <select name="search_sub_district" id="search_sub_district" class="form-select">
                                                        <option value="" selected>Select Sub District</option>
                                                        @foreach ($subdistricts as $subdistrict)
                                                            <option value="{{ $subdistrict->sub_district }}">{{ $subdistrict->sub_district_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-2 d-none" id="clear_detail_div_button">
                                                <a class="btn btn-icon btn-active-light-primary w-30px h-30px me-3 align-bottom"
                                                    href="#" onclick="filterSearchData()" data-bs-toggle="tooltip" data-bs-placement="top" title="Reset Form">
                                                    <i class="ki-outline ki-cross-circle text-danger" style="font-size: 20px !important"></i>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control mb-3 mb-lg-0" onkeypress="return event.keyCode == 13?false:true"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="district" id="district" class="form-select"
                                            ...
                                            @foreach ($district as $districts)
                                                <option value="{{ $districts->district }}">{{ $districts->district_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        <span class="text-danger"
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-6 lead_datetime d-none">
                                        ...
                                        <input type="datetime-local" name="lead_datetime" class="form-control" value="" id="lead_datetime">
                                    </div>
...
@section('page')
    ...
    <script>$('#lead_datetime').val(moment().format('YYYY-MM-DDTHH:mm'));</script>
