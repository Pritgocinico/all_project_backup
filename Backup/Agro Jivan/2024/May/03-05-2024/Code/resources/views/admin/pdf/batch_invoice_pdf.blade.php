...
<body>
    <div style="border: 1px solid black; width: 1000px;">
        <table class="table table-hover" border="1" style="border-collapse: collapse; width: 100%; font-size: 18px;">
            <tbody>
                <tr>
                    ...
                    @endif
                        <p style="margin:3px 0px; font-size: 18px; "><span
            ...
            <tbody>
                <tr>
                    ...
                    <td style="padding: 5px 24px; width: 50%; text-align: left; margin-bottom: auto;">
                        ...
                        <p style="margin:3px 0px; font-size: 20px;">Name:- <b>{{ isset($orders->orderDetail)?$orders->orderDetail->customer_name:"" }}</b></p>
                        <p style="margin:3px 0px; font-size: 20px;">Address:- <b>{{ isset($orders->orderDetail)?$orders->orderDetail->address:"" }} </b></p>
                        <p style="margin:3px 0px; font-size: 20px;">Village:- <b>{{ isset($orders->orderDetail->villageDetail)?$orders->orderDetail->villageDetail->village_name:"" }} </b></p>
                        <p style="margin:3px 0px; font-size: 20px;">Sub District:- <b>{{ isset($orders->orderDetail->subDistrictDetail)?$orders->orderDetail->subDistrictDetail->sub_district_name:"" }} </b></p>
                        <p style="margin:3px 0px; font-size: 20px;">District:- <b>{{ isset($orders->orderDetail->districtDetail)?$orders->orderDetail->districtDetail->district_name:"" }} </b> </p>
                        <p style="margin:3px 0px; font-size: 20px;">State:- <b>{{ isset($orders->orderDetail->stateDetail)?$orders->orderDetail->stateDetail->name:"" }} </b></p>
                        <p style="margin:3px 0px; font-size: 20px;">Mobile Number:- <b>{{ isset($orders->orderDetail)?$orders->orderDetail->phoneno:"" }}</b> </p>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <div style="margin-bottom: 0px;">
                ...
                <tbody>
                    ...
                    @foreach ($orders->orderDetail->orderItem as $key => $item)
                        <tr>
                            ...
                            <td style="width: 50px; padding:5px 5px;text-align: center">{{ $item->productDetail->c_gst + $item->productDetail->s_gst }} %</td>
                            <td style="width: 50px; padding:5px 5px;text-align: center">
            ...
            <div
                style=" text-align: right; border-bottom: 1px solid; border-top: 0; margin: 0; gap: 15px;">
