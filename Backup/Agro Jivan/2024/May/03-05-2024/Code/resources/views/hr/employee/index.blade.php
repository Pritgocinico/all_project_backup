                ...
                <div id="kt_app_content_container" class="container-fluid ">
                    ...
                    <div class="row gx-6 gx-xl-9">
                        ...
                        <div class="col-lg-4 col-md-5 col-xl-3 col-xxl-2 mx-auto">
                            <canvas id="present_absent_chart"></canvas>
                        </div>
                    </div>
                    <div id="kt_app_content" class="flex-column-fluid pt-15">
                        <div id="kt_app_content_container" class="app-container container-fluid">
                             <div class="card-header custom-responsive-div d-flex justify-content-between align-items-center flex-column-1199">
                                    ...
                                    <div class="card-toolbar">
                                        <div class="d-flex justify-content-end custom-responsive-div" data-kt-user-table-toolbar="base">
                                            ...
                                            @if (Permission::checkPermission('employee-create'))
                            ...
                            <div class="card-body py-4 table-responsive" id="employee_table_ajax">
                            </div>
                        </div>
                    </div>
                </div>
...
@section('page')
    <script>
        var ajaxList = "{{ route('hr-employee-ajax') }}"
        var exportFile = "{{ route('hr-employee-export') }}";
        var deleteURL = "{{ route('hr.destroy', 'id') }}";
