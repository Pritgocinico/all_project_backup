...
<body>
    ...
    <h5 style="text-align: center">Driver Detail</h5>
    ...
    <h5 style="text-align: center">Order Detail</h5>
    <table class="table" id="kt_table_users">
        <thead>
            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                <th class="table">Order Id</th>
                <th class="table" style="min-width: 50px;">Customer Name</th>
                <th class="table">Mobile Number</th>
        ...
        <tbody class="text-gray-600 ">
            @forelse ($batchItem as $key=>$order)
                <tr>
                    ...
                    <td class="table">
                        {{ isset($order->orderDetail) ? $order->orderDetail->phoneno : '' }}
                    </td>
                    ...
                    if ($order->created_at  !== null) {
                        $date = Utility::convertFullDateTime($order->created_at);
                    }
                    @endphp
