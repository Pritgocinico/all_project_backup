...
Route::group(['prefix' => 'admin'], function(){
    Route::middleware('auth','role:admin','autoLogout')->group(function () {
        ...
        Route::get('admin-dashboard-product-chart',[AdminDashboardController::class,'OrderProductChart'])->name('admin-dashboard-product-chart');
        ...
        Route::get('order-product-report',[ReportController::class,'salesReport'])->name('order-product-report');
        ...
        Route::get('order-feedback-export',[AfterSaleServiceController::class,'exportCSV'])->name('order-feedback-ajax-export');
        ...
        Route::get('admin-order-status-update',[DriverController::class,'statusUpdate'])->name('admin-order-status-update');

         // Lead
         Route::resource('admin-lead',EmployeeLeadController::class);
         Route::get('admin-lead-ajax',[EmployeeLeadController::class,'ajaxList'])->name('admin-lead-ajax');
         Route::get('admin-add-lead-ajax',[EmployeeLeadController::class,'getLeadDetail'])->name('admin-add-lead-ajax');
         Route::get('admin-lead-export',[EmployeeLeadController::class,'exportCSV'])->name('admin-lead-export');
         Route::get('convert-lead-order',[EmployeeLeadController::class,'convertLeadToOrder'])->name('admin-convert-lead-order');
    });
...
Route::group(['prefix' => 'transport'], function(){
    Route::middleware(['auth','role:Transport Department','autoLogout'])->group(function () {
        ...
        Route::get('generate-bulk-invoice',[TransportDepartmentController::class,'generateBulkInvoice'])->name('generate-bulk-invoice');
        Route::get('export-delivered-order',[TransportDepartmentController::class,'exportDeliveredOrder'])->name('export-delivered-order');

        Route::get('transport-order-list',[OrderController::class,'confirmOrderQuery'])->name('transport-order-list');
        Route::get('transport-order-status-update',[DriverController::class,'statusUpdate'])->name('transport-order-status-update');
        Route::get('transport-order-edit/{id}',[OrderController::class,'edit'])->name('transport-order-edit');
    });
    Route::get('deliver-order-list',[OrderController::class,'deliveredAjaxList'])->name('deliver-order-list');
    ...
    Route::get('batch-list',[TransportDepartmentController::class,'batchList'])->name('transport-batch-list');  
...
Route::group(['prefix' => 'warehouse'], function(){
    Route::middleware(['auth','role:Warehouse Manager','autoLogout'])->group(function () {
        ...
        Route::get('warehouse-order-status-update',[DriverController::class,'statusUpdate'])->name('warehouse-order-status-update');
    });
    ...
    Route::get('delete-batch',[WarehouseManagerController::class,'deleteBatch'])->name('delete-batch');
...
Route::group(['prefix' => 'sales'], function(){
    Route::middleware(['auth','role:Sales Manager','autoLogout'])->group(function () {
        ...
        Route::get('daily-order-list',[OrderController::class,'confirmOrderQuery'])->name('daily-order-list');
...
Route::group(['prefix' => 'sales_service'], function(){
    Route::middleware(['auth','role:After Sales Service','autoLogout'])->group(function () {
        ...
        Route::get('sale-order-feedback-export',[AfterSaleServiceController::class,'exportCSV'])->name('sale-order-feedback-ajax-export');
