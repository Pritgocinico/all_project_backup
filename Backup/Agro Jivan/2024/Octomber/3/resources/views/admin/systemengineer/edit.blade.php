        ...
        <div class="d-flex flex-column flex-column-fluid">
                    ...
                    <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                        <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                            ...
                            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                                ...
                                <li class="breadcrumb-item text-muted">
                                    <a href="{{ route('systemengineer.index') }}" class="text-muted text-hover-primary">
            ...
            <div id="kt_app_content" class="app-content  flex-column-fluid">
                <div id="kt_app_content_container" class="app-container  container-fluid">
                    <form class="form" action="{{ route('systemengineer.update',$systemengineer->id) }}" method="post" enctype="multipart/form-data" >
                        <input type="hidden" name="id" value="{{$systemengineer->id}}">
                        @method('PUT')
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control mb-3 mb-lg-0"
                                    placeholder="Enter Name" name="name" value="{{ $systemengineer->name }}" id="name">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control" placeholder="Enter Email" name="email"
                                    value="{{ $systemengineer->email }}" id="email">
                                <span class="text-danger"
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" placeholder="Enter Phone Number"
                                    name="phone_number" value="{{ $systemengineer->phone_number }}" id="phone_number">
                                <span class="text-danger"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="status"
                                        id="flexSwitchCheckChecked" @if($systemengineer->status == 1) {{'checked'}} @endif>
