        ...
        @forelse ($orderList as $key=>$order)
            <tr>
                <td class="align-middle">
                    <a href="{{route('orders.show',$order->id)}}" class="pre-agro-emp">{{ $order->order_id }}</a>
                </td>
                ...
                <td>
                    <a class="btn btn-primary" onclick="openAssignDriver({{$order->id}})" data-bs-toggle="tooltip" data-bs-placement="top" title="Assign Driver">Assign Driver</a> 
                </td>
            </tr>
        @empty
            <tr>
