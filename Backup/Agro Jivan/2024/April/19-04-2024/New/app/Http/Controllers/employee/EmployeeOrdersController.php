...
class EmployeeOrdersController extends Controller
{
    ...
    public function OrderajaxList(Request $request)
    {
        ...
        $orderList = $this->employeeOrderRepository->getAllData($search, $status, $district, $date, "all", 'paginate');
    ...
    public function pendingOrderList(Request $request)
    {
        ...
        $district = $request->district;
        $date = $request->date;
        $pending_order = $this->employeeOrderRepository->getAllData($search, "", $district, $date, 1, 'paginate');
    ...
    public function cancelOrderList(Request $request)
    {
        ...
        $district = $request->district;
        $date = $request->date;
        $cancel_order = $this->employeeOrderRepository->getAllData($search, "", $district, $date, 4, 'paginate');
    ...
    public function returnOrderList(Request $request)
    {
        ...
        $return_order = $this->employeeOrderRepository->getAllData($search, "", $district, $date, 5, 'paginate');
    ...
    public function completedOrderList(Request $request)
    {
        ...
        $district = $request->district;
        $date = $request->date;
        $completed_order = $this->employeeOrderRepository->getAllData($search, "", $district, $date, 6, 'paginate');
    ...
    public function confirmOrderList(Request $request)
    {
        ...
        $district = $request->district;
        $date = $request->date;
        $return_order = $this->employeeOrderRepository->getAllData($search, "", $district, $date, 2, 'paginate');
