...
class OrderRepository implements OrderRepositoryInterface
{
    ...
    public function getAllData($status, $search, $type, $driverId = "", $date = "", $order_district = "",$userId = "")
    {
        $query = $this->getQuery($status, $search, $driverId, $date, $order_district,$userId)->latest();
        if ($type == 'paginate') {
            $query = $query->paginate(15);
        }
        if ($type == "export") {
    ...
    public function getQuery($status, $search, $driverId, $date = "", $order_district,$userId)
    {
