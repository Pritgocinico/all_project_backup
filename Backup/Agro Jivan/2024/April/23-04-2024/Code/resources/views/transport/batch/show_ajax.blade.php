    ...
    <tbody class="text-gray-600 fw-semibold">
        @forelse ($batchItem as $key=>$order)
            <tr>
                ...
                <td>
                    <a class="btn btn-icon btn-danger w-30px h-30px me-3" onclick="removeOrder({{ $order->orderDetail->id }})" data-bs-toggle="tooltip" data-bs-placement="top" title="Cancel Order">
