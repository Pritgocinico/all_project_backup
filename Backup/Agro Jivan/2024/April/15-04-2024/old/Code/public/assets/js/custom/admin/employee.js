        ...
        if (isConfirm.isConfirmed) {
            $.ajax({
                ...
                success: function (res) {
                    ...
                    employeeAjaxList(parseInt(document.querySelector('.pagination .page-item.active .page-link').innerText));
                },
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data.repeat_login !== null){
                        repeatTime = moment(data.repeat_login, 'YYYY-MM-DD hh:mm:ss').format('DD-MM-YYYY hh:mm A');
                    }
