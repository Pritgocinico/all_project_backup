...
{
    protected $productRepository, $categoryRepository, $employeeRepository, $batchRepository;
    public function __construct(ProductRepositoryInterface $productRepository, CategoryRepositoryInterface $categoryRepository, EmployeeRepositoryInterface $employeeRepository, BatchRepositoryInterface $batchRepository)
    {
    ...
    public function index()
    {
        ...
        return view('warehouse.index', compact('driverList', 'batchCount', 'productCount', 'page'));
    }
