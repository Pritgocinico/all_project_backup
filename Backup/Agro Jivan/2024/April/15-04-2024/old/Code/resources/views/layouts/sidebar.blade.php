            ...
            <div id="kt_app_header" class="app-header  d-flex flex-column flex-stack ">
                ...
                <div class="d-flex flex-stack flex-grow-1">
                    ...
                    <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
                            ...
                            <div class="app-navbar-item ms-2 ms-lg-6">
                                <ul class="navbar-nav justify-content-end">
                                    @if (!empty($break))
                                        @if ($break->break_over != '')
                                            <li class="nav-item">
                                                <a href="javascript:void(0);" class="btn btn-primary mx-sm-3 mx-0 take_break text-nowrap">
                                        ...
                                        @else
                                            <li class="nav-item">
                                                <a href="#" class="btn btn-primary mx-3 text-nowrap">Complete Break</a>
                                            </li>
                                        @endif
                                    @else
                                        <li class="nav-item">
                        ...
                        <div class="app-navbar-item ms-2 ms-lg-6">
                        <a href="#" class="main-cmn-back-btn" onclick="window.history.back();" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Back"><i class="fa-solid fa-arrow-left"></i></a>
                            <a href="{{ url('/') }}/chatify" class="btn btn-primary mx-xs-3 mx-0 text-nowrap" target="_blank"> <span class="chat-text">Chat</span>
                        ...
                        <div class="app-navbar-item ms-2 ms-lg-6">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown custom-pre-menu-notification menu-column"
                                ...
                                <!--begin::Heading-->
                                <div class="d-flex inner-custom-notification justify-content-between bgi-no-repeat rounded-top px-9 py-5">
                                    <!--begin::Title-->
                        ...
                        <div id="kt_app_sidebar_wrapper" class="hover-scroll-y my-5 my-lg-2 mx-4"
                            ...
                            @if (Auth()->user() !== null && Auth()->user()->role_id == 1)
                                ...
                                <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link @if (\Route::currentRouteName() == 'dashboard') active @endif" href="{{ $route }}">
                                    ...
                                    @php $sales = "" @endphp
                                    @if (\Route::currentRouteName() == 'employees.index' || \Route::currentRouteName() == 'department.index' || \Route::currentRouteName() == 'vip-customer-list')
                                        @php $sales = "show" @endphp
                                    @endif
                                    <!--begin:Menu item-->
                                    @if (Permission::checkPermission('employee-list') ||
                                            Permission::checkPermission('department'))
                                                    ...
                                                    <div class="menu-item"><!--begin:Menu link-->
                                                        <a class="menu-link @if (\Route::currentRouteName() == 'vip-customer-list') active @endif"
                                                            href="{{ route('vip-customer-list') }}"><span
                                                                class="menu-bullet"><span
                                                                    class="bullet bullet-dot"></span></span><span
                                                                class="menu-title">VIP Customer</span></a><!--end:Menu link-->
                                                    </div>
                                                </div>
                                            @endif
                                        ...
                                        <div class="menu-sub menu-sub-accordion"><!--begin:Menu item-->
                                            <div class="menu-item"><!--begin:Menu link--><a
                                                    ...
                                                    href="{{ route('daily-attendance') }}"><span
                                                        class="menu-bullet"><span
                                                            class="bullet bullet-dot"></span></span><span
                                                        class="menu-title">Daily Attendance</span></a><!--end:Menu link-->
                                            </div>
                                        </div>
                                        ...
                                        <div class="menu-sub menu-sub-accordion"><!--begin:Menu item-->
                                            <div class="menu-item"><!--begin:Menu link--><a
                                                    ...
                                                    href="{{ route('all-deliver-order') }}"><span
                                                        class="menu-bullet"><span
                                                            class="bullet bullet-dot"></span></span><span
                                                        class="menu-title">Completed Order</span></a><!--end:Menu link-->
                                            </div>
                                        </div>
                                        <div class="menu-sub menu-sub-accordion"><!--begin:Menu item-->
                                            <div class="menu-item"><!--begin:Menu link--><a
                                        ...
                                        <div class="menu-sub menu-sub-accordion"><!--begin:Menu item-->
                                            <div class="menu-item"><!--begin:Menu link--><a
                                                    ...
                                                    href="{{ route('top-order-product') }}"><span
                                                        class="menu-bullet"><span
                                                            class="bullet bullet-dot"></span></span><span
                                                        class="menu-title">Top Product Sale</span></a><!--end:Menu link-->
                                            </div>
                                        </div>
                                    </div>
                                    @php $product = "" @endphp
                                    ...
                                    <div data-kt-menu-trigger="click"
                                        ...
                                        <div class="menu-sub menu-sub-accordion"><!--begin:Menu item-->
                                            <div class="menu-item"><!--begin:Menu link--><a
                                                    ...
                                                    href="{{ route('admin-in-out-stock') }}"><span class="menu-bullet"><span
                                                            class="bullet bullet-dot"></span></span><span
                                        ...
                                        <div class="menu-sub menu-sub-accordion"><!--begin:Menu item-->
                                            <div class="menu-item"><!--begin:Menu link--><a
                                                    ...
                                                    href="{{ route('return-order') }}"><span
                                                        class="menu-bullet"><span
                                                            class="bullet bullet-dot"></span></span><span
                                                        class="menu-title">Return Order</span></a><!--end:Menu link-->
                                            </div>
                                        </div>
                                        <div class="menu-sub menu-sub-accordion"><!--begin:Menu item-->
                                            <div class="menu-item"><!--begin:Menu link--><a
                                                    ...
                                                    href="{{ route('divert-transport') }}"><span
                                                        ...
                                                        Transposrt</span></a><!--end:Menu link-->
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div data-kt-menu-trigger="click"
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            <div class="menu-item"><a
                                                    ...
                                                    href="{{ route('admin-batch-list') }}"><span class="menu-bullet"><span
                                                            class="bullet bullet-dot"></span></span><span
                                    ...
                                    {{-- @php $account = "" @endphp
                                    @if (
                                        \Route::currentRouteName() == 'order-deliver' ||
                                            Route::currentRouteName() == 'hr-salary-slip' ||
                                            Route::currentRouteName() == 'all-stock')
                                    ...
                                    @if (
                                        \Route::currentRouteName() == 'order_report' ||
                                            ...
                                            \Route::currentRouteName() == 'sales-report' ||
                                    ...
                                    <div data-kt-menu-trigger="click"
                                        ...
                                        {{-- <div class="menu-sub menu-sub-accordion"><!--begin:Menu item-->
                                            <div class="menu-item"><!--begin:Menu link--><a
                                                    class="menu-link @if (\Route::currentRouteName() == 'sales-report') active @endif"
                                                    href="{{ route('sales-report') }}"><span
                                                        class="menu-bullet"><span
                                                            class="bullet bullet-dot"></span></span><span
                                                        class="menu-title">Sales Report</span></a><!--end:Menu link-->
                                            </div>
                                        </div> --}}
                                        <div class="menu-sub menu-sub-accordion"><!--begin:Menu item-->
                                            <div class="menu-item"><!--begin:Menu link--><a
                            ...
                            @if (Auth()->user() !== null && Auth()->user()->role_id == 2)
                                ...
                                <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
                                    class="app-sidebar-menu-primary menu menu-column menu-rounded menu-sub-indention menu-state-bullet-primary px-3 mb-5">
                                    <div class="menu-item">
                                        <a class="menu-link @if (\Route::currentRouteName() == 'employee-dashboard') active @endif" href="{{ $route }}">
                                    ...
                                    @if (Permission::checkPermission('info-sheet-list'))
                                        <div class="menu-item">
                                            <a class="menu-link @if (\Route::currentRouteName() == 'employee-info-sheet.index') active @endif" href="{{ route('employee-info-sheet.index') }}">
                                    ...
                                    @if (Permission::checkPermission('attendance-list'))
                                        <div class="menu-item">
                                            <a class="menu-link @if (\Route::currentRouteName() == 'attendance') active @endif" href="{{ route('attendance') }}">
                                                <span class="menu-icon"><i class="fa-regular fa-clock"></i></span><span
                                                    class="menu-title">
                                                    Attendance</span>
                                            </a>
                                        </div>
                                    ...
                                    @if (Permission::checkPermission('leave-list'))
                                        <div class="menu-item">
                                            <a class="menu-link @if (\Route::currentRouteName() == 'employee-leave.index') active @endif" href="{{ route('employee-leave.index') }}">
                                    ...
                                    @if (Permission::checkPermission('holiday-list'))
                                        <div class="menu-item">
                                            <a class="menu-link @if (\Route::currentRouteName() == 'holiday') active @endif" href="{{ route('holiday') }}">
                                                <span class="menu-icon"><i class="fa-solid fa-pencil"></i></span><span class="menu-title">
                                                    Holidays</span>
                                            </a>
                                        </div>
                            ...
                            @if (Auth()->user() !== null && Auth()->user()->role_id == 3)
                                <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
                                    class="app-sidebar-menu-primary menu menu-column menu-rounded menu-sub-indention menu-state-bullet-primary px-3 mb-5">
                                    <div class="menu-item">
                                        <a class="menu-link @if (\Route::currentRouteName() == 'hr-dashboard') active @endif" href="{{ $route }}">
                                            <span class="menu-icon"><i class="fa-solid fa-home"></i></span><span
                                                class="menu-title">
                                                Dashboard</span>
                                        </a>
                                    ...
                                    @if (Permission::checkPermission('employee-list'))
                                        <div class="menu-item">
                                            <a class="menu-link @if (\Route::currentRouteName() == 'hr-employee') active @endif" href="{{ route('hr-employee') }}">
                                    ...
                                    @if (Permission::checkPermission('info-sheet-list'))
                                        <div class="menu-item">
                                            <a class="menu-link @if (\Route::currentRouteName() == 'hr-info-sheet') active @endif" href="{{ route('hr-info-sheet.index') }}">
                                                <span class="menu-icon"><i
                                                        class="fa-solid fa-circle-info"></i></span><span
                                                    class="menu-title">
                                                    Info Sheets</span>
                                    ...
                                    @if (Permission::checkPermission('holiday-list'))
                                        <div class="menu-item">
                                            <a class="menu-link @if (\Route::currentRouteName() == 'hr-holiday') active @endif" href="{{ route('hr-holiday') }}">
                                                <span class="menu-icon"><i class="fa fa-ticket"
                                                        aria-hidden="true"></i></span><span class="menu-title">
                                                    Holiday</span>
                                            </a>
                                    ...
                                    @if (Permission::checkPermission('leave-list'))
                                        <div class="menu-item">
                                            <a class="menu-link @if (\Route::currentRouteName() == 'hr-leave') active @endif" href="{{ route('hr-leave') }}">
                                                <span class="menu-icon"><i class="fa fa-certificate"
                                                        aria-hidden="true"></i></span><span class="menu-title">
                                                    Leave</span>
                                            </a>
                                    ...
                                    @if (Permission::checkPermission('ticket-view'))
                                        <div class="menu-item">
                                            <a class="menu-link @if (\Route::currentRouteName() == 'hr-ticket') active @endif" href="{{ route('hr-ticket') }}">
                                    ...
                                    @if (Permission::checkPermission('attendance-list'))
                                        <div class="menu-item">
                                            <a class="menu-link @if (\Route::currentRouteName() == 'hr-attendance') active @endif" href="{{ route('hr-attendance') }}">
                                                <span class="menu-icon"><i class="fa-solid fa-house"></i></span><span
                                                    class="menu-title">
                                                    Attendance</span>
                                            </a>
                                    ...
                                    @if (Permission::checkPermission('salary-slip-list'))
                                        <div class="menu-item">
                                            <a class="menu-link @if (\Route::currentRouteName() == 'hr-salaryslip.index') active @endif" href="{{ route('hr-salaryslip.index') }}">
                                    ...
                                    @endif
                                    <div class="menu-item">
                                        <a class="menu-link @if (\Route::currentRouteName() == 'hr-daily-attendance') active @endif" href="{{ route('hr-daily-attendance') }}">
                                            <span class="menu-icon"><i class="fa-solid fa-calendar-day fs-2"></i></span><span class="menu-title">
                            ...
                            @if (Auth()->user() !== null && Auth()->user()->role_id == 4)
                                <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
                                    class="app-sidebar-menu-primary menu menu-column menu-rounded menu-sub-indention menu-state-bullet-primary px-3 mb-5">
                                    <div class="menu-item">
                                        <a class="menu-link @if (\Route::currentRouteName() == 'confirm-dashboard') active @endif" href="{{ $route }}">
                                            <span class="menu-icon"><i class="fa-solid fa-home"></i></span><span
                                                class="menu-title">
                                                Dashboard</span>
                                        </a>
                                    ...
                                    @if (Permission::checkPermission('pending-order-list'))
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link"
                                                class="menu-link @if (\Route::currentRouteName() == 'confirm-order') active @endif"
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link"
                                                class="menu-link @if (\Route::currentRouteName() == 'cancel-order') active @endif"
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link"
                                                class="menu-link @if (\Route::currentRouteName() == 'confirm-return-order') active @endif"
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link"
                                                class="menu-link @if (\Route::currentRouteName() == 'deliver-order') active @endif"
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link"
                                            class="menu-link @if (\Route::currentRouteName() == 'top-five-confirm-order') active @endif"
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link"
                                            class="menu-link @if (\Route::currentRouteName() == 'confirm-leave.index') active @endif"
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link"
                                            class="menu-link @if (\Route::currentRouteName() == 'confirm-ticket.index') active @endif"
                                            href="{{ route('confirm-ticket.index') }}">
                                            <span class="menu-icon"><i
                                                    class="fa-solid fa-ticket"></i></span><span
                                                class="menu-title">
                                                Ticket</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link @if (\Route::currentRouteName() == 'confirm-holiday') active @endif" href="{{ route('confirm-holiday') }}">
                                            <span class="menu-icon"><i class="fa-solid fa-pencil"></i></span><span class="menu-title">
                                                Holidays</span>
                                        </a>
                                    </div>
                                    @if (Permission::checkPermission('vip-customer-list'))
                                        <div class="menu-item">
                                            <a class="menu-link @if (\Route::currentRouteName() == 'confirm-vip-customer-list') active @endif" href="{{ route('confirm-vip-customer-list') }}">
                            ...
                            @if (Auth()->user() !== null && Auth()->user()->role_id == 5)
                                <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
                                    class="app-sidebar-menu-primary menu menu-column menu-rounded menu-sub-indention menu-state-bullet-primary px-3 mb-5">
                                    <div class="menu-item">
                                        <a class="menu-link @if (\Route::currentRouteName() == 'driver-dashboard') active @endif" href="{{ route('driver-dashboard') }}">
                                            <span class="menu-icon"><i class="fa fa-home fs-2"
                                                    aria-hidden="true"></i></span><span class="menu-title">
                                                Dashboard</span>
                                        </a>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link"
                                            class="menu-link @if (\Route::currentRouteName() == 'driver-leave.index') active @endif"
                                            href="{{ route('driver-leave.index') }}">
                                            <span class="menu-icon"><i
                                                    class="fa-solid fa-house"></i></span><span
                                                class="menu-title">
                                                Leave</span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link"
                                            class="menu-link @if (\Route::currentRouteName() == 'driver-ticket.index') active @endif"
                                            href="{{ route('driver-ticket.index') }}">
                                            <span class="menu-icon"><i
                                                    class="fa-solid fa-ticket"></i></span><span
                                                class="menu-title">
                                                Ticket</span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link @if (\Route::currentRouteName() == 'driver-holiday') active @endif" href="{{ route('driver-holiday') }}">
                                            <span class="menu-icon"><i class="fa-solid fa-pencil"></i></span><span class="menu-title">
                                                Holidays</span>
                                        </a>
                                    </div>
                            ...
                            @if (Auth()->user() !== null && Auth()->user()->role_id == 7)
                                <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link"
                                            class="menu-link @if (\Route::currentRouteName() == 'transport-leave.index') active @endif"
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link"
                                            class="menu-link @if (\Route::currentRouteName() == 'transport-ticket.index') active @endif"
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link @if (\Route::currentRouteName() == 'transport-holiday') active @endif" href="{{ route('transport-holiday') }}">
                                            <span class="menu-icon"><i class="fa-solid fa-pencil"></i></span><span class="menu-title">
                                                Holidays</span>
                                        </a>
                                    </div>
                            ...
                            @if (Auth()->user() !== null && Auth()->user()->role_id == 8)
                                <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link"
                                            class="menu-link @if (\Route::currentRouteName() == 'warehouse-leave.index') active @endif"
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link"
                                            class="menu-link @if (\Route::currentRouteName() == 'warehouse-ticket.index') active @endif"
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link @if (\Route::currentRouteName() == 'warehouse-holiday') active @endif" href="{{ route('warehouse-holiday') }}">
                                            <span class="menu-icon"><i class="fa-solid fa-pencil"></i></span><span class="menu-title">
                                                Holidays</span>
                                        </a>
                                    </div>
                            ...
                            @if (Auth()->user() !== null && Auth()->user()->role_id == 9)
                                <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
                                    ...
                                    @if (Permission::checkPermission('pending-order-list'))
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link"
                                                class="menu-link @if (\Route::currentRouteName() == 'sale-confirm-order') active @endif"
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link"
                                                class="menu-link @if (\Route::currentRouteName() == 'sale-cancel-order') active @endif"
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link"
                                                class="menu-link @if (\Route::currentRouteName() == 'sale-return-order') active @endif"
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link"
                                                class="menu-link @if (\Route::currentRouteName() == 'sale-deliver-order') active @endif"
                                    ...
                                    @if (Permission::checkPermission('vip-customer-list'))
                                        <div class="menu-item">
                                            <a class="menu-link @if (\Route::currentRouteName() == 'sale-manager-vip-customer-list') active @endif" href="{{ route('sale-manager-vip-customer-list') }}">
                                                <span class="menu-icon"><i class="fa fa-star fs-2"
                                                        aria-hidden="true"></i></span><span class="menu-title">
                                                    VIP Customer</span>
                                            </a>
                                    ...
                                    @endif
                                    <div class="menu-item">
                                        <a class="menu-link @if (\Route::currentRouteName() == 'sale-manager-team.index') active @endif" href="{{ route('sale-manager-team.index') }}">
                                            <span class="menu-icon"><i class="fa-solid fa-people-group"></i></span><span class="menu-title">
                                                        All Teams</span>
                                        </a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link"
                                            class="menu-link @if (\Route::currentRouteName() == 'sales-leave.index') active @endif"
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link"
                                            class="menu-link @if (\Route::currentRouteName() == 'sales-ticket.index') active @endif"
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link @if (\Route::currentRouteName() == 'sales-holiday') active @endif" href="{{ route('sales-holiday') }}">
                                            <span class="menu-icon"><i class="fa-solid fa-pencil"></i></span><span class="menu-title">
                                                Holidays</span>
                                        </a>
                                    </div>
                            ...
                            @if (Auth()->user() !== null && Auth()->user()->role_id == 10)
                                <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
                                    ...
                                    @if (Permission::checkPermission('vip-customer-list'))
                                        <div class="menu-item">
                                            <a class="menu-link @if (\Route::currentRouteName() == 'sale-service-vip-customer-list') active @endif" href="{{ route('sale-service-vip-customer-list') }}">
                                                <span class="menu-icon"><i class="fa fa-star fs-2"
                                                        aria-hidden="true"></i></span><span class="menu-title">
                                                    VIP Customer</span>
                                            </a>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link"
                                            class="menu-link @if (\Route::currentRouteName() == 'sale-service-leave.index') active @endif"
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link"
                                            class="menu-link @if (\Route::currentRouteName() == 'sale-service-ticket.index') active @endif"
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link @if (\Route::currentRouteName() == 'sale-service-holiday') active @endif" href="{{ route('sale-service-holiday') }}">
                                            <span class="menu-icon"><i class="fa-solid fa-pencil"></i></span><span class="menu-title">
                                                Holidays</span>
                                        </a>
                                    </div>
                            ...
                            @endif
                            @if (Auth()->user() !== null && Auth()->user()->role_id !== 1 && Auth()->user()->is_manager == '1' && Auth()->user()->role_id !== 9)
                                @php $manager = DB::table('team')->where('manager_id',Auth()->user()->id)->first(); @endphp
                                @if(!blank($manager))
                            ...
                            @if (Auth()->user() !== null && Auth()->user()->role_id !== 5)
                                <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
                                    class="app-sidebar-menu-primary menu menu-column menu-rounded menu-sub-indention menu-state-bullet-primary px-3 mb-5 log_menu">
                                    <div class="menu-item">
                                        <a class="menu-link @if (\Route::currentRouteName() == 'all-logs') active @endif"
                                            href="{{ route('all-logs') }}">
                                            <span class="menu-icon"><i class="fa-solid fa-clock-rotate-left"></i></span><span class="menu-title">
                                                Logs</span>
                                        </a>
