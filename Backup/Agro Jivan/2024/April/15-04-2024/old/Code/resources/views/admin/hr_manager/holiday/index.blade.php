                                    ...
                                    <div class="card-title">
                                        <div class="d-flex align-items-center position-relative my-1">
                                            ...
                                            <input type="text" data-kt-user-table-filter="search" id="search_data"
                                                onkeyup="holidayAjaxList(1)" class="form-control w-250px ps-13"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <label for="Status" class="required fs-6 fw-semibold mb-2">Holiday Date</label>
                        <input class="form-control" type="date" name="edit_holiday_date" id="edit_holiday_date"
                            placeholder="Enter Holiday Date" value="" min="{{ date('Y-m-d') }}">
                        <span id="edit_holiday_date_error" class="text-danger"></span>
                    </div>
                    <div class="row mt-2">
                        <label for="Status" class="required fs-6 fw-semibold mb-2">Holiday name</label>
                        <input class="form-control" type="text" name="edit_holiday_name" id="edit_holiday_name"
                            placeholder="Enter Holiday Name">
            ...
            function updateHoliday() {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        holidayAjaxList(parseInt(document.querySelector('.pagination .page-item.active .page-link').innerText));
                    },
                    error: function(error) {
                        toastr.error(error.responseJSON.message)
                    }
