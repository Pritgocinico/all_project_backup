...
@section('page')
    <script>
        ...
        if(role_id == '5'){
            ajaxList = "{{ route('driver-ticket-ajax') }}";
            storeURL = "{{ route('driver-ticket.store') }}";
            edit = "{{ route('driver-ticket.edit', 'id') }}";
            update = "{{ route('driver-ticket.update', 'id') }}";
            deleteURL = "{{ route('driver-ticket.destroy', 'id') }}";
            exportFile = "{{ route('driver-ticket-ajax-export') }}";
        }
        if(role_id == 7){
