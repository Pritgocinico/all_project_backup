...
Route::group(['prefix' => 'admin'], function(){
    Route::middleware('auth','role:admin','autoLogout')->group(function () {
        ...
        // User Logs
        Route::get('all-logs',[UserLogController::class,'index'])->name('all-logs');
...
Route::group(['prefix' => 'driver'], function(){
    Route::middleware(['auth','role:driver','autoLogout'])->group(function () {
        ...
        Route::resource('driver-leave',EmployeeLeaveController::class);
        Route::get('driver-leave-ajax',[EmployeeLeaveController::class,'ajaxList'])->name('driver-leave-ajax');
        Route::get('driver-leave-export',[EmployeeLeaveController::class,'exportCSV'])->name('driver-leave-export');

        Route::resource('driver-ticket',TicketController::class);
        Route::get('driver-ticket-ajax',[TicketController::class,'ajaxList'])->name('driver-ticket-ajax');
        Route::get('driver-ticket-ajax-export',[TicketController::class,'exportCSV'])->name('driver-ticket-ajax-export');
        Route::post('driver-ticket-comment',[TicketController::class,'ticketComment'])->name('driver-ticket-comment');

        Route::get('driver-holiday',[EmployeeHolidayController::class,'index'])->name('driver-holiday');
        Route::get('driver-holiday-ajax',[EmployeeHolidayController::class,'ajaxList'])->name('driver-holiday-ajax');
        Route::get('driver-holiday-export',[EmployeeHolidayController::class,'exportCSV'])->name('driver-holiday-export');
    });
});
...
Route::group(['prefix' => 'transport'], function(){
    ...
    Route::get('batch-list',[TransportDepartmentController::class,'https://portal.agrojivan.com/warehouse/warehouse-dashboard'])->name('batch-list');  
