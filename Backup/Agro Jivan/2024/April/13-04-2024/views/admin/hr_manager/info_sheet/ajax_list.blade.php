        ...
        @forelse ($infoSheetList as $info)
            <tr>
                ...
                <td class="btn-actions">
                    <a class="btn btn-icon btn-info w-30px h-30px me-3" href="{{ route('info-sheet.edit', $info->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Edit Info Sheet" data-bs-original-title="Edit Info Sheet" aria-describedby="tooltip553274">
