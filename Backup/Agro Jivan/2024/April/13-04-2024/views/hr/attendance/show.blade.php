                                            ...
                                            <div id="kt_app_content" class="flex-column-fluid ">
                                                <div id="kt_app_content_container" class="container-fluid ">
                                                    <div class="card-body py-4">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="card-body py-4 table-responsive attendance_table_scroll"
                                                                ...
                                                                <div class="modal-dialog modal-lg">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header justify-content-start">
                                                                            <h5 class="modal-title houmanity-color"
                                                                                id="log_detail_date">
                                                                                {{ date('d-m-Y') }}</h5>
                                                                        </div>
                                                                        <div class="row gy-10 mt-1">
                                                                            <div class="col-md-6 mt-0">
                                                                                <div data-kt-href="true"
                                                                                    ...
                                                                                    <h3
                                                                                        class="ps-12 text-gray-900 fw-bold letter-spacing fs-4">
                                                                                        Login At : </h3>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6 mt-0">
                                                                                <div data-kt-href="true"
                                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                                    <h3 class="ps-12 text-gray-900 fw-normal letter-spacing fs-4"
                                                                                        id="side_login_at"></h3>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                            ...
                                                                            <div class="">
                                                                                <div class="table-responsive"
                                                                                    ...
                                                                                    <table id=""
                                                                                        ...
                                                                                        <tbody class="side_break_logs"></tbody>
                                                                                    </table>
                                                                                </div>
                                                                            </div>
                                                                            <hr>
            ...
            function loadLogDetail() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#side_repeate_login').html(repeatTime);
                        ...
                        $('#side_work_hours').html(hours.hours + ' hours: ' + hours.minutes + 'minutes');
                        var html = "";
                        ...
                        $('.side_break_logs').html('');
                        $('.side_break_logs').html(html);
                        $.ajax({
                            type: 'GET',
                            url: breakCount,
                            data: {
                            ...
                            success: function(data) {
                                $('#side_break_time_count').html(data);
                            }
                        });
                        $.ajax({
                            type: "GET",
                    ...
                    error: function() {
                        ...
                        $('#side_login_at').html('-')
                        $('#side_logout_at').html('-')
                        $('#side_repeate_login').html('-')
                        $('#side_work_hours').html('-')
                        $('#side_break_time_count').html('-')
                        html = "<tr><td class='text-center' colspan='3'>No Data Available</td></tr>";
                        $('.side_break_logs').html('');
                        $('.side_break_logs').html(html);
                    }
