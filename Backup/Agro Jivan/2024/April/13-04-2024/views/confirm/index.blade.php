                        ...
                        <div class="col-md-12">
                            <div class="row pt-0 gy-5 g-xl-10 agro-parent-main-dashboard">
                                ...
                                <div class="agro-main-dashboard-child">
                                    <a href="{{ route('confirm-order') }}" target="_blank">
                                        <!--begin::Card widget 2-->
                                ...
                                <!--end::Col-->
                                <div class="agro-main-dashboard-child">
                                    <a href="{{ route('manual-order') }}" target="_blank">
                                        <!--begin::Card widget 2-->
                                        <div class="card h-lg-100 bg-arielle-smile">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex flex-column my-7">
                                                    <!--begin::Number-->
                                                    <span
                                                        class="fw-semibold fs-3x text-white lh-1 ls-n2">{{ $data['pendingCount'] }}</span>
                                                    <!--end::Number-->
                                        ...
                                        <div class="card h-lg-100 bg-midnight-bloom">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex flex-column my-7">
                                                    <!--begin::Number-->
                                                    <span
                                                        class="fw-semibold fs-3x text-white lh-1 ls-n2">{{ $data['confirmCount'] }}</span>
                                                    <!--end::Number-->
                                ...
                                <!--begin::Col-->
                                <div class="agro-main-dashboard-child">
                                    <a href="{{ route('deliver-order') }}" target="_blank">
                                        <!--begin::Card widget 2-->
                                        <div class="card h-lg-100 bg-grow-ice">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex flex-column my-7">
                                                    <!--begin::Number-->
                                                    <span
                                                        class="fw-semibold fs-3x text-white lh-1 ls-n2">{{ $data['deliverCount'] }}</span>
                                                    <!--end::Number-->
                                ...
                                <!--begin::Col-->
                                <div class="agro-main-dashboard-child ">
                                    <a href="{{ route('cancel-order') }}" target="_blank">
                                        <!--begin::Card widget 2-->
                                        <div class="card h-lg-100 bg-grow-stone">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex flex-column my-7">
                                                    <!--begin::Number-->
                                                    <span
                                                        class="fw-semibold fs-3x text-white lh-1 ls-n2">{{ $data['cancelCount'] }}</span>
                                                    <!--end::Number-->
                                ...
                                <div class="agro-main-dashboard-child">
                                    <a href="{{ route('return-order') }}" target="_blank">
                                        <!--begin::Card widget 2-->
                                        <div class="card h-lg-100 bg-grow-early">
                                            <!--begin::Body-->
                                            <div
