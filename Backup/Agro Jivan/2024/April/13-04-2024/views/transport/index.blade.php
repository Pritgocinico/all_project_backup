                        ...
                        <div class="col-md-12">
                            <div class="row gy-5 g-xl-10 agro-parent-main-dashboard">
                                <div class="agro-main-dashboard-child">
                                    <a href="{{ route('transport-confirm-order') }}">
                                        <div class="card h-lg-100 bg-grow-early">
                                            <div
                                                ...
                                                <div class="d-flex flex-column my-7">
                                                    <span class="fw-semibold fs-3x lh-1 ls-n2 text-white">{{$confirmCount}}</span>
                                                    <div class="m-0">
                                    ...
                                    <a href="{{ route('batch-list') }}">
                                        <div class="card h-lg-100 bg-arielle-smile">
                                            <div
                                                ...
                                                <div class="d-flex flex-column my-7">
                                                    <span class="fw-semibold fs-3x text-black-800 lh-1 ls-n2 text-white">{{$batchCount}}</span>
                                                    <div class="m-0">
                                                        <span class="fw-semibold fs-2x text-white">
                                                            Total Batch</span>
                                                    </div>
                                    ...
                                    <a href="{{ route('in-out-stock') }}">
                                        <div class="card h-lg-100 bg-midnight-bloom">
                                            <div
                                                ...
                                                <div class="d-flex flex-column my-7">
                                                    <span class="fw-semibold fs-3x text-white lh-1 ls-n2">{{$inOutStockCount->total_in_stock}}</span>
                                                    <div class="m-0">
                                                        <span class="fw-semibold fs-2x text-white">
                                    ...
                                    <a href="{{ route('in-out-stock') }}">
                                        <div class="card h-lg-100 bg-grow-ice">
                                            <div
                                                ...
                                                <div class="d-flex flex-column my-7">
                                                    <span class="fw-semibold fs-3x text-white lh-1 ls-n2">{{$inOutStockCount->total_out_stock}}</span>
                                                    <div class="m-0">
                                                        <span class="fw-semibold fs-2x text-white">
                                                            Total In Stock</span>
                                                    </div>
