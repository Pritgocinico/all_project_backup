...
class BatchRepository implements BatchRepositoryInterface
{
    ...
    {
        $query = $this->getQuery($search, $date, $driverId)->latest();
        if ($type == 'paginate') {
    ...
    public function getQuery($search, $date, $driverId)
    {
    ...
    {
        return BatchDetail::with('orderItemDetail', 'orderItemDetail.productDetail', 'orderItemDetail.schemeDetail', 'orderItemDetail.schemeDetail.discountItemDetail')->where('batch_id', $id)->get();
    }
