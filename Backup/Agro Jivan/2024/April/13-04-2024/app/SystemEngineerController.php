...
class SystemEngineerController extends Controller
{
    ...
    public function index()
    {
        ...
        $ticketCount = $this->ticketRepository->totalTicketCount('System Repair');
        return view('system.index', compact('ticketCount','page'));
    }
    ...
    {
        $search = $request->search;
        $SystemCodeList = $this->employeeRepository->getAllData('', '', $search, 'paginate');
