            ...
            <div id="kt_app_toolbar_container" class="app-container  container-fluid d-flex align-items-stretch ">
                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <a href="{{ route('confirm-orders.create') }}" class="btn btn-flex btn-primary h-40px fs-7 fw-bold">
                            <i class="fa-solid fa-plus"></i>&nbsp; New Orders
                        </a>
                        <a href="{{ route('confirm-manual-order') }}" class="btn btn-flex btn-primary h-40px fs-7 fw-bold">
                                    ...
                                    <div class="card h-lg-100 bg-grow-early">
                                        ...
                                        <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                            ...
                                            <div class="d-flex flex-column my-7">
                                                <!--begin::Number-->
                                                <span class="fw-semibold fs-3x text-white lh-1 ls-n2" id="total_order_count"></span>
                                                <!--end::Number-->
                                ...
                                <a href="{{ route('confirmation-order-list') }}?status=2">
                                    ...
                                    <div class="card h-lg-100 bg-midnight-bloom">
                                        ...
                                        <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                            ...
                                            <div class="d-flex flex-column my-7">
                                                <!--begin::Number-->
                                                <span class="fw-semibold fs-3x text-white lh-1 ls-n2" id="confirmed_order_count"></span>
                                                <!--end::Number-->
                                ...
                                <a href="{{ route('confirmation-order-list') }}?status=6">
                                    ...
                                    <div class="card h-lg-100 bg-grow-ice">
                                        ...
                                        <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                            ...
                                            <div class="d-flex flex-column my-7">
                                                <!--begin::Number-->
                                                <span class="fw-semibold fs-3x text-white lh-1 ls-n2" id="delivered_order_count"></span>
                                                <!--end::Number-->
                                ...
                                <a href="{{ route('confirmation-order-list') }}?status=4">
                                    ...
                                    <div class="card h-lg-100 bg-grow-stone">
                                        ...
                                        <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                            ...
                                            <div class="d-flex flex-column my-7">
                                                <!--begin::Number-->
                                                <span class="fw-semibold fs-3x text-white lh-1 ls-n2" id="cancel_order_count"></span>
                                                <!--end::Number-->
                                ...
                                <a href="{{ route('confirmation-order-list') }}?status=5">
                                    ...
                                    <div class="card h-lg-100 bg-grow-early">
                                        ...
                                        <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                            ...
                                            <div class="d-flex flex-column my-7">
                                                <!--begin::Number-->
                                                <span class="fw-semibold fs-3x text-white lh-1 ls-n2" id="return_order_count"></span>
                                                <!--end::Number-->
                            ...
                            <div class="d-flex flex-column my-7 me-1">
                                <div class="row mx-5 align-items-center">
                                    ...
                                    <div class="col-xl-4 col-md-4">
                                        <input type="text" class="form-control search_date" id="search_date" name="search_date" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="card-body d-flex justify-content-between align-items-start flex-column w-50 m-auto">
                        ...
                        <div class="card bg-light">
                            ...
                            <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                <div class="d-flex justify-content-start mb-7 w-100 flex-column-1299">
                                    <input type="text" class="form-control search_date_picker" id="winner_date_picker" name="winner_date_picker" value="">&nbsp;

                                    <input type="button" name="button" class="btn btn-primary" value="Search" onclick="getwinnerCount()">
                                </div>
                                <!--begin::Avatar-->
                                <div class="symbol symbol-100px symbol-circle mb-7">
                                    <img src="{{ url('/') }}/public/assets/media/dashboard/winner.png" width="150px" alt="">
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Name-->
                                ...
                                <div class="d-flex flex-center flex-wrap">
                                    ...
                                    <div class="row gap-5 w-100">
                                        ...
                                        <div class="text-center">
                                            <a class="btn btn-primary" onclick="viewAll()" href="#">See All</a>
                                        </div>
                                        @endif
                                    </div>
...
<script>
    ...
    function viewAll(){
        window.location.href = '{{route("show-winner-list")}}?date='+$('#winner_date_picker').val();
    }
</script>
@endsection