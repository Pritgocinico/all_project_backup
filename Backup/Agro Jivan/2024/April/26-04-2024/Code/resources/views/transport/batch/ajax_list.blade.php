    ...
    <tbody class="text-gray-600 fw-semibold">
        ...
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-icon btn-success w-30px h-30px me-3" href="#" onclick="editBatch({{ $batch->id }})" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Edit Batch" data-bs-original-title="Edit Batch" aria-describedby="tooltip553274">
