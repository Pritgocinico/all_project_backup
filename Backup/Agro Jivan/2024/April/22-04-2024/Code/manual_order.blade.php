                            ...
                            <div
                                ...
                                <div class="card-toolbar">
                                    <div class="d-flex justify-content-end custom-responsive-div"
                                        ...
                                        <button type="button" class="btn btn-light-primary me-3" onclick="showPendingOrderItem()">
...
<input type="hidden" id="confirm_role_id" name="confirm_role_id" value="{{Auth()->user() !== null? Auth()->user()->role_id:""}}">
    </body>
@endsection
...
@section('page')
    <script>
        ...
        function generatePDF(){
            ...
            var user_id = $('#user_id').val();
            var date = $('#search_date').val();
        window.open(pdfUrl + '?search=' + search + "&order_district="+order_district + "&userId="+user_id + "&date="+date, '_blank');
        }
    </script>
