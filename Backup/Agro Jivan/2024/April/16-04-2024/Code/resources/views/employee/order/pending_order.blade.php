                ...
                <div id="kt_app_content_container" class="container-fluid ">
                    ...
                    <div id="kt_app_content" class="flex-column-fluid ">
                        <div id="kt_app_content_container" class="app-container  container-fluid ">
                            ...
                            <div class="card-body py-4 table-responsive" id="pending_order_table_ajax">
                            </div>
                        </div>
                    </div>
                </div>
...
@section('page')
    <script>
        var pendingOrderList = "{{route('employee-pending-orderlist')}}";
        var exportFile = "{{route('employee-orders-export')}}";
        var date = "{{date('Y-m-d')}}"
    </script>
    <script src="{{ asset('public\assets\js\custom\employee\employee_pendingorder.js') }}?{{ time() }}"></script>
