...
function employeeOrderAjaxList(page) {
    ...
    $.ajax({
        ...
        success: function (res) {
            $('#cancel_order_table_ajax').html('');
            $('#cancel_order_table_ajax').html(res);
...
function exportCSV(){
    ...
    window.open(exportFile + '?format=' + format + '&search=' + search +'&district=' + district + '&date=' + date+'&type=cancel', '_blank');
}
