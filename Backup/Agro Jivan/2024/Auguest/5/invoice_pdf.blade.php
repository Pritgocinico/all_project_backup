            ...
            <tbody>
                <tr>
                    ...
                    <td style="padding: 5px 24px; width: 50%; text-align: left; margin-bottom: auto;">
                        ...
                        <p style="margin:3px 0px; font-size: 20px;">State:- <b>{{ $orders->stateDetail->name }}, {{$orders->pincode}}</b>
                        </p>
            ...
            <table class="table table-hover" border="1"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="padding: 5px 24px;text-align: center">{{ number_format($gstPrice, 2) }}</td>
