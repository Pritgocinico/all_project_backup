                                ...
                                <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
                                    ...
                                    @if (
                                        \Route::currentRouteName() == 'orders.index' ||
                                            ...
                                            \Route::currentRouteName() == 'admin-lead.index' ||
                                    ...
                                    <div data-kt-menu-trigger="click"
                                        ...
                                        <div class="menu-sub menu-sub-accordion"><!--begin:Menu item-->
                                            <div class="menu-item"><!--begin:Menu link--><a
                                                    class="menu-link @if (\Route::currentRouteName() == 'admin-lead.index') active @endif"
                                                    href="{{ route('admin-lead.index') }}"><span
                                                        class="menu-bullet"><span
                                                            class="bullet bullet-dot"></span></span><span
                                                        class="menu-title">Leads</span></a><!--end:Menu link-->
                                            </div>
                                        </div>
                                        <div class="menu-sub menu-sub-accordion"><!--begin:Menu item-->
                                            <div class="menu-item"><!--begin:Menu link--><a
                            ...
                            @if (Auth()->user() !== null && Auth()->user()->role_id == 7)
                                <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
                                    ...
                                    @if (Permission::checkPermission('batch-list'))
                                        <div class="menu-item">
                                            <a class="menu-link @if (\Route::currentRouteName() == 'transport-batch-list') active @endif"
                                                href="{{ route('transport-batch-list') }}">
                                                <span class="menu-icon"><i class="fa-brands fa-first-order fs-2"
                                                        aria-hidden="true"></i></span><span class="menu-title">
                                                    Batch</span>
                                            </a>
                            ...
                            @if (Auth()->user() !== null && Auth()->user()->role_id == 9)
                                <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
                                    ...
                                    @if (Permission::checkPermission('pending-order-list'))
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link @if (\Route::currentRouteName() == 'daily-order-list') active @endif"
                                                href="{{ route('daily-order-list') }}">
                                                <span class="menu-icon"><i
                                                        class="fa-solid fa-clipboard-check fs-2"></i></span><span
                                                    class="menu-title">
                                                    Today Confirmed</span>
