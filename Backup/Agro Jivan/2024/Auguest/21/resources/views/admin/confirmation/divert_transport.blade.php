...
@section('section')
                    ...
                    <div id="kt_app_content" class="flex-column-fluid ">
                        <div id="kt_app_content_container" class="container-fluid ">
                            <div
                                ...
                                <input type="hidden" name="order_id" id="order_id" value="{{ $driverId }}">
                                                ...
                                                <div class="px-7 py-5" data-kt-user-table-filter="form">
                                                    <div class="mb-10">
                                                        ...
                                                        <select class="form-select form-select-solid fw-bold"
                                                            ...
                                                            data-allow-clear="true" data-kt-user-table-filter="two-step" onchange="getSubDistrictDetail()"
                                                    ...
                                                    <div class="mb-10">
                                                        ...
                                                        <select class="form-select form-select-solid fw-bold"
                                                            id="user_id" data-placeholder="Select option"
    ...
    <input type="hidden" id="deliver_role_id" value="{{Auth()->user() !== null? Auth()->user()->role_id:""}}">
    </body>
@endsection

@section('page')
    <script>
        var ajaxList = "{{ route('divert-transport-ajax') }}";
        var exportUrl = "{{ route('manual-orders-export') }}";
        var token = "{{ csrf_token() }}"
        var role = $('#deliver_role_id').val();
        ...
        if(role == 4){
            ajaxList = "{{ route('confirm-transport-ajax') }}";
        }
        var type = "divert";
        ...
        function exportCSV2() {
            ...
            window.open("{{ route('manual-orders-export') }}" + '?format=' + format + '&search=' + search + '&type=divert',
                '_blank');
        }
    </script>
