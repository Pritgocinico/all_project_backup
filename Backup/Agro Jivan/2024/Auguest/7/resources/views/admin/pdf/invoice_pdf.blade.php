            ...
            <tbody>
                <tr>
                    <td style="padding: 5px 24px; width: 50%; text-align: left;    ">
                        ...
                        @endif
                        <p style="margin:3px 0px; font-size: 20px; ">Agent Name: <span
                                style="">{{ isset($orders->userDetail) ? $orders->userDetail->name : '-' }}</span>
                        </p>
                    ...
                    <td style="padding: 5px 24px; width: 50%; text-align: left; margin-bottom: auto;">
                        ...
                        <p style="margin:3px 0px; font-size: 20px;">Village:-
                            <b>{{ $orders->villageDetail->village_name }}</b>
                        </p>
                        <p style="margin:3px 0px; font-size: 20px;">Sub District:-
                            <b>{{ $orders->subDistrictDetail->sub_district_name }}</b>
                        </p>
                        <p style="margin:3px 0px; font-size: 20px;">District:-
                            <b>{{ $orders->districtDetail->district_name }}</b>
                        </p>
                        <p style="margin:3px 0px; font-size: 20px;">State:- <b>{{ $orders->stateDetail->name }},
                                {{ $orders->pincode }}</b>
                        </p>
