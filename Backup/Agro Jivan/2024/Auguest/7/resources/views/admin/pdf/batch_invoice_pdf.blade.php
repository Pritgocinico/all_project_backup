                            ...
                            <tr>
                                ...
                                <td style="width: 50px; padding:5px 5px;text-align: center">
                                    @php
                                        if ($item->productDetail->product_type == 'tax_product') {
                                            $percentage = $setting->bill_amount_percentage;
                                            $cutPrice = ($item->amount * $percentage) / 100;
                                            $toatalPrice = $item->amount - $cutPrice;
                                        } else {
                                            $toatalPrice = $item->amount;
                                        }
                                    @endphp
                                ...
                                <td style="width: 50px; padding:5px 5px;text-align: center">
                                    @php
                                        ...
                                        $CGPrice = ($toatalPrice * $item->productDetail->c_gst) / 100;
                                        $totalCGPrice += $CGPrice;
                                    @endphp
                                    {{ number_format($CGPrice, 2) }} /
                                    @php
                                        $SGPrice = ($toatalPrice * $item->productDetail->s_gst) / 100;
