...
class AdminDashboardController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $totalEmployeePresent = $this->adminDashboardRepository->userLoginCount(1);
        $totalEmployeeAbsent = $this->adminDashboardRepository->userLoginCount(0);
    ...
    public function OrderProductChart(Request $request){
        $date = $request->search_date;
        $productOrderChart = $this->adminDashboardRepository->getOrderProductChart($date);
        return response()->json($productOrderChart);
    }
}
