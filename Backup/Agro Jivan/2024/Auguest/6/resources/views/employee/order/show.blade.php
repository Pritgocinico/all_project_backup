                                ...
                                <div class="card-body pt-15">
                                    ...
                                    <div id="kt_customer_view_details" class="collapse show">
                                        <div class="py-5 fs-6">
                                            ...
                                            <div class="text-gray-600">
                                                {{ Utility::convertDmyWith12HourFormat($order->created_at) }}</div>
                                            <div class="fw-bold mt-5">Created By</div>
                                            <div class="text-gray-600">{{ $order->userDetail->name }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <table class="table align-middle table-row-dashed gy-5"
                                                ...
                                                <tbody class="fs-6 fw-semibold text-gray-600">
                                                    @forelse ($order->orderItem as $item)
                                                        <tr>
                                                            <td><img src="{{ ImageHelper::getImageUrl($item->productDetail->product_imag) }}" height="60px"
                                                                alt=""></td>
                                                            <td>{{ $item->productDetail->product_name }}</td>
                                                            <td>{{ $item->categoryDetail->name }}</td>
                                                            <td>{{ $item->varientDetail->sku_name }}</td>
