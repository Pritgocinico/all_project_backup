                            ...
                            <div
                                ...
                                <div class="card-title">
                                    <div class="d-flex align-items-center position-relative my-1">
                                        ...
                                        <input type="text" data-kt-user-table-filter="search" id="search_data"
                                            class="form-control w-250px ps-13" placeholder="Search Lead" onkeyup="leadAjaxList(1)" />
                                    </div>
                                </div>
                                <div class="card-toolbar">
                                    <div class="d-flex justify-content-end custom-responsive-div"
                                                        ...
                                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                            <form id="" class="form" action="#">
                                                                ...
                                                                <div class="text-center">
                                                                    ...
                                                                    <button type="button" class="btn btn-primary" onclick="exportCSV2()">
                                                                        Submit
                                                                    </button>
                                                                </div>
                                                            </form>
                                        ...
                                        @php
                                            $route = route('employee-lead.create');
                                            if(isset(Auth()->user()->role_id) && Auth()->user()->role_id == 1){
                                                $route = route('admin-lead.create');
                                            }
                                        @endphp
                                            <a href="{{ $route }}"
...
@section('page')
    <script>
        ...
        if(role == 1){
            ...
            ajaxList = "{{ route('admin-lead-ajax') }}";
            exportFile = "{{ route('admin-lead-export') }}";
            convertUrl = "{{ route('admin-convert-lead-order') }}"
        }
