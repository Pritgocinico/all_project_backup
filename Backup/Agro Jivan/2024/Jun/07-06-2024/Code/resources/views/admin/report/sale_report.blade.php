                                                ...
                                                <div class="px-7 py-5" data-kt-user-table-filter="form" id="filter_menu_option_form">
                                                    ...
                                                    <div class="mb-5">
                                                        ...
                                                        <input type="text" placeholder="Select Date"
                                                            ...
                                                            name="search_date" value="2024-04-01/{{date('Y-m-d')}}">&nbsp;
                                                    </div>
...
@section('page')
    <script>
        ...
        function exportCSV() {
            ...
            var order_district = $('#order_district').val();
            var order_sub_district = $('#order_sub_district').val();
            window.open("{{ route('sales-report-export') }}" + '?format=' + format + '&order_status=' + order_status +
                '&search=' + search + '&date=' + date + "&user_id="+user_id + "&order_district="+ order_district + "&order_sub_district=" + order_sub_district, '_blank');
        }
