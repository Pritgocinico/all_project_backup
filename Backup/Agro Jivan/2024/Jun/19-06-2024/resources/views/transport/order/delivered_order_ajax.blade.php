<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
    <thead>
        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
            ...
            @if (Auth()->user() !== null &&
                    (Auth()->user()->role_id == 1 || Auth()->user()->role_id == 9 || Auth()->user()->role_id == 2))
            ...
            <th class="min-w-100px">Delivered AT</th>
        </tr>
    </thead>
            ...
            <tr>
                ...
                <td class="align-middle">
                    ...
                    @elseif(Auth()->user()->role_id == 7)
                        @php $route = route('transport-confirm-view', $order->id) @endphp
                    @endif
                ...
                <td style="white-space: normal!important">
                    ...
                    @if ($order->delivery_date !== null)
                        @php $date = Utility::convertDmyWith12HourFormat($order->delivery_date) ; @endphp
                    @endif
                    {{ $date }}
                </td>
