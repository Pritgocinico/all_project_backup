                                        ...
                                        <div class="menu filter-menu custom-close w-300px w-md-325px" data-kt-menu="true">
                                            ...
                                            <div class="px-7 py-5" data-kt-user-table-filter="form">
                                                ...
                                                <div class="mb-10">
                                                    ...
                                                    <select class="form-select form-select-solid fw-bold" id="user_id" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="two-step" data-hide-search="true">
                                                        <option value="">Select User</option>
                                                        @foreach ($userData as $user)
                                                        @if(isset($user->userDetail))
                                                        <option value="{{$user->created_by}}">{{$user->userDetail->name}}</option>
                                                        @endif
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="mb-10">
                                                    ...
                                                    <input type="text" placeholder="Select Date" class="form-control search_date" id="search_date" name="search_date" value="">&nbsp;
                                                </div>
...
@section('page')
<script>
    var ajaxList = "{{ route('orders-ajax') }}";
