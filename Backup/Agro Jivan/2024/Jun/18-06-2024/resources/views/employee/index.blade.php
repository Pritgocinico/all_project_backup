                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                        <div class="d-flex align-items-center gap-2 gap-lg-3 mt-3">
                            ...
                            <a href="{{ route('employee-lead.create') }}" class="btn btn-flex btn-primary h-40px fs-7 fw-bold">
                ...
                <div class="row gy-5 g-xl-10">
                            ...
                            <div class="card-header flex-sm-row flex-column border-0">
                                ...
                                <div class="card-title">
                                    <div class="d-flex justify-content-end flex-row-991 flex-column-1299">
                                        <input type="text" class="form-control search_date_picker" id="from_date_order" name="from_date_order" value="{{ date('Y-m-d') }}/{{ date('Y-m-d') }}">&nbsp;

                                        <input type="button" name="button" class="btn btn-primary" value="Search" onclick="getOrderDetail()">
                                    </div>
                                </div>
                            </div>
                            <!--begin::Body-->
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-row-dashed align-middle gs-0 gy-4 my-0 th">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <a href="{{route('employee-pending-order')}}" class="text-gray-800 fw-bold d-block mb-1 fs-2" id="pending_order_count"></a>
                                                    <span class="fw-semibold text-gray-500 d-block">Pending
                                                        Orders</span>
                                                </td>
                                                <td>
                                                    <a href="{{route('employee-confirm-order')}}" class="text-gray-800 fw-bold d-block mb-1 fs-2" id="confirm_order_count"></a>
                                                    <span class="fw-semibold text-gray-500 d-block">Confirmed
                                                        Orders</span>
                                                </td>
                                                <td>
                                                    <a href="{{route('employee-cancel-order')}}" class="text-gray-800 fw-bold d-block mb-1 fs-2" id="cancel_order_count"></a>
                                                    <span class="fw-semibold text-gray-500 d-block">Cancelled
                                                        Orders</span>
                                                </td>
                                                <td>
                                                    <a href="{{route('employee-return-order')}}" class="text-gray-800 fw-bold d-block mb-1 fs-2" id="return_order_count"></a>
                                                    <span class="fw-semibold text-gray-500 d-block">Returned
                                                        Orders</span>
                                                </td>
                                                <td>
                                                    <a href="{{route('employee-completed-order')}}" class="text-gray-800 fw-bold d-block mb-1 fs-2" id="deliver_order_count"></a>
                            ...
                            <div class="d-flex flex-column my-7 me-1">
                                <div class="row align-items-center px-2">
                                    ...
                                    <div class="col-xl-4 col-md-4">
                                        <input type="text" class="form-control search_date_picker" id="chart_date_picker" name="chart_date_picker" value="{{ date('Y-m-d') }}/{{ date('Y-m-d') }}">&nbsp;

                                    </div>
                                </div>
                            </div>
                            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                <div id="performance_chart" class="h-325px w-100 min-h-auto ps-4 pe-6">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 col-xl-4 mb-xl-10 col-xxl-4">
                        ...
                        <div class="card bg-light">
                            ...
                            <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                <div class="d-flex justify-content-start mb-7 w-100 flex-column-1299">
                                    <input type="text" class="form-control search_date_picker" id="leave_date_picker" name="leave_date_picker" value="{{ date('Y-m-01') }}/{{ date('Y-m-30') }}">&nbsp;

                                    <input type="button" name="button" class="btn btn-primary" value="Search" onclick="getLeavData()">
                                </div>
                                <!--begin::Name-->
                        ...
                        <div class="card bg-light mt-5">
                            ...
                            <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                <div class="d-flex justify-content-start mb-7 w-100 flex-column-1299">
                                    <input type="text" class="form-control search_date_picker" id="winner_date_picker" name="winner_date_picker" value="{{ $attendance['order_date'] }}">&nbsp;

                                    <input type="button" name="button" class="btn btn-primary" value="Search" onclick="getwinnerCount()">
                                </div>
                                <!--begin::Avatar-->
                            ...
                            <!--end::Avatar-->
                            <!--begin::Name-->
                            <a href="#" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">Winners</a>
                            <!--end::Name-->
                            ...
                            <div class="d-flex flex-center flex-wrap">
                                <!--begin::Stats-->
                                <div class="border d-flex align-items-center gap-3 border-gray-900 border-dotted rounded min-w-80px py-3 px-4 mb-3 w-100 text-center">
                                    <div class="symbol symbol-100px symbol-circle">
                                        <img src="{{ url('/') }}/public/assets/images/certificate/1-m.png" width="150px" alt="">
                                    </div>
                                    <div>
                                        <div class="fs-4 fw-bold text-gray-900" id="first_winner_0">
                                        </div>
                                ...
                                <div class="row gap-5 w-100">
                                    <div class="col-md-12 px-0">
                                        <div class="border d-flex align-items-center gap-3 border-gray-900 border-dotted rounded min-w-80px py-3 px-1 text-center">
                                            <div class="symbol symbol-100px symbol-circle">
                                                <img src="{{ url('/') }}/public/assets/images/certificate/2-m.png" width="150px" alt="">
                                            </div>
                                            <div>
                                    ...
                                    <div class="col-md-12 px-0">
                                        <div class="border d-flex align-items-center gap-3 border-gray-900 border-dotted rounded min-w-80px py-3 px-1 text-center">
                                            <div class="symbol symbol-100px symbol-circle">
                                                <img src="{{ url('/') }}/public/assets/images/certificate/3-m.png" width="150px" alt="">
                                            </div>
                                            <div>
...
<script>
    ...
    $(function() {
        $('.search_date_picker').daterangepicker({
            ...
            $('.search_date_picker').val(start.format('Y-MM-DD') + '/' + end.format('Y-MM-DD'));
        });
    });
    ...
    function getChartData() {
        $.ajax({
            ...
            success: function(response) {
                ...
                var color = ['blue', '#17c653', 'green', 'pink','red']
                response.labels.forEach(function(label, index) {
                    processedData.push([label, response.data[index], color[index]]);
                });
