...
class BatchRepository implements BatchRepositoryInterface
{
    ...
    public function getItemDetailById($id, $search, $date, $type,$status="")
    {
        ...
        })->whereHas('orderDetail',function($query)use($status){
    ...
    {
        return BatchDetail::with('orderDetail','orderItemDetail', 'orderItemDetail.productDetail','orderItemDetail.varientDetail', 'orderItemDetail.schemeDetail', 'orderItemDetail.schemeDetail.discountItemDetail')->where('batch_id', $id)->get();
    }
    ...
    public function getBatchDetailByOrderId($id){
        return BatchDetail::where('order_id',$id)->first();
    }

    public function deleteBatchDetailByOrderId($id){
        return BatchDetail::where('order_id',$id)->delete();
    }
    ...
    public function removerOrder($where){
        return BatchDetail::where($where)->delete();
    }

    public function delete($where){
        return Batch::where($where)->delete();
    }
}
