                ...
                <div id="kt_app_content_container" class="app-container  container-fluid ">
                    <div id="kt_app_content" class="flex-column-fluid ">
                        <div id="kt_app_content_container" class="container-fluid ">
                                                ...
                                                <div class="px-7 py-5" data-kt-user-table-filter="form">
                                                    <div class="mb-10">
                                                        ...
                                                        <select class="form-select form-select-solid fw-bold"
                                                            id="ticket_dropdown_filter" data-placeholder="Select option"
                                                    ...
                                                    <div class="mb-10">
                                                        ...
                                                        <input type="text" name="order_date" id="ticket_date" class="form-control form-select-solid fw-bold search_ticket_date" max="{{date('Y-m-d')}}" placeholder="Select Date" onchange="ticketAjaxList(1)">
                                                    </div>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h2 class="fw-bold">Export Ticket List</h2>
                            ...
                            <div class="card-body py-4 table-responsive" id="hr_ticket_ajax_table">
                            </div>
                        </div>
                    </div>
                </div>
...
@section('page')
    <script>
        var ajaxList = "{{ route('hr-ticket-ajax-list') }}"
        var exportFileTicket = "{{route('hr-ticket-export')}}";
    </script>
    <script src="{{asset('public/assets/js/custom/hr/ticket.js')}}"></script>
@endsection
